...
############################# Head ############################
head_title: "Parse Data from OTT in Java"
head_description: "Quickly parse data from documents in Java."

############################# Header ############################
title: "Parse data from OTT In Java"
description: "Parse data from OTT with a few lines of Java code."
...
demos:
    enable: true
    title: "Live Demos - Parse data from OTT Online"
    content: |
       Parse data from OTT file right now by visiting [GroupDocs.Parser Live Demos](https://products.groupdocs.app/parser/ott) website.
