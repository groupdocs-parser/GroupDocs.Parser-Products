...
############################# Head ############################
head_title: "Analizar datos de DOT en Java"
head_description: "Analice rápidamente los datos de los documentos en Java."

############################# Header ############################
title: "Analizar datos de DOT en Java"
description: "Analice los datos de DOT con unas pocas líneas de código Java."
...
demos:
    enable: true
    title: "Demostraciones en vivo: analice datos de DOT en línea"
    content: |
       Analice los datos del archivo DOT ahora mismo visitando el sitio web [GroupDocs.Parser Live Demos](https://products.groupdocs.app/parser/dot).
