...
############################# Head ############################
head_title: "Parse Data from DOCX in Java"
head_description: "Quickly parse data from documents in Java."

############################# Header ############################
title: "Parse data from DOCX In Java"
description: "Parse data from DOCX with a few lines of Java code."
...
demos:
    enable: true
    title: "Live Demos - Parse data from DOCX Online"
    content: |
       Parse data from DOCX file right now by visiting [GroupDocs.Parser Live Demos](https://products.groupdocs.app/parser/docx) website.
