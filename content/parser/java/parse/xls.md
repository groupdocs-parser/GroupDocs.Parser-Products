...
############################# Head ############################
head_title: "Parse Data from XLS in Java"
head_description: "Quickly parse data from documents in Java."

############################# Header ############################
title: "Parse data from XLS In Java"
description: "Parse data from XLS with a few lines of Java code."
...
demos:
    enable: true
    title: "Live Demos - Parse data from XLS Online"
    content: |
       Parse data from XLS file right now by visiting [GroupDocs.Parser Live Demos](https://products.groupdocs.app/parser/xls) website.
