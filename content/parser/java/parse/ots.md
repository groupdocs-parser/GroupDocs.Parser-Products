...
############################# Head ############################
head_title: "Parse Data from OTS in Java"
head_description: "Quickly parse data from documents in Java."

############################# Header ############################
title: "Parse data from OTS In Java"
description: "Parse data from OTS with a few lines of Java code."
...
demos:
    enable: true
    title: "Live Demos - Parse data from OTS Online"
    content: |
       Parse data from OTS file right now by visiting [GroupDocs.Parser Live Demos](https://products.groupdocs.app/parser/ots) website.
