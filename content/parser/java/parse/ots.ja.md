...
############################# Head ############################
head_title: "Java の OTS からのデータを解析する"
head_description: "Java のドキュメントからのデータを迅速に解析します。"

############################# Header ############################
title: "OTS からのデータを Java で解析する"
description: "数行の Java コードを使用して、OTS からのデータを解析します。"
...
demos:
    enable: true
    title: "ライブ デモ - OTS オンラインからのデータを解析する"
    content: |
       [GroupDocs.Parser ライブ デモ](https://products.groupdocs.app/parser/ots) Web サイトにアクセスして、今すぐ OTS ファイルのデータを解析してください。
