...
############################# Head ############################
head_title: "Parse Data from DOTX in Java"
head_description: "Quickly parse data from documents in Java."

############################# Header ############################
title: "Parse data from DOTX In Java"
description: "Parse data from DOTX with a few lines of Java code."
...
demos:
    enable: true
    title: "Live Demos - Parse data from DOTX Online"
    content: |
       Parse data from DOTX file right now by visiting [GroupDocs.Parser Live Demos](https://products.groupdocs.app/parser/dotx) website.
