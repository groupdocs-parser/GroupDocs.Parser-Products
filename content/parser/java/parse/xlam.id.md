...
############################# Head ############################
head_title: "Parsing Data dari XLAM di Java"
head_description: "Mengurai data dengan cepat dari dokumen di Java."

############################# Header ############################
title: "Mengurai data dari XLAM Di Java"
description: "Parsing data dari XLAM dengan beberapa baris kode Java."
...
demos:
    enable: true
    title: "Demo Langsung - Mengurai data dari XLAM Online"
    content: |
       Parse data dari XLAM file sekarang juga dengan mengunjungi situs web [GroupDocs.Parser Demo Langsung](https://products.groupdocs.app/parser/xlam).
