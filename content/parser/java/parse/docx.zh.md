...
############################# Head ############################
head_title: "解析 Java 中 DOCX 的数据"
head_description: "快速解析 Java 中文档的数据。"

############################# Header ############################
title: "解析 Java 中 DOCX 的数据"
description: "使用几行 Java 代码解析来自 DOCX 的数据。"
...
demos:
    enable: true
    title: "现场演示 - 解析来自 DOCX 在线的数据"
    content: |
       立即访问 [GroupDocs.Parser 现场演示](https://products.groupdocs.app/parser/docx) 网站解析 DOCX 文件中的数据。
       现场演示有以下好处。
