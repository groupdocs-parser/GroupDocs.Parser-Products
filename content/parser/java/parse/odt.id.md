...
############################# Head ############################
head_title: "Parsing Data dari ODT di Java"
head_description: "Mengurai data dengan cepat dari dokumen di Java."

############################# Header ############################
title: "Mengurai data dari ODT Di Java"
description: "Parsing data dari ODT dengan beberapa baris kode Java."
...
demos:
    enable: true
    title: "Demo Langsung - Mengurai data dari ODT Online"
    content: |
       Parse data dari ODT file sekarang juga dengan mengunjungi situs web [GroupDocs.Parser Demo Langsung](https://products.groupdocs.app/parser/odt).
