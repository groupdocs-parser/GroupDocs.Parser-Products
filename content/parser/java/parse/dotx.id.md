...
############################# Head ############################
head_title: "Parsing Data dari DOTX di Java"
head_description: "Mengurai data dengan cepat dari dokumen di Java."

############################# Header ############################
title: "Mengurai data dari DOTX Di Java"
description: "Parsing data dari DOTX dengan beberapa baris kode Java."
...
demos:
    enable: true
    title: "Demo Langsung - Mengurai data dari DOTX Online"
    content: |
       Parse data dari DOTX file sekarang juga dengan mengunjungi situs web [GroupDocs.Parser Demo Langsung](https://products.groupdocs.app/parser/dotx).
