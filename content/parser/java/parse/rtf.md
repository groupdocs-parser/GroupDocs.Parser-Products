...
############################# Head ############################
head_title: "Parse Data from RTF in Java"
head_description: "Quickly parse data from documents in Java."

############################# Header ############################
title: "Parse data from RTF In Java"
description: "Parse data from RTF with a few lines of Java code."
...
demos:
    enable: true
    title: "Live Demos - Parse data from RTF Online"
    content: |
       Parse data from RTF file right now by visiting [GroupDocs.Parser Live Demos](https://products.groupdocs.app/parser/rtf) website.
