...
############################# Head ############################
head_title: "Parse Data from DOTM in Java"
head_description: "Quickly parse data from documents in Java."

############################# Header ############################
title: "Parse data from DOTM In Java"
description: "Parse data from DOTM with a few lines of Java code."
...
demos:
    enable: true
    title: "Live Demos - Parse data from DOTM Online"
    content: |
       Parse data from DOTM file right now by visiting [GroupDocs.Parser Live Demos](https://products.groupdocs.app/parser/dotm) website.
