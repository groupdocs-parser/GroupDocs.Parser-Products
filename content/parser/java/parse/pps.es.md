...
############################# Head ############################
head_title: "Analizar datos de PPS en Java"
head_description: "Analice rápidamente los datos de los documentos en Java."

############################# Header ############################
title: "Analizar datos de PPS en Java"
description: "Analice los datos de PPS con unas pocas líneas de código Java."
...
demos:
    enable: true
    title: "Demostraciones en vivo: analice datos de PPS en línea"
    content: |
       Analice los datos del archivo PPS ahora mismo visitando el sitio web [GroupDocs.Parser Live Demos](https://products.groupdocs.app/parser/pps).
