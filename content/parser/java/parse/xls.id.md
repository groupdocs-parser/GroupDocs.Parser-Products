...
############################# Head ############################
head_title: "Parsing Data dari XLS di Java"
head_description: "Mengurai data dengan cepat dari dokumen di Java."

############################# Header ############################
title: "Mengurai data dari XLS Di Java"
description: "Parsing data dari XLS dengan beberapa baris kode Java."
...
demos:
    enable: true
    title: "Demo Langsung - Mengurai data dari XLS Online"
    content: |
       Parse data dari XLS file sekarang juga dengan mengunjungi situs web [GroupDocs.Parser Demo Langsung](https://products.groupdocs.app/parser/xls).
