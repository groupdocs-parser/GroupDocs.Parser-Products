...
############################# Head ############################
head_title: "Analizar datos de DOC en Java"
head_description: "Analice rápidamente los datos de los documentos en Java."

############################# Header ############################
title: "Analizar datos de DOC en Java"
description: "Analice los datos de DOC con unas pocas líneas de código Java."
...
demos:
    enable: true
    title: "Demostraciones en vivo: analice datos de DOC en línea"
    content: |
       Analice los datos del archivo DOC ahora mismo visitando el sitio web [GroupDocs.Parser Live Demos](https://products.groupdocs.app/parser/doc).
