...
############################# Head ############################
head_title: "Parse Data from PPTM in Java"
head_description: "Quickly parse data from documents in Java."

############################# Header ############################
title: "Parse data from PPTM In Java"
description: "Parse data from PPTM with a few lines of Java code."
...
demos:
    enable: true
    title: "Live Demos - Parse data from PPTM Online"
    content: |
       Parse data from PPTM file right now by visiting [GroupDocs.Parser Live Demos](https://products.groupdocs.app/parser/pptm) website.
