...
############################# Head ############################
head_title: "Parsing Data dari DOCX di Java"
head_description: "Mengurai data dengan cepat dari dokumen di Java."

############################# Header ############################
title: "Mengurai data dari DOCX Di Java"
description: "Parsing data dari DOCX dengan beberapa baris kode Java."
...
demos:
    enable: true
    title: "Demo Langsung - Mengurai data dari DOCX Online"
    content: |
       Parse data dari DOCX file sekarang juga dengan mengunjungi situs web [GroupDocs.Parser Demo Langsung](https://products.groupdocs.app/parser/docx).
