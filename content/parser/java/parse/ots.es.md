...
############################# Head ############################
head_title: "Analizar datos de OTS en Java"
head_description: "Analice rápidamente los datos de los documentos en Java."

############################# Header ############################
title: "Analizar datos de OTS en Java"
description: "Analice los datos de OTS con unas pocas líneas de código Java."
...
demos:
    enable: true
    title: "Demostraciones en vivo: analice datos de OTS en línea"
    content: |
       Analice los datos del archivo OTS ahora mismo visitando el sitio web [GroupDocs.Parser Live Demos](https://products.groupdocs.app/parser/ots).
