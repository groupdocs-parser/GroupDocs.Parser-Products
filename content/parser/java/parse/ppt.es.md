...
############################# Head ############################
head_title: "Analizar datos de PPT en Java"
head_description: "Analice rápidamente los datos de los documentos en Java."

############################# Header ############################
title: "Analizar datos de PPT en Java"
description: "Analice los datos de PPT con unas pocas líneas de código Java."
...
demos:
    enable: true
    title: "Demostraciones en vivo: analice datos de PPT en línea"
    content: |
       Analice los datos del archivo PPT ahora mismo visitando el sitio web [GroupDocs.Parser Live Demos](https://products.groupdocs.app/parser/ppt).
