...
############################# Head ############################
head_title: "Разобрать данные из RTF в Java"
head_description: "Быстро сканируйте штрих-коды из файла RTF в Java. Сохраните новый документ, содержащий выбранные страницы, с помощью API слияния документов."

############################# Header ############################
title: "Разобрать данные из RTF в Java"
description: "Проанализируйте данные из RTF с помощью нескольких строк кода Java."
...
demos:
    enable: true
    title: "Демонстрации в реальном времени — анализ данных из RTF онлайн"
    content: |
       Проанализируйте данные из файла RTF прямо сейчас, посетив веб-сайт [GroupDocs.Parser Live Demos](https://products.groupdocs.app/parser/rtf).
