...
############################# Head ############################
head_title: "Analizar datos de PPSM en Java"
head_description: "Analice rápidamente los datos de los documentos en Java."

############################# Header ############################
title: "Analizar datos de PPSM en Java"
description: "Analice los datos de PPSM con unas pocas líneas de código Java."
...
demos:
    enable: true
    title: "Demostraciones en vivo: analice datos de PPSM en línea"
    content: |
       Analice los datos del archivo PPSM ahora mismo visitando el sitio web [GroupDocs.Parser Live Demos](https://products.groupdocs.app/parser/ppsm).
