...
############################# Head ############################
head_title: "Java の XLSB からのデータを解析する"
head_description: "Java のドキュメントからのデータを迅速に解析します。"

############################# Header ############################
title: "XLSB からのデータを Java で解析する"
description: "数行の Java コードを使用して、XLSB からのデータを解析します。"
...
demos:
    enable: true
    title: "ライブ デモ - XLSB オンラインからのデータを解析する"
    content: |
       [GroupDocs.Parser ライブ デモ](https://products.groupdocs.app/parser/xlsb) Web サイトにアクセスして、今すぐ XLSB ファイルのデータを解析してください。
