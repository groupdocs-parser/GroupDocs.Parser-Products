...
############################# Head ############################
head_title: "Parsing Data dari PPSX di Java"
head_description: "Mengurai data dengan cepat dari dokumen di Java."

############################# Header ############################
title: "Mengurai data dari PPSX Di Java"
description: "Parsing data dari PPSX dengan beberapa baris kode Java."
...
demos:
    enable: true
    title: "Demo Langsung - Mengurai data dari PPSX Online"
    content: |
       Parse data dari PPSX file sekarang juga dengan mengunjungi situs web [GroupDocs.Parser Demo Langsung](https://products.groupdocs.app/parser/ppsx).
