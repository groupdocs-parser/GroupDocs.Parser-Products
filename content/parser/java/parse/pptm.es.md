...
############################# Head ############################
head_title: "Analizar datos de PPTM en Java"
head_description: "Analice rápidamente los datos de los documentos en Java."

############################# Header ############################
title: "Analizar datos de PPTM en Java"
description: "Analice los datos de PPTM con unas pocas líneas de código Java."
...
demos:
    enable: true
    title: "Demostraciones en vivo: analice datos de PPTM en línea"
    content: |
       Analice los datos del archivo PPTM ahora mismo visitando el sitio web [GroupDocs.Parser Live Demos](https://products.groupdocs.app/parser/pptm).
