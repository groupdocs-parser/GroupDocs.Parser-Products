...
############################# Head ############################
head_title: "Java の DOC からのデータを解析する"
head_description: "Java のドキュメントからのデータを迅速に解析します。"

############################# Header ############################
title: "DOC からのデータを Java で解析する"
description: "数行の Java コードを使用して、DOC からのデータを解析します。"
...
demos:
    enable: true
    title: "ライブ デモ - DOC オンラインからのデータを解析する"
    content: |
       [GroupDocs.Parser ライブ デモ](https://products.groupdocs.app/parser/doc) Web サイトにアクセスして、今すぐ DOC ファイルのデータを解析してください。
