...
############################# Head ############################
head_title: "Parse Data from PPTX in Java"
head_description: "Quickly parse data from documents in Java."

############################# Header ############################
title: "Parse data from PPTX In Java"
description: "Parse data from PPTX with a few lines of Java code."
...
demos:
    enable: true
    title: "Live Demos - Parse data from PPTX Online"
    content: |
       Parse data from PPTX file right now by visiting [GroupDocs.Parser Live Demos](https://products.groupdocs.app/parser/pptx) website.
