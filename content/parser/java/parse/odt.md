...
############################# Head ############################
head_title: "Parse Data from ODT in Java"
head_description: "Quickly parse data from documents in Java."

############################# Header ############################
title: "Parse data from ODT In Java"
description: "Parse data from ODT with a few lines of Java code."
...
demos:
    enable: true
    title: "Live Demos - Parse data from ODT Online"
    content: |
       Parse data from ODT file right now by visiting [GroupDocs.Parser Live Demos](https://products.groupdocs.app/parser/odt) website.
