...
############################# Head ############################
head_title: "Parsing Data dari XLT di Java"
head_description: "Mengurai data dengan cepat dari dokumen di Java."

############################# Header ############################
title: "Mengurai data dari XLT Di Java"
description: "Parsing data dari XLT dengan beberapa baris kode Java."
...
demos:
    enable: true
    title: "Demo Langsung - Mengurai data dari XLT Online"
    content: |
       Parse data dari XLT file sekarang juga dengan mengunjungi situs web [GroupDocs.Parser Demo Langsung](https://products.groupdocs.app/parser/xlt).
