...
############################# Head ############################
head_title: "Analizar datos de ODS en Java"
head_description: "Analice rápidamente los datos de los documentos en Java."

############################# Header ############################
title: "Analizar datos de ODS en Java"
description: "Analice los datos de ODS con unas pocas líneas de código Java."
...
demos:
    enable: true
    title: "Demostraciones en vivo: analice datos de ODS en línea"
    content: |
       Analice los datos del archivo ODS ahora mismo visitando el sitio web [GroupDocs.Parser Live Demos](https://products.groupdocs.app/parser/ods).
