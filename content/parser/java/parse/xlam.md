...
############################# Head ############################
head_title: "Parse Data from XLAM in Java"
head_description: "Quickly parse data from documents in Java."

############################# Header ############################
title: "Parse data from XLAM In Java"
description: "Parse data from XLAM with a few lines of Java code."
...
demos:
    enable: true
    title: "Live Demos - Parse data from XLAM Online"
    content: |
       Parse data from XLAM file right now by visiting [GroupDocs.Parser Live Demos](https://products.groupdocs.app/parser/xlam) website.
