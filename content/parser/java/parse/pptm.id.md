...
############################# Head ############################
head_title: "Parsing Data dari PPTM di Java"
head_description: "Mengurai data dengan cepat dari dokumen di Java."

############################# Header ############################
title: "Mengurai data dari PPTM Di Java"
description: "Parsing data dari PPTM dengan beberapa baris kode Java."
...
demos:
    enable: true
    title: "Demo Langsung - Mengurai data dari PPTM Online"
    content: |
       Parse data dari PPTM file sekarang juga dengan mengunjungi situs web [GroupDocs.Parser Demo Langsung](https://products.groupdocs.app/parser/pptm).
