...
############################# Head ############################
head_title: "Java の XLAM からのデータを解析する"
head_description: "Java のドキュメントからのデータを迅速に解析します。"

############################# Header ############################
title: "XLAM からのデータを Java で解析する"
description: "数行の Java コードを使用して、XLAM からのデータを解析します。"
...
demos:
    enable: true
    title: "ライブ デモ - XLAM オンラインからのデータを解析する"
    content: |
       [GroupDocs.Parser ライブ デモ](https://products.groupdocs.app/parser/xlam) Web サイトにアクセスして、今すぐ XLAM ファイルのデータを解析してください。
