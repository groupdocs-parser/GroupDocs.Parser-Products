...
############################# Head ############################
head_title: "Java の XLTM からのデータを解析する"
head_description: "Java のドキュメントからのデータを迅速に解析します。"

############################# Header ############################
title: "XLTM からのデータを Java で解析する"
description: "数行の Java コードを使用して、XLTM からのデータを解析します。"
...
demos:
    enable: true
    title: "ライブ デモ - XLTM オンラインからのデータを解析する"
    content: |
       [GroupDocs.Parser ライブ デモ](https://products.groupdocs.app/parser/xltm) Web サイトにアクセスして、今すぐ XLTM ファイルのデータを解析してください。
