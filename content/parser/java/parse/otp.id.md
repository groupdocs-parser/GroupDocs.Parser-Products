...
############################# Head ############################
head_title: "Parsing Data dari OTP di Java"
head_description: "Mengurai data dengan cepat dari dokumen di Java."

############################# Header ############################
title: "Mengurai data dari OTP Di Java"
description: "Parsing data dari OTP dengan beberapa baris kode Java."
...
demos:
    enable: true
    title: "Demo Langsung - Mengurai data dari OTP Online"
    content: |
       Parse data dari OTP file sekarang juga dengan mengunjungi situs web [GroupDocs.Parser Demo Langsung](https://products.groupdocs.app/parser/otp).
