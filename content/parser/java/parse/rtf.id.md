...
############################# Head ############################
head_title: "Parsing Data dari RTF di Java"
head_description: "Mengurai data dengan cepat dari dokumen di Java."

############################# Header ############################
title: "Mengurai data dari RTF Di Java"
description: "Parsing data dari RTF dengan beberapa baris kode Java."
...
demos:
    enable: true
    title: "Demo Langsung - Mengurai data dari RTF Online"
    content: |
       Parse data dari RTF file sekarang juga dengan mengunjungi situs web [GroupDocs.Parser Demo Langsung](https://products.groupdocs.app/parser/rtf).
