...
############################# Head ############################
head_title: "Analyser les données de POTX dans Java"
head_description: "Analysez rapidement les données des documents dans Java."

############################# Header ############################
title: "Analyser les données de POTX dans Java"
description: "Analysez les données de POTX avec quelques lignes de code Java."
...
demos:
    enable: true
    title: "Démos en direct - Analyser les données de POTX en ligne"
    content: |
       Analysez les données du fichier POTX dès maintenant en visitant le site Web [GroupDocs.Parser Live Demos](https://products.groupdocs.app/parser/potx).
