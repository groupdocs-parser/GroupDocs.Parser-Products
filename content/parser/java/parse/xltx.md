...
############################# Head ############################
head_title: "Parse Data from XLTX in Java"
head_description: "Quickly parse data from documents in Java."

############################# Header ############################
title: "Parse data from XLTX In Java"
description: "Parse data from XLTX with a few lines of Java code."
...
demos:
    enable: true
    title: "Live Demos - Parse data from XLTX Online"
    content: |
       Parse data from XLTX file right now by visiting [GroupDocs.Parser Live Demos](https://products.groupdocs.app/parser/xltx) website.
