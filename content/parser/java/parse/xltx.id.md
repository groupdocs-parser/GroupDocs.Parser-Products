...
############################# Head ############################
head_title: "Parsing Data dari XLTX di Java"
head_description: "Mengurai data dengan cepat dari dokumen di Java."

############################# Header ############################
title: "Mengurai data dari XLTX Di Java"
description: "Parsing data dari XLTX dengan beberapa baris kode Java."
...
demos:
    enable: true
    title: "Demo Langsung - Mengurai data dari XLTX Online"
    content: |
       Parse data dari XLTX file sekarang juga dengan mengunjungi situs web [GroupDocs.Parser Demo Langsung](https://products.groupdocs.app/parser/xltx).
