...
############################# Head ############################
head_title: "Parse Data from XLSM in Java"
head_description: "Quickly parse data from documents in Java."

############################# Header ############################
title: "Parse data from XLSM In Java"
description: "Parse data from XLSM with a few lines of Java code."
...
demos:
    enable: true
    title: "Live Demos - Parse data from XLSM Online"
    content: |
       Parse data from XLSM file right now by visiting [GroupDocs.Parser Live Demos](https://products.groupdocs.app/parser/xlsm) website.
