...
############################# Head ############################
head_title: "Parsing Data dari PPT di Java"
head_description: "Mengurai data dengan cepat dari dokumen di Java."

############################# Header ############################
title: "Mengurai data dari PPT Di Java"
description: "Parsing data dari PPT dengan beberapa baris kode Java."
...
demos:
    enable: true
    title: "Demo Langsung - Mengurai data dari PPT Online"
    content: |
       Parse data dari PPT file sekarang juga dengan mengunjungi situs web [GroupDocs.Parser Demo Langsung](https://products.groupdocs.app/parser/ppt).
