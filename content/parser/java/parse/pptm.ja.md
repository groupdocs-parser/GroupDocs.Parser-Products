...
############################# Head ############################
head_title: "Java の PPTM からのデータを解析する"
head_description: "Java のドキュメントからのデータを迅速に解析します。"

############################# Header ############################
title: "PPTM からのデータを Java で解析する"
description: "数行の Java コードを使用して、PPTM からのデータを解析します。"
...
demos:
    enable: true
    title: "ライブ デモ - PPTM オンラインからのデータを解析する"
    content: |
       [GroupDocs.Parser ライブ デモ](https://products.groupdocs.app/parser/pptm) Web サイトにアクセスして、今すぐ PPTM ファイルのデータを解析してください。
