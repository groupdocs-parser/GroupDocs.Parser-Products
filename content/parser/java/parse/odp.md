...
############################# Head ############################
head_title: "Parse Data from ODP in Java"
head_description: "Quickly parse data from documents in Java."

############################# Header ############################
title: "Parse data from ODP In Java"
description: "Parse data from ODP with a few lines of Java code."
...
demos:
    enable: true
    title: "Live Demos - Parse data from ODP Online"
    content: |
       Parse data from ODP file right now by visiting [GroupDocs.Parser Live Demos](https://products.groupdocs.app/parser/odp) website.
