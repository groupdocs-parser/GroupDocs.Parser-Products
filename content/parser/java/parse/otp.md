...
############################# Head ############################
head_title: "Parse Data from OTP in Java"
head_description: "Quickly parse data from documents in Java."

############################# Header ############################
title: "Parse data from OTP In Java"
description: "Parse data from OTP with a few lines of Java code."
...
demos:
    enable: true
    title: "Live Demos - Parse data from OTP Online"
    content: |
       Parse data from OTP file right now by visiting [GroupDocs.Parser Live Demos](https://products.groupdocs.app/parser/otp) website.
