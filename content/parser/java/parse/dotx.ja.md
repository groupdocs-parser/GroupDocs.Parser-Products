...
############################# Head ############################
head_title: "Java の DOTX からのデータを解析する"
head_description: "Java のドキュメントからのデータを迅速に解析します。"

############################# Header ############################
title: "DOTX からのデータを Java で解析する"
description: "数行の Java コードを使用して、DOTX からのデータを解析します。"
...
demos:
    enable: true
    title: "ライブ デモ - DOTX オンラインからのデータを解析する"
    content: |
       [GroupDocs.Parser ライブ デモ](https://products.groupdocs.app/parser/dotx) Web サイトにアクセスして、今すぐ DOTX ファイルのデータを解析してください。
