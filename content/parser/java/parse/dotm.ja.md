...
############################# Head ############################
head_title: "Java の DOTM からのデータを解析する"
head_description: "Java のドキュメントからのデータを迅速に解析します。"

############################# Header ############################
title: "DOTM からのデータを Java で解析する"
description: "数行の Java コードを使用して、DOTM からのデータを解析します。"
...
demos:
    enable: true
    title: "ライブ デモ - DOTM オンラインからのデータを解析する"
    content: |
       [GroupDocs.Parser ライブ デモ](https://products.groupdocs.app/parser/dotm) Web サイトにアクセスして、今すぐ DOTM ファイルのデータを解析してください。
