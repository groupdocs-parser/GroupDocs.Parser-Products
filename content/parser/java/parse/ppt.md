...
############################# Head ############################
head_title: "Parse Data from PPT in Java"
head_description: "Quickly parse data from documents in Java."

############################# Header ############################
title: "Parse data from PPT In Java"
description: "Parse data from PPT with a few lines of Java code."
...
demos:
    enable: true
    title: "Live Demos - Parse data from PPT Online"
    content: |
       Parse data from PPT file right now by visiting [GroupDocs.Parser Live Demos](https://products.groupdocs.app/parser/ppt) website.
