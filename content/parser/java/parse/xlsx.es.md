...
############################# Head ############################
head_title: "Extraer contenido de archivos XLSX en aplicaciones Java"
head_description: "Aprovecha GroupDocs.Parser para analizar y recuperar datos estructurados, texto, tablas e imágenes de archivos XLSX en Java, sin necesidad de herramientas externas."

############################# Header ############################
title: "Extraer datos de documentos XLSX en Java" 
...
steps:
    enable: true
    title: "Cómo extraer datos de Xlsx usando Java"
    content: |
      Para extraer información útil de documentos XLSX en tus proyectos de Java usando [GroupDocs.Parser](/parser/java/), sigue estas instrucciones:
      
      1. Abre el archivo XLSX con un objeto Parser.
