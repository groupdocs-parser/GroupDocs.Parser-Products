...
############################# Head ############################
head_title: "Ekstrak konten dari file XML dalam aplikasi Java"
head_description: "Manfaatkan GroupDocs.Parser untuk mem-parsing dan mengambil data terstruktur, teks, tabel, dan gambar dari file XML dalam Java, tanpa memerlukan alat eksternal."

############################# Header ############################
title: "Ekstrak data dari dokumen XML dalam Java" 
...
steps:
    enable: true
    title: "Cara mengekstrak data dari Xml menggunakan Java"
    content: |
      Untuk mengekstrak informasi berguna dari dokumen XML dalam proyek Java Anda menggunakan [GroupDocs.Parser](/parser/java/), ikuti instruksi berikut:
      
      1. Buka file XML dengan objek Parser.
