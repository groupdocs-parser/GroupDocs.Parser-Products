...
############################# Head ############################
head_title: "Parsing Data dari ODS di Java"
head_description: "Mengurai data dengan cepat dari dokumen di Java."

############################# Header ############################
title: "Mengurai data dari ODS Di Java"
description: "Parsing data dari ODS dengan beberapa baris kode Java."
...
demos:
    enable: true
    title: "Demo Langsung - Mengurai data dari ODS Online"
    content: |
       Parse data dari ODS file sekarang juga dengan mengunjungi situs web [GroupDocs.Parser Demo Langsung](https://products.groupdocs.app/parser/ods).
