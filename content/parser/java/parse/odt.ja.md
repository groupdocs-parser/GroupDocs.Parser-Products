...
############################# Head ############################
head_title: "Java の ODT からのデータを解析する"
head_description: "Java のドキュメントからのデータを迅速に解析します。"

############################# Header ############################
title: "ODT からのデータを Java で解析する"
description: "数行の Java コードを使用して、ODT からのデータを解析します。"
...
demos:
    enable: true
    title: "ライブ デモ - ODT オンラインからのデータを解析する"
    content: |
       [GroupDocs.Parser ライブ デモ](https://products.groupdocs.app/parser/odt) Web サイトにアクセスして、今すぐ ODT ファイルのデータを解析してください。
