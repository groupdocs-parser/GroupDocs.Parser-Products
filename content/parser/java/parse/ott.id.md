...
############################# Head ############################
head_title: "Parsing Data dari OTT di Java"
head_description: "Mengurai data dengan cepat dari dokumen di Java."

############################# Header ############################
title: "Mengurai data dari OTT Di Java"
description: "Parsing data dari OTT dengan beberapa baris kode Java."
...
demos:
    enable: true
    title: "Demo Langsung - Mengurai data dari OTT Online"
    content: |
       Parse data dari OTT file sekarang juga dengan mengunjungi situs web [GroupDocs.Parser Demo Langsung](https://products.groupdocs.app/parser/ott).
