...
############################# Head ############################
head_title: "Analyser les données de DOTX dans Java"
head_description: "Analysez rapidement les données des documents dans Java."

############################# Header ############################
title: "Analyser les données de DOTX dans Java"
description: "Analysez les données de DOTX avec quelques lignes de code Java."
...
demos:
    enable: true
    title: "Démos en direct - Analyser les données de DOTX en ligne"
    content: |
       Analysez les données du fichier DOTX dès maintenant en visitant le site Web [GroupDocs.Parser Live Demos](https://products.groupdocs.app/parser/dotx).
