...
############################# Head ############################
head_title: "Extract content from XLSX files in Java applications"
...
steps:
    enable: true
    title: "How to extract data from Xlsx using Java"
    content: |
      To extract useful information from XLSX documents in your Java projects using [GroupDocs.Parser](/parser/java/), follow these instructions:
      
      1. Open the XLSX file with a Parser object.
