...
############################# Head ############################
head_title: "Java の DOCM からのデータを解析する"
head_description: "Java のドキュメントからのデータを迅速に解析します。"

############################# Header ############################
title: "DOCM からのデータを Java で解析する"
description: "数行の Java コードを使用して、DOCM からのデータを解析します。"
...
demos:
    enable: true
    title: "ライブ デモ - DOCM オンラインからのデータを解析する"
    content: |
       [GroupDocs.Parser ライブ デモ](https://products.groupdocs.app/parser/docm) Web サイトにアクセスして、今すぐ DOCM ファイルのデータを解析してください。
