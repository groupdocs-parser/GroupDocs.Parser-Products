...
############################# Head ############################
head_title: "Analyser les données de ODT dans Java"
head_description: "Analysez rapidement les données des documents dans Java."

############################# Header ############################
title: "Analyser les données de ODT dans Java"
description: "Analysez les données de ODT avec quelques lignes de code Java."
...
demos:
    enable: true
    title: "Démos en direct - Analyser les données de ODT en ligne"
    content: |
       Analysez les données du fichier ODT dès maintenant en visitant le site Web [GroupDocs.Parser Live Demos](https://products.groupdocs.app/parser/odt).
