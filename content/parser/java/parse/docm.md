...
############################# Head ############################
head_title: "Parse Data from DOCM in Java"
head_description: "Quickly parse data from documents in Java."

############################# Header ############################
title: "Parse data from DOCM In Java"
description: "Parse data from DOCM with a few lines of Java code."
...
demos:
    enable: true
    title: "Live Demos - Parse data from DOCM Online"
    content: |
       Parse data from DOCM file right now by visiting [GroupDocs.Parser Live Demos](https://products.groupdocs.app/parser/docm) website.
