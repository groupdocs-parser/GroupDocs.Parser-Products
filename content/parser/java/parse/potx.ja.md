...
############################# Head ############################
head_title: "Java の POTX からのデータを解析する"
head_description: "Java のドキュメントからのデータを迅速に解析します。"

############################# Header ############################
title: "POTX からのデータを Java で解析する"
description: "数行の Java コードを使用して、POTX からのデータを解析します。"
...
demos:
    enable: true
    title: "ライブ デモ - POTX オンラインからのデータを解析する"
    content: |
       [GroupDocs.Parser ライブ デモ](https://products.groupdocs.app/parser/potx) Web サイトにアクセスして、今すぐ POTX ファイルのデータを解析してください。
