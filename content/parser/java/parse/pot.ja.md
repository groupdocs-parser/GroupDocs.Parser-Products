...
############################# Head ############################
head_title: "Java の POT からのデータを解析する"
head_description: "Java のドキュメントからのデータを迅速に解析します。"

############################# Header ############################
title: "POT からのデータを Java で解析する"
description: "数行の Java コードを使用して、POT からのデータを解析します。"
...
demos:
    enable: true
    title: "ライブ デモ - POT オンラインからのデータを解析する"
    content: |
       [GroupDocs.Parser ライブ デモ](https://products.groupdocs.app/parser/pot) Web サイトにアクセスして、今すぐ POT ファイルのデータを解析してください。
