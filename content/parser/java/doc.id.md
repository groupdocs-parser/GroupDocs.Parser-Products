...
about:
    enable: true
    title: "Bagaimana cara Mengurai & Mengekstrak Hyperlink dari DOC dokumen melalui Java API?"
    content: |
...
steps:
    enable: true
    title_left: "Ekstrak hyperlink dari DOC di Java"
    content_left: |
        [GroupDocs.Parser for Java](/id/parser/java/) memudahkan pengembang Java untuk mengekstrak hyperlink dari file DOC dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< parser/code-parser title="Cara mengekstrak hyperlink dari file DOC menggunakan kode contoh Java">}}
