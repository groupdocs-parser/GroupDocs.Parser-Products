...
############################# Head ############################
head_title: "Извлечение гиперссылок из PDF докуметов, страниц или области страницы через Java"
...
############################# Header ############################
title: "Java API для извлечения гиперссылок из PDF документов, страниц или определенной области страницы"
...
about:
    enable: true
    title: "Как анализировать и извлекать гиперссылки из документов PDF через Java API?"
    content: |
...
steps:
    enable: true
    title_left: "Извлечь гиперссылки из PDF в Java"
    content_left: |
        [GroupDocs.Parser for Java](/ru/parser/java/) позволяет разработчикам Java легко извлекать гиперссылки из файла PDF, выполняя несколько простых шагов. .
    ...
    code: |
     ...
     {{< parser/code-parser title="Как извлечь гиперссылки из файла PDF, используя пример кода Java">}}

        ```java    
        // Извлечение гиперссылок из файла PDF с помощью API GroupDocs.Parser
