...
############################# Head ############################
head_title: "Recupere tabelas de documentos DOCX em aplicativos Java"
head_description: "Extraia dados tabulares estruturados de arquivos DOCX em aplicações Java usando GroupDocs.Parser—sem necessidade de ferramentas externas."

############################# Header ############################
title: "Recupere dados de tabela de DOCX usando Java" 
...
steps:
    enable: true
    title: "Como recuperar tabelas de Docx em Java"
    content: |
      Para analisar tabelas de documentos DOCX usando [GroupDocs.Parser](/parser/java/), siga estes passos em seu ambiente Java:
      
      1. Crie uma instância de Parser e carregue o arquivo DOCX alvo.
