...
############################# Head ############################
head_title: "使用 Java 应用从 XML 文档中提取表格"
head_description: "使用 GroupDocs.Parser 从 Java 应用程序中提取 XML 文件的结构化表格数据——无需外部工具。"

############################# Header ############################
title: "使用 Java 从 XML 提取表格数据" 
...
steps:
    enable: true
    title: "如何在 Java 中从 Xml 获取表格"
    content: |
      要使用 [GroupDocs.Parser](/parser/java/) 从 XML 文档中解析表格，请按照以下步骤在您的 Java 环境中操作：
