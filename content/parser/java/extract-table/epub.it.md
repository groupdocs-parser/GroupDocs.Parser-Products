...
############################# Head ############################
head_title: "Recupera tabelle da documenti EPUB nelle app Java"
head_description: "Estrai dati tabulari strutturati da file EPUB nelle applicazioni Java utilizzando GroupDocs.Parser—senza strumenti esterni."

############################# Header ############################
title: "Recupera dati tabulari da EPUB utilizzando Java" 
...
steps:
    enable: true
    title: "Come recuperare tabelle da Epub in Java"
    content: |
      Per analizzare tabelle da documenti EPUB utilizzando [GroupDocs.Parser](/parser/java/), segui questi passaggi nel tuo ambiente Java:
      
      1. Crea un'istanza di Parser e carica il file EPUB di destinazione.
