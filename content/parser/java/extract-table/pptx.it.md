...
############################# Head ############################
head_title: "Recupera tabelle da documenti PPTX nelle app Java"
head_description: "Estrai dati tabulari strutturati da file PPTX nelle applicazioni Java utilizzando GroupDocs.Parser—senza strumenti esterni."

############################# Header ############################
title: "Recupera dati tabulari da PPTX utilizzando Java" 
...
steps:
    enable: true
    title: "Come recuperare tabelle da Pptx in Java"
    content: |
      Per analizzare tabelle da documenti PPTX utilizzando [GroupDocs.Parser](/parser/java/), segui questi passaggi nel tuo ambiente Java:
      
      1. Crea un'istanza di Parser e carica il file PPTX di destinazione.
