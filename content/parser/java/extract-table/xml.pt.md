...
############################# Head ############################
head_title: "Recupere tabelas de documentos XML em aplicativos Java"
head_description: "Extraia dados tabulares estruturados de arquivos XML em aplicações Java usando GroupDocs.Parser—sem necessidade de ferramentas externas."

############################# Header ############################
title: "Recupere dados de tabela de XML usando Java" 
...
steps:
    enable: true
    title: "Como recuperar tabelas de Xml em Java"
    content: |
      Para analisar tabelas de documentos XML usando [GroupDocs.Parser](/parser/java/), siga estes passos em seu ambiente Java:
      
      1. Crie uma instância de Parser e carregue o arquivo XML alvo.
