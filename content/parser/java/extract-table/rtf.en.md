...
############################# Head ############################
head_title: "Retrieve tables from RTF documents in Java apps"
head_description: "Extract structured tabular data from RTF files in Java applications using GroupDocs.Parser—no external tools needed."

############################# Header ############################
title: "Retrieve table data from RTF using Java" 
...
steps:
    enable: true
    title: "How to retrieve tables from Rtf in Java"
    content: |
      To parse tables from RTF documents using [GroupDocs.Parser](/parser/java/), follow these easy steps in your Java environment:
      
      1. Create a Parser instance and load the target RTF file.
