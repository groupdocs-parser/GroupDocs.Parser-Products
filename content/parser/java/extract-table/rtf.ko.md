...
############################# Head ############################
head_title: "Java 앱에서 RTF 문서의 테이블을 가져오기"
head_description: "GroupDocs.Parser를 사용하여 Java 애플리케이션에서 RTF 파일의 구조화된 표 데이터를 추출합니다. 외부 도구는 필요하지 않습니다."

############################# Header ############################
title: "Java를 사용하여 RTF에서 테이블 데이터 가져오기" 
...
steps:
    enable: true
    title: "Java에서 Rtf 문서의 테이블을 가져오는 방법"
    content: |
      [GroupDocs.Parser](/parser/java/)를 사용하여 RTF 문서에서 테이블을 구문 분석하려면 Java 환경에서 다음 단계를 따르십시오:
      
      1. Parser 인스턴스를 생성하고 대상 RTF 파일을 로드합니다.
