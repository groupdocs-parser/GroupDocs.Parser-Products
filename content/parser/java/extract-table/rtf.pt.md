...
############################# Head ############################
head_title: "Recupere tabelas de documentos RTF em aplicativos Java"
head_description: "Extraia dados tabulares estruturados de arquivos RTF em aplicações Java usando GroupDocs.Parser—sem necessidade de ferramentas externas."

############################# Header ############################
title: "Recupere dados de tabela de RTF usando Java" 
...
steps:
    enable: true
    title: "Como recuperar tabelas de Rtf em Java"
    content: |
      Para analisar tabelas de documentos RTF usando [GroupDocs.Parser](/parser/java/), siga estes passos em seu ambiente Java:
      
      1. Crie uma instância de Parser e carregue o arquivo RTF alvo.
