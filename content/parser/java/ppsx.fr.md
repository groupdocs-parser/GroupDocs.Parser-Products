...
about:
    enable: true
    title: "Comment analyser et extraire les hyperliens des documents PPSX via l'API Java ?"
    content: |
...
steps:
    enable: true
    title_left: "Extraire les hyperliens de PPSX dans Java"
    content_left: |
        [GroupDocs.Parser for Java](/fr/parser/java/) permet aux développeurs Java d'extraire facilement des liens hypertexte d'un fichier PPSX en mettant en œuvre quelques étapes simples.
    ...
    code: |
     ...
     {{< parser/code-parser title="Comment extraire des hyperliens du fichier PPSX à l'aide de l'exemple de code Java">}}

        ```java    
        // Extraire les hyperliens du fichier PPSX à l'aide de l'API GroupDocs.Parser
