...
about:
    enable: true
    title: "How to Parse & Extract Hyperlinks from FB2 documents via Java API?"
    content: |
...
steps:
    enable: true
    title_left: "Extract hyperlinks from FB2 in Java"
    content_left: |
        [GroupDocs.Parser for Java](/parser/java/) makes it easy for Java developers to extract hyperlinks from a FB2 file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< parser/code-parser title="How to extract hyperlinks from FB2 file using Java example code">}}

        ```java    
        // Extract hyperlinks from FB2 file using GroupDocs.Parser API
