...
############################# Head ############################
head_title: "Recupere texto de arquivos PPTX em aplicações Java"
head_description: "Utilize GroupDocs.Parser para extrair conteúdo textual não estruturado ou estruturado de documentos PPTX em Java, sem depender de bibliotecas externas."

############################# Header ############################
title: "Recupere texto de PPTX usando Java" 
...
steps:
    enable: true
    title: "Como recuperar texto de Pptx usando Java"
    content: |
      Siga os passos abaixo para extrair texto de arquivos PPTX usando [GroupDocs.Parser](/parser/java/) dentro do seu projeto Java:
      
      1. Carregue o documento PPTX usando a classe Parser.
