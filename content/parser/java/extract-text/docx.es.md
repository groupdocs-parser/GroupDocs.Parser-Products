...
############################# Head ############################
head_title: "Recuperar texto de archivos DOCX en aplicaciones Java"
head_description: "Aproveche GroupDocs.Parser para extraer contenido de texto no estructurado o estructurado de documentos DOCX en Java, sin dependencias externas."

############################# Header ############################
title: "Recuperar texto de DOCX usando Java" 
...
steps:
    enable: true
    title: "Cómo recuperar texto de Docx usando Java"
    content: |
      Siga los pasos a continuación para extraer texto de archivos DOCX utilizando [GroupDocs.Parser](/parser/java/) dentro de su proyecto Java:
