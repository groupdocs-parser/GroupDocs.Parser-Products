...
############################# Head ############################
head_title: "Récupérez du texte à partir de fichiers DOCX dans des applications Java"
head_description: "Exploitez GroupDocs.Parser pour extraire du contenu textuel non structuré ou structuré à partir de documents DOCX en Java, sans dépendances externes."

############################# Header ############################
title: "Récupérez du texte à partir de DOCX en utilisant Java" 
...
steps:
    enable: true
    title: "Comment récupérer du texte à partir de Docx en utilisant Java"
    content: |
      Suivez les étapes ci-dessous pour extraire du texte à partir de fichiers DOCX en utilisant [GroupDocs.Parser](/parser/java/) dans votre projet Java :
      
      1. Chargez le document DOCX à l'aide de la classe Parser.
