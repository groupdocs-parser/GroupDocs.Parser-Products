...
############################# Head ############################
head_title: "Récupérez du texte à partir de fichiers XML dans des applications Java"
head_description: "Exploitez GroupDocs.Parser pour extraire du contenu textuel non structuré ou structuré à partir de documents XML en Java, sans dépendances externes."

############################# Header ############################
title: "Récupérez du texte à partir de XML en utilisant Java" 
...
steps:
    enable: true
    title: "Comment récupérer du texte à partir de Xml en utilisant Java"
    content: |
      Suivez les étapes ci-dessous pour extraire du texte à partir de fichiers XML en utilisant [GroupDocs.Parser](/parser/java/) dans votre projet Java :
      
      1. Chargez le document XML à l'aide de la classe Parser.
