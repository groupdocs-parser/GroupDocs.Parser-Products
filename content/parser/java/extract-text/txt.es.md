...
############################# Head ############################
head_title: "Recuperar texto de archivos TXT en aplicaciones Java"
head_description: "Aproveche GroupDocs.Parser para extraer contenido de texto no estructurado o estructurado de documentos TXT en Java, sin dependencias externas."

############################# Header ############################
title: "Recuperar texto de TXT usando Java" 
...
steps:
    enable: true
    title: "Cómo recuperar texto de Txt usando Java"
    content: |
      Siga los pasos a continuación para extraer texto de archivos TXT utilizando [GroupDocs.Parser](/parser/java/) dentro de su proyecto Java:
      
      1. Cargar el documento TXT usando la clase Parser.
