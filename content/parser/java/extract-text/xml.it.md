...
############################# Head ############################
head_title: "Recupera testo da file XML nelle applicazioni Java"
head_description: "Sfrutta GroupDocs.Parser per estrarre contenuti testuali non strutturati o strutturati da documenti XML in Java, senza dipendenze esterne."

############################# Header ############################
title: "Recupera testo da XML usando Java" 
...
steps:
    enable: true
    title: "Come recuperare testo da Xml usando Java"
    content: |
      Segui i passaggi seguenti per estrarre testo da file XML utilizzando [GroupDocs.Parser](/parser/java/) nel tuo progetto Java:
      
      1. Carica il documento XML utilizzando la classe Parser.
