...
############################# Head ############################
head_title: "Recupere texto de arquivos EPUB em aplicações Java"
head_description: "Utilize GroupDocs.Parser para extrair conteúdo textual não estruturado ou estruturado de documentos EPUB em Java, sem depender de bibliotecas externas."

############################# Header ############################
title: "Recupere texto de EPUB usando Java" 
...
steps:
    enable: true
    title: "Como recuperar texto de Epub usando Java"
    content: |
      Siga os passos abaixo para extrair texto de arquivos EPUB usando [GroupDocs.Parser](/parser/java/) dentro do seu projeto Java:
      
      1. Carregue o documento EPUB usando a classe Parser.
