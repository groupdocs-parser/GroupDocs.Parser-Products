...
############################# Head ############################
head_title: "Recuperar texto de archivos RTF en aplicaciones Java"
head_description: "Aproveche GroupDocs.Parser para extraer contenido de texto no estructurado o estructurado de documentos RTF en Java, sin dependencias externas."

############################# Header ############################
title: "Recuperar texto de RTF usando Java" 
...
steps:
    enable: true
    title: "Cómo recuperar texto de Rtf usando Java"
    content: |
      Siga los pasos a continuación para extraer texto de archivos RTF utilizando [GroupDocs.Parser](/parser/java/) dentro de su proyecto Java:
      
      1. Cargar el documento RTF usando la clase Parser.
