...
############################# Head ############################
head_title: "Retrieve text from DOCX files in Java applications"
head_description: "Leverage GroupDocs.Parser to extract unstructured or structured text content from DOCX documents in Java, without any external dependencies."

############################# Header ############################
title: "Retrieve text from DOCX using Java" 
...
steps:
    enable: true
    title: "How to retrieve text from Docx using Java"
    content: |
      Follow the steps below to extract text from DOCX files using [GroupDocs.Parser](/parser/java/) within your Java project:
      
      1. Load the DOCX document using the Parser class.
