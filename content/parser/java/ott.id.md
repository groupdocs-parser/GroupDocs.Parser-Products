...
about:
    enable: true
    title: "Bagaimana cara Mengurai & Mengekstrak Hyperlink dari OTT dokumen melalui Java API?"
    content: |
...
steps:
    enable: true
    title_left: "Ekstrak hyperlink dari OTT di Java"
    content_left: |
        [GroupDocs.Parser for Java](/id/parser/java/) memudahkan pengembang Java untuk mengekstrak hyperlink dari file OTT dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< parser/code-parser title="Cara mengekstrak hyperlink dari file OTT menggunakan kode contoh Java">}}

        ```java    
        // Ekstrak hyperlink dari file OTT menggunakan GroupDocs.Parser API
