...
############################# Head ############################
head_title: "Extraire des images des fichiers EPUB dans les applications Java"
head_description: "Avec GroupDocs.Parser, vous pouvez extraire des images des fichiers EPUB dans Java sans avoir recours à des outils tiers."

############################# Header ############################
title: "Extraire des images des EPUB en utilisant Java" 
...
steps:
    enable: true
    title: "Comment extraire des images de Epub en Java"
    content: |
      Suivez ces étapes pour extraire des images des documents EPUB en utilisant [GroupDocs.Parser](/parser/java/) dans votre application Java :
      
      1. Créer une instance de Parser et charger le fichier EPUB.
