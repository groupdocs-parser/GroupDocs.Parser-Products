...
############################# Head ############################
head_title: "Ekstrak gambar dari file EPUB dalam aplikasi Java"
head_description: "Dengan GroupDocs.Parser, Anda dapat mengekstrak gambar dari file EPUB dalam Java tanpa kesulitan, tanpa perlu alat pihak ketiga."

############################# Header ############################
title: "Ekstrak gambar dari EPUB menggunakan Java" 
...
steps:
    enable: true
    title: "Cara mengekstrak gambar dari Epub dalam Java"
    content: |
      Ikuti langkah-langkah ini untuk mengekstrak gambar dari dokumen EPUB menggunakan [GroupDocs.Parser](/parser/java/) dalam aplikasi Java Anda:
      
      1. Buat instance Parser dan muat file EPUB.
