...
############################# Head ############################
head_title: "Bilder aus ODT-Dateien in Java-Anwendungen extrahieren"
head_description: "GroupDocs.Parser ermöglicht Ihnen das Extrahieren von Bildern aus ODT-Dateien in Java ohne zusätzliche Tools."

############################# Header ############################
title: "Bilder aus ODT mithilfe von Java extrahieren" 
...
steps:
    enable: true
    title: "So extrahieren Sie Bilder aus Odt in Java"
    content: |
      Befolgen Sie diese Schritte, um Bilder aus ODT-Dokumenten mit [GroupDocs.Parser](/parser/java/) in Ihrer Java-Anwendung zu extrahieren:
      
      1. Erstellen Sie eine Instanz von Parser und laden Sie die ODT-Datei.
