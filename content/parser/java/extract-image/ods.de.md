...
############################# Head ############################
head_title: "Bilder aus ODS-Dateien in Java-Anwendungen extrahieren"
head_description: "GroupDocs.Parser ermöglicht Ihnen das Extrahieren von Bildern aus ODS-Dateien in Java ohne zusätzliche Tools."

############################# Header ############################
title: "Bilder aus ODS mithilfe von Java extrahieren" 
...
steps:
    enable: true
    title: "So extrahieren Sie Bilder aus Ods in Java"
    content: |
      Befolgen Sie diese Schritte, um Bilder aus ODS-Dokumenten mit [GroupDocs.Parser](/parser/java/) in Ihrer Java-Anwendung zu extrahieren:
      
      1. Erstellen Sie eine Instanz von Parser und laden Sie die ODS-Datei.
