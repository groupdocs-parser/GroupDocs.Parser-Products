...
############################# Head ############################
head_title: "Extraia imagens de arquivos DOCX em aplicações Java"
head_description: "Com GroupDocs.Parser, você pode extrair imagens de arquivos DOCX em Java sem a necessidade de ferramentas externas."

############################# Header ############################
title: "Extraia imagens de DOCX usando Java" 
...
steps:
    enable: true
    title: "Como extrair imagens de Docx em Java"
    content: |
      Siga estas etapas para extrair imagens de documentos DOCX usando [GroupDocs.Parser](/parser/java/) em sua aplicação Java:
      
      1. Crie uma instância de Parser e carregue o arquivo DOCX.
