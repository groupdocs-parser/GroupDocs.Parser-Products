...
############################# Head ############################
head_title: "Estrai immagini da file XLSX nelle applicazioni Java"
head_description: "Con GroupDocs.Parser, puoi estrarre immagini da file XLSX in Java senza la necessità di strumenti di terze parti."

############################# Header ############################
title: "Estrai immagini da XLSX utilizzando Java" 
...
steps:
    enable: true
    title: "Come estrarre immagini da Xlsx in Java"
    content: |
      Segui questi passaggi per estrarre immagini da documenti XLSX utilizzando [GroupDocs.Parser](/parser/java/) nella tua applicazione Java:
      
      1. Crea un'istanza di Parser e carica il file XLSX.
