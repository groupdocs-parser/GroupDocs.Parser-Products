...
############################# Head ############################
head_title: "Extract images from FB2 files in Java applications"
head_description: "With GroupDocs.Parser, you can extract images from FB2 files in Java effortlessly, with no need for third-party tools."

############################# Header ############################
title: "Extract images from FB2 using Java" 
...
steps:
    enable: true
    title: "How to extract images from Fb2 in Java"
    content: |
      Follow these steps to extract images from FB2 documents using [GroupDocs.Parser](/parser/java/) in your Java application:
      
      1. Create a Parser instance and load the FB2 file.
