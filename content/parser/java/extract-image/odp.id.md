...
############################# Head ############################
head_title: "Ekstrak gambar dari file ODP dalam aplikasi Java"
head_description: "Dengan GroupDocs.Parser, Anda dapat mengekstrak gambar dari file ODP dalam Java tanpa kesulitan, tanpa perlu alat pihak ketiga."

############################# Header ############################
title: "Ekstrak gambar dari ODP menggunakan Java" 
...
steps:
    enable: true
    title: "Cara mengekstrak gambar dari Odp dalam Java"
    content: |
      Ikuti langkah-langkah ini untuk mengekstrak gambar dari dokumen ODP menggunakan [GroupDocs.Parser](/parser/java/) dalam aplikasi Java Anda:
