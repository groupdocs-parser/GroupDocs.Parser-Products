...
############################# Head ############################
head_title: "Extract images from ODS files in Java applications"
head_description: "With GroupDocs.Parser, you can extract images from ODS files in Java effortlessly, with no need for third-party tools."

############################# Header ############################
title: "Extract images from ODS using Java" 
...
steps:
    enable: true
    title: "How to extract images from Ods in Java"
    content: |
      Follow these steps to extract images from ODS documents using [GroupDocs.Parser](/parser/java/) in your Java application:
      
      1. Create a Parser instance and load the ODS file.
