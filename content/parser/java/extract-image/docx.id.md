...
############################# Head ############################
head_title: "Ekstrak gambar dari file DOCX dalam aplikasi Java"
head_description: "Dengan GroupDocs.Parser, Anda dapat mengekstrak gambar dari file DOCX dalam Java tanpa kesulitan, tanpa perlu alat pihak ketiga."

############################# Header ############################
title: "Ekstrak gambar dari DOCX menggunakan Java" 
...
steps:
    enable: true
    title: "Cara mengekstrak gambar dari Docx dalam Java"
    content: |
      Ikuti langkah-langkah ini untuk mengekstrak gambar dari dokumen DOCX menggunakan [GroupDocs.Parser](/parser/java/) dalam aplikasi Java Anda:
      
      1. Buat instance Parser dan muat file DOCX.
