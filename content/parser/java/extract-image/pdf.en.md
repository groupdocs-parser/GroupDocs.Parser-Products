...
############################# Head ############################
head_title: "Extract images from PDF files in Java applications"
head_description: "With GroupDocs.Parser, you can extract images from PDF files in Java effortlessly, with no need for third-party tools."
...
steps:
    enable: true
    title: "How to extract images from Pdf in Java"
    content: |
      Follow these steps to extract images from PDF documents using [GroupDocs.Parser](/parser/java/) in your Java application:
      
      1. Create a Parser instance and load the PDF file.
