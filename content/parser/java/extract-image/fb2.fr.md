...
############################# Head ############################
head_title: "Extraire des images des fichiers FB2 dans les applications Java"
head_description: "Avec GroupDocs.Parser, vous pouvez extraire des images des fichiers FB2 dans Java sans avoir recours à des outils tiers."

############################# Header ############################
title: "Extraire des images des FB2 en utilisant Java" 
...
steps:
    enable: true
    title: "Comment extraire des images de Fb2 en Java"
    content: |
      Suivez ces étapes pour extraire des images des documents FB2 en utilisant [GroupDocs.Parser](/parser/java/) dans votre application Java :
      
      1. Créer une instance de Parser et charger le fichier FB2.
