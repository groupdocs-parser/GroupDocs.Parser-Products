...
about:
    enable: true
    title: "How to Parse & Extract Hyperlinks from ONE documents via Java API?"
    content: |
...
steps:
    enable: true
    title_left: "Extract hyperlinks from ONE in Java"
    content_left: |
        [GroupDocs.Parser for Java](/parser/java/) makes it easy for Java developers to extract hyperlinks from a ONE file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< parser/code-parser title="How to extract hyperlinks from ONE file using Java example code">}}

        ```java    
        // Extract hyperlinks from ONE file using GroupDocs.Parser API
