...
############################# Head ############################
head_title: "Java のドキュメントからのデータを解析する"
head_description: "Java のドキュメントからのデータを迅速に解析します。"

############################# Header ############################
title: "Java のドキュメントからのデータを解析する"
description: "数行の Java コードを使用してドキュメントのデータを解析します。"
...
demos:
    enable: true
    title: "ライブデモ - オンラインでドキュメントからデータを解析する"
    content: |
       [GroupDocs.Parser ライブ デモ](https://products.groupdocs.app/parser/) Web サイトにアクセスして、ドキュメントのデータを今すぐ解析してください。
