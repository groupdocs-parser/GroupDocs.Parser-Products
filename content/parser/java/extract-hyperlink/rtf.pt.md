...
############################# Head ############################
head_title: "Extraia hiperlinks de arquivos RTF em aplicativos Java"
head_description: "Utilize GroupDocs.Parser para encontrar e extrair links URL de documentos RTF em projetos Java—sem necessidade de software adicional."

############################# Header ############################
title: "Extraia hiperlinks de RTF com Java" 
...
steps:
    enable: true
    title: "Como extrair hiperlinks de Rtf em Java"
    content: |
      [GroupDocs.Parser](/parser/java/) simplifica a extração de hiperlinks de arquivos RTF em aplicações Java com estes passos básicos:
      
      1. Abra o arquivo RTF usando uma instância do Parser.
