...
############################# Head ############################
head_title: "Ekstrak hyperlink dari file TXT dalam aplikasi Java"
head_description: "Gunakan GroupDocs.Parser untuk menemukan dan mengekstrak tautan URL dari dokumen TXT dalam proyek Java—tanpa perangkat lunak tambahan."

############################# Header ############################
title: "Ekstrak hyperlink dari TXT dengan Java" 
...
steps:
    enable: true
    title: "Cara mengekstrak hyperlink dari Txt dalam Java"
    content: |
      [GroupDocs.Parser](/parser/java/) menyederhanakan ekstraksi hyperlink dari file TXT dalam aplikasi Java dengan langkah-langkah dasar berikut:
      
      1. Buka file TXT menggunakan instance dari Parser.
