...
############################# Head ############################
head_title: "Extraia hiperlinks de arquivos XML em aplicativos Java"
head_description: "Utilize GroupDocs.Parser para encontrar e extrair links URL de documentos XML em projetos Java—sem necessidade de software adicional."

############################# Header ############################
title: "Extraia hiperlinks de XML com Java" 
...
steps:
    enable: true
    title: "Como extrair hiperlinks de Xml em Java"
    content: |
      [GroupDocs.Parser](/parser/java/) simplifica a extração de hiperlinks de arquivos XML em aplicações Java com estes passos básicos:
      
      1. Abra o arquivo XML usando uma instância do Parser.
