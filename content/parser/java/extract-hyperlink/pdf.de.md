...
############################# Head ############################
head_title: "Hyperlinks aus PDF-Dateien in Java-Apps extrahieren"
head_description: "Verwenden Sie GroupDocs.Parser, um URL-Links aus PDF-Dokumenten in Java-Projekten zu finden und zu extrahieren – keine zusätzliche Software erforderlich."

############################# Header ############################
title: "Hyperlinks aus PDF mit Java extrahieren" 
...
steps:
    enable: true
    title: "Wie man Hyperlinks aus Pdf in Java extrahiert"
    content: |
      [GroupDocs.Parser](/parser/java/) vereinfacht die Hyperlink-Extraktion aus PDF-Dateien in Java-Anwendungen mit diesen grundlegenden Schritten:
      
      1. Öffnen Sie die PDF-Datei mit einer Instanz von Parser.
