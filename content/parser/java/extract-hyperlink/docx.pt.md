...
############################# Head ############################
head_title: "Extraia hiperlinks de arquivos DOCX em aplicativos Java"
head_description: "Utilize GroupDocs.Parser para encontrar e extrair links URL de documentos DOCX em projetos Java—sem necessidade de software adicional."

############################# Header ############################
title: "Extraia hiperlinks de DOCX com Java" 
...
steps:
    enable: true
    title: "Como extrair hiperlinks de Docx em Java"
    content: |
      [GroupDocs.Parser](/parser/java/) simplifica a extração de hiperlinks de arquivos DOCX em aplicações Java com estes passos básicos:
      
      1. Abra o arquivo DOCX usando uma instância do Parser.
