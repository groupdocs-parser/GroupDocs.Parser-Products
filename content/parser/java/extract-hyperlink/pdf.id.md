...
############################# Head ############################
head_title: "Ekstrak hyperlink dari file PDF dalam aplikasi Java"
head_description: "Gunakan GroupDocs.Parser untuk menemukan dan mengekstrak tautan URL dari dokumen PDF dalam proyek Java—tanpa perangkat lunak tambahan."

############################# Header ############################
title: "Ekstrak hyperlink dari PDF dengan Java" 
...
steps:
    enable: true
    title: "Cara mengekstrak hyperlink dari Pdf dalam Java"
    content: |
      [GroupDocs.Parser](/parser/java/) menyederhanakan ekstraksi hyperlink dari file PDF dalam aplikasi Java dengan langkah-langkah dasar berikut:
      
      1. Buka file PDF menggunakan instance dari Parser.
