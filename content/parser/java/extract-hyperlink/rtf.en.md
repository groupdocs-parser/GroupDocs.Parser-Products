...
############################# Head ############################
head_title: "Extract hyperlinks from RTF files in Java apps"
head_description: "Use GroupDocs.Parser to find and extract URL links from RTF documents in Java projects—no extra software needed."

############################# Header ############################
title: "Extract hyperlinks from RTF with Java" 
...
steps:
    enable: true
    title: "How to extract hyperlinks from Rtf in Java"
    content: |
      [GroupDocs.Parser](/parser/java/) simplifies hyperlink extraction from RTF files in Java applications with these basic steps:
      
      1. Open the RTF file using an instance of Parser.
