...
############################# Head ############################
head_title: "Estrai collegamenti ipertestuali da file TXT in app Java"
head_description: "Utilizza GroupDocs.Parser per trovare ed estrarre collegamenti URL da documenti TXT nei progetti Java—senza necessità di software aggiuntivo."

############################# Header ############################
title: "Estrai collegamenti ipertestuali da TXT con Java" 
...
steps:
    enable: true
    title: "Come estrarre collegamenti ipertestuali da Txt in Java"
    content: |
      [GroupDocs.Parser](/parser/java/) semplifica l'estrazione di collegamenti ipertestuali da file TXT nelle applicazioni Java con questi passaggi fondamentali:
      
      1. Apri il file TXT utilizzando un'istanza di Parser.
