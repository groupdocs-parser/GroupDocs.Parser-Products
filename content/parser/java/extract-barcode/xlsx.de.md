...
############################# Head ############################
head_title: "Barcode aus XLSX-Dateien in Java-Apps lesen"
head_description: "GroupDocs.Parser ermöglicht es, Barcode-Daten aus XLSX-Dokumenten mit Java ohne externe Tools zu extrahieren."

############################# Header ############################
title: "Barcode aus XLSX mit Java lesen" 
...
steps:
    enable: true
    title: "So lesen Sie Barcodes aus Xlsx in Java"
    content: |
      Mit [GroupDocs.Parser](/parser/java/) können Java-Entwickler Barcodes aus XLSX-Dokumenten in wenigen Schritten extrahieren:
      
      1. Parser verwenden, um das XLSX-Dokument zu laden.
