...
############################# Head ############################
head_title: "Читання штрих-кодів з файлів ODS в додатках Java"
head_description: "З GroupDocs.Parser, витягніть дані штрих-кодів з документів ODS за допомогою Java без зовнішніх інструментів."

############################# Header ############################
title: "Читання штрих-кодів з ODS за допомогою Java" 
...
steps:
    enable: true
    title: "Як прочитати штрих-коди з Ods у Java"
    content: |
      З [GroupDocs.Parser](/parser/java/) розробники Java можуть витягувати штрих-коди з документів ODS всього за кілька кроків:
      
      1. Завантажте документ ODS за допомогою Parser.
