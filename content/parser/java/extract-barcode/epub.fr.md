...
############################# Head ############################
head_title: "Lire les codes-barres des fichiers EPUB dans les applications Java"
head_description: "Avec GroupDocs.Parser, extrayez les données des codes-barres à partir de documents EPUB en utilisant Java sans outils externes."

############################# Header ############################
title: "Lire les codes-barres des fichiers EPUB avec Java" 
...
steps:
    enable: true
    title: "Comment lire des codes-barres à partir de Epub en Java"
    content: |
      Avec [GroupDocs.Parser](/parser/java/), les développeurs Java peuvent extraire des codes-barres des documents EPUB en quelques étapes :
      
      1. Chargez le document EPUB à l'aide de Parser.
