...
############################# Head ############################
head_title: "Lire les codes-barres des fichiers FB2 dans les applications Java"
head_description: "Avec GroupDocs.Parser, extrayez les données des codes-barres à partir de documents FB2 en utilisant Java sans outils externes."

############################# Header ############################
title: "Lire les codes-barres des fichiers FB2 avec Java" 
...
steps:
    enable: true
    title: "Comment lire des codes-barres à partir de Fb2 en Java"
    content: |
      Avec [GroupDocs.Parser](/parser/java/), les développeurs Java peuvent extraire des codes-barres des documents FB2 en quelques étapes :
      
      1. Chargez le document FB2 à l'aide de Parser.
