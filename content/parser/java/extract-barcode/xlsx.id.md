...
############################# Head ############################
head_title: "Baca kode batang dari file XLSX dalam aplikasi Java"
head_description: "Dengan GroupDocs.Parser, ekstrak data kode batang dari dokumen XLSX menggunakan Java tanpa alat eksternal."

############################# Header ############################
title: "Baca kode batang dari XLSX menggunakan Java" 
...
steps:
    enable: true
    title: "Cara membaca kode batang dari Xlsx di Java"
    content: |
      Dengan [GroupDocs.Parser](/parser/java/), pengembang Java dapat mengekstrak kode batang dari dokumen XLSX dalam beberapa langkah:
      
      1. Muatan dokumen XLSX menggunakan Parser.
