...
############################# Head ############################
head_title: "Читання штрих-кодів з файлів XLSX в додатках Java"
head_description: "З GroupDocs.Parser, витягніть дані штрих-кодів з документів XLSX за допомогою Java без зовнішніх інструментів."

############################# Header ############################
title: "Читання штрих-кодів з XLSX за допомогою Java" 
...
steps:
    enable: true
    title: "Як прочитати штрих-коди з Xlsx у Java"
    content: |
      З [GroupDocs.Parser](/parser/java/) розробники Java можуть витягувати штрих-коди з документів XLSX всього за кілька кроків:
      
      1. Завантажте документ XLSX за допомогою Parser.
