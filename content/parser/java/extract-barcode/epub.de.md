...
############################# Head ############################
head_title: "Barcode aus EPUB-Dateien in Java-Apps lesen"
head_description: "GroupDocs.Parser ermöglicht es, Barcode-Daten aus EPUB-Dokumenten mit Java ohne externe Tools zu extrahieren."

############################# Header ############################
title: "Barcode aus EPUB mit Java lesen" 
...
steps:
    enable: true
    title: "So lesen Sie Barcodes aus Epub in Java"
    content: |
      Mit [GroupDocs.Parser](/parser/java/) können Java-Entwickler Barcodes aus EPUB-Dokumenten in wenigen Schritten extrahieren:
      
      1. Parser verwenden, um das EPUB-Dokument zu laden.
