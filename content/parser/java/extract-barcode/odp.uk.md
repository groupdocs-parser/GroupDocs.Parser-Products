...
############################# Head ############################
head_title: "Читання штрих-кодів з файлів ODP в додатках Java"
head_description: "З GroupDocs.Parser, витягніть дані штрих-кодів з документів ODP за допомогою Java без зовнішніх інструментів."

############################# Header ############################
title: "Читання штрих-кодів з ODP за допомогою Java" 
...
steps:
    enable: true
    title: "Як прочитати штрих-коди з Odp у Java"
    content: |
      З [GroupDocs.Parser](/parser/java/) розробники Java можуть витягувати штрих-коди з документів ODP всього за кілька кроків:
      
      1. Завантажте документ ODP за допомогою Parser.
