...
############################# Head ############################
head_title: "Barcode aus ODP-Dateien in Java-Apps lesen"
head_description: "GroupDocs.Parser ermöglicht es, Barcode-Daten aus ODP-Dokumenten mit Java ohne externe Tools zu extrahieren."

############################# Header ############################
title: "Barcode aus ODP mit Java lesen" 
...
steps:
    enable: true
    title: "So lesen Sie Barcodes aus Odp in Java"
    content: |
      Mit [GroupDocs.Parser](/parser/java/) können Java-Entwickler Barcodes aus ODP-Dokumenten in wenigen Schritten extrahieren:
      
      1. Parser verwenden, um das ODP-Dokument zu laden.
