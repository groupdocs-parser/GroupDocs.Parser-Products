...
############################# Head ############################
head_title: "Baca kode batang dari file ODT dalam aplikasi Java"
head_description: "Dengan GroupDocs.Parser, ekstrak data kode batang dari dokumen ODT menggunakan Java tanpa alat eksternal."

############################# Header ############################
title: "Baca kode batang dari ODT menggunakan Java" 
...
steps:
    enable: true
    title: "Cara membaca kode batang dari Odt di Java"
    content: |
      Dengan [GroupDocs.Parser](/parser/java/), pengembang Java dapat mengekstrak kode batang dari dokumen ODT dalam beberapa langkah:
      
      1. Muatan dokumen ODT menggunakan Parser.
