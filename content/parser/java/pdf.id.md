...
about:
    enable: true
    title: "Bagaimana cara Mengurai & Mengekstrak Hyperlink dari PDF dokumen melalui Java API?"
    content: |
...
steps:
    enable: true
    title_left: "Ekstrak hyperlink dari PDF di Java"
    content_left: |
        [GroupDocs.Parser for Java](/id/parser/java/) memudahkan pengembang Java untuk mengekstrak hyperlink dari file PDF dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< parser/code-parser title="Cara mengekstrak hyperlink dari file PDF menggunakan kode contoh Java">}}

        ```java    
        // Ekstrak hyperlink dari file PDF menggunakan GroupDocs.Parser API
