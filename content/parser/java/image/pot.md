...
steps:
    enable: true
    block:
    - title_left: "Extract Images from POT Documents via C# "
      content_left: |
       GroupDocs.Parser .NET API enables software developers to extract images from POT documents. The following C# .NET code example demonstrates how to extract images inside a POT document. 
    ...
    - title_left: "Images Extraction from POT Document's Page via C#"
      content_left: |
       GroupDocs.Parser .NET allows software developers to extract images from POT documents's page. The below C# .NET code shows how images extraction can be achived  inside a POT document. 
    ...
    - title_left: "How to Extract Image from POT Documents Page Area"
      content_left: |
       GroupDocs.Parser .NET API fully supports extraction of images from POT documents using a couple of lines of .NET code. The following .NET code example shows how to perform images extraction from a POT document page area.
    ...
    - title_left: "How to Extract & Save Image to a File via C# .NET"
      content_left: |
       GroupDocs.Parser .NET API allows software developers to extract images from a document and save it into a file with a just couple of lines of .NET code. The following example demonstrates  how to perform images extraction from a POT document and save the image contents to the file. 
