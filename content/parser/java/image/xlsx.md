...
steps:
    enable: true
    block:
    - title_left: "Extract Images from XLSX Documents via C# "
      content_left: |
       GroupDocs.Parser .NET API enables software developers to extract images from XLSX documents. The following C# .NET code example demonstrates how to extract images inside a XLSX document. 
    ...
    - title_left: "Images Extraction from XLSX Document's Page via C#"
      content_left: |
       GroupDocs.Parser .NET allows software developers to extract images from XLSX documents's page. The below C# .NET code shows how images extraction can be achived  inside a XLSX document. 
    ...
    - title_left: "How to Extract Image from XLSX Documents Page Area"
      content_left: |
       GroupDocs.Parser .NET API fully supports extraction of images from XLSX documents using a couple of lines of .NET code. The following .NET code example shows how to perform images extraction from a XLSX document page area.
    ...
    - title_left: "How to Extract & Save Image to a File via C# .NET"
      content_left: |
       GroupDocs.Parser .NET API allows software developers to extract images from a document and save it into a file with a just couple of lines of .NET code. The following example demonstrates  how to perform images extraction from a XLSX document and save the image contents to the file. 
