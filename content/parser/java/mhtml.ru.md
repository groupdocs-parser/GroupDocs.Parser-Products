...
############################# Head ############################
head_title: "Извлечение гиперссылок из MHTML докуметов, страниц или области страницы через Java"
...
############################# Header ############################
title: "Java API для извлечения гиперссылок из MHTML документов, страниц или определенной области страницы"
...
about:
    enable: true
    title: "Как анализировать и извлекать гиперссылки из документов MHTML через Java API?"
    content: |
...
steps:
    enable: true
    title_left: "Извлечь гиперссылки из MHTML в Java"
    content_left: |
        [GroupDocs.Parser for Java](/ru/parser/java/) позволяет разработчикам Java легко извлекать гиперссылки из файла MHTML, выполняя несколько простых шагов. .
    ...
    code: |
     ...
     {{< parser/code-parser title="Как извлечь гиперссылки из файла MHTML, используя пример кода Java">}}
