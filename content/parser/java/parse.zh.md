...
############################# Head ############################
head_title: "从 Java 中的文档解析数据"
head_description: "快速解析 Java 中文档的数据。"

############################# Header ############################
title: "从 Java 中的文档中解析数据"
description: "使用几行 Java 代码解析文档中的数据。"
...
demos:
    enable: true
    title: "现场演示 - 在线解析文档中的数据"
    content: |
       立即访问 [GroupDocs.Parser 现场演示](https://products.groupdocs.app/parser/) 网站解析文档中的数据。
       现场演示有以下好处。
