...
about:
    enable: true
    title: "Bagaimana cara Mengurai & Mengekstrak Hyperlink dari MD dokumen melalui Java API?"
    content: |
...
steps:
    enable: true
    title_left: "Ekstrak hyperlink dari MD di Java"
    content_left: |
        [GroupDocs.Parser for Java](/id/parser/java/) memudahkan pengembang Java untuk mengekstrak hyperlink dari file MD dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< parser/code-parser title="Cara mengekstrak hyperlink dari file MD menggunakan kode contoh Java">}}

        ```java    
        // Ekstrak hyperlink dari file MD menggunakan GroupDocs.Parser API
