...
steps:
    enable: true
    block:
    - title_left: "Cara Mengekstrak Hyperlink dari Dokumen"
      content_left: |
       GroupDocs.Parser Java telah menyertakan fungsionalitas untuk mengekstraksi Hyperlink dari dokumen. Contoh kode Java berikut menunjukkan bagaimana hyperlink dapat diekstraksi dari dokumen. 
    ...
    - title_left: "Cara Mengekstrak Hyperlink dari Halaman Dokumen"
      content_left: |
    ...
    - title_left: "Ekstrak Hyperlink dari Area Halaman Dokumen"
      content_left: |
       GroupDocs.Parser Java API telah menyediakan dukungan lengkap untuk mengekstrak hyperlink dari kemudahan halaman dokumen. Kode Java berikut menunjukkan bagaimana programmer dapat mengekstrak hyperlink dari area halaman dokumen di dalam aplikasi Java mereka sendiri.
