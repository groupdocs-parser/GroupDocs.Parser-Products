...
draft: false
path: "de/parser/java/extract/xlt/"
...
steps:
    enable: true
    block:
    - title_left: "So extrahieren Sie Hyperlinks aus XLT-Dokumenten"
      content_left: |
       GroupDocs.Parser Java enthält Funktionen zum Extrahieren von Hyperlinks aus XLT-Dokumenten. Das folgende Java-Codebeispiel zeigt, wie Hyperlinks aus dem XLT-Dokument extrahiert werden können.
    ...
    - title_left: "So extrahieren Sie Hyperlinks von der XLT-Dokumentenseite"
      content_left: |
       GroupDocs.Parser .NET ermöglicht es Softwareentwicklern, mit ein paar Codezeilen Hyperlinks aus XLT-Dokumenten zu extrahieren. Der folgende C# .NET-Code zeigt die Extraktion von Hyperlinks innerhalb eines XLT-Dokuments. 
    ...
    - title_left: "Extrahieren Sie Hyperlinks aus dem Seitenbereich für XLT-Dokumente"
      content_left: |
       Die GroupDocs.Parser-Java-API bietet vollständige Unterstützung zum einfachen Extrahieren von Hyperlinks aus der Seite des XLT-Dokuments. Der folgende Java-Code zeigt, wie Programmierer Hyperlinks aus einem XLT-Dokumentseitenbereich in ihren eigenen Java-Anwendungen extrahieren können.
