...
draft: false
path: "es/parser/java/extract/table/md/"
...
steps:
    enable: true
    block:
    - title_left: "Utilice código Java para extraer tablas de MD "
      content_left: |
       GroupDocs.Parser Java API ha incluido soporte completo para procesar varios tipos de documentos y extraer datos de ellos. El siguiente ejemplo de código Java muestra cómo los programadores de software pueden extraer tablas de un documento MD con solo un par de líneas de código.

      title_right: "Extracción de tablas de MD Documentos"
      content_right: |
