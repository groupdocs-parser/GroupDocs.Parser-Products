...
about:
    enable: true
    title: "Wie extrahiere ich Tabellen aus DOC-Dateien über die Java-API?"
    content: |
...
steps:
    enable: true
    title_left: "Tabellen aus DOC in Java extrahieren"
    content_left: |
        [GroupDocs.Parser for Java](/de/parser/java/) erleichtert Java-Entwicklern das Extrahieren von Tabellen aus einer DOC-Datei durch die Implementierung einiger einfacher Schritte.
    ...
    code: |
     ...
     {{< parser/code-parser title="So extrahieren Sie Tabellen aus der Datei DOC mithilfe des Beispielcodes Java">}}
