...
about:
    enable: true
    title: "Bagaimana cara Mengekstrak Tabel dari DOT file melalui Java API?"
    content: |
...
steps:
    enable: true
    title_left: "Ekstrak tabel dari DOT di Java"
    content_left: |
        [GroupDocs.Parser for Java](/id/parser/java/) memudahkan pengembang Java untuk mengekstrak tabel dari file DOT dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< parser/code-parser title="Cara mengekstrak tabel dari file DOT menggunakan kode contoh Java">}}

        ```java    
        // Ekstrak tabel dari file DOT menggunakan GroupDocs.Parser API
