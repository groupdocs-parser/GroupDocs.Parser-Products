...
draft: false
path: "parser/java/extract/table/xhtml/"
...
steps:
    enable: true
    block:
    - title_left: "Use Java Code to Extract Tables from XHTML Documents "
      content_left: |
       GroupDocs.Parser Java API has included complete support for processing various documents types and extract data from it. The following Java code example shows how software programmers can extract tables from a XHTML document with just couple of lines of code. 

      title_right: "Tables Extraction from XHTML Documents"
      content_right: |
