...
steps:
    enable: true
    title_left: "Извлечь таблицы из FB2 в Java"
    content_left: |
        [GroupDocs.Parser for Java](/ru/parser/java/) позволяет разработчикам Java извлекать таблицы из файла FB2, выполняя несколько простых шагов. .
    ...
    code: |
     ...
     {{< parser/code-parser title="Как извлечь таблицы из файла FB2, используя пример кода Java">}}
