...
about:
    enable: true
    title: "Bagaimana cara Mengekstrak Tabel dari CHM file melalui Java API?"
    content: |
...
steps:
    enable: true
    title_left: "Ekstrak tabel dari CHM di Java"
    content_left: |
        [GroupDocs.Parser for Java](/id/parser/java/) memudahkan pengembang Java untuk mengekstrak tabel dari file CHM dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< parser/code-parser title="Cara mengekstrak tabel dari file CHM menggunakan kode contoh Java">}}
