...
steps:
    enable: true
    title_left: "Извлечь таблицы из PPSM в Java"
    content_left: |
        [GroupDocs.Parser for Java](/ru/parser/java/) позволяет разработчикам Java извлекать таблицы из файла PPSM, выполняя несколько простых шагов. .
    ...
    code: |
     ...
     {{< parser/code-parser title="Как извлечь таблицы из файла PPSM, используя пример кода Java">}}
