...
draft: false
path: "es/parser/java/extract/table/xhtml/"
...
steps:
    enable: true
    block:
    - title_left: "Utilice código Java para extraer tablas de XHTML "
      content_left: |
       GroupDocs.Parser Java API ha incluido soporte completo para procesar varios tipos de documentos y extraer datos de ellos. El siguiente ejemplo de código Java muestra cómo los programadores de software pueden extraer tablas de un documento XHTML con solo un par de líneas de código.

      title_right: "Extracción de tablas de XHTML Documentos"
      content_right: |
