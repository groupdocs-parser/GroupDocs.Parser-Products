...
steps:
    enable: true
    title_left: "Извлечь таблицы из CSV в Java"
    content_left: |
        [GroupDocs.Parser for Java](/ru/parser/java/) позволяет разработчикам Java извлекать таблицы из файла CSV, выполняя несколько простых шагов. .
    ...
    code: |
     ...
     {{< parser/code-parser title="Как извлечь таблицы из файла CSV, используя пример кода Java">}}
