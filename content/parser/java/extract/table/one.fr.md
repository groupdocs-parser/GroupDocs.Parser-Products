...
about:
    enable: true
    title: "Comment extraire des tables de fichiers ONE via l'API Java ?"
    content: |
...
steps:
    enable: true
    title_left: "Extraire les tables de ONE dans Java"
    content_left: |
        [GroupDocs.Parser for Java](/fr/parser/java/) permet aux développeurs Java d'extraire facilement des tables d'un fichier ONE en mettant en œuvre quelques étapes simples.
    ...
    code: |
     ...
     {{< parser/code-parser title="Comment extraire des tables du fichier ONE à l'aide de l'exemple de code Java">}}

        ```java    
        // Extraire les tables du fichier ONE à l'aide de l'API GroupDocs.Parser
