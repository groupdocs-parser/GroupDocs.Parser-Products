...
about:
    enable: true
    title: "¿Cómo extraer tablas de archivos PPSX a través de la API Java?"
    content: |
...
steps:
    enable: true
    title_left: "Extraer tablas de PPSX en Java"
    content_left: |
        [GroupDocs.Parser for Java](/es/parser/java/) facilita a los desarrolladores de Java extraer tablas de un archivo PPSX mediante la implementación de unos sencillos pasos.
    ...
    code: |
     ...
     {{< parser/code-parser title="Cómo extraer tablas del archivo PPSX usando el código de ejemplo Java">}}

        ```java    
        // Extraiga tablas del archivo PPSX usando la API GroupDocs.Parser
