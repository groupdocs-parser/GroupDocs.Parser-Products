...
about:
    enable: true
    title: "Wie extrahiere ich Tabellen aus RTF-Dateien über die Java-API?"
    content: |
...
steps:
    enable: true
    title_left: "Tabellen aus RTF in Java extrahieren"
    content_left: |
        [GroupDocs.Parser for Java](/de/parser/java/) erleichtert Java-Entwicklern das Extrahieren von Tabellen aus einer RTF-Datei durch die Implementierung einiger einfacher Schritte.
    ...
    code: |
     ...
     {{< parser/code-parser title="So extrahieren Sie Tabellen aus der Datei RTF mithilfe des Beispielcodes Java">}}

        ```java    
        // Extrahieren Sie Tabellen aus der Datei RTF mit der API GroupDocs.Parser
