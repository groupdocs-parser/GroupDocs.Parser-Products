...
about:
    enable: true
    title: "Bagaimana cara Mengekstrak Tabel dari XLS file melalui Java API?"
    content: |
...
steps:
    enable: true
    title_left: "Ekstrak tabel dari XLS di Java"
    content_left: |
        [GroupDocs.Parser for Java](/id/parser/java/) memudahkan pengembang Java untuk mengekstrak tabel dari file XLS dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< parser/code-parser title="Cara mengekstrak tabel dari file XLS menggunakan kode contoh Java">}}

        ```java    
        // Ekstrak tabel dari file XLS menggunakan GroupDocs.Parser API
