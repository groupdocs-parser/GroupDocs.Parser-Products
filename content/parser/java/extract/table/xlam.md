...
about:
    enable: true
    title: "How to Extract Tables from XLAM files via Java API?"
    content: |
...
steps:
    enable: true
    title_left: "Extract tables from XLAM in Java"
    content_left: |
        [GroupDocs.Parser for Java](/parser/java/) makes it easy for Java developers to extract tables from a XLAM file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< parser/code-parser title="How to extract tables from XLAM file using Java example code">}}
