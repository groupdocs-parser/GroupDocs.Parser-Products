...
steps:
    enable: true
    title_left: "Извлечь таблицы из DOTX в Java"
    content_left: |
        [GroupDocs.Parser for Java](/ru/parser/java/) позволяет разработчикам Java извлекать таблицы из файла DOTX, выполняя несколько простых шагов. .
    ...
    code: |
     ...
     {{< parser/code-parser title="Как извлечь таблицы из файла DOTX, используя пример кода Java">}}
