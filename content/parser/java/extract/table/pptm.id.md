...
about:
    enable: true
    title: "Bagaimana cara Mengekstrak Tabel dari PPTM file melalui Java API?"
    content: |
...
steps:
    enable: true
    title_left: "Ekstrak tabel dari PPTM di Java"
    content_left: |
        [GroupDocs.Parser for Java](/id/parser/java/) memudahkan pengembang Java untuk mengekstrak tabel dari file PPTM dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< parser/code-parser title="Cara mengekstrak tabel dari file PPTM menggunakan kode contoh Java">}}

        ```java    
        // Ekstrak tabel dari file PPTM menggunakan GroupDocs.Parser API
