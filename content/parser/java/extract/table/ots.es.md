...
about:
    enable: true
    title: "¿Cómo extraer tablas de archivos OTS a través de la API Java?"
    content: |
...
steps:
    enable: true
    title_left: "Extraer tablas de OTS en Java"
    content_left: |
        [GroupDocs.Parser for Java](/es/parser/java/) facilita a los desarrolladores de Java extraer tablas de un archivo OTS mediante la implementación de unos sencillos pasos.
    ...
    code: |
     ...
     {{< parser/code-parser title="Cómo extraer tablas del archivo OTS usando el código de ejemplo Java">}}

        ```java    
        // Extraiga tablas del archivo OTS usando la API GroupDocs.Parser
