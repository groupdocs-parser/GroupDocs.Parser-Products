...
about:
    enable: true
    title: "Bagaimana cara Mengekstrak Tabel dari EMLX file melalui Java API?"
    content: |
...
steps:
    enable: true
    title_left: "Ekstrak tabel dari EMLX di Java"
    content_left: |
        [GroupDocs.Parser for Java](/id/parser/java/) memudahkan pengembang Java untuk mengekstrak tabel dari file EMLX dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< parser/code-parser title="Cara mengekstrak tabel dari file EMLX menggunakan kode contoh Java">}}

        ```java    
        // Ekstrak tabel dari file EMLX menggunakan GroupDocs.Parser API
