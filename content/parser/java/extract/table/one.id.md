...
about:
    enable: true
    title: "Bagaimana cara Mengekstrak Tabel dari ONE file melalui Java API?"
    content: |
...
steps:
    enable: true
    title_left: "Ekstrak tabel dari ONE di Java"
    content_left: |
        [GroupDocs.Parser for Java](/id/parser/java/) memudahkan pengembang Java untuk mengekstrak tabel dari file ONE dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< parser/code-parser title="Cara mengekstrak tabel dari file ONE menggunakan kode contoh Java">}}

        ```java    
        // Ekstrak tabel dari file ONE menggunakan GroupDocs.Parser API
