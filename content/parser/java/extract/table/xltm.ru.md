...
steps:
    enable: true
    title_left: "Извлечь таблицы из XLTM в Java"
    content_left: |
        [GroupDocs.Parser for Java](/ru/parser/java/) позволяет разработчикам Java извлекать таблицы из файла XLTM, выполняя несколько простых шагов. .
    ...
    code: |
     ...
     {{< parser/code-parser title="Как извлечь таблицы из файла XLTM, используя пример кода Java">}}
