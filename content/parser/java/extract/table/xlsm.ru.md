...
steps:
    enable: true
    title_left: "Извлечь таблицы из XLSM в Java"
    content_left: |
        [GroupDocs.Parser for Java](/ru/parser/java/) позволяет разработчикам Java извлекать таблицы из файла XLSM, выполняя несколько простых шагов. .
    ...
    code: |
     ...
     {{< parser/code-parser title="Как извлечь таблицы из файла XLSM, используя пример кода Java">}}
