...
about:
    enable: true
    title: "How to Extract Tables from FB2 files via Java API?"
    content: |
...
steps:
    enable: true
    title_left: "Extract tables from FB2 in Java"
    content_left: |
        [GroupDocs.Parser for Java](/parser/java/) makes it easy for Java developers to extract tables from a FB2 file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< parser/code-parser title="How to extract tables from FB2 file using Java example code">}}

        ```java    
        // Extract tables from FB2 file using GroupDocs.Parser API
