...
about:
    enable: true
    title: "How to Extract Tables from DOCM files via Java API?"
    content: |
...
steps:
    enable: true
    title_left: "Extract tables from DOCM in Java"
    content_left: |
        [GroupDocs.Parser for Java](/parser/java/) makes it easy for Java developers to extract tables from a DOCM file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< parser/code-parser title="How to extract tables from DOCM file using Java example code">}}
