...
about:
    enable: true
    title: "Wie extrahiere ich Tabellen aus XLSM-Dateien über die Java-API?"
    content: |
...
steps:
    enable: true
    title_left: "Tabellen aus XLSM in Java extrahieren"
    content_left: |
        [GroupDocs.Parser for Java](/de/parser/java/) erleichtert Java-Entwicklern das Extrahieren von Tabellen aus einer XLSM-Datei durch die Implementierung einiger einfacher Schritte.
    ...
    code: |
     ...
     {{< parser/code-parser title="So extrahieren Sie Tabellen aus der Datei XLSM mithilfe des Beispielcodes Java">}}
