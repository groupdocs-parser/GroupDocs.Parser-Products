...
about:
    enable: true
    title: "Wie extrahiere ich Tabellen aus XHTML-Dateien über die Java-API?"
    content: |
...
steps:
    enable: true
    title_left: "Tabellen aus XHTML in Java extrahieren"
    content_left: |
        [GroupDocs.Parser for Java](/de/parser/java/) erleichtert Java-Entwicklern das Extrahieren von Tabellen aus einer XHTML-Datei durch die Implementierung einiger einfacher Schritte.
    ...
    code: |
     ...
     {{< parser/code-parser title="So extrahieren Sie Tabellen aus der Datei XHTML mithilfe des Beispielcodes Java">}}

        ```java    
        // Extrahieren Sie Tabellen aus der Datei XHTML mit der API GroupDocs.Parser
