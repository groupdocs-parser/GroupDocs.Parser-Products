...
about:
    enable: true
    title: "¿Cómo extraer tablas de archivos XLTM a través de la API Java?"
    content: |
...
steps:
    enable: true
    title_left: "Extraer tablas de XLTM en Java"
    content_left: |
        [GroupDocs.Parser for Java](/es/parser/java/) facilita a los desarrolladores de Java extraer tablas de un archivo XLTM mediante la implementación de unos sencillos pasos.
    ...
    code: |
     ...
     {{< parser/code-parser title="Cómo extraer tablas del archivo XLTM usando el código de ejemplo Java">}}

        ```java    
        // Extraiga tablas del archivo XLTM usando la API GroupDocs.Parser
