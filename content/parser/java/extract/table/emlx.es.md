...
about:
    enable: true
    title: "¿Cómo extraer tablas de archivos EMLX a través de la API Java?"
    content: |
...
steps:
    enable: true
    title_left: "Extraer tablas de EMLX en Java"
    content_left: |
        [GroupDocs.Parser for Java](/es/parser/java/) facilita a los desarrolladores de Java extraer tablas de un archivo EMLX mediante la implementación de unos sencillos pasos.
    ...
    code: |
     ...
     {{< parser/code-parser title="Cómo extraer tablas del archivo EMLX usando el código de ejemplo Java">}}

        ```java    
        // Extraiga tablas del archivo EMLX usando la API GroupDocs.Parser
