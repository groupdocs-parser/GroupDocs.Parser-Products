...
about:
    enable: true
    title: "Bagaimana cara Mengekstrak Tabel dari EPUB file melalui Java API?"
    content: |
...
steps:
    enable: true
    title_left: "Ekstrak tabel dari EPUB di Java"
    content_left: |
        [GroupDocs.Parser for Java](/id/parser/java/) memudahkan pengembang Java untuk mengekstrak tabel dari file EPUB dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< parser/code-parser title="Cara mengekstrak tabel dari file EPUB menggunakan kode contoh Java">}}

        ```java    
        // Ekstrak tabel dari file EPUB menggunakan GroupDocs.Parser API
