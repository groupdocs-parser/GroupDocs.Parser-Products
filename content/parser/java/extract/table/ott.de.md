...
about:
    enable: true
    title: "Wie extrahiere ich Tabellen aus OTT-Dateien über die Java-API?"
    content: |
...
steps:
    enable: true
    title_left: "Tabellen aus OTT in Java extrahieren"
    content_left: |
        [GroupDocs.Parser for Java](/de/parser/java/) erleichtert Java-Entwicklern das Extrahieren von Tabellen aus einer OTT-Datei durch die Implementierung einiger einfacher Schritte.
    ...
    code: |
     ...
     {{< parser/code-parser title="So extrahieren Sie Tabellen aus der Datei OTT mithilfe des Beispielcodes Java">}}

        ```java    
        // Extrahieren Sie Tabellen aus der Datei OTT mit der API GroupDocs.Parser
