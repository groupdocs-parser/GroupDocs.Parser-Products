...
steps:
    enable: true
    title_left: "Извлечь таблицы из ODT в Java"
    content_left: |
        [GroupDocs.Parser for Java](/ru/parser/java/) позволяет разработчикам Java извлекать таблицы из файла ODT, выполняя несколько простых шагов. .
    ...
    code: |
     ...
     {{< parser/code-parser title="Как извлечь таблицы из файла ODT, используя пример кода Java">}}
