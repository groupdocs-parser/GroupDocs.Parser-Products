...
about:
    enable: true
    title: "Bagaimana cara Mengekstrak Tabel dari DOCM file melalui Java API?"
    content: |
...
steps:
    enable: true
    title_left: "Ekstrak tabel dari DOCM di Java"
    content_left: |
        [GroupDocs.Parser for Java](/id/parser/java/) memudahkan pengembang Java untuk mengekstrak tabel dari file DOCM dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< parser/code-parser title="Cara mengekstrak tabel dari file DOCM menggunakan kode contoh Java">}}
