...
about:
    enable: true
    title: "Bagaimana cara Mengekstrak Tabel dari FB2 file melalui Java API?"
    content: |
...
steps:
    enable: true
    title_left: "Ekstrak tabel dari FB2 di Java"
    content_left: |
        [GroupDocs.Parser for Java](/id/parser/java/) memudahkan pengembang Java untuk mengekstrak tabel dari file FB2 dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< parser/code-parser title="Cara mengekstrak tabel dari file FB2 menggunakan kode contoh Java">}}

        ```java    
        // Ekstrak tabel dari file FB2 menggunakan GroupDocs.Parser API
