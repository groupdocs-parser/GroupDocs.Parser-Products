...
steps:
    enable: true
    title_left: "Извлечь таблицы из PDF в Java"
    content_left: |
        [GroupDocs.Parser for Java](/ru/parser/java/) позволяет разработчикам Java извлекать таблицы из файла PDF, выполняя несколько простых шагов. .
    ...
    code: |
     ...
     {{< parser/code-parser title="Как извлечь таблицы из файла PDF, используя пример кода Java">}}
