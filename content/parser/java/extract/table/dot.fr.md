...
about:
    enable: true
    title: "Comment extraire des tables de fichiers DOT via l'API Java ?"
    content: |
...
steps:
    enable: true
    title_left: "Extraire les tables de DOT dans Java"
    content_left: |
        [GroupDocs.Parser for Java](/fr/parser/java/) permet aux développeurs Java d'extraire facilement des tables d'un fichier DOT en mettant en œuvre quelques étapes simples.
    ...
    code: |
     ...
     {{< parser/code-parser title="Comment extraire des tables du fichier DOT à l'aide de l'exemple de code Java">}}
