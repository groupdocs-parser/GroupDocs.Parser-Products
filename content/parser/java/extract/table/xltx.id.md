...
about:
    enable: true
    title: "Bagaimana cara Mengekstrak Tabel dari XLTX file melalui Java API?"
    content: |
...
steps:
    enable: true
    title_left: "Ekstrak tabel dari XLTX di Java"
    content_left: |
        [GroupDocs.Parser for Java](/id/parser/java/) memudahkan pengembang Java untuk mengekstrak tabel dari file XLTX dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< parser/code-parser title="Cara mengekstrak tabel dari file XLTX menggunakan kode contoh Java">}}

        ```java    
        // Ekstrak tabel dari file XLTX menggunakan GroupDocs.Parser API
