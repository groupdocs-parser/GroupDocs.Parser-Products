...
about:
    enable: true
    title: "¿Cómo extraer tablas de archivos PDF a través de la API Java?"
    content: |
...
steps:
    enable: true
    title_left: "Extraer tablas de PDF en Java"
    content_left: |
        [GroupDocs.Parser for Java](/es/parser/java/) facilita a los desarrolladores de Java extraer tablas de un archivo PDF mediante la implementación de unos sencillos pasos.
    ...
    code: |
     ...
     {{< parser/code-parser title="Cómo extraer tablas del archivo PDF usando el código de ejemplo Java">}}

        ```java    
        // Extraiga tablas del archivo PDF usando la API GroupDocs.Parser
