...
about:
    enable: true
    title: "¿Cómo extraer tablas de archivos POTX a través de la API Java?"
    content: |
...
steps:
    enable: true
    title_left: "Extraer tablas de POTX en Java"
    content_left: |
        [GroupDocs.Parser for Java](/es/parser/java/) facilita a los desarrolladores de Java extraer tablas de un archivo POTX mediante la implementación de unos sencillos pasos.
    ...
    code: |
     ...
     {{< parser/code-parser title="Cómo extraer tablas del archivo POTX usando el código de ejemplo Java">}}

        ```java    
        // Extraiga tablas del archivo POTX usando la API GroupDocs.Parser
