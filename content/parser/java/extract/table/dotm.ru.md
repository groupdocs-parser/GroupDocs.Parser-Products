...
steps:
    enable: true
    title_left: "Извлечь таблицы из DOTM в Java"
    content_left: |
        [GroupDocs.Parser for Java](/ru/parser/java/) позволяет разработчикам Java извлекать таблицы из файла DOTM, выполняя несколько простых шагов. .
    ...
    code: |
     ...
     {{< parser/code-parser title="Как извлечь таблицы из файла DOTM, используя пример кода Java">}}
