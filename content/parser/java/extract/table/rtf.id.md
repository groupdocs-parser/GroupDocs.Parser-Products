...
about:
    enable: true
    title: "Bagaimana cara Mengekstrak Tabel dari RTF file melalui Java API?"
    content: |
...
steps:
    enable: true
    title_left: "Ekstrak tabel dari RTF di Java"
    content_left: |
        [GroupDocs.Parser for Java](/id/parser/java/) memudahkan pengembang Java untuk mengekstrak tabel dari file RTF dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< parser/code-parser title="Cara mengekstrak tabel dari file RTF menggunakan kode contoh Java">}}

        ```java    
        // Ekstrak tabel dari file RTF menggunakan GroupDocs.Parser API
