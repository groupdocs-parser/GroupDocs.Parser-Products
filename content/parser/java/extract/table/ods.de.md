...
about:
    enable: true
    title: "Wie extrahiere ich Tabellen aus ODS-Dateien über die Java-API?"
    content: |
...
steps:
    enable: true
    title_left: "Tabellen aus ODS in Java extrahieren"
    content_left: |
        [GroupDocs.Parser for Java](/de/parser/java/) erleichtert Java-Entwicklern das Extrahieren von Tabellen aus einer ODS-Datei durch die Implementierung einiger einfacher Schritte.
    ...
    code: |
     ...
     {{< parser/code-parser title="So extrahieren Sie Tabellen aus der Datei ODS mithilfe des Beispielcodes Java">}}

        ```java    
        // Extrahieren Sie Tabellen aus der Datei ODS mit der API GroupDocs.Parser
