...
about:
    enable: true
    title: "Wie extrahiere ich Tabellen aus CHM-Dateien über die Java-API?"
    content: |
...
steps:
    enable: true
    title_left: "Tabellen aus CHM in Java extrahieren"
    content_left: |
        [GroupDocs.Parser for Java](/de/parser/java/) erleichtert Java-Entwicklern das Extrahieren von Tabellen aus einer CHM-Datei durch die Implementierung einiger einfacher Schritte.
    ...
    code: |
     ...
     {{< parser/code-parser title="So extrahieren Sie Tabellen aus der Datei CHM mithilfe des Beispielcodes Java">}}

        ```java    
        // Extrahieren Sie Tabellen aus der Datei CHM mit der API GroupDocs.Parser
