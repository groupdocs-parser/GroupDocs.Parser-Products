...
steps:
    enable: true
    block:
    - title_left: "Cara Mengekstrak Hyperlink dari Dokumen EMLX"
      content_left: |
       GroupDocs.Parser Java telah menyertakan fungsionalitas untuk mengekstraksi Hyperlink dari dokumen EMLX. Contoh kode Java berikut menunjukkan bagaimana hyperlink dapat diekstraksi dari dokumen EMLX. 
    ...
    - title_left: "Cara Mengekstrak Hyperlink dari Halaman Dokumen EMLX"
      content_left: |
       GroupDocs.Parser .NET memungkinkan pengembang perangkat lunak untuk mengekstrak hyperlink dari dokumen EMLX dengan beberapa baris kode. Kode C# .NET di bawah ini menunjukkan ekstraksi hyperlink di dalam dokumen EMLX. 
    ...
    - title_left: "Ekstrak Hyperlink dari EMLX Area Halaman Dokumen"
      content_left: |
       GroupDocs.Parser Java API telah memberikan dukungan lengkap untuk mengekstrak hyperlink dari halaman dokumen EMLX dengan mudah. Kode Java berikut menunjukkan bagaimana programmer dapat mengekstrak hyperlink dari area halaman dokumen EMLX di dalam aplikasi Java mereka sendiri.
