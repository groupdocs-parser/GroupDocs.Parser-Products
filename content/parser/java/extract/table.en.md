...
about:
    enable: true
    title: "How to Extract Tables from Excel, Word, PDF & other documents via Java API?"
    content: |
...
steps:
    enable: true
    title_left: "Extract tables from documents in Java"
    content_left: |
        [GroupDocs.Parser for Java](/parser/java/) makes it easy for Java developers to extract tables from documents by implementing a few easy steps.
    ...
    code: |
     ...
     {{< parser/code-parser title="How to extract tables from documents using Java example code">}}

        ```java    
        // Extract tables from documents using GroupDocs.Parser API
