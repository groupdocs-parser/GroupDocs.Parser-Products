...
draft: false
path: "de/parser/java/extract/docx/"
...
steps:
    enable: true
    block:
    - title_left: "So extrahieren Sie Hyperlinks aus DOCX-Dokumenten"
      content_left: |
       GroupDocs.Parser Java enthält Funktionen zum Extrahieren von Hyperlinks aus DOCX-Dokumenten. Das folgende Java-Codebeispiel zeigt, wie Hyperlinks aus dem DOCX-Dokument extrahiert werden können.
    ...
    - title_left: "So extrahieren Sie Hyperlinks von der DOCX-Dokumentenseite"
      content_left: |
       GroupDocs.Parser .NET ermöglicht es Softwareentwicklern, mit ein paar Codezeilen Hyperlinks aus DOCX-Dokumenten zu extrahieren. Der folgende C# .NET-Code zeigt die Extraktion von Hyperlinks innerhalb eines DOCX-Dokuments. 
    ...
    - title_left: "Extrahieren Sie Hyperlinks aus dem Seitenbereich für DOCX-Dokumente"
      content_left: |
       Die GroupDocs.Parser-Java-API bietet vollständige Unterstützung zum einfachen Extrahieren von Hyperlinks aus der Seite des DOCX-Dokuments. Der folgende Java-Code zeigt, wie Programmierer Hyperlinks aus einem DOCX-Dokumentseitenbereich in ihren eigenen Java-Anwendungen extrahieren können.
