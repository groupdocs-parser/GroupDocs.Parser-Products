...
draft: false
path: "de/parser/java/extract/xlsx/"
...
steps:
    enable: true
    block:
    - title_left: "So extrahieren Sie Hyperlinks aus XLSX-Dokumenten"
      content_left: |
       GroupDocs.Parser Java enthält Funktionen zum Extrahieren von Hyperlinks aus XLSX-Dokumenten. Das folgende Java-Codebeispiel zeigt, wie Hyperlinks aus dem XLSX-Dokument extrahiert werden können.
    ...
    - title_left: "So extrahieren Sie Hyperlinks von der XLSX-Dokumentenseite"
      content_left: |
       GroupDocs.Parser .NET ermöglicht es Softwareentwicklern, mit ein paar Codezeilen Hyperlinks aus XLSX-Dokumenten zu extrahieren. Der folgende C# .NET-Code zeigt die Extraktion von Hyperlinks innerhalb eines XLSX-Dokuments. 
    ...
    - title_left: "Extrahieren Sie Hyperlinks aus dem Seitenbereich für XLSX-Dokumente"
      content_left: |
       Die GroupDocs.Parser-Java-API bietet vollständige Unterstützung zum einfachen Extrahieren von Hyperlinks aus der Seite des XLSX-Dokuments. Der folgende Java-Code zeigt, wie Programmierer Hyperlinks aus einem XLSX-Dokumentseitenbereich in ihren eigenen Java-Anwendungen extrahieren können.
