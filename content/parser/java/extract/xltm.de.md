...
draft: false
path: "de/parser/java/extract/xltm/"
...
steps:
    enable: true
    block:
    - title_left: "So extrahieren Sie Hyperlinks aus XLTM-Dokumenten"
      content_left: |
       GroupDocs.Parser Java enthält Funktionen zum Extrahieren von Hyperlinks aus XLTM-Dokumenten. Das folgende Java-Codebeispiel zeigt, wie Hyperlinks aus dem XLTM-Dokument extrahiert werden können.
    ...
    - title_left: "So extrahieren Sie Hyperlinks von der XLTM-Dokumentenseite"
      content_left: |
       GroupDocs.Parser .NET ermöglicht es Softwareentwicklern, mit ein paar Codezeilen Hyperlinks aus XLTM-Dokumenten zu extrahieren. Der folgende C# .NET-Code zeigt die Extraktion von Hyperlinks innerhalb eines XLTM-Dokuments. 
    ...
    - title_left: "Extrahieren Sie Hyperlinks aus dem Seitenbereich für XLTM-Dokumente"
      content_left: |
       Die GroupDocs.Parser-Java-API bietet vollständige Unterstützung zum einfachen Extrahieren von Hyperlinks aus der Seite des XLTM-Dokuments. Der folgende Java-Code zeigt, wie Programmierer Hyperlinks aus einem XLTM-Dokumentseitenbereich in ihren eigenen Java-Anwendungen extrahieren können.
