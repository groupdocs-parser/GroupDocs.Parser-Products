...
about:
    enable: true
    title: "How to Extract Barcodes from Excel, Word, PDF & Other Documents Java API?"
    content: |
...
steps:
    enable: true
    title_left: "Extract barcodes from documents in Java"
    content_left: |
        [GroupDocs.Parser for Java](/parser/java/) makes it easy for Java developers to extract barcodes from documents by implementing a few easy steps.
    ...
    code: |
     ...
     {{< parser/code-parser title="How to extract barcodes from documents using Java example code">}}

        ```java    
        // Extract barcodes from documents using GroupDocs.Parser API
