...
draft: false
path: "de/parser/java/extract/pptx/"
...
steps:
    enable: true
    block:
    - title_left: "So extrahieren Sie Hyperlinks aus PPTX-Dokumenten"
      content_left: |
       GroupDocs.Parser Java enthält Funktionen zum Extrahieren von Hyperlinks aus PPTX-Dokumenten. Das folgende Java-Codebeispiel zeigt, wie Hyperlinks aus dem PPTX-Dokument extrahiert werden können.
    ...
    - title_left: "So extrahieren Sie Hyperlinks von der PPTX-Dokumentenseite"
      content_left: |
    ...
    - title_left: "Extrahieren Sie Hyperlinks aus dem Seitenbereich für PPTX-Dokumente"
      content_left: |
       Die GroupDocs.Parser-Java-API bietet vollständige Unterstützung zum einfachen Extrahieren von Hyperlinks aus der Seite des PPTX-Dokuments. Der folgende Java-Code zeigt, wie Programmierer Hyperlinks aus einem PPTX-Dokumentseitenbereich in ihren eigenen Java-Anwendungen extrahieren können.
