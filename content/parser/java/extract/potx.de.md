...
draft: false
path: "de/parser/java/extract/potx/"
...
steps:
    enable: true
    block:
    - title_left: "So extrahieren Sie Hyperlinks aus POTX-Dokumenten"
      content_left: |
       GroupDocs.Parser Java enthält Funktionen zum Extrahieren von Hyperlinks aus POTX-Dokumenten. Das folgende Java-Codebeispiel zeigt, wie Hyperlinks aus dem POTX-Dokument extrahiert werden können.
    ...
    - title_left: "So extrahieren Sie Hyperlinks von der POTX-Dokumentenseite"
      content_left: |
       GroupDocs.Parser .NET ermöglicht es Softwareentwicklern, mit ein paar Codezeilen Hyperlinks aus POTX-Dokumenten zu extrahieren. Der folgende C# .NET-Code zeigt die Extraktion von Hyperlinks innerhalb eines POTX-Dokuments. 
    ...
    - title_left: "Extrahieren Sie Hyperlinks aus dem Seitenbereich für POTX-Dokumente"
      content_left: |
       Die GroupDocs.Parser-Java-API bietet vollständige Unterstützung zum einfachen Extrahieren von Hyperlinks aus der Seite des POTX-Dokuments. Der folgende Java-Code zeigt, wie Programmierer Hyperlinks aus einem POTX-Dokumentseitenbereich in ihren eigenen Java-Anwendungen extrahieren können.
