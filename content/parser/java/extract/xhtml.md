...
draft: false
path: "parser/java/extract/xhtml"
...
steps:
    enable: true
    block:
    - title_left: "How to Extract Hyperlinks from XHTML Documents"
      content_left: |
       GroupDocs.Parser Java has included functionality for extracting Hyperlinks from XHTML documents. The following Java code example shows how hyperlinks can be extracted from XHTML document. 
    ...
    - title_left: "How to Extract Hyperlinks from XHTML Documents Page"
      content_left: |
       GroupDocs.Parser .NET allows software developers to extract hyperlinks from XHTML documents with a couple of lines of code. The below C# .NET code shows hyperlinks extraction inside a XHTML document. 
    ...
    - title_left: "Extract Hyperlinks from XHTML Documents Page Area"
      content_left: |
       GroupDocs.Parser Java API has provided complete support to extract hyperlinks from XHTML document's page ease. The following Java code shows how programmers can extract hyperlinks from a XHTML document page area inside their own Java applications.
