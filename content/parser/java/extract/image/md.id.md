...
draft: false
path: "parser/java/extract/image/md"
...
steps:
    enable: true
    block:
    - title_left: "Cara Mengekstrak gambar dari MD Dokumen"
      content_left: |
       GroupDocs.Parser Java telah menyertakan fungsionalitas untuk mengekstraksi gambar dari dokumen MD. Contoh kode Java berikut menunjukkan bagaimana gambar dapat diekstraksi dari dokumen MD dengan mudah. 
    ...
    - title_left: "Ekstraksi Gambar dari Halaman Dokumen MD"
      content_left: |
       GroupDocs.Parser Java API memungkinkan pengembang perangkat lunak untuk mengekstrak gambar dari dokumen MD dengan beberapa baris kode. Kode Java di bawah ini menunjukkan ekstraksi gambar dari dokumen MD. 
    ...
    - title_left: "Cara Mengekstrak Gambar dari Area Halaman Dokumen MD"
      content_left: |
       GroupDocs.Parser Java API telah menyediakan dukungan lengkap untuk mengekstrak dari halaman dokumen MD dengan mudah. Kode Java berikut menunjukkan bagaimana pemrogram dapat mengekstrak gambar dari area halaman dokumen MD di dalam aplikasi Java mereka sendiri.
    ...
    - title_left: "Cara Mengekstrak Gambar ke File melalui Java API"
      content_left: |
       GroupDocs.Parser Java API memungkinkan ekstraksi gambar dari dokumen MD dan menyimpan konten gambar ke file. Kode Java berikut menunjukkan bagaimana programmer dapat mengekstrak gambar dari ke file pilihan mereka di dalam aplikasi Java mereka sendiri.
