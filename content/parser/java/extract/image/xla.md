...
steps:
    enable: true
    block:
    - title_left: "How to Extract images from XLA Documents"
      content_left: |
       GroupDocs.Parser Java has included functionality for extracting images from XLA documents. The following Java code example shows how images can be extracted from XLA document with ease. 
    ...
    - title_left: "Images Extraction from XLA Documents Page"
      content_left: |
       GroupDocs.Parser Java API allows software developers to extract images from XLA documents with a couple of lines of code. The below Java code shows images extraction from a XLA document. 
    ...
    - title_left: "How to Extract Images from XLA Documents Page Area"
      content_left: |
       GroupDocs.Parser Java API has provided complete support for extracting from XLA document's page ease. The following Java code demonstrates how programmers can extract images from a XLA document page area inside their own Java apps.
    ...
    - title_left: "How to Extract Images to a File via Java API"
      content_left: |
       GroupDocs.Parser Java API allows extracting images from XLA document's and save  image contents to a file. The following Java code demonstrates how programmers can extract images from to file of their choice inside their own Java apps.
