...
draft: false
path: "es/parser/java/extract/image/fb2/"
...
steps:
    enable: true
    block:
    - title_left: "Extraiga imágenes de FB2 Documentos a través de C# "
      content_left: |
       GroupDocs.Parser .NET API permite a los desarrolladores de software extraer imágenes de FB2 documentos. El siguiente ejemplo de código C# .NET demuestra cómo extraer imágenes dentro de un documento FB2.
    ...
    - title_left: "Extracción de imágenes de la página del documento FB2 a través de C#"
      content_left: |
       GroupDocs.Parser .NET permite a los desarrolladores de software extraer imágenes de la página de documentos FB2. El siguiente código C# .NET muestra cómo se puede lograr la extracción de imágenes dentro de un documento FB2.
    ...
    - title_left: "Cómo extraer una imagen del área de la página de documentos FB2"
      content_left: |
       GroupDocs.Parser .NET API es totalmente compatible con la extracción de imágenes de documentos FB2 usando un par de líneas de código .NET. El siguiente ejemplo de código .NET muestra cómo realizar la extracción de imágenes desde un área de página de documento FB2.
