...
steps:
    enable: true
    block:
    - title_left: "Cara Mengekstrak Gambar dari MHTML Dokumen"
      content_left: |
       GroupDocs.Parser Java telah menyertakan fungsionalitas untuk mengekstraksi gambar dari dokumen MHTML. Contoh kode Java berikut menunjukkan bagaimana gambar dapat diekstraksi dari dokumen MHTML dengan mudah. 
    ...
    - title_left: "Ekstraksi Gambar dari Halaman Dokumen MHTML"
      content_left: |
       GroupDocs.Parser Java API memungkinkan pengembang perangkat lunak untuk mengekstrak gambar dari dokumen MHTML dengan beberapa baris kode. Kode Java di bawah ini menunjukkan ekstraksi gambar dari dokumen MHTML. 
    ...
    - title_left: "Cara Mengekstrak Gambar dari Area Halaman Dokumen MHTML"
      content_left: |
       GroupDocs.Parser Java API telah menyediakan dukungan lengkap untuk mengekstrak dari halaman dokumen MHTML dengan mudah. Kode Java berikut menunjukkan bagaimana pemrogram dapat mengekstrak gambar dari area halaman dokumen MHTML di dalam aplikasi Java mereka sendiri.
    ...
    - title_left: "Cara Mengekstrak Gambar ke File melalui Java API"
      content_left: |
       GroupDocs.Parser Java API memungkinkan ekstraksi gambar dari dokumen MHTML dan menyimpan konten gambar ke file. Kode Java berikut menunjukkan bagaimana programmer dapat mengekstrak gambar dari ke file pilihan mereka di dalam aplikasi Java mereka sendiri.
