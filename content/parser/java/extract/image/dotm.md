...
steps:
    enable: true
    block:
    - title_left: "How to Extract images from DOTM Documents"
      content_left: |
       GroupDocs.Parser Java has included functionality for extracting images from DOTM documents. The following Java code example shows how images can be extracted from DOTM document with ease. 
    ...
    - title_left: "Images Extraction from DOTM Documents Page"
      content_left: |
       GroupDocs.Parser Java API allows software developers to extract images from DOTM documents with a couple of lines of code. The below Java code shows images extraction from a DOTM document. 
    ...
    - title_left: "How to Extract Images from DOTM Documents Page Area"
      content_left: |
       GroupDocs.Parser Java API has provided complete support for extracting from DOTM document's page ease. The following Java code demonstrates how programmers can extract images from a DOTM document page area inside their own Java apps.
    ...
    - title_left: "How to Extract Images to a File via Java API"
      content_left: |
       GroupDocs.Parser Java API allows extracting images from DOTM document's and save  image contents to a file. The following Java code demonstrates how programmers can extract images from to file of their choice inside their own Java apps.
