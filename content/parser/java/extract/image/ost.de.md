...
draft: false
path: "de/parser/java/extract/image/ost/"
...
steps:
    enable: true
    block:
    - title_left: "So extrahieren Sie Bilder aus OST-Dokumenten"
      content_left: |
       GroupDocs.Parser Java enthält Funktionen zum Extrahieren von Bildern aus OST-Dokumenten. Das folgende Java-Codebeispiel zeigt, wie Bilder problemlos aus dem OST-Dokument extrahiert werden können.
    ...
    - title_left: "Bildextraktion aus OST-Dokumentenseite"
      content_left: |
       GroupDocs.Parser Java API ermöglicht es Softwareentwicklern, Bilder aus OST-Dokumenten mit ein paar Codezeilen zu extrahieren. Der folgende Java-Code zeigt die Bildextraktion aus einem OST-Dokument.
    ...
    - title_left: "So extrahieren Sie Bilder aus dem OST-Dokumentseitenbereich"
      content_left: |
       GroupDocs.Parser Java API bietet vollständige Unterstützung für das einfache Extrahieren von OST-Dokumentseiten. Der folgende Java-Code zeigt, wie Programmierer Bilder aus einem OST-Dokumentseitenbereich in ihren eigenen Java-Apps extrahieren können.
    ...
    - title_left: "So extrahieren Sie Bilder über die Java-API in eine Datei"
      content_left: |
       GroupDocs.Parser Java API ermöglicht das Extrahieren von Bildern aus OST-Dokumenten und das Speichern von Bildinhalten in einer Datei. Der folgende Java-Code zeigt, wie Programmierer Bilder aus einer Datei ihrer Wahl in ihren eigenen Java-Apps extrahieren können.
