...
draft: false
path: "fr/parser/java/extract/image/ost/"
...
steps:
    enable: true
    block:
    - title_left: "Comment extraire des images de documents OST"
      content_left: |
       GroupDocs.Parser Java a inclus une fonctionnalité pour extraire des images à partir de documents OST. L'exemple de code Java suivant montre comment extraire facilement des images du document OST. 
    ...
    - title_left: "Extraction d'images à partir de la page des documents OST"
      content_left: |
       L'API Java GroupDocs.Parser permet aux développeurs de logiciels d'extraire des images des documents OST avec quelques lignes de code. Le code Java ci-dessous montre l'extraction d'images d'un document OST. 
    ...
    - title_left: "Comment extraire des images de la zone de page des documents OST"
      content_left: |
       L'API Java GroupDocs.Parser a fourni un support complet pour l'extraction de la facilité de page du document OST. Le code Java suivant montre comment les programmeurs peuvent extraire des images d'une zone de page de document OST dans leurs propres applications Java.
    ...
    - title_left: "Comment extraire des images dans un fichier via l'API Java"
      content_left: |
       L'API Java GroupDocs.Parser permet d'extraire des images du document OST et d'enregistrer le contenu de l'image dans un fichier. Le code Java suivant montre comment les programmeurs peuvent extraire des images du fichier de leur choix dans leurs propres applications Java.
