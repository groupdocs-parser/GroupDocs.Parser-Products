...
steps:
    enable: true
    block:
    - title_left: "How to Extract images from PPTM Documents"
      content_left: |
       GroupDocs.Parser Java has included functionality for extracting images from PPTM documents. The following Java code example shows how images can be extracted from PPTM document with ease. 
    ...
    - title_left: "Images Extraction from PPTM Documents Page"
      content_left: |
       GroupDocs.Parser Java API allows software developers to extract images from PPTM documents with a couple of lines of code. The below Java code shows images extraction from a PPTM document. 
    ...
    - title_left: "How to Extract Images from PPTM Documents Page Area"
      content_left: |
       GroupDocs.Parser Java API has provided complete support for extracting from PPTM document's page ease. The following Java code demonstrates how programmers can extract images from a PPTM document page area inside their own Java apps.
    ...
    - title_left: "How to Extract Images to a File via Java API"
      content_left: |
       GroupDocs.Parser Java API allows extracting images from PPTM document's and save  image contents to a file. The following Java code demonstrates how programmers can extract images from to file of their choice inside their own Java apps.
