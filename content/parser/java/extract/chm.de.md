...
draft: false
path: "de/parser/java/extract/chm/"
...
steps:
    enable: true
    block:
    - title_left: "So extrahieren Sie Hyperlinks aus CHM-Dokumenten"
      content_left: |
       GroupDocs.Parser Java enthält Funktionen zum Extrahieren von Hyperlinks aus CHM-Dokumenten. Das folgende Java-Codebeispiel zeigt, wie Hyperlinks aus dem CHM-Dokument extrahiert werden können.
    ...
    - title_left: "So extrahieren Sie Hyperlinks von der CHM-Dokumentenseite"
      content_left: |
    ...
    - title_left: "Extrahieren Sie Hyperlinks aus dem Seitenbereich für CHM-Dokumente"
      content_left: |
       Die GroupDocs.Parser-Java-API bietet vollständige Unterstützung zum einfachen Extrahieren von Hyperlinks aus der Seite des CHM-Dokuments. Der folgende Java-Code zeigt, wie Programmierer Hyperlinks aus einem CHM-Dokumentseitenbereich in ihren eigenen Java-Anwendungen extrahieren können.
