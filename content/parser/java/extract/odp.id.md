...
steps:
    enable: true
    block:
    - title_left: "Cara Mengekstrak Hyperlink dari Dokumen ODP"
      content_left: |
       GroupDocs.Parser Java telah menyertakan fungsionalitas untuk mengekstraksi Hyperlink dari dokumen ODP. Contoh kode Java berikut menunjukkan bagaimana hyperlink dapat diekstraksi dari dokumen ODP. 
    ...
    - title_left: "Cara Mengekstrak Hyperlink dari Halaman Dokumen ODP"
      content_left: |
       GroupDocs.Parser .NET memungkinkan pengembang perangkat lunak untuk mengekstrak hyperlink dari dokumen ODP dengan beberapa baris kode. Kode C# .NET di bawah ini menunjukkan ekstraksi hyperlink di dalam dokumen ODP. 
    ...
    - title_left: "Ekstrak Hyperlink dari ODP Area Halaman Dokumen"
      content_left: |
       GroupDocs.Parser Java API telah memberikan dukungan lengkap untuk mengekstrak hyperlink dari halaman dokumen ODP dengan mudah. Kode Java berikut menunjukkan bagaimana programmer dapat mengekstrak hyperlink dari area halaman dokumen ODP di dalam aplikasi Java mereka sendiri.
