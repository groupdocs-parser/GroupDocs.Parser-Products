...
steps:
    enable: true
    block:
    - title_left: "How to Extract Hyperlinks from FB2 Documents"
      content_left: |
       GroupDocs.Parser Java has included functionality for extracting Hyperlinks from FB2 documents. The following Java code example shows how hyperlinks can be extracted from FB2 document. 
    ...
    - title_left: "How to Extract Hyperlinks from FB2 Documents Page"
      content_left: |
       GroupDocs.Parser .NET allows software developers to extract hyperlinks from FB2 documents with a couple of lines of code. The below C# .NET code shows hyperlinks extraction inside a FB2 document. 
    ...
    - title_left: "Extract Hyperlinks from FB2 Documents Page Area"
      content_left: |
       GroupDocs.Parser Java API has provided complete support to extract hyperlinks from FB2 document's page ease. The following Java code shows how programmers can extract hyperlinks from a FB2 document page area inside their own Java applications.
