...
draft: false
path: "de/parser/java/extract/ods/"
...
steps:
    enable: true
    block:
    - title_left: "So extrahieren Sie Hyperlinks aus ODS-Dokumenten"
      content_left: |
       GroupDocs.Parser Java enthält Funktionen zum Extrahieren von Hyperlinks aus ODS-Dokumenten. Das folgende Java-Codebeispiel zeigt, wie Hyperlinks aus dem ODS-Dokument extrahiert werden können.
    ...
    - title_left: "So extrahieren Sie Hyperlinks von der ODS-Dokumentenseite"
      content_left: |
       GroupDocs.Parser .NET ermöglicht es Softwareentwicklern, mit ein paar Codezeilen Hyperlinks aus ODS-Dokumenten zu extrahieren. Der folgende C# .NET-Code zeigt die Extraktion von Hyperlinks innerhalb eines ODS-Dokuments. 
    ...
    - title_left: "Extrahieren Sie Hyperlinks aus dem Seitenbereich für ODS-Dokumente"
      content_left: |
       Die GroupDocs.Parser-Java-API bietet vollständige Unterstützung zum einfachen Extrahieren von Hyperlinks aus der Seite des ODS-Dokuments. Der folgende Java-Code zeigt, wie Programmierer Hyperlinks aus einem ODS-Dokumentseitenbereich in ihren eigenen Java-Anwendungen extrahieren können.
