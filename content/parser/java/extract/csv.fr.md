...
draft: false
path: "fr/parser/java/extract/csv/"
...
steps:
    enable: true
    block:
    - title_left: "Comment extraire des liens hypertexte de CSV Documents"
      content_left: |
       GroupDocs.Parser Java a inclus une fonctionnalité pour extraire des liens hypertexte à partir de documents CSV. L'exemple de code Java suivant montre comment les liens hypertexte peuvent être extraits du document CSV. 
    ...
    - title_left: "Comment extraire des liens hypertexte de la page CSV Documents"
      content_left: |
       GroupDocs.Parser .NET permet aux développeurs de logiciels d'extraire des liens hypertexte à partir de documents CSV avec quelques lignes de code. Le code C# .NET ci-dessous montre l'extraction de liens hypertexte dans un document CSV. 
    ...
    - title_left: "Extraire les liens hypertexte de la zone de page CSV Documents"
      content_left: |
       L'API Java GroupDocs.Parser a fourni une prise en charge complète pour extraire les liens hypertexte de la facilité de page du document CSV. Le code Java suivant montre comment les programmeurs peuvent extraire des liens hypertexte d'une zone de page de document CSV dans leurs propres applications Java.
