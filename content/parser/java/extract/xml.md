...
steps:
    enable: true
    block:
    - title_left: "How to Extract Hyperlinks from  Documents"
      content_left: |
       GroupDocs.Parser Java has included functionality for extracting Hyperlinks from  documents. The following Java code example shows how hyperlinks can be extracted from  document. 
    ...
    - title_left: "How to Extract Hyperlinks from  Documents Page"
      content_left: |
    ...
    - title_left: "Extract Hyperlinks from  Documents Page Area"
      content_left: |
       GroupDocs.Parser Java API has provided complete support to extract hyperlinks from  document's page ease. The following Java code shows how programmers can extract hyperlinks from a  document page area inside their own Java applications.
