...
draft: false
path: "fr/parser/java/extract/xlsm/"
...
steps:
    enable: true
    block:
    - title_left: "Comment extraire des liens hypertexte de XLSM Documents"
      content_left: |
       GroupDocs.Parser Java a inclus une fonctionnalité pour extraire des liens hypertexte à partir de documents XLSM. L'exemple de code Java suivant montre comment les liens hypertexte peuvent être extraits du document XLSM. 
    ...
    - title_left: "Comment extraire des liens hypertexte de la page XLSM Documents"
      content_left: |
       GroupDocs.Parser .NET permet aux développeurs de logiciels d'extraire des liens hypertexte à partir de documents XLSM avec quelques lignes de code. Le code C# .NET ci-dessous montre l'extraction de liens hypertexte dans un document XLSM. 
    ...
    - title_left: "Extraire les liens hypertexte de la zone de page XLSM Documents"
      content_left: |
       L'API Java GroupDocs.Parser a fourni une prise en charge complète pour extraire les liens hypertexte de la facilité de page du document XLSM. Le code Java suivant montre comment les programmeurs peuvent extraire des liens hypertexte d'une zone de page de document XLSM dans leurs propres applications Java.
