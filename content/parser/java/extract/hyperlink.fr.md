...
about:
    enable: true
    title: "Comment analyser et extraire les hyperliens des documents via l'API Java ?"
    content: |
...
steps:
    enable: true
    title_left: "Extraire les hyperliens des documents dans Java"
    content_left: |
        [GroupDocs.Parser for Java](/fr/parser/java/) permet aux développeurs Java d'extraire facilement des liens hypertexte à partir de documents en mettant en œuvre quelques étapes simples.
    ...
    code: |
     ...
     {{< parser/code-parser title="Comment extraire des hyperliens de documents à l'aide de l'exemple de code Java">}}

        ```java    
        // Extrayez les hyperliens des documents à l'aide de l'API GroupDocs.Parser
