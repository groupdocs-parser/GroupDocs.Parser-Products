...
about:
    enable: true
    title: "如何通过Java API从Excel、Word、PDF和其他文档中提取表格？"
    content: |
...
steps:
    enable: true
    title_left: "从 Java 中的文档中提取表格"
    content_left: |
        [GroupDocs.Parser for Java](/zh/parser/java/) 让 Java 开发者只需执行几个简单的步骤即可轻松从文档中提取表格。
    ...
    code: |
     ...
     {{< parser/code-parser title="如何使用 Java 示例代码从文档中提取表格">}}
