...
draft: false
path: "de/parser/java/extract/pdf/"
...
steps:
    enable: true
    block:
    - title_left: "So extrahieren Sie Hyperlinks aus PDF-Dokumenten"
      content_left: |
       GroupDocs.Parser Java enthält Funktionen zum Extrahieren von Hyperlinks aus PDF-Dokumenten. Das folgende Java-Codebeispiel zeigt, wie Hyperlinks aus dem PDF-Dokument extrahiert werden können.
    ...
    - title_left: "So extrahieren Sie Hyperlinks von der PDF-Dokumentenseite"
      content_left: |
       GroupDocs.Parser .NET ermöglicht es Softwareentwicklern, mit ein paar Codezeilen Hyperlinks aus PDF-Dokumenten zu extrahieren. Der folgende C# .NET-Code zeigt die Extraktion von Hyperlinks innerhalb eines PDF-Dokuments. 
    ...
    - title_left: "Extrahieren Sie Hyperlinks aus dem Seitenbereich für PDF-Dokumente"
      content_left: |
       Die GroupDocs.Parser-Java-API bietet vollständige Unterstützung zum einfachen Extrahieren von Hyperlinks aus der Seite des PDF-Dokuments. Der folgende Java-Code zeigt, wie Programmierer Hyperlinks aus einem PDF-Dokumentseitenbereich in ihren eigenen Java-Anwendungen extrahieren können.
