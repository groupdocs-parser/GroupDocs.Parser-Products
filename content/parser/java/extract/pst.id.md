...
steps:
    enable: true
    block:
    - title_left: "Cara Mengekstrak Hyperlink dari Dokumen PST"
      content_left: |
       GroupDocs.Parser Java telah menyertakan fungsionalitas untuk mengekstraksi Hyperlink dari dokumen PST. Contoh kode Java berikut menunjukkan bagaimana hyperlink dapat diekstraksi dari dokumen PST. 
    ...
    - title_left: "Cara Mengekstrak Hyperlink dari Halaman Dokumen PST"
      content_left: |
       GroupDocs.Parser .NET memungkinkan pengembang perangkat lunak untuk mengekstrak hyperlink dari dokumen PST dengan beberapa baris kode. Kode C# .NET di bawah ini menunjukkan ekstraksi hyperlink di dalam dokumen PST. 
    ...
    - title_left: "Ekstrak Hyperlink dari PST Area Halaman Dokumen"
      content_left: |
       GroupDocs.Parser Java API telah memberikan dukungan lengkap untuk mengekstrak hyperlink dari halaman dokumen PST dengan mudah. Kode Java berikut menunjukkan bagaimana programmer dapat mengekstrak hyperlink dari area halaman dokumen PST di dalam aplikasi Java mereka sendiri.
