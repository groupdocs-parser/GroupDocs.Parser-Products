...
about:
    enable: true
    title: "¿Cómo extraer tablas de Excel, Word, PDF y otros documentos a través de la API Java?"
    content: |
...
steps:
    enable: true
    title_left: "Extraer tablas de documentos en Java"
    content_left: |
        [GroupDocs.Parser for Java](/es/parser/java/) facilita a los desarrolladores de Java la extracción de tablas de documentos mediante la implementación de unos sencillos pasos.
    ...
    code: |
     ...
     {{< parser/code-parser title="Cómo extraer tablas de documentos usando el código de ejemplo Java">}}

        ```java    
        // Extrae tablas de documentos usando la API GroupDocs.Parser
