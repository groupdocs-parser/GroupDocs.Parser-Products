...
draft: false
path: "de/parser/java/extract/dotx/"
...
steps:
    enable: true
    block:
    - title_left: "So extrahieren Sie Hyperlinks aus DOTX-Dokumenten"
      content_left: |
       GroupDocs.Parser Java enthält Funktionen zum Extrahieren von Hyperlinks aus DOTX-Dokumenten. Das folgende Java-Codebeispiel zeigt, wie Hyperlinks aus dem DOTX-Dokument extrahiert werden können.
    ...
    - title_left: "So extrahieren Sie Hyperlinks von der DOTX-Dokumentenseite"
      content_left: |
       GroupDocs.Parser .NET ermöglicht es Softwareentwicklern, mit ein paar Codezeilen Hyperlinks aus DOTX-Dokumenten zu extrahieren. Der folgende C# .NET-Code zeigt die Extraktion von Hyperlinks innerhalb eines DOTX-Dokuments. 
    ...
    - title_left: "Extrahieren Sie Hyperlinks aus dem Seitenbereich für DOTX-Dokumente"
      content_left: |
       Die GroupDocs.Parser-Java-API bietet vollständige Unterstützung zum einfachen Extrahieren von Hyperlinks aus der Seite des DOTX-Dokuments. Der folgende Java-Code zeigt, wie Programmierer Hyperlinks aus einem DOTX-Dokumentseitenbereich in ihren eigenen Java-Anwendungen extrahieren können.
