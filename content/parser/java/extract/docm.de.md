...
draft: false
path: "de/parser/java/extract/docm/"
...
steps:
    enable: true
    block:
    - title_left: "So extrahieren Sie Hyperlinks aus DOCM-Dokumenten"
      content_left: |
       GroupDocs.Parser Java enthält Funktionen zum Extrahieren von Hyperlinks aus DOCM-Dokumenten. Das folgende Java-Codebeispiel zeigt, wie Hyperlinks aus dem DOCM-Dokument extrahiert werden können.
    ...
    - title_left: "So extrahieren Sie Hyperlinks von der DOCM-Dokumentenseite"
      content_left: |
       GroupDocs.Parser .NET ermöglicht es Softwareentwicklern, mit ein paar Codezeilen Hyperlinks aus DOCM-Dokumenten zu extrahieren. Der folgende C# .NET-Code zeigt die Extraktion von Hyperlinks innerhalb eines DOCM-Dokuments. 
    ...
    - title_left: "Extrahieren Sie Hyperlinks aus dem Seitenbereich für DOCM-Dokumente"
      content_left: |
       Die GroupDocs.Parser-Java-API bietet vollständige Unterstützung zum einfachen Extrahieren von Hyperlinks aus der Seite des DOCM-Dokuments. Der folgende Java-Code zeigt, wie Programmierer Hyperlinks aus einem DOCM-Dokumentseitenbereich in ihren eigenen Java-Anwendungen extrahieren können.
