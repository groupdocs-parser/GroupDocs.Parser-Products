...
draft: false
path: "de/parser/java/extract/xls/"
...
steps:
    enable: true
    block:
    - title_left: "So extrahieren Sie Hyperlinks aus XLS-Dokumenten"
      content_left: |
       GroupDocs.Parser Java enthält Funktionen zum Extrahieren von Hyperlinks aus XLS-Dokumenten. Das folgende Java-Codebeispiel zeigt, wie Hyperlinks aus dem XLS-Dokument extrahiert werden können.
    ...
    - title_left: "So extrahieren Sie Hyperlinks von der XLS-Dokumentenseite"
      content_left: |
    ...
    - title_left: "Extrahieren Sie Hyperlinks aus dem Seitenbereich für XLS-Dokumente"
      content_left: |
       Die GroupDocs.Parser-Java-API bietet vollständige Unterstützung zum einfachen Extrahieren von Hyperlinks aus der Seite des XLS-Dokuments. Der folgende Java-Code zeigt, wie Programmierer Hyperlinks aus einem XLS-Dokumentseitenbereich in ihren eigenen Java-Anwendungen extrahieren können.
