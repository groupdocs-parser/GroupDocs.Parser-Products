...
steps:
    enable: true
    block:
    - title_left: "Cara Mengekstrak Hyperlink dari Dokumen XLSM"
      content_left: |
       GroupDocs.Parser Java telah menyertakan fungsionalitas untuk mengekstraksi Hyperlink dari dokumen XLSM. Contoh kode Java berikut menunjukkan bagaimana hyperlink dapat diekstraksi dari dokumen XLSM. 
    ...
    - title_left: "Cara Mengekstrak Hyperlink dari Halaman Dokumen XLSM"
      content_left: |
       GroupDocs.Parser .NET memungkinkan pengembang perangkat lunak untuk mengekstrak hyperlink dari dokumen XLSM dengan beberapa baris kode. Kode C# .NET di bawah ini menunjukkan ekstraksi hyperlink di dalam dokumen XLSM. 
    ...
    - title_left: "Ekstrak Hyperlink dari XLSM Area Halaman Dokumen"
      content_left: |
       GroupDocs.Parser Java API telah memberikan dukungan lengkap untuk mengekstrak hyperlink dari halaman dokumen XLSM dengan mudah. Kode Java berikut menunjukkan bagaimana programmer dapat mengekstrak hyperlink dari area halaman dokumen XLSM di dalam aplikasi Java mereka sendiri.
