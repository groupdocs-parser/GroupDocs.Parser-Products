...
draft: false
path: "zh/parser/java/extract/emlx/"
...
steps:
    enable: true
    block:
    - title_left: "如何从 EMLX 文档中提取超链接"
      content_left: |
       GroupDocs.Parser Java 包含从 EMLX 文档中提取超链接的功能。 以下 Java 代码示例显示了如何从 EMLX 文档中提取超链接。 
    ...
    - title_left: "如何从 EMLX 文档页面中提取超链接"
      content_left: |
       GroupDocs.Parser .NET 允许软件开发人员使用几行代码从 EMLX 文档中提取超链接。 下面的 C# .NET 代码显示了 EMLX 文档中的超链接提取。 
    ...
    - title_left: "从 EMLX 文档页面区域提取超链接"
      content_left: |
       GroupDocs.Parser Java API 提供了从 EMLX 文档的页面轻松提取超链接的完整支持。 下面的 Java 代码展示了程序员如何从他们自己的 Java 应用程序中的 EMLX 文档页面区域中提取超链接。
