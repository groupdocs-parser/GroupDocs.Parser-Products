...
draft: false
path: "de/parser/java/extract/xltx/"
...
steps:
    enable: true
    block:
    - title_left: "So extrahieren Sie Hyperlinks aus XLTX-Dokumenten"
      content_left: |
       GroupDocs.Parser Java enthält Funktionen zum Extrahieren von Hyperlinks aus XLTX-Dokumenten. Das folgende Java-Codebeispiel zeigt, wie Hyperlinks aus dem XLTX-Dokument extrahiert werden können.
    ...
    - title_left: "So extrahieren Sie Hyperlinks von der XLTX-Dokumentenseite"
      content_left: |
       GroupDocs.Parser .NET ermöglicht es Softwareentwicklern, mit ein paar Codezeilen Hyperlinks aus XLTX-Dokumenten zu extrahieren. Der folgende C# .NET-Code zeigt die Extraktion von Hyperlinks innerhalb eines XLTX-Dokuments. 
    ...
    - title_left: "Extrahieren Sie Hyperlinks aus dem Seitenbereich für XLTX-Dokumente"
      content_left: |
       Die GroupDocs.Parser-Java-API bietet vollständige Unterstützung zum einfachen Extrahieren von Hyperlinks aus der Seite des XLTX-Dokuments. Der folgende Java-Code zeigt, wie Programmierer Hyperlinks aus einem XLTX-Dokumentseitenbereich in ihren eigenen Java-Anwendungen extrahieren können.
