...
draft: false
path: "de/parser/java/extract/ppt/"
...
steps:
    enable: true
    block:
    - title_left: "So extrahieren Sie Hyperlinks aus PPT-Dokumenten"
      content_left: |
       GroupDocs.Parser Java enthält Funktionen zum Extrahieren von Hyperlinks aus PPT-Dokumenten. Das folgende Java-Codebeispiel zeigt, wie Hyperlinks aus dem PPT-Dokument extrahiert werden können.
    ...
    - title_left: "So extrahieren Sie Hyperlinks von der PPT-Dokumentenseite"
      content_left: |
       GroupDocs.Parser .NET ermöglicht es Softwareentwicklern, mit ein paar Codezeilen Hyperlinks aus PPT-Dokumenten zu extrahieren. Der folgende C# .NET-Code zeigt die Extraktion von Hyperlinks innerhalb eines PPT-Dokuments. 
    ...
    - title_left: "Extrahieren Sie Hyperlinks aus dem Seitenbereich für PPT-Dokumente"
      content_left: |
       Die GroupDocs.Parser-Java-API bietet vollständige Unterstützung zum einfachen Extrahieren von Hyperlinks aus der Seite des PPT-Dokuments. Der folgende Java-Code zeigt, wie Programmierer Hyperlinks aus einem PPT-Dokumentseitenbereich in ihren eigenen Java-Anwendungen extrahieren können.
