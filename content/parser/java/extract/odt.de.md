...
draft: false
path: "de/parser/java/extract/odt/"
...
steps:
    enable: true
    block:
    - title_left: "So extrahieren Sie Hyperlinks aus ODT-Dokumenten"
      content_left: |
       GroupDocs.Parser Java enthält Funktionen zum Extrahieren von Hyperlinks aus ODT-Dokumenten. Das folgende Java-Codebeispiel zeigt, wie Hyperlinks aus dem ODT-Dokument extrahiert werden können.
    ...
    - title_left: "So extrahieren Sie Hyperlinks von der ODT-Dokumentenseite"
      content_left: |
       GroupDocs.Parser .NET ermöglicht es Softwareentwicklern, mit ein paar Codezeilen Hyperlinks aus ODT-Dokumenten zu extrahieren. Der folgende C# .NET-Code zeigt die Extraktion von Hyperlinks innerhalb eines ODT-Dokuments. 
    ...
    - title_left: "Extrahieren Sie Hyperlinks aus dem Seitenbereich für ODT-Dokumente"
      content_left: |
       Die GroupDocs.Parser-Java-API bietet vollständige Unterstützung zum einfachen Extrahieren von Hyperlinks aus der Seite des ODT-Dokuments. Der folgende Java-Code zeigt, wie Programmierer Hyperlinks aus einem ODT-Dokumentseitenbereich in ihren eigenen Java-Anwendungen extrahieren können.
