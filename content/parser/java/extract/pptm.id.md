...
steps:
    enable: true
    block:
    - title_left: "Cara Mengekstrak Hyperlink dari Dokumen PPTM"
      content_left: |
       GroupDocs.Parser Java telah menyertakan fungsionalitas untuk mengekstraksi Hyperlink dari dokumen PPTM. Contoh kode Java berikut menunjukkan bagaimana hyperlink dapat diekstraksi dari dokumen PPTM. 
    ...
    - title_left: "Cara Mengekstrak Hyperlink dari Halaman Dokumen PPTM"
      content_left: |
       GroupDocs.Parser .NET memungkinkan pengembang perangkat lunak untuk mengekstrak hyperlink dari dokumen PPTM dengan beberapa baris kode. Kode C# .NET di bawah ini menunjukkan ekstraksi hyperlink di dalam dokumen PPTM. 
    ...
    - title_left: "Ekstrak Hyperlink dari PPTM Area Halaman Dokumen"
      content_left: |
       GroupDocs.Parser Java API telah memberikan dukungan lengkap untuk mengekstrak hyperlink dari halaman dokumen PPTM dengan mudah. Kode Java berikut menunjukkan bagaimana programmer dapat mengekstrak hyperlink dari area halaman dokumen PPTM di dalam aplikasi Java mereka sendiri.
