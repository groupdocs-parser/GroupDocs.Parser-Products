...
draft: false
path: "de/parser/java/extract/odp/"
...
steps:
    enable: true
    block:
    - title_left: "So extrahieren Sie Hyperlinks aus ODP-Dokumenten"
      content_left: |
       GroupDocs.Parser Java enthält Funktionen zum Extrahieren von Hyperlinks aus ODP-Dokumenten. Das folgende Java-Codebeispiel zeigt, wie Hyperlinks aus dem ODP-Dokument extrahiert werden können.
    ...
    - title_left: "So extrahieren Sie Hyperlinks von der ODP-Dokumentenseite"
      content_left: |
       GroupDocs.Parser .NET ermöglicht es Softwareentwicklern, mit ein paar Codezeilen Hyperlinks aus ODP-Dokumenten zu extrahieren. Der folgende C# .NET-Code zeigt die Extraktion von Hyperlinks innerhalb eines ODP-Dokuments. 
    ...
    - title_left: "Extrahieren Sie Hyperlinks aus dem Seitenbereich für ODP-Dokumente"
      content_left: |
       Die GroupDocs.Parser-Java-API bietet vollständige Unterstützung zum einfachen Extrahieren von Hyperlinks aus der Seite des ODP-Dokuments. Der folgende Java-Code zeigt, wie Programmierer Hyperlinks aus einem ODP-Dokumentseitenbereich in ihren eigenen Java-Anwendungen extrahieren können.
