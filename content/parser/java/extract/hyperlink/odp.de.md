...
about:
    enable: true
    title: "Wie kann ich Hyperlinks aus ODP-Dokumenten über die Java-API analysieren und extrahieren?"
    content: |
...
steps:
    enable: true
    title_left: "Extrahieren Sie Hyperlinks von ODP in Java"
    content_left: |
        [GroupDocs.Parser for Java](/de/parser/java/) erleichtert Java-Entwicklern das Extrahieren von Hyperlinks aus einer ODP-Datei durch die Implementierung einiger einfacher Schritte.
    ...
    code: |
     ...
     {{< parser/code-parser title="So extrahieren Sie Hyperlinks aus der Datei ODP mithilfe des Beispielcodes Java">}}

        ```java    
        // Extrahieren Sie Hyperlinks aus der Datei ODP mit der API GroupDocs.Parser
