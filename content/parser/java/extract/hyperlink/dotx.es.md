...
about:
    enable: true
    title: "¿Cómo analizar y extraer hipervínculos de documentos DOTX a través de la API Java?"
    content: |
...
steps:
    enable: true
    title_left: "Extraer hipervínculos de DOTX en Java"
    content_left: |
        [GroupDocs.Parser for Java](/es/parser/java/) facilita a los desarrolladores de Java extraer hipervínculos de un archivo DOTX mediante la implementación de unos sencillos pasos.
    ...
    code: |
     ...
     {{< parser/code-parser title="Cómo extraer hipervínculos del archivo DOTX usando el código de ejemplo Java">}}

        ```java    
        // Extraiga hipervínculos del archivo DOTX usando la API GroupDocs.Parser
