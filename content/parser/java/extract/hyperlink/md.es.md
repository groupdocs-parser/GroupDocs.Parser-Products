...
about:
    enable: true
    title: "¿Cómo analizar y extraer hipervínculos de documentos MD a través de la API Java?"
    content: |
...
steps:
    enable: true
    title_left: "Extraer hipervínculos de MD en Java"
    content_left: |
        [GroupDocs.Parser for Java](/es/parser/java/) facilita a los desarrolladores de Java extraer hipervínculos de un archivo MD mediante la implementación de unos sencillos pasos.
    ...
    code: |
     ...
     {{< parser/code-parser title="Cómo extraer hipervínculos del archivo MD usando el código de ejemplo Java">}}

        ```java    
        // Extraiga hipervínculos del archivo MD usando la API GroupDocs.Parser
