...
about:
    enable: true
    title: "¿Cómo analizar y extraer hipervínculos de documentos POTX a través de la API Java?"
    content: |
...
steps:
    enable: true
    title_left: "Extraer hipervínculos de POTX en Java"
    content_left: |
        [GroupDocs.Parser for Java](/es/parser/java/) facilita a los desarrolladores de Java extraer hipervínculos de un archivo POTX mediante la implementación de unos sencillos pasos.
    ...
    code: |
     ...
     {{< parser/code-parser title="Cómo extraer hipervínculos del archivo POTX usando el código de ejemplo Java">}}

        ```java    
        // Extraiga hipervínculos del archivo POTX usando la API GroupDocs.Parser
