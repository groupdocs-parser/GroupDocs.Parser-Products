...
about:
    enable: true
    title: "Wie kann ich Hyperlinks aus OST-Dokumenten über die Java-API analysieren und extrahieren?"
    content: |
...
steps:
    enable: true
    title_left: "Extrahieren Sie Hyperlinks von OST in Java"
    content_left: |
        [GroupDocs.Parser for Java](/de/parser/java/) erleichtert Java-Entwicklern das Extrahieren von Hyperlinks aus einer OST-Datei durch die Implementierung einiger einfacher Schritte.
    ...
    code: |
     ...
     {{< parser/code-parser title="So extrahieren Sie Hyperlinks aus der Datei OST mithilfe des Beispielcodes Java">}}

        ```java    
        // Extrahieren Sie Hyperlinks aus der Datei OST mit der API GroupDocs.Parser
