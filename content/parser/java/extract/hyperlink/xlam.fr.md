...
about:
    enable: true
    title: "Comment analyser et extraire les hyperliens des documents XLAM via l'API Java ?"
    content: |
...
steps:
    enable: true
    title_left: "Extraire les hyperliens de XLAM dans Java"
    content_left: |
        [GroupDocs.Parser for Java](/fr/parser/java/) permet aux développeurs Java d'extraire facilement des liens hypertexte d'un fichier XLAM en mettant en œuvre quelques étapes simples.
    ...
    code: |
     ...
     {{< parser/code-parser title="Comment extraire des hyperliens du fichier XLAM à l'aide de l'exemple de code Java">}}

        ```java    
        // Extraire les hyperliens du fichier XLAM à l'aide de l'API GroupDocs.Parser
