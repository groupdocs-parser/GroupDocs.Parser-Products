...
about:
    enable: true
    title: "Comment analyser et extraire les hyperliens des documents FB2 via l'API Java ?"
    content: |
...
steps:
    enable: true
    title_left: "Extraire les hyperliens de FB2 dans Java"
    content_left: |
        [GroupDocs.Parser for Java](/fr/parser/java/) permet aux développeurs Java d'extraire facilement des liens hypertexte d'un fichier FB2 en mettant en œuvre quelques étapes simples.
    ...
    code: |
     ...
     {{< parser/code-parser title="Comment extraire des hyperliens du fichier FB2 à l'aide de l'exemple de code Java">}}

        ```java    
        // Extraire les hyperliens du fichier FB2 à l'aide de l'API GroupDocs.Parser
