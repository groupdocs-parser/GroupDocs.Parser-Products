...
about:
    enable: true
    title: "¿Cómo analizar y extraer hipervínculos de documentos XLA a través de la API Java?"
    content: |
...
steps:
    enable: true
    title_left: "Extraer hipervínculos de XLA en Java"
    content_left: |
        [GroupDocs.Parser for Java](/es/parser/java/) facilita a los desarrolladores de Java extraer hipervínculos de un archivo XLA mediante la implementación de unos sencillos pasos.
    ...
    code: |
     ...
     {{< parser/code-parser title="Cómo extraer hipervínculos del archivo XLA usando el código de ejemplo Java">}}

        ```java    
        // Extraiga hipervínculos del archivo XLA usando la API GroupDocs.Parser
