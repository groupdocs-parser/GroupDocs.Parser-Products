...
about:
    enable: true
    title: "¿Cómo extraer códigos de barras de Excel, Word, PDF y otros documentos Java API?"
    content: |
...
steps:
    enable: true
    title_left: "Extraer códigos de barras de documentos en Java"
    content_left: |
        [GroupDocs.Parser for Java](/es/parser/java/) facilita a los desarrolladores de Java la extracción de códigos de barras de los documentos mediante la implementación de unos sencillos pasos.
    ...
    code: |
     ...
     {{< parser/code-parser title="Cómo extraer códigos de barras de documentos usando el código de ejemplo Java">}}

        ```java    
        // Extrae códigos de barras de documentos usando la API GroupDocs.Parser
