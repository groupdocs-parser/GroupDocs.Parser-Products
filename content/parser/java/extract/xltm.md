...
steps:
    enable: true
    block:
    - title_left: "How to Extract Hyperlinks from XLTM Documents"
      content_left: |
       GroupDocs.Parser Java has included functionality for extracting Hyperlinks from XLTM documents. The following Java code example shows how hyperlinks can be extracted from XLTM document. 
    ...
    - title_left: "How to Extract Hyperlinks from XLTM Documents Page"
      content_left: |
    ...
    - title_left: "Extract Hyperlinks from XLTM Documents Page Area"
      content_left: |
       GroupDocs.Parser Java API has provided complete support to extract hyperlinks from XLTM document's page ease. The following Java code shows how programmers can extract hyperlinks from a XLTM document page area inside their own Java applications.
