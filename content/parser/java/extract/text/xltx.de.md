...
############################# Head ############################
head_title: "Text aus XLTX in Java extrahieren"
head_description: "Extrahieren Sie schnell Text aus einer Dokumentdatei in Java."

############################# Header ############################
title: "Text aus XLTX in Java extrahieren"
description: "Extrahieren Sie Text aus XLTX mit ein paar Zeilen Java-Code."
...
about:
    enable: true
    title: "Wie extrahiere ich einen Text aus der XLTX-API der Datei Java?"
    content: |
...
steps:
    enable: true
    title_left: "Text aus XLTX in Java extrahieren"
    content_left: |
        [GroupDocs.Parser for Java](/de/parser/java/) erleichtert Java-Entwicklern das Extrahieren eines Textes aus einer XLTX-Datei durch die Implementierung einiger einfacher Schritte.
    ...
    code: |
     ...
     {{< parser/code-parser title="So extrahieren Sie Text aus der Datei XLTX mithilfe des Beispielcodes Java">}}
