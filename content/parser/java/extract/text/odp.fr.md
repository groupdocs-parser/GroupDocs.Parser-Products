...
############################# Head ############################
head_title: "Extraire le texte de ODP dans Java"
head_description: "Extrayez rapidement du texte d'un fichier de documents dans Java."

############################# Header ############################
title: "Extraire le texte de ODP Dans Java"
description: "Extrayez le texte de ODP avec quelques lignes de code Java."
...
about:
    enable: true
    title: "Comment extraire un texte de ODP fichiers Java API ?"
    content: |
...
steps:
    enable: true
    title_left: "Extraire le texte de ODP dans Java"
    content_left: |
        [GroupDocs.Parser for Java](/fr/parser/java/) permet aux développeurs Java d'extraire facilement un texte d'un fichier ODP en mettant en œuvre quelques étapes simples.
    ...
    code: |
     ...
     {{< parser/code-parser title="Comment extraire du texte du fichier ODP à l'aide de l'exemple de code Java">}}

        ```java    
        // Extraire le texte du fichier ODP à l'aide de l'API GroupDocs.Parser
...
demos:
    enable: true
    title: "Démos en direct - Extraire le texte de ODP en ligne"
    content: |
       Extrayez le texte du fichier ODP dès maintenant en visitant le site Web [GroupDocs.Parser Live Demos](https://products.groupdocs.app/parser/text/odp).
