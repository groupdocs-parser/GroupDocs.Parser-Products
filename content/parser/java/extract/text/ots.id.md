...
############################# Head ############################
head_title: "Ekstrak Teks dari OTS di Java"
head_description: "Ekstrak teks dengan cepat dari file dokumen di Java."

############################# Header ############################
title: "Ekstrak teks dari OTS Di Java"
description: "Ekstrak teks dari OTS dengan beberapa baris kode Java."
...
about:
    enable: true
    title: "Bagaimana cara mengekstrak teks dari OTS file Java API?"
    content: |
...
steps:
    enable: true
    title_left: "Ekstrak teks dari OTS di Java"
    content_left: |
        [GroupDocs.Parser for Java](/id/parser/java/) memudahkan pengembang Java untuk mengekstrak teks dari file OTS dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< parser/code-parser title="Cara mengekstrak teks dari file OTS menggunakan kode contoh Java">}}

        ```java    
        // Ekstrak teks dari file OTS menggunakan GroupDocs.Parser API
...
demos:
    enable: true
    title: "Demo Langsung - Ekstrak teks dari OTS Online"
    content: |
       Ekstrak teks dari file OTS sekarang juga dengan mengunjungi situs web [GroupDocs.Parser Demo Langsung](https://products.groupdocs.app/parser/text/ots).
