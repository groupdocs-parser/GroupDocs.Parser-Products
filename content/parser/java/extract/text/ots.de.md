...
############################# Head ############################
head_title: "Text aus OTS in Java extrahieren"
head_description: "Extrahieren Sie schnell Text aus einer Dokumentdatei in Java."

############################# Header ############################
title: "Text aus OTS in Java extrahieren"
description: "Extrahieren Sie Text aus OTS mit ein paar Zeilen Java-Code."
...
about:
    enable: true
    title: "Wie extrahiere ich einen Text aus der OTS-API der Datei Java?"
    content: |
...
steps:
    enable: true
    title_left: "Text aus OTS in Java extrahieren"
    content_left: |
        [GroupDocs.Parser for Java](/de/parser/java/) erleichtert Java-Entwicklern das Extrahieren eines Textes aus einer OTS-Datei durch die Implementierung einiger einfacher Schritte.
    ...
    code: |
     ...
     {{< parser/code-parser title="So extrahieren Sie Text aus der Datei OTS mithilfe des Beispielcodes Java">}}

        ```java    
        // Extrahieren Sie Text aus der Datei OTS mit der API GroupDocs.Parser
...
demos:
    enable: true
    title: "Live-Demos – Extrahieren Sie Text aus OTS Online"
    content: |
       Extrahieren Sie jetzt Text aus der Datei OTS, indem Sie die Website [GroupDocs.Parser Live Demos](https://products.groupdocs.app/parser/text/ots) besuchen.
