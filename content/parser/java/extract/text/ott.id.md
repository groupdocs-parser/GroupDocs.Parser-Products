...
############################# Head ############################
head_title: "Ekstrak Teks dari OTT di Java"
head_description: "Ekstrak teks dengan cepat dari file dokumen di Java."

############################# Header ############################
title: "Ekstrak teks dari OTT Di Java"
description: "Ekstrak teks dari OTT dengan beberapa baris kode Java."
...
about:
    enable: true
    title: "Bagaimana cara mengekstrak teks dari OTT file Java API?"
    content: |
...
steps:
    enable: true
    title_left: "Ekstrak teks dari OTT di Java"
    content_left: |
        [GroupDocs.Parser for Java](/id/parser/java/) memudahkan pengembang Java untuk mengekstrak teks dari file OTT dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< parser/code-parser title="Cara mengekstrak teks dari file OTT menggunakan kode contoh Java">}}

        ```java    
        // Ekstrak teks dari file OTT menggunakan GroupDocs.Parser API
...
demos:
    enable: true
    title: "Demo Langsung - Ekstrak teks dari OTT Online"
    content: |
       Ekstrak teks dari file OTT sekarang juga dengan mengunjungi situs web [GroupDocs.Parser Demo Langsung](https://products.groupdocs.app/parser/text/ott).
