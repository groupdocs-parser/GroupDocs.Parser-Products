...
############################# Head ############################
head_title: "Extraire le texte de PDF dans Java"
head_description: "Extrayez rapidement du texte d'un fichier de documents dans Java."

############################# Header ############################
title: "Extraire le texte de PDF Dans Java"
description: "Extrayez le texte de PDF avec quelques lignes de code Java."
...
about:
    enable: true
    title: "Comment extraire un texte de PDF fichiers Java API ?"
    content: |
...
steps:
    enable: true
    title_left: "Extraire le texte de PDF dans Java"
    content_left: |
        [GroupDocs.Parser for Java](/fr/parser/java/) permet aux développeurs Java d'extraire facilement un texte d'un fichier PDF en mettant en œuvre quelques étapes simples.
    ...
    code: |
     ...
     {{< parser/code-parser title="Comment extraire du texte du fichier PDF à l'aide de l'exemple de code Java">}}
...
demos:
    enable: true
    title: "Démos en direct - Extraire le texte de PDF en ligne"
    content: |
       Extrayez le texte du fichier PDF dès maintenant en visitant le site Web [GroupDocs.Parser Live Demos](https://products.groupdocs.app/parser/text/pdf).
