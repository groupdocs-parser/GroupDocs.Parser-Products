...
############################# Head ############################
head_title: "Extract Text from DOT in Java"
head_description: "Quickly extract text from a documents file in Java."

############################# Header ############################
title: "Extract text from DOT In Java"
description: "Extract text from DOT with a few lines of Java code."
...
about:
    enable: true
    title: "How to extract a text from DOT files Java API?"
    content: |
...
steps:
    enable: true
    title_left: "Extract text from DOT in Java"
    content_left: |
        [GroupDocs.Parser for Java](/parser/java/) makes it easy for Java developers to extract a text from a DOT file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< parser/code-parser title="How to extract text from DOT file using Java example code">}}

        ```java    
        // Extract text from DOT file using GroupDocs.Parser API
...
demos:
    enable: true
    title: "Live Demos - Extract text from DOT Online"
    content: |
       Extract text from DOT file right now by visiting [GroupDocs.Parser Live Demos](https://products.groupdocs.app/parser/text/dot) website.
