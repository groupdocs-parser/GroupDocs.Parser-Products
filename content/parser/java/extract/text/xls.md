...
############################# Head ############################
head_title: "Extract Text from XLS in Java"
head_description: "Quickly extract text from a documents file in Java."

############################# Header ############################
title: "Extract text from XLS In Java"
description: "Extract text from XLS with a few lines of Java code."
...
about:
    enable: true
    title: "How to extract a text from XLS files Java API?"
    content: |
...
steps:
    enable: true
    title_left: "Extract text from XLS in Java"
    content_left: |
        [GroupDocs.Parser for Java](/parser/java/) makes it easy for Java developers to extract a text from a XLS file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< parser/code-parser title="How to extract text from XLS file using Java example code">}}

        ```java    
        // Extract text from XLS file using GroupDocs.Parser API
...
demos:
    enable: true
    title: "Live Demos - Extract text from XLS Online"
    content: |
       Extract text from XLS file right now by visiting [GroupDocs.Parser Live Demos](https://products.groupdocs.app/parser/text/xls) website.
