...
############################# Head ############################
head_title: "Extract Text from PPTM in Java"
head_description: "Quickly extract text from a documents file in Java."

############################# Header ############################
title: "Extract text from PPTM In Java"
description: "Extract text from PPTM with a few lines of Java code."
...
about:
    enable: true
    title: "How to extract a text from PPTM files Java API?"
    content: |
...
steps:
    enable: true
    title_left: "Extract text from PPTM in Java"
    content_left: |
        [GroupDocs.Parser for Java](/parser/java/) makes it easy for Java developers to extract a text from a PPTM file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< parser/code-parser title="How to extract text from PPTM file using Java example code">}}

        ```java    
        // Extract text from PPTM file using GroupDocs.Parser API
...
demos:
    enable: true
    title: "Live Demos - Extract text from PPTM Online"
    content: |
       Extract text from PPTM file right now by visiting [GroupDocs.Parser Live Demos](https://products.groupdocs.app/parser/text/pptm) website.
