...
############################# Head ############################
head_title: "Extract Text from ODP in Java"
head_description: "Quickly extract text from a documents file in Java."

############################# Header ############################
title: "Extract text from ODP In Java"
description: "Extract text from ODP with a few lines of Java code."
...
about:
    enable: true
    title: "How to extract a text from ODP files Java API?"
    content: |
...
steps:
    enable: true
    title_left: "Extract text from ODP in Java"
    content_left: |
        [GroupDocs.Parser for Java](/parser/java/) makes it easy for Java developers to extract a text from a ODP file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< parser/code-parser title="How to extract text from ODP file using Java example code">}}

        ```java    
        // Extract text from ODP file using GroupDocs.Parser API
...
demos:
    enable: true
    title: "Live Demos - Extract text from ODP Online"
    content: |
       Extract text from ODP file right now by visiting [GroupDocs.Parser Live Demos](https://products.groupdocs.app/parser/text/odp) website.
