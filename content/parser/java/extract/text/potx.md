...
############################# Head ############################
head_title: "Extract Text from POTX in Java"
head_description: "Quickly extract text from a documents file in Java."

############################# Header ############################
title: "Extract text from POTX In Java"
description: "Extract text from POTX with a few lines of Java code."
...
about:
    enable: true
    title: "How to extract a text from POTX files Java API?"
    content: |
...
steps:
    enable: true
    title_left: "Extract text from POTX in Java"
    content_left: |
        [GroupDocs.Parser for Java](/parser/java/) makes it easy for Java developers to extract a text from a POTX file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< parser/code-parser title="How to extract text from POTX file using Java example code">}}

        ```java    
        // Extract text from POTX file using GroupDocs.Parser API
...
demos:
    enable: true
    title: "Live Demos - Extract text from POTX Online"
    content: |
       Extract text from POTX file right now by visiting [GroupDocs.Parser Live Demos](https://products.groupdocs.app/parser/text/potx) website.
