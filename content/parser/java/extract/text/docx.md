...
############################# Head ############################
head_title: "Extract Text from DOCX in Java"
head_description: "Quickly extract text from a documents file in Java."

############################# Header ############################
title: "Extract text from DOCX In Java"
description: "Extract text from DOCX with a few lines of Java code."
...
about:
    enable: true
    title: "How to extract a text from DOCX files Java API?"
    content: |
...
steps:
    enable: true
    title_left: "Extract text from DOCX in Java"
    content_left: |
        [GroupDocs.Parser for Java](/parser/java/) makes it easy for Java developers to extract a text from a DOCX file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< parser/code-parser title="How to extract text from DOCX file using Java example code">}}

        ```java    
        // Extract text from DOCX file using GroupDocs.Parser API
...
demos:
    enable: true
    title: "Live Demos - Extract text from DOCX Online"
    content: |
       Extract text from DOCX file right now by visiting [GroupDocs.Parser Live Demos](https://products.groupdocs.app/parser/text/docx) website.
