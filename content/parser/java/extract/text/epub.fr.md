...
############################# Head ############################
head_title: "Extraire le texte de EPUB dans Java"
head_description: "Extrayez rapidement du texte d'un fichier de documents dans Java."

############################# Header ############################
title: "Extraire le texte de EPUB Dans Java"
description: "Extrayez le texte de EPUB avec quelques lignes de code Java."
...
about:
    enable: true
    title: "Comment extraire un texte de EPUB fichiers Java API ?"
    content: |
...
steps:
    enable: true
    title_left: "Extraire le texte de EPUB dans Java"
    content_left: |
        [GroupDocs.Parser for Java](/fr/parser/java/) permet aux développeurs Java d'extraire facilement un texte d'un fichier EPUB en mettant en œuvre quelques étapes simples.
    ...
    code: |
     ...
     {{< parser/code-parser title="Comment extraire du texte du fichier EPUB à l'aide de l'exemple de code Java">}}
