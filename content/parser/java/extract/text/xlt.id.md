...
############################# Head ############################
head_title: "Ekstrak Teks dari XLT di Java"
head_description: "Ekstrak teks dengan cepat dari file dokumen di Java."

############################# Header ############################
title: "Ekstrak teks dari XLT Di Java"
description: "Ekstrak teks dari XLT dengan beberapa baris kode Java."
...
about:
    enable: true
    title: "Bagaimana cara mengekstrak teks dari XLT file Java API?"
    content: |
...
steps:
    enable: true
    title_left: "Ekstrak teks dari XLT di Java"
    content_left: |
        [GroupDocs.Parser for Java](/id/parser/java/) memudahkan pengembang Java untuk mengekstrak teks dari file XLT dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< parser/code-parser title="Cara mengekstrak teks dari file XLT menggunakan kode contoh Java">}}

        ```java    
        // Ekstrak teks dari file XLT menggunakan GroupDocs.Parser API
...
demos:
    enable: true
    title: "Demo Langsung - Ekstrak teks dari XLT Online"
    content: |
       Ekstrak teks dari file XLT sekarang juga dengan mengunjungi situs web [GroupDocs.Parser Demo Langsung](https://products.groupdocs.app/parser/text/xlt).
