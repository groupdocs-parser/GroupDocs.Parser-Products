...
############################# Head ############################
head_title: "Extract Text from PPTX in Java"
head_description: "Quickly extract text from a documents file in Java."

############################# Header ############################
title: "Extract text from PPTX In Java"
description: "Extract text from PPTX with a few lines of Java code."
...
about:
    enable: true
    title: "How to extract a text from PPTX files Java API?"
    content: |
...
steps:
    enable: true
    title_left: "Extract text from PPTX in Java"
    content_left: |
        [GroupDocs.Parser for Java](/parser/java/) makes it easy for Java developers to extract a text from a PPTX file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< parser/code-parser title="How to extract text from PPTX file using Java example code">}}

        ```java    
        // Extract text from PPTX file using GroupDocs.Parser API
...
demos:
    enable: true
    title: "Live Demos - Extract text from PPTX Online"
    content: |
       Extract text from PPTX file right now by visiting [GroupDocs.Parser Live Demos](https://products.groupdocs.app/parser/text/pptx) website.
