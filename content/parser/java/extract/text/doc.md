...
############################# Head ############################
head_title: "Extract Text from DOC in Java"
head_description: "Quickly extract text from a documents file in Java."

############################# Header ############################
title: "Extract text from DOC In Java"
description: "Extract text from DOC with a few lines of Java code."
...
about:
    enable: true
    title: "How to extract a text from DOC files Java API?"
    content: |
...
steps:
    enable: true
    title_left: "Extract text from DOC in Java"
    content_left: |
        [GroupDocs.Parser for Java](/parser/java/) makes it easy for Java developers to extract a text from a DOC file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< parser/code-parser title="How to extract text from DOC file using Java example code">}}
