...
############################# Head ############################
head_title: "Ekstrak Teks dari XLS di Java"
head_description: "Ekstrak teks dengan cepat dari file dokumen di Java."

############################# Header ############################
title: "Ekstrak teks dari XLS Di Java"
description: "Ekstrak teks dari XLS dengan beberapa baris kode Java."
...
about:
    enable: true
    title: "Bagaimana cara mengekstrak teks dari XLS file Java API?"
    content: |
...
steps:
    enable: true
    title_left: "Ekstrak teks dari XLS di Java"
    content_left: |
        [GroupDocs.Parser for Java](/id/parser/java/) memudahkan pengembang Java untuk mengekstrak teks dari file XLS dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< parser/code-parser title="Cara mengekstrak teks dari file XLS menggunakan kode contoh Java">}}

        ```java    
        // Ekstrak teks dari file XLS menggunakan GroupDocs.Parser API
...
demos:
    enable: true
    title: "Demo Langsung - Ekstrak teks dari XLS Online"
    content: |
       Ekstrak teks dari file XLS sekarang juga dengan mengunjungi situs web [GroupDocs.Parser Demo Langsung](https://products.groupdocs.app/parser/text/xls).
