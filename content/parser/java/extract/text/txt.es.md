...
############################# Head ############################
head_title: "Extraer texto de TXT en Java"
head_description: "Extraiga rápidamente texto de un archivo de documentos en Java."

############################# Header ############################
title: "Extraer texto de TXT en Java"
description: "Extraiga texto de TXT con unas pocas líneas de código Java."
...
about:
    enable: true
    title: "¿Cómo extraer un texto de TXT archivos Java API?"
    content: |
...
steps:
    enable: true
    title_left: "Extraer texto de TXT en Java"
    content_left: |
        [GroupDocs.Parser for Java](/es/parser/java/) facilita a los desarrolladores de Java extraer un texto de un archivo TXT mediante la implementación de unos sencillos pasos.
    ...
    code: |
     ...
     {{< parser/code-parser title="Cómo extraer texto del archivo TXT usando el código de ejemplo Java">}}
