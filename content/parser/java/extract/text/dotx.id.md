...
############################# Head ############################
head_title: "Ekstrak Teks dari DOTX di Java"
head_description: "Ekstrak teks dengan cepat dari file dokumen di Java."

############################# Header ############################
title: "Ekstrak teks dari DOTX Di Java"
description: "Ekstrak teks dari DOTX dengan beberapa baris kode Java."
...
about:
    enable: true
    title: "Bagaimana cara mengekstrak teks dari DOTX file Java API?"
    content: |
...
steps:
    enable: true
    title_left: "Ekstrak teks dari DOTX di Java"
    content_left: |
        [GroupDocs.Parser for Java](/id/parser/java/) memudahkan pengembang Java untuk mengekstrak teks dari file DOTX dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< parser/code-parser title="Cara mengekstrak teks dari file DOTX menggunakan kode contoh Java">}}
