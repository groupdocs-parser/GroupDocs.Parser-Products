...
############################# Head ############################
head_title: "Извлечь текст из XML в Java"
head_description: "Быстро извлекайте текст из файла XML в Java. Сохраните новый документ, содержащий выбранные страницы, с помощью API слияния документов."

############################# Header ############################
title: "Извлечь текст из XML в Java"
description: "Извлеките текст из XML с помощью нескольких строк кода Java."
...
about:
    enable: true
    title: "Как извлечь текст из XML файлов Java API?"
    content: |
...
steps:
    enable: true
    title_left: "Извлечь текст из XML в Java"
    content_left: |
        [GroupDocs.Parser for Java](/ru/parser/java/) позволяет разработчикам Java легко извлекать текст из файла XML, реализуя несколько простых шаги.
    ...
    code: |
     ...
     {{< parser/code-parser title="Как извлечь текст из файла XML, используя пример кода Java">}}
