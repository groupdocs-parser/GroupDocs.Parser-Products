...
############################# Head ############################
head_title: "Extract Text from OTS in Java"
head_description: "Quickly extract text from a documents file in Java."

############################# Header ############################
title: "Extract text from OTS In Java"
description: "Extract text from OTS with a few lines of Java code."
...
about:
    enable: true
    title: "How to extract a text from OTS files Java API?"
    content: |
...
steps:
    enable: true
    title_left: "Extract text from OTS in Java"
    content_left: |
        [GroupDocs.Parser for Java](/parser/java/) makes it easy for Java developers to extract a text from a OTS file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< parser/code-parser title="How to extract text from OTS file using Java example code">}}

        ```java    
        // Extract text from OTS file using GroupDocs.Parser API
...
demos:
    enable: true
    title: "Live Demos - Extract text from OTS Online"
    content: |
       Extract text from OTS file right now by visiting [GroupDocs.Parser Live Demos](https://products.groupdocs.app/parser/text/ots) website.
