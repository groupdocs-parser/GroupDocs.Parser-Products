...
############################# Head ############################
head_title: "Extract Text from OTP in Java"
head_description: "Quickly extract text from a documents file in Java."

############################# Header ############################
title: "Extract text from OTP In Java"
description: "Extract text from OTP with a few lines of Java code."
...
about:
    enable: true
    title: "How to extract a text from OTP files Java API?"
    content: |
...
steps:
    enable: true
    title_left: "Extract text from OTP in Java"
    content_left: |
        [GroupDocs.Parser for Java](/parser/java/) makes it easy for Java developers to extract a text from a OTP file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< parser/code-parser title="How to extract text from OTP file using Java example code">}}

        ```java    
        // Extract text from OTP file using GroupDocs.Parser API
...
demos:
    enable: true
    title: "Live Demos - Extract text from OTP Online"
    content: |
       Extract text from OTP file right now by visiting [GroupDocs.Parser Live Demos](https://products.groupdocs.app/parser/text/otp) website.
