...
############################# Head ############################
head_title: "Извлечь текст из ODS в Java"
head_description: "Быстро извлекайте текст из файла ODS в Java. Сохраните новый документ, содержащий выбранные страницы, с помощью API слияния документов."

############################# Header ############################
title: "Извлечь текст из ODS в Java"
description: "Извлеките текст из ODS с помощью нескольких строк кода Java."
...
about:
    enable: true
    title: "Как извлечь текст из ODS файлов Java API?"
    content: |
...
steps:
    enable: true
    title_left: "Извлечь текст из ODS в Java"
    content_left: |
        [GroupDocs.Parser for Java](/ru/parser/java/) позволяет разработчикам Java легко извлекать текст из файла ODS, реализуя несколько простых шаги.
    ...
    code: |
     ...
     {{< parser/code-parser title="Как извлечь текст из файла ODS, используя пример кода Java">}}

        ```java    
        // Извлечь текст из файла ODS с помощью API GroupDocs.Parser
...
demos:
    enable: true
    title: "Демонстрации в реальном времени — извлечение текста из ODS онлайн"
    content: |
       Извлеките текст из файла ODS прямо сейчас, посетив веб-сайт [GroupDocs.Parser Live Demos](https://products.groupdocs.app/parser/text/ods).
