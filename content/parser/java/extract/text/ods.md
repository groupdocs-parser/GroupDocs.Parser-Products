...
############################# Head ############################
head_title: "Extract Text from ODS in Java"
head_description: "Quickly extract text from a documents file in Java."

############################# Header ############################
title: "Extract text from ODS In Java"
description: "Extract text from ODS with a few lines of Java code."
...
about:
    enable: true
    title: "How to extract a text from ODS files Java API?"
    content: |
...
steps:
    enable: true
    title_left: "Extract text from ODS in Java"
    content_left: |
        [GroupDocs.Parser for Java](/parser/java/) makes it easy for Java developers to extract a text from a ODS file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< parser/code-parser title="How to extract text from ODS file using Java example code">}}

        ```java    
        // Extract text from ODS file using GroupDocs.Parser API
...
demos:
    enable: true
    title: "Live Demos - Extract text from ODS Online"
    content: |
       Extract text from ODS file right now by visiting [GroupDocs.Parser Live Demos](https://products.groupdocs.app/parser/text/ods) website.
