...
############################# Head ############################
head_title: "Ekstrak Teks dari XLA di Java"
head_description: "Ekstrak teks dengan cepat dari file dokumen di Java."

############################# Header ############################
title: "Ekstrak teks dari XLA Di Java"
description: "Ekstrak teks dari XLA dengan beberapa baris kode Java."
...
about:
    enable: true
    title: "Bagaimana cara mengekstrak teks dari XLA file Java API?"
    content: |
...
steps:
    enable: true
    title_left: "Ekstrak teks dari XLA di Java"
    content_left: |
        [GroupDocs.Parser for Java](/id/parser/java/) memudahkan pengembang Java untuk mengekstrak teks dari file XLA dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< parser/code-parser title="Cara mengekstrak teks dari file XLA menggunakan kode contoh Java">}}

        ```java    
        // Ekstrak teks dari file XLA menggunakan GroupDocs.Parser API
...
demos:
    enable: true
    title: "Demo Langsung - Ekstrak teks dari XLA Online"
    content: |
       Ekstrak teks dari file XLA sekarang juga dengan mengunjungi situs web [GroupDocs.Parser Demo Langsung](https://products.groupdocs.app/parser/text/xla).
