...
############################# Head ############################
head_title: "Извлечь текст из POTX в Java"
head_description: "Быстро извлекайте текст из файла POTX в Java. Сохраните новый документ, содержащий выбранные страницы, с помощью API слияния документов."

############################# Header ############################
title: "Извлечь текст из POTX в Java"
description: "Извлеките текст из POTX с помощью нескольких строк кода Java."
...
about:
    enable: true
    title: "Как извлечь текст из POTX файлов Java API?"
    content: |
...
steps:
    enable: true
    title_left: "Извлечь текст из POTX в Java"
    content_left: |
        [GroupDocs.Parser for Java](/ru/parser/java/) позволяет разработчикам Java легко извлекать текст из файла POTX, реализуя несколько простых шаги.
    ...
    code: |
     ...
     {{< parser/code-parser title="Как извлечь текст из файла POTX, используя пример кода Java">}}
