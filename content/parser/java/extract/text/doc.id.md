...
############################# Head ############################
head_title: "Ekstrak Teks dari DOC di Java"
head_description: "Ekstrak teks dengan cepat dari file dokumen di Java."

############################# Header ############################
title: "Ekstrak teks dari DOC Di Java"
description: "Ekstrak teks dari DOC dengan beberapa baris kode Java."
...
about:
    enable: true
    title: "Bagaimana cara mengekstrak teks dari DOC file Java API?"
    content: |
...
steps:
    enable: true
    title_left: "Ekstrak teks dari DOC di Java"
    content_left: |
        [GroupDocs.Parser for Java](/id/parser/java/) memudahkan pengembang Java untuk mengekstrak teks dari file DOC dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< parser/code-parser title="Cara mengekstrak teks dari file DOC menggunakan kode contoh Java">}}

        ```java    
        // Ekstrak teks dari file DOC menggunakan GroupDocs.Parser API
...
demos:
    enable: true
    title: "Demo Langsung - Ekstrak teks dari DOC Online"
    content: |
       Ekstrak teks dari file DOC sekarang juga dengan mengunjungi situs web [GroupDocs.Parser Demo Langsung](https://products.groupdocs.app/parser/text/doc).
