...
############################# Head ############################
head_title: "Extract Text from FB2 in Java"
head_description: "Quickly extract text from a documents file in Java."

############################# Header ############################
title: "Extract text from FB2 In Java"
description: "Extract text from FB2 with a few lines of Java code."
...
about:
    enable: true
    title: "How to extract a text from FB2 files Java API?"
    content: |
...
steps:
    enable: true
    title_left: "Extract text from FB2 in Java"
    content_left: |
        [GroupDocs.Parser for Java](/parser/java/) makes it easy for Java developers to extract a text from a FB2 file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< parser/code-parser title="How to extract text from FB2 file using Java example code">}}

        ```java    
        // Extract text from FB2 file using GroupDocs.Parser API
...
demos:
    enable: true
    title: "Live Demos - Extract text from FB2 Online"
    content: |
       Extract text from FB2 file right now by visiting [GroupDocs.Parser Live Demos](https://products.groupdocs.app/parser/text/fb2) website.
