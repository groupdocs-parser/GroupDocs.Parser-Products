...
############################# Head ############################
head_title: "Ekstrak Teks dari POT di Java"
head_description: "Ekstrak teks dengan cepat dari file dokumen di Java."

############################# Header ############################
title: "Ekstrak teks dari POT Di Java"
description: "Ekstrak teks dari POT dengan beberapa baris kode Java."
...
about:
    enable: true
    title: "Bagaimana cara mengekstrak teks dari POT file Java API?"
    content: |
...
steps:
    enable: true
    title_left: "Ekstrak teks dari POT di Java"
    content_left: |
        [GroupDocs.Parser for Java](/id/parser/java/) memudahkan pengembang Java untuk mengekstrak teks dari file POT dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< parser/code-parser title="Cara mengekstrak teks dari file POT menggunakan kode contoh Java">}}
