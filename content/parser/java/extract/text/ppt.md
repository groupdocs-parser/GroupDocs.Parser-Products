...
############################# Head ############################
head_title: "Extract Text from PPT in Java"
head_description: "Quickly extract text from a documents file in Java."

############################# Header ############################
title: "Extract text from PPT In Java"
description: "Extract text from PPT with a few lines of Java code."
...
about:
    enable: true
    title: "How to extract a text from PPT files Java API?"
    content: |
...
steps:
    enable: true
    title_left: "Extract text from PPT in Java"
    content_left: |
        [GroupDocs.Parser for Java](/parser/java/) makes it easy for Java developers to extract a text from a PPT file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< parser/code-parser title="How to extract text from PPT file using Java example code">}}

        ```java    
        // Extract text from PPT file using GroupDocs.Parser API
...
demos:
    enable: true
    title: "Live Demos - Extract text from PPT Online"
    content: |
       Extract text from PPT file right now by visiting [GroupDocs.Parser Live Demos](https://products.groupdocs.app/parser/text/ppt) website.
