...
############################# Head ############################
head_title: "Извлечь текст из XHTML в Java"
head_description: "Быстро извлекайте текст из файла XHTML в Java. Сохраните новый документ, содержащий выбранные страницы, с помощью API слияния документов."

############################# Header ############################
title: "Извлечь текст из XHTML в Java"
description: "Извлеките текст из XHTML с помощью нескольких строк кода Java."
...
about:
    enable: true
    title: "Как извлечь текст из XHTML файлов Java API?"
    content: |
...
steps:
    enable: true
    title_left: "Извлечь текст из XHTML в Java"
    content_left: |
        [GroupDocs.Parser for Java](/ru/parser/java/) позволяет разработчикам Java легко извлекать текст из файла XHTML, реализуя несколько простых шаги.
    ...
    code: |
     ...
     {{< parser/code-parser title="Как извлечь текст из файла XHTML, используя пример кода Java">}}

        ```java    
        // Извлечь текст из файла XHTML с помощью API GroupDocs.Parser
...
demos:
    enable: true
    title: "Демонстрации в реальном времени — извлечение текста из XHTML онлайн"
    content: |
       Извлеките текст из файла XHTML прямо сейчас, посетив веб-сайт [GroupDocs.Parser Live Demos](https://products.groupdocs.app/parser/text/xhtml).
