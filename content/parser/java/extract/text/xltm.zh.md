...
############################# Head ############################
head_title: "从 Java 中的 XLTM 中提取文本"
head_description: "从 Java 中的文档文件中快速提取文本。"

############################# Header ############################
title: "从 Java 中的 XLTM 中提取文本"
description: "使用几行 Java 代码从 XLTM 中提取文本。"
...
about:
    enable: true
    title: "如何从 XLTM 文件 Java API 中提取文本？"
    content: |
...
steps:
    enable: true
    title_left: "从 Java 中的 XLTM 中提取文本"
    content_left: |
        [GroupDocs.Parser for Java](/zh/parser/java/) 让 Java 开发者只需执行几个简单的步骤即可轻松从 XLTM 文件中提取文本。
    ...
    code: |
     ...
     {{< parser/code-parser title="如何使用 Java 示例代码从 XLTM 文件中提取文本">}}

        ```java    
        // 使用 GroupDocs.Parser API 从 XLTM 文件中提取文本
        // 创建 Parser 类的实例
...
demos:
    enable: true
    title: "现场演示 - 从 XLTM 在线提取文本"
    content: |
       立即访问 [GroupDocs.Parser 现场演示](https://products.groupdocs.app/parser/text/xltm) 网站，从 XLTM 文件中提取文本。
       现场演示有以下好处。
