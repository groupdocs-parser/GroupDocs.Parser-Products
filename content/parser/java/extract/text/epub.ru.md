...
############################# Head ############################
head_title: "Извлечь текст из EPUB в Java"
head_description: "Быстро извлекайте текст из файла EPUB в Java. Сохраните новый документ, содержащий выбранные страницы, с помощью API слияния документов."

############################# Header ############################
title: "Извлечь текст из EPUB в Java"
description: "Извлеките текст из EPUB с помощью нескольких строк кода Java."
...
about:
    enable: true
    title: "Как извлечь текст из EPUB файлов Java API?"
    content: |
...
steps:
    enable: true
    title_left: "Извлечь текст из EPUB в Java"
    content_left: |
        [GroupDocs.Parser for Java](/ru/parser/java/) позволяет разработчикам Java легко извлекать текст из файла EPUB, реализуя несколько простых шаги.
    ...
    code: |
     ...
     {{< parser/code-parser title="Как извлечь текст из файла EPUB, используя пример кода Java">}}
