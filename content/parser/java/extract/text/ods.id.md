...
############################# Head ############################
head_title: "Ekstrak Teks dari ODS di Java"
head_description: "Ekstrak teks dengan cepat dari file dokumen di Java."

############################# Header ############################
title: "Ekstrak teks dari ODS Di Java"
description: "Ekstrak teks dari ODS dengan beberapa baris kode Java."
...
about:
    enable: true
    title: "Bagaimana cara mengekstrak teks dari ODS file Java API?"
    content: |
...
steps:
    enable: true
    title_left: "Ekstrak teks dari ODS di Java"
    content_left: |
        [GroupDocs.Parser for Java](/id/parser/java/) memudahkan pengembang Java untuk mengekstrak teks dari file ODS dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< parser/code-parser title="Cara mengekstrak teks dari file ODS menggunakan kode contoh Java">}}

        ```java    
        // Ekstrak teks dari file ODS menggunakan GroupDocs.Parser API
...
demos:
    enable: true
    title: "Demo Langsung - Ekstrak teks dari ODS Online"
    content: |
       Ekstrak teks dari file ODS sekarang juga dengan mengunjungi situs web [GroupDocs.Parser Demo Langsung](https://products.groupdocs.app/parser/text/ods).
