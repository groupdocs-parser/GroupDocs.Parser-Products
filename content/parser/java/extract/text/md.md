...
############################# Head ############################
head_title: "Extract Text from MD in Java"
head_description: "Quickly extract text from a documents file in Java."

############################# Header ############################
title: "Extract text from MD In Java"
description: "Extract text from MD with a few lines of Java code."
...
about:
    enable: true
    title: "How to extract a text from MD files Java API?"
    content: |
...
steps:
    enable: true
    title_left: "Extract text from MD in Java"
    content_left: |
        [GroupDocs.Parser for Java](/parser/java/) makes it easy for Java developers to extract a text from a MD file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< parser/code-parser title="How to extract text from MD file using Java example code">}}

        ```java    
        // Extract text from MD file using GroupDocs.Parser API
...
demos:
    enable: true
    title: "Live Demos - Extract text from MD Online"
    content: |
       Extract text from MD file right now by visiting [GroupDocs.Parser Live Demos](https://products.groupdocs.app/parser/text/md) website.
