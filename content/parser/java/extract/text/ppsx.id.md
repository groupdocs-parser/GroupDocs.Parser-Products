...
############################# Head ############################
head_title: "Ekstrak Teks dari PPSX di Java"
head_description: "Ekstrak teks dengan cepat dari file dokumen di Java."

############################# Header ############################
title: "Ekstrak teks dari PPSX Di Java"
description: "Ekstrak teks dari PPSX dengan beberapa baris kode Java."
...
about:
    enable: true
    title: "Bagaimana cara mengekstrak teks dari PPSX file Java API?"
    content: |
...
steps:
    enable: true
    title_left: "Ekstrak teks dari PPSX di Java"
    content_left: |
        [GroupDocs.Parser for Java](/id/parser/java/) memudahkan pengembang Java untuk mengekstrak teks dari file PPSX dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< parser/code-parser title="Cara mengekstrak teks dari file PPSX menggunakan kode contoh Java">}}
