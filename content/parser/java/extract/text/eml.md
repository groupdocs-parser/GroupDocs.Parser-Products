...
############################# Head ############################
head_title: "Extract Text from EML in Java"
head_description: "Quickly extract text from a documents file in Java."

############################# Header ############################
title: "Extract text from EML In Java"
description: "Extract text from EML with a few lines of Java code."
...
about:
    enable: true
    title: "How to extract a text from EML files Java API?"
    content: |
...
steps:
    enable: true
    title_left: "Extract text from EML in Java"
    content_left: |
        [GroupDocs.Parser for Java](/parser/java/) makes it easy for Java developers to extract a text from a EML file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< parser/code-parser title="How to extract text from EML file using Java example code">}}

        ```java    
        // Extract text from EML file using GroupDocs.Parser API
...
demos:
    enable: true
    title: "Live Demos - Extract text from EML Online"
    content: |
       Extract text from EML file right now by visiting [GroupDocs.Parser Live Demos](https://products.groupdocs.app/parser/text/eml) website.
