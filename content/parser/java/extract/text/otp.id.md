...
############################# Head ############################
head_title: "Ekstrak Teks dari OTP di Java"
head_description: "Ekstrak teks dengan cepat dari file dokumen di Java."

############################# Header ############################
title: "Ekstrak teks dari OTP Di Java"
description: "Ekstrak teks dari OTP dengan beberapa baris kode Java."
...
about:
    enable: true
    title: "Bagaimana cara mengekstrak teks dari OTP file Java API?"
    content: |
...
steps:
    enable: true
    title_left: "Ekstrak teks dari OTP di Java"
    content_left: |
        [GroupDocs.Parser for Java](/id/parser/java/) memudahkan pengembang Java untuk mengekstrak teks dari file OTP dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< parser/code-parser title="Cara mengekstrak teks dari file OTP menggunakan kode contoh Java">}}
