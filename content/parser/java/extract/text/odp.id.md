...
############################# Head ############################
head_title: "Ekstrak Teks dari ODP di Java"
head_description: "Ekstrak teks dengan cepat dari file dokumen di Java."

############################# Header ############################
title: "Ekstrak teks dari ODP Di Java"
description: "Ekstrak teks dari ODP dengan beberapa baris kode Java."
...
about:
    enable: true
    title: "Bagaimana cara mengekstrak teks dari ODP file Java API?"
    content: |
...
steps:
    enable: true
    title_left: "Ekstrak teks dari ODP di Java"
    content_left: |
        [GroupDocs.Parser for Java](/id/parser/java/) memudahkan pengembang Java untuk mengekstrak teks dari file ODP dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< parser/code-parser title="Cara mengekstrak teks dari file ODP menggunakan kode contoh Java">}}

        ```java    
        // Ekstrak teks dari file ODP menggunakan GroupDocs.Parser API
...
demos:
    enable: true
    title: "Demo Langsung - Ekstrak teks dari ODP Online"
    content: |
       Ekstrak teks dari file ODP sekarang juga dengan mengunjungi situs web [GroupDocs.Parser Demo Langsung](https://products.groupdocs.app/parser/text/odp).
