...
############################# Head ############################
head_title: "Extract Text from PPS in Java"
head_description: "Quickly extract text from a documents file in Java."

############################# Header ############################
title: "Extract text from PPS In Java"
description: "Extract text from PPS with a few lines of Java code."
...
about:
    enable: true
    title: "How to extract a text from PPS files Java API?"
    content: |
...
steps:
    enable: true
    title_left: "Extract text from PPS in Java"
    content_left: |
        [GroupDocs.Parser for Java](/parser/java/) makes it easy for Java developers to extract a text from a PPS file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< parser/code-parser title="How to extract text from PPS file using Java example code">}}

        ```java    
        // Extract text from PPS file using GroupDocs.Parser API
...
demos:
    enable: true
    title: "Live Demos - Extract text from PPS Online"
    content: |
       Extract text from PPS file right now by visiting [GroupDocs.Parser Live Demos](https://products.groupdocs.app/parser/text/pps) website.
