...
############################# Head ############################
head_title: "Ekstrak Teks dari ODT di Java"
head_description: "Ekstrak teks dengan cepat dari file dokumen di Java."

############################# Header ############################
title: "Ekstrak teks dari ODT Di Java"
description: "Ekstrak teks dari ODT dengan beberapa baris kode Java."
...
about:
    enable: true
    title: "Bagaimana cara mengekstrak teks dari ODT file Java API?"
    content: |
...
steps:
    enable: true
    title_left: "Ekstrak teks dari ODT di Java"
    content_left: |
        [GroupDocs.Parser for Java](/id/parser/java/) memudahkan pengembang Java untuk mengekstrak teks dari file ODT dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< parser/code-parser title="Cara mengekstrak teks dari file ODT menggunakan kode contoh Java">}}

        ```java    
        // Ekstrak teks dari file ODT menggunakan GroupDocs.Parser API
...
demos:
    enable: true
    title: "Demo Langsung - Ekstrak teks dari ODT Online"
    content: |
       Ekstrak teks dari file ODT sekarang juga dengan mengunjungi situs web [GroupDocs.Parser Demo Langsung](https://products.groupdocs.app/parser/text/odt).
