...
############################# Head ############################
head_title: "Text aus DOT in Java extrahieren"
head_description: "Extrahieren Sie schnell Text aus einer Dokumentdatei in Java."

############################# Header ############################
title: "Text aus DOT in Java extrahieren"
description: "Extrahieren Sie Text aus DOT mit ein paar Zeilen Java-Code."
...
about:
    enable: true
    title: "Wie extrahiere ich einen Text aus der DOT-API der Datei Java?"
    content: |
...
steps:
    enable: true
    title_left: "Text aus DOT in Java extrahieren"
    content_left: |
        [GroupDocs.Parser for Java](/de/parser/java/) erleichtert Java-Entwicklern das Extrahieren eines Textes aus einer DOT-Datei durch die Implementierung einiger einfacher Schritte.
    ...
    code: |
     ...
     {{< parser/code-parser title="So extrahieren Sie Text aus der Datei DOT mithilfe des Beispielcodes Java">}}

        ```java    
        // Extrahieren Sie Text aus der Datei DOT mit der API GroupDocs.Parser
...
demos:
    enable: true
    title: "Live-Demos – Extrahieren Sie Text aus DOT Online"
    content: |
       Extrahieren Sie jetzt Text aus der Datei DOT, indem Sie die Website [GroupDocs.Parser Live Demos](https://products.groupdocs.app/parser/text/dot) besuchen.
