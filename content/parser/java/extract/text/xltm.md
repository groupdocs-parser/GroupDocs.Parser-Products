...
############################# Head ############################
head_title: "Extract Text from XLTM in Java"
head_description: "Quickly extract text from a documents file in Java."

############################# Header ############################
title: "Extract text from XLTM In Java"
description: "Extract text from XLTM with a few lines of Java code."
...
about:
    enable: true
    title: "How to extract a text from XLTM files Java API?"
    content: |
...
steps:
    enable: true
    title_left: "Extract text from XLTM in Java"
    content_left: |
        [GroupDocs.Parser for Java](/parser/java/) makes it easy for Java developers to extract a text from a XLTM file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< parser/code-parser title="How to extract text from XLTM file using Java example code">}}
