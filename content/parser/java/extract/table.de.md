...
about:
    enable: true
    title: "Wie extrahiere ich Tabellen aus Excel, Word, PDF und anderen Dokumenten über die Java-API?"
    content: |
...
steps:
    enable: true
    title_left: "Extrahieren Sie Tabellen aus Dokumenten in Java"
    content_left: |
        [GroupDocs.Parser for Java](/de/parser/java/) erleichtert Java Entwicklern das Extrahieren von Tabellen aus Dokumenten durch die Implementierung einiger einfacher Schritte.
    ...
    code: |
     ...
     {{< parser/code-parser title="So extrahieren Sie Tabellen aus Dokumenten mithilfe des Beispielcodes Java">}}

        ```java    
        // Extrahieren Sie Tabellen aus Dokumenten mithilfe der GroupDocs.Parser-API
