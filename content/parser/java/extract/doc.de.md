...
draft: false
path: "de/parser/java/extract/doc/"
...
steps:
    enable: true
    block:
    - title_left: "So extrahieren Sie Hyperlinks aus DOC-Dokumenten"
      content_left: |
       GroupDocs.Parser Java enthält Funktionen zum Extrahieren von Hyperlinks aus DOC-Dokumenten. Das folgende Java-Codebeispiel zeigt, wie Hyperlinks aus dem DOC-Dokument extrahiert werden können.
    ...
    - title_left: "So extrahieren Sie Hyperlinks von der DOC-Dokumentenseite"
      content_left: |
       GroupDocs.Parser .NET ermöglicht es Softwareentwicklern, mit ein paar Codezeilen Hyperlinks aus DOC-Dokumenten zu extrahieren. Der folgende C# .NET-Code zeigt die Extraktion von Hyperlinks innerhalb eines DOC-Dokuments. 
    ...
    - title_left: "Extrahieren Sie Hyperlinks aus dem Seitenbereich für DOC-Dokumente"
      content_left: |
       Die GroupDocs.Parser-Java-API bietet vollständige Unterstützung zum einfachen Extrahieren von Hyperlinks aus der Seite des DOC-Dokuments. Der folgende Java-Code zeigt, wie Programmierer Hyperlinks aus einem DOC-Dokumentseitenbereich in ihren eigenen Java-Anwendungen extrahieren können.
