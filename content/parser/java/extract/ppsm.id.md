...
steps:
    enable: true
    block:
    - title_left: "Cara Mengekstrak Hyperlink dari Dokumen PPSM"
      content_left: |
       GroupDocs.Parser Java telah menyertakan fungsionalitas untuk mengekstraksi Hyperlink dari dokumen PPSM. Contoh kode Java berikut menunjukkan bagaimana hyperlink dapat diekstraksi dari dokumen PPSM. 
    ...
    - title_left: "Cara Mengekstrak Hyperlink dari Halaman Dokumen PPSM"
      content_left: |
       GroupDocs.Parser .NET memungkinkan pengembang perangkat lunak untuk mengekstrak hyperlink dari dokumen PPSM dengan beberapa baris kode. Kode C# .NET di bawah ini menunjukkan ekstraksi hyperlink di dalam dokumen PPSM. 
    ...
    - title_left: "Ekstrak Hyperlink dari PPSM Area Halaman Dokumen"
      content_left: |
       GroupDocs.Parser Java API telah memberikan dukungan lengkap untuk mengekstrak hyperlink dari halaman dokumen PPSM dengan mudah. Kode Java berikut menunjukkan bagaimana programmer dapat mengekstrak hyperlink dari area halaman dokumen PPSM di dalam aplikasi Java mereka sendiri.
