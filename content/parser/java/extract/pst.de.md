...
draft: false
path: "de/parser/java/extract/pst/"
...
steps:
    enable: true
    block:
    - title_left: "So extrahieren Sie Hyperlinks aus PST-Dokumenten"
      content_left: |
       GroupDocs.Parser Java enthält Funktionen zum Extrahieren von Hyperlinks aus PST-Dokumenten. Das folgende Java-Codebeispiel zeigt, wie Hyperlinks aus dem PST-Dokument extrahiert werden können.
    ...
    - title_left: "So extrahieren Sie Hyperlinks von der PST-Dokumentenseite"
      content_left: |
       GroupDocs.Parser .NET ermöglicht es Softwareentwicklern, mit ein paar Codezeilen Hyperlinks aus PST-Dokumenten zu extrahieren. Der folgende C# .NET-Code zeigt die Extraktion von Hyperlinks innerhalb eines PST-Dokuments. 
    ...
    - title_left: "Extrahieren Sie Hyperlinks aus dem Seitenbereich für PST-Dokumente"
      content_left: |
       Die GroupDocs.Parser-Java-API bietet vollständige Unterstützung zum einfachen Extrahieren von Hyperlinks aus der Seite des PST-Dokuments. Der folgende Java-Code zeigt, wie Programmierer Hyperlinks aus einem PST-Dokumentseitenbereich in ihren eigenen Java-Anwendungen extrahieren können.
