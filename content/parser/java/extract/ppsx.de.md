...
draft: false
path: "de/parser/java/extract/ppsx/"
...
steps:
    enable: true
    block:
    - title_left: "So extrahieren Sie Hyperlinks aus PPSX-Dokumenten"
      content_left: |
       GroupDocs.Parser Java enthält Funktionen zum Extrahieren von Hyperlinks aus PPSX-Dokumenten. Das folgende Java-Codebeispiel zeigt, wie Hyperlinks aus dem PPSX-Dokument extrahiert werden können.
    ...
    - title_left: "So extrahieren Sie Hyperlinks von der PPSX-Dokumentenseite"
      content_left: |
       GroupDocs.Parser .NET ermöglicht es Softwareentwicklern, mit ein paar Codezeilen Hyperlinks aus PPSX-Dokumenten zu extrahieren. Der folgende C# .NET-Code zeigt die Extraktion von Hyperlinks innerhalb eines PPSX-Dokuments. 
    ...
    - title_left: "Extrahieren Sie Hyperlinks aus dem Seitenbereich für PPSX-Dokumente"
      content_left: |
       Die GroupDocs.Parser-Java-API bietet vollständige Unterstützung zum einfachen Extrahieren von Hyperlinks aus der Seite des PPSX-Dokuments. Der folgende Java-Code zeigt, wie Programmierer Hyperlinks aus einem PPSX-Dokumentseitenbereich in ihren eigenen Java-Anwendungen extrahieren können.
