...
draft: false
path: "ko/parser/java/extract/xhtml/"
...
steps:
    enable: true
    block:
    - title_left: "XHTML 문서에서 하이퍼링크를 추출하는 방법"
      content_left: |
       GroupDocs.Parser Java에는 XHTML 문서에서 하이퍼링크를 추출하는 기능이 포함되어 있습니다. 다음 Java 코드 예제는 XHTML 문서에서 하이퍼링크를 추출하는 방법을 보여줍니다. 
    ...
    - title_left: "XHTML 문서 페이지에서 하이퍼링크를 추출하는 방법"
      content_left: |
    ...
    - title_left: "XHTML 문서 페이지 영역에서 하이퍼링크 추출"
      content_left: |
       GroupDocs.Parser Java API는 XHTML 문서의 페이지 용이성에서 하이퍼링크를 추출하기 위한 완전한 지원을 제공했습니다. 다음 Java 코드는 프로그래머가 자체 Java 애플리케이션 내부의 XHTML 문서 페이지 영역에서 하이퍼링크를 추출하는 방법을 보여줍니다.
