...
draft: false
path: "fr/parser/java/extract/xhtml/"
...
steps:
    enable: true
    block:
    - title_left: "Comment extraire des liens hypertexte de XHTML Documents"
      content_left: |
       GroupDocs.Parser Java a inclus une fonctionnalité pour extraire des liens hypertexte à partir de documents XHTML. L'exemple de code Java suivant montre comment les liens hypertexte peuvent être extraits du document XHTML. 
    ...
    - title_left: "Comment extraire des liens hypertexte de la page XHTML Documents"
      content_left: |
       GroupDocs.Parser .NET permet aux développeurs de logiciels d'extraire des liens hypertexte à partir de documents XHTML avec quelques lignes de code. Le code C# .NET ci-dessous montre l'extraction de liens hypertexte dans un document XHTML. 
    ...
    - title_left: "Extraire les liens hypertexte de la zone de page XHTML Documents"
      content_left: |
       L'API Java GroupDocs.Parser a fourni une prise en charge complète pour extraire les liens hypertexte de la facilité de page du document XHTML. Le code Java suivant montre comment les programmeurs peuvent extraire des liens hypertexte d'une zone de page de document XHTML dans leurs propres applications Java.
