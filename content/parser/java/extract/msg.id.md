...
steps:
    enable: true
    block:
    - title_left: "Cara Mengekstrak Hyperlink dari Dokumen MSG"
      content_left: |
       GroupDocs.Parser Java telah menyertakan fungsionalitas untuk mengekstraksi Hyperlink dari dokumen MSG. Contoh kode Java berikut menunjukkan bagaimana hyperlink dapat diekstraksi dari dokumen MSG. 
    ...
    - title_left: "Cara Mengekstrak Hyperlink dari Halaman Dokumen MSG"
      content_left: |
    ...
    - title_left: "Ekstrak Hyperlink dari MSG Area Halaman Dokumen"
      content_left: |
       GroupDocs.Parser Java API telah memberikan dukungan lengkap untuk mengekstrak hyperlink dari halaman dokumen MSG dengan mudah. Kode Java berikut menunjukkan bagaimana programmer dapat mengekstrak hyperlink dari area halaman dokumen MSG di dalam aplikasi Java mereka sendiri.
