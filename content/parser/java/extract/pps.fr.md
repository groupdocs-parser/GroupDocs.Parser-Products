...
draft: false
path: "fr/parser/java/extract/pps/"
...
steps:
    enable: true
    block:
    - title_left: "Comment extraire des liens hypertexte de PPS Documents"
      content_left: |
       GroupDocs.Parser Java a inclus une fonctionnalité pour extraire des liens hypertexte à partir de documents PPS. L'exemple de code Java suivant montre comment les liens hypertexte peuvent être extraits du document PPS. 
    ...
    - title_left: "Comment extraire des liens hypertexte de la page PPS Documents"
      content_left: |
       GroupDocs.Parser .NET permet aux développeurs de logiciels d'extraire des liens hypertexte à partir de documents PPS avec quelques lignes de code. Le code C# .NET ci-dessous montre l'extraction de liens hypertexte dans un document PPS. 
    ...
    - title_left: "Extraire les liens hypertexte de la zone de page PPS Documents"
      content_left: |
       L'API Java GroupDocs.Parser a fourni une prise en charge complète pour extraire les liens hypertexte de la facilité de page du document PPS. Le code Java suivant montre comment les programmeurs peuvent extraire des liens hypertexte d'une zone de page de document PPS dans leurs propres applications Java.
