...
steps:
    enable: true
    block:
    - title_left: "Cara Mengekstrak Hyperlink dari Dokumen MD"
      content_left: |
       GroupDocs.Parser Java telah menyertakan fungsionalitas untuk mengekstraksi Hyperlink dari dokumen MD. Contoh kode Java berikut menunjukkan bagaimana hyperlink dapat diekstraksi dari dokumen MD. 
    ...
    - title_left: "Cara Mengekstrak Hyperlink dari Halaman Dokumen MD"
      content_left: |
       GroupDocs.Parser .NET memungkinkan pengembang perangkat lunak untuk mengekstrak hyperlink dari dokumen MD dengan beberapa baris kode. Kode C# .NET di bawah ini menunjukkan ekstraksi hyperlink di dalam dokumen MD. 
    ...
    - title_left: "Ekstrak Hyperlink dari MD Area Halaman Dokumen"
      content_left: |
       GroupDocs.Parser Java API telah memberikan dukungan lengkap untuk mengekstrak hyperlink dari halaman dokumen MD dengan mudah. Kode Java berikut menunjukkan bagaimana programmer dapat mengekstrak hyperlink dari area halaman dokumen MD di dalam aplikasi Java mereka sendiri.
