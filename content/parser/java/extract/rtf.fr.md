...
draft: false
path: "fr/parser/java/extract/rtf/"
...
steps:
    enable: true
    block:
    - title_left: "Comment extraire des liens hypertexte de RTF Documents"
      content_left: |
       GroupDocs.Parser Java a inclus une fonctionnalité pour extraire des liens hypertexte à partir de documents RTF. L'exemple de code Java suivant montre comment les liens hypertexte peuvent être extraits du document RTF. 
    ...
    - title_left: "Comment extraire des liens hypertexte de la page RTF Documents"
      content_left: |
    ...
    - title_left: "Extraire les liens hypertexte de la zone de page RTF Documents"
      content_left: |
       L'API Java GroupDocs.Parser a fourni une prise en charge complète pour extraire les liens hypertexte de la facilité de page du document RTF. Le code Java suivant montre comment les programmeurs peuvent extraire des liens hypertexte d'une zone de page de document RTF dans leurs propres applications Java.
