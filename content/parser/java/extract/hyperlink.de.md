...
about:
    enable: true
    title: "Wie kann ich Hyperlinks aus Dokumenten über die Java-API analysieren und extrahieren?"
    content: |
...
steps:
    enable: true
    title_left: "Extrahieren Sie Hyperlinks aus Dokumenten in Java"
    content_left: |
        [GroupDocs.Parser for Java](/de/parser/java/) erleichtert Java Entwicklern das Extrahieren von Hyperlinks aus Dokumenten durch die Implementierung einiger einfacher Schritte.
    ...
    code: |
     ...
     {{< parser/code-parser title="So extrahieren Sie Hyperlinks aus Dokumenten mithilfe von Java-Beispielcode">}}

        ```java    
        // Extrahieren Sie Hyperlinks aus Dokumenten mithilfe der GroupDocs.Parser-API
