...
steps:
    enable: true
    title_left: "Извлечение таблиц из документов в Java"
    content_left: |
        [GroupDocs.Parser for Java](/ru/parser/java/) позволяет разработчикам Java легко извлекать таблицы из документов, выполняя несколько простых шагов.
    ...
    code: |
     ...
     {{< parser/code-parser title="Как извлечь таблицы из документов, используя пример кода Java">}}
