...
steps:
    enable: true
    block:
    - title_left: "Cara Mengekstrak Hyperlink dari Dokumen EPUB"
      content_left: |
       GroupDocs.Parser Java telah menyertakan fungsionalitas untuk mengekstraksi Hyperlink dari dokumen EPUB. Contoh kode Java berikut menunjukkan bagaimana hyperlink dapat diekstraksi dari dokumen EPUB. 
    ...
    - title_left: "Cara Mengekstrak Hyperlink dari Halaman Dokumen EPUB"
      content_left: |
       GroupDocs.Parser .NET memungkinkan pengembang perangkat lunak untuk mengekstrak hyperlink dari dokumen EPUB dengan beberapa baris kode. Kode C# .NET di bawah ini menunjukkan ekstraksi hyperlink di dalam dokumen EPUB. 
    ...
    - title_left: "Ekstrak Hyperlink dari EPUB Area Halaman Dokumen"
      content_left: |
       GroupDocs.Parser Java API telah memberikan dukungan lengkap untuk mengekstrak hyperlink dari halaman dokumen EPUB dengan mudah. Kode Java berikut menunjukkan bagaimana programmer dapat mengekstrak hyperlink dari area halaman dokumen EPUB di dalam aplikasi Java mereka sendiri.
