...
about:
    enable: true
    title: "Bagaimana cara Mengekstrak Kode Batang dari API Excel, Word, PDF & Dokumen Lainnya Java?"
    content: |
...
steps:
    enable: true
    title_left: "Ekstrak kode batang dari dokumen di Java"
    content_left: |
        [GroupDocs.Parser for Java](/id/parser/java/) memudahkan pengembang Java untuk mengekstrak kode batang dari dokumen dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< parser/code-parser title="Cara mengekstrak kode batang dari dokumen menggunakan kode contoh Java">}}
