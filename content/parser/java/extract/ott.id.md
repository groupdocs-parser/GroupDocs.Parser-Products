...
steps:
    enable: true
    block:
    - title_left: "Cara Mengekstrak Hyperlink dari Dokumen OTT"
      content_left: |
       GroupDocs.Parser Java telah menyertakan fungsionalitas untuk mengekstraksi Hyperlink dari dokumen OTT. Contoh kode Java berikut menunjukkan bagaimana hyperlink dapat diekstraksi dari dokumen OTT. 
    ...
    - title_left: "Cara Mengekstrak Hyperlink dari Halaman Dokumen OTT"
      content_left: |
       GroupDocs.Parser .NET memungkinkan pengembang perangkat lunak untuk mengekstrak hyperlink dari dokumen OTT dengan beberapa baris kode. Kode C# .NET di bawah ini menunjukkan ekstraksi hyperlink di dalam dokumen OTT. 
    ...
    - title_left: "Ekstrak Hyperlink dari OTT Area Halaman Dokumen"
      content_left: |
       GroupDocs.Parser Java API telah memberikan dukungan lengkap untuk mengekstrak hyperlink dari halaman dokumen OTT dengan mudah. Kode Java berikut menunjukkan bagaimana programmer dapat mengekstrak hyperlink dari area halaman dokumen OTT di dalam aplikasi Java mereka sendiri.
