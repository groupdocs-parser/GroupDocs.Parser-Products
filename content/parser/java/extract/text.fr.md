...
############################# Head ############################
head_title: "Extraire le texte des documents dans Java"
head_description: "Extrayez rapidement du texte d'un fichier de documents dans Java."

############################# Header ############################
title: "Extraire le texte des documents dans Java"
description: "Extrayez du texte de documents avec quelques lignes de code Java."
...
about:
    enable: true
    title: "Comment extraire un texte des fichiers API Java ?"
    content: |
...
steps:
    enable: true
    title_left: "Extraire le texte des documents dans Java"
    content_left: |
        [GroupDocs.Parser for Java](/fr/parser/java/) permet aux développeurs Java d'extraire facilement un texte de documents en mettant en œuvre quelques étapes simples.
    ...
    code: |
     ...
     {{< parser/code-parser title="Comment extraire du texte de documents à l'aide de l'exemple de code Java">}}
...
demos:
    enable: true
    title: "Démos en direct - Extraire du texte de documents en ligne"
    content: |
       Extrayez le texte des documents dès maintenant en visitant le site Web [GroupDocs.Parser Live Demos](https://products.groupdocs.app/parser/text/).
