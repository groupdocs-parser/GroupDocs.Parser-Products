...
steps:
    enable: true
    block:
    - title_left: "Cara Mengekstrak Hyperlink dari Dokumen XLSB"
      content_left: |
       GroupDocs.Parser Java telah menyertakan fungsionalitas untuk mengekstraksi Hyperlink dari dokumen XLSB. Contoh kode Java berikut menunjukkan bagaimana hyperlink dapat diekstraksi dari dokumen XLSB. 
    ...
    - title_left: "Cara Mengekstrak Hyperlink dari Halaman Dokumen XLSB"
      content_left: |
       GroupDocs.Parser .NET memungkinkan pengembang perangkat lunak untuk mengekstrak hyperlink dari dokumen XLSB dengan beberapa baris kode. Kode C# .NET di bawah ini menunjukkan ekstraksi hyperlink di dalam dokumen XLSB. 
    ...
    - title_left: "Ekstrak Hyperlink dari XLSB Area Halaman Dokumen"
      content_left: |
       GroupDocs.Parser Java API telah memberikan dukungan lengkap untuk mengekstrak hyperlink dari halaman dokumen XLSB dengan mudah. Kode Java berikut menunjukkan bagaimana programmer dapat mengekstrak hyperlink dari area halaman dokumen XLSB di dalam aplikasi Java mereka sendiri.
