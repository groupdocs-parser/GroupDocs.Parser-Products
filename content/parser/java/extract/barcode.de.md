...
about:
    enable: true
    title: "Wie extrahiere ich Barcodes aus der API Excel, Word, PDF und anderen Dokumenten Java?"
    content: |
...
steps:
    enable: true
    title_left: "Barcodes aus Dokumenten in Java extrahieren"
    content_left: |
        [GroupDocs.Parser for Java](/de/parser/java/) erleichtert Java Entwicklern das Extrahieren von Barcodes aus Dokumenten durch die Implementierung einiger einfacher Schritte.
    ...
    code: |
     ...
     {{< parser/code-parser title="So extrahieren Sie Barcodes aus Dokumenten mithilfe des Beispielcodes Java">}}

        ```java    
        // Extrahieren Sie Barcodes aus Dokumenten mithilfe der GroupDocs.Parser-API
