...
steps:
    enable: true
    block:
    - title_left: "Cara Mengekstrak Hyperlink dari Dokumen DOCX"
      content_left: |
       GroupDocs.Parser Java telah menyertakan fungsionalitas untuk mengekstraksi Hyperlink dari dokumen DOCX. Contoh kode Java berikut menunjukkan bagaimana hyperlink dapat diekstraksi dari dokumen DOCX. 
    ...
    - title_left: "Cara Mengekstrak Hyperlink dari Halaman Dokumen DOCX"
      content_left: |
       GroupDocs.Parser .NET memungkinkan pengembang perangkat lunak untuk mengekstrak hyperlink dari dokumen DOCX dengan beberapa baris kode. Kode C# .NET di bawah ini menunjukkan ekstraksi hyperlink di dalam dokumen DOCX. 
    ...
    - title_left: "Ekstrak Hyperlink dari DOCX Area Halaman Dokumen"
      content_left: |
       GroupDocs.Parser Java API telah memberikan dukungan lengkap untuk mengekstrak hyperlink dari halaman dokumen DOCX dengan mudah. Kode Java berikut menunjukkan bagaimana programmer dapat mengekstrak hyperlink dari area halaman dokumen DOCX di dalam aplikasi Java mereka sendiri.
