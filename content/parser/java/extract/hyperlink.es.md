...
about:
    enable: true
    title: "¿Cómo analizar y extraer hipervínculos de documentos a través de la API Java?"
    content: |
...
steps:
    enable: true
    title_left: "Extraer hipervínculos de documentos en Java"
    content_left: |
        [GroupDocs.Parser for Java](/es/parser/java/) facilita a los desarrolladores de Java extraer hipervínculos de los documentos mediante la implementación de unos sencillos pasos.
    ...
    code: |
     ...
     {{< parser/code-parser title="Cómo extraer hipervínculos de documentos utilizando el código de ejemplo Java">}}

        ```java    
        // Extraiga hipervínculos de documentos usando la API GroupDocs.Parser
