...
draft: false
path: "de/parser/java/extract/rtf/"
...
steps:
    enable: true
    block:
    - title_left: "So extrahieren Sie Hyperlinks aus RTF-Dokumenten"
      content_left: |
       GroupDocs.Parser Java enthält Funktionen zum Extrahieren von Hyperlinks aus RTF-Dokumenten. Das folgende Java-Codebeispiel zeigt, wie Hyperlinks aus dem RTF-Dokument extrahiert werden können.
    ...
    - title_left: "So extrahieren Sie Hyperlinks von der RTF-Dokumentenseite"
      content_left: |
       GroupDocs.Parser .NET ermöglicht es Softwareentwicklern, mit ein paar Codezeilen Hyperlinks aus RTF-Dokumenten zu extrahieren. Der folgende C# .NET-Code zeigt die Extraktion von Hyperlinks innerhalb eines RTF-Dokuments. 
    ...
    - title_left: "Extrahieren Sie Hyperlinks aus dem Seitenbereich für RTF-Dokumente"
      content_left: |
       Die GroupDocs.Parser-Java-API bietet vollständige Unterstützung zum einfachen Extrahieren von Hyperlinks aus der Seite des RTF-Dokuments. Der folgende Java-Code zeigt, wie Programmierer Hyperlinks aus einem RTF-Dokumentseitenbereich in ihren eigenen Java-Anwendungen extrahieren können.
