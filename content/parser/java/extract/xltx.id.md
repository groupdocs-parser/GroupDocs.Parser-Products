...
steps:
    enable: true
    block:
    - title_left: "Cara Mengekstrak Hyperlink dari Dokumen XLTX"
      content_left: |
       GroupDocs.Parser Java telah menyertakan fungsionalitas untuk mengekstraksi Hyperlink dari dokumen XLTX. Contoh kode Java berikut menunjukkan bagaimana hyperlink dapat diekstraksi dari dokumen XLTX. 
    ...
    - title_left: "Cara Mengekstrak Hyperlink dari Halaman Dokumen XLTX"
      content_left: |
    ...
    - title_left: "Ekstrak Hyperlink dari XLTX Area Halaman Dokumen"
      content_left: |
       GroupDocs.Parser Java API telah memberikan dukungan lengkap untuk mengekstrak hyperlink dari halaman dokumen XLTX dengan mudah. Kode Java berikut menunjukkan bagaimana programmer dapat mengekstrak hyperlink dari area halaman dokumen XLTX di dalam aplikasi Java mereka sendiri.
