...
steps:
    enable: true
    block:
    - title_left: "How to Extract Hyperlinks from DOCM Documents"
      content_left: |
       GroupDocs.Parser Java has included functionality for extracting Hyperlinks from DOCM documents. The following Java code example shows how hyperlinks can be extracted from DOCM document. 
    ...
    - title_left: "How to Extract Hyperlinks from DOCM Documents Page"
      content_left: |
       GroupDocs.Parser .NET allows software developers to extract hyperlinks from DOCM documents with a couple of lines of code. The below C# .NET code shows hyperlinks extraction inside a DOCM document. 
    ...
    - title_left: "Extract Hyperlinks from DOCM Documents Page Area"
      content_left: |
       GroupDocs.Parser Java API has provided complete support to extract hyperlinks from DOCM document's page ease. The following Java code shows how programmers can extract hyperlinks from a DOCM document page area inside their own Java applications.
