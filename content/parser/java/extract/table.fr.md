...
about:
    enable: true
    title: "Comment extraire des tableaux de Excel, Word, PDF et d'autres documents via l'API Java ?"
    content: |
...
steps:
    enable: true
    title_left: "Extraire les tables des documents dans Java"
    content_left: |
        [GroupDocs.Parser for Java](/fr/parser/java/) permet aux développeurs Java d'extraire facilement des tableaux de documents en mettant en œuvre quelques étapes simples.
    ...
    code: |
     ...
     {{< parser/code-parser title="Comment extraire des tableaux de documents à l'aide de l'exemple de code Java">}}

        ```java    
        // Extraire des tableaux de documents à l'aide de l'API GroupDocs.Parser
