...
steps:
    enable: true
    block:
    - title_left: "Cara Mengekstrak Hyperlink dari Dokumen XLAM"
      content_left: |
       GroupDocs.Parser Java telah menyertakan fungsionalitas untuk mengekstraksi Hyperlink dari dokumen XLAM. Contoh kode Java berikut menunjukkan bagaimana hyperlink dapat diekstraksi dari dokumen XLAM. 
    ...
    - title_left: "Cara Mengekstrak Hyperlink dari Halaman Dokumen XLAM"
      content_left: |
       GroupDocs.Parser .NET memungkinkan pengembang perangkat lunak untuk mengekstrak hyperlink dari dokumen XLAM dengan beberapa baris kode. Kode C# .NET di bawah ini menunjukkan ekstraksi hyperlink di dalam dokumen XLAM. 
    ...
    - title_left: "Ekstrak Hyperlink dari XLAM Area Halaman Dokumen"
      content_left: |
       GroupDocs.Parser Java API telah memberikan dukungan lengkap untuk mengekstrak hyperlink dari halaman dokumen XLAM dengan mudah. Kode Java berikut menunjukkan bagaimana programmer dapat mengekstrak hyperlink dari area halaman dokumen XLAM di dalam aplikasi Java mereka sendiri.
