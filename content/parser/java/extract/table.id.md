...
about:
    enable: true
    title: "Bagaimana cara Mengekstrak Tabel dari Excel, Word, PDF & dokumen lain melalui Java API?"
    content: |
...
steps:
    enable: true
    title_left: "Ekstrak tabel dari dokumen di Java"
    content_left: |
        [GroupDocs.Parser for Java](/id/parser/java/) memudahkan pengembang Java untuk mengekstrak tabel dari dokumen dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< parser/code-parser title="Cara mengekstrak tabel dari dokumen menggunakan kode contoh Java">}}

        ```java    
        // Ekstrak tabel dari dokumen menggunakan GroupDocs.Parser API
