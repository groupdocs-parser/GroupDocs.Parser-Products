...
steps:
    enable: true
    block:
    - title_left: "Cara Mengekstrak Hyperlink dari Dokumen ONE"
      content_left: |
       GroupDocs.Parser Java telah menyertakan fungsionalitas untuk mengekstraksi Hyperlink dari dokumen ONE. Contoh kode Java berikut menunjukkan bagaimana hyperlink dapat diekstraksi dari dokumen ONE. 
    ...
    - title_left: "Cara Mengekstrak Hyperlink dari Halaman Dokumen ONE"
      content_left: |
       GroupDocs.Parser .NET memungkinkan pengembang perangkat lunak untuk mengekstrak hyperlink dari dokumen ONE dengan beberapa baris kode. Kode C# .NET di bawah ini menunjukkan ekstraksi hyperlink di dalam dokumen ONE. 
    ...
    - title_left: "Ekstrak Hyperlink dari ONE Area Halaman Dokumen"
      content_left: |
       GroupDocs.Parser Java API telah memberikan dukungan lengkap untuk mengekstrak hyperlink dari halaman dokumen ONE dengan mudah. Kode Java berikut menunjukkan bagaimana programmer dapat mengekstrak hyperlink dari area halaman dokumen ONE di dalam aplikasi Java mereka sendiri.
