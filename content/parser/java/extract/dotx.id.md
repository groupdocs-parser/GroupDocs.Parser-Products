...
steps:
    enable: true
    block:
    - title_left: "Cara Mengekstrak Hyperlink dari Dokumen DOTX"
      content_left: |
       GroupDocs.Parser Java telah menyertakan fungsionalitas untuk mengekstraksi Hyperlink dari dokumen DOTX. Contoh kode Java berikut menunjukkan bagaimana hyperlink dapat diekstraksi dari dokumen DOTX. 
    ...
    - title_left: "Cara Mengekstrak Hyperlink dari Halaman Dokumen DOTX"
      content_left: |
       GroupDocs.Parser .NET memungkinkan pengembang perangkat lunak untuk mengekstrak hyperlink dari dokumen DOTX dengan beberapa baris kode. Kode C# .NET di bawah ini menunjukkan ekstraksi hyperlink di dalam dokumen DOTX. 
    ...
    - title_left: "Ekstrak Hyperlink dari DOTX Area Halaman Dokumen"
      content_left: |
       GroupDocs.Parser Java API telah memberikan dukungan lengkap untuk mengekstrak hyperlink dari halaman dokumen DOTX dengan mudah. Kode Java berikut menunjukkan bagaimana programmer dapat mengekstrak hyperlink dari area halaman dokumen DOTX di dalam aplikasi Java mereka sendiri.
