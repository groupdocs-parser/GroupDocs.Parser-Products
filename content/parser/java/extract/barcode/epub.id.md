...
about:
    enable: true
    title: "Bagaimana cara Mengekstrak Kode Batang dari EPUB file Java API?"
    content: |
...
steps:
    enable: true
    title_left: "Ekstrak kode batang dari EPUB di Java"
    content_left: |
        [GroupDocs.Parser for Java](/id/parser/java/) memudahkan pengembang Java untuk mengekstrak kode batang dari file EPUB dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< parser/code-parser title="Cara mengekstrak kode batang dari file EPUB menggunakan kode contoh Java">}}

        ```java    
        // Ekstrak kode batang dari file EPUB menggunakan GroupDocs.Parser API
...
demos:
    enable: true
    title: "Demo Langsung - Ekstrak kode batang dari EPUB Online"
    content: |
       Ekstrak kode batang dari file EPUB sekarang juga dengan mengunjungi situs web [GroupDocs.Parser Demo Langsung](https://products.groupdocs.app/parser/barcodes/epub).
