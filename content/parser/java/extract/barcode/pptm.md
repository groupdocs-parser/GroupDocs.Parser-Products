...
draft: false
path: "parser/java/extract/barcode/pptm/"
...
steps:
    enable: true
    block:
    - title_left: "How to Extract Barcodes from PPTM Documents via Java"
      content_left: |
       GroupDocs.Parser Java API gives programmers the power to easily extract barcodes from PPTM documents. The following Java code example demonstrates how to extract barcode images inside a PPTM document with minimum effort and cost. 
    ...
    - title_left: "Get Barcodes from PPTM Document's Page via Java"
      content_left: |
       GroupDocs.Parser Java enables software developers to parse and get barcodes from a PPTM documents's page with ease. The following Java code shows how barcode extraction can be achived  from a specific document page inside a PPTM document. 
    ...
    - title_left: "How to Extract Barcodes from PPTM Documents Page Area"
      content_left: |
       GroupDocs.Parser Java API fully supports extraction of barcodes from PPTM documents with ease. The following Java code example shows how to perform barcodes extraction from a PPTM document page area.
