...
about:
    enable: true
    title: "Bagaimana cara Mengekstrak Kode Batang dari PPTX file Java API?"
    content: |
...
steps:
    enable: true
    title_left: "Ekstrak kode batang dari PPTX di Java"
    content_left: |
        [GroupDocs.Parser for Java](/id/parser/java/) memudahkan pengembang Java untuk mengekstrak kode batang dari file PPTX dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< parser/code-parser title="Cara mengekstrak kode batang dari file PPTX menggunakan kode contoh Java">}}
...
demos:
    enable: true
    title: "Demo Langsung - Ekstrak kode batang dari PPTX Online"
    content: |
       Ekstrak kode batang dari file PPTX sekarang juga dengan mengunjungi situs web [GroupDocs.Parser Demo Langsung](https://products.groupdocs.app/parser/barcodes/pptx).
