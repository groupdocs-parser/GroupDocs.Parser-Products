...
about:
    enable: true
    title: "Bagaimana cara Mengekstrak Kode Batang dari PDF file Java API?"
    content: |
...
steps:
    enable: true
    title_left: "Ekstrak kode batang dari PDF di Java"
    content_left: |
        [GroupDocs.Parser for Java](/id/parser/java/) memudahkan pengembang Java untuk mengekstrak kode batang dari file PDF dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< parser/code-parser title="Cara mengekstrak kode batang dari file PDF menggunakan kode contoh Java">}}

        ```java    
        // Ekstrak kode batang dari file PDF menggunakan GroupDocs.Parser API
...
demos:
    enable: true
    title: "Demo Langsung - Ekstrak kode batang dari PDF Online"
    content: |
       Ekstrak kode batang dari file PDF sekarang juga dengan mengunjungi situs web [GroupDocs.Parser Demo Langsung](https://products.groupdocs.app/parser/barcodes/pdf).
