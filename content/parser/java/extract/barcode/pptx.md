...
about:
    enable: true
    title: "How to Extract Barcodes from PPTX files Java API?"
    content: |
...
steps:
    enable: true
    title_left: "Extract barcodes from PPTX in Java"
    content_left: |
        [GroupDocs.Parser for Java](/parser/java/) makes it easy for Java developers to extract barcodes from a PPTX file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< parser/code-parser title="How to extract barcodes from PPTX file using Java example code">}}

        ```java    
        // Extract barcodes from PPTX file using GroupDocs.Parser API
...
demos:
    enable: true
    title: "Live Demos - Extract barcodes from PPTX Online"
    content: |
       Extract barcodes from PPTX file right now by visiting [GroupDocs.Parser Live Demos](https://products.groupdocs.app/parser/barcodes/pptx) website.
