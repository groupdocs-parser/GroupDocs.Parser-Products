...
about:
    enable: true
    title: "¿Cómo extraer códigos de barras de XHTML archivos Java API?"
    content: |
...
steps:
    enable: true
    title_left: "Extraer códigos de barras de XHTML en Java"
    content_left: |
        [GroupDocs.Parser for Java](/es/parser/java/) facilita a los desarrolladores de Java la extracción de códigos de barras de un archivo XHTML mediante la implementación de unos sencillos pasos.
    ...
    code: |
     ...
     {{< parser/code-parser title="Cómo extraer códigos de barras del archivo XHTML usando el código de ejemplo Java">}}

        ```java    
        // Extraiga códigos de barras del archivo XHTML usando la API GroupDocs.Parser
...
demos:
    enable: true
    title: "Demostraciones en vivo: extraiga códigos de barras de XHTML en línea"
    content: |
       Extraiga los códigos de barras del archivo XHTML ahora mismo visitando el sitio web [GroupDocs.Parser Live Demos](https://products.groupdocs.app/parser/barcodes/xhtml).
