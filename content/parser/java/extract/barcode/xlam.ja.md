...
about:
    enable: true
    title: "XLAM ファイルからバーコードを抽出する方法 Java API?"
    content: |
...
steps:
    enable: true
    title_left: "Java の XLAM からバーコードを抽出します"
    content_left: |
        [GroupDocs.Parser for Java](/ja/parser/java/) を使用すると、Java 開発者は、いくつかの簡単な手順を実装することで、XLAM ファイルからバーコードを簡単に抽出できます。
    ...
    code: |
     ...
     {{< parser/code-parser title="Java サンプルコードを使用して XLAM ファイルからバーコードを抽出する方法">}}
...
demos:
    enable: true
    title: "ライブ デモ - オンライン XLAM からバーコードを抽出"
    content: |
       [GroupDocs.Parser ライブ デモ](https://products.groupdocs.app/parser/barcodes/xlam) Web サイトにアクセスして、今すぐ XLAM ファイルからバーコードを抽出してください。
