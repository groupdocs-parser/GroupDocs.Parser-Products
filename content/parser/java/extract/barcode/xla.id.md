...
about:
    enable: true
    title: "Bagaimana cara Mengekstrak Kode Batang dari XLA file Java API?"
    content: |
...
steps:
    enable: true
    title_left: "Ekstrak kode batang dari XLA di Java"
    content_left: |
        [GroupDocs.Parser for Java](/id/parser/java/) memudahkan pengembang Java untuk mengekstrak kode batang dari file XLA dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< parser/code-parser title="Cara mengekstrak kode batang dari file XLA menggunakan kode contoh Java">}}

        ```java    
        // Ekstrak kode batang dari file XLA menggunakan GroupDocs.Parser API
...
demos:
    enable: true
    title: "Demo Langsung - Ekstrak kode batang dari XLA Online"
    content: |
       Ekstrak kode batang dari file XLA sekarang juga dengan mengunjungi situs web [GroupDocs.Parser Demo Langsung](https://products.groupdocs.app/parser/barcodes/xla).
