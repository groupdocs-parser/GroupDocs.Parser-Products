...
about:
    enable: true
    title: "Wie extrahiere ich Barcodes aus OTP-Dateien mit der Java-API?"
    content: |
...
steps:
    enable: true
    title_left: "Barcodes aus OTP in Java extrahieren"
    content_left: |
        [GroupDocs.Parser for Java](/de/parser/java/) erleichtert Java-Entwicklern das Extrahieren von Barcodes aus einer OTP-Datei durch die Implementierung einiger einfacher Schritte.
    ...
    code: |
     ...
     {{< parser/code-parser title="So extrahieren Sie Barcodes aus der Datei OTP mithilfe des Beispielcodes Java">}}

        ```java    
        // Extrahieren Sie Barcodes aus der Datei OTP mit der API GroupDocs.Parser
...
demos:
    enable: true
    title: "Live-Demos – Barcodes aus OTP online extrahieren"
    content: |
       Extrahieren Sie jetzt Barcodes aus der Datei OTP, indem Sie die Website [GroupDocs.Parser Live Demos](https://products.groupdocs.app/parser/barcodes/otp) besuchen.
