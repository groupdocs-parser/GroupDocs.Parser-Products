...
draft: false
path: "parser/java/extract/barcode/fb2/"
...
steps:
    enable: true
    block:
    - title_left: "How to Extract Barcodes from FB2 Documents via Java"
      content_left: |
       GroupDocs.Parser Java API gives programmers the power to easily extract barcodes from FB2 documents. The following Java code example demonstrates how to extract barcode images inside a FB2 document with minimum effort and cost. 
    ...
    - title_left: "Get Barcodes from FB2 Document's Page via Java"
      content_left: |
       GroupDocs.Parser Java enables software developers to parse and get barcodes from a FB2 documents's page with ease. The following Java code shows how barcode extraction can be achived  from a specific document page inside a FB2 document. 
    ...
    - title_left: "How to Extract Barcodes from FB2 Documents Page Area"
      content_left: |
       GroupDocs.Parser Java API fully supports extraction of barcodes from FB2 documents with ease. The following Java code example shows how to perform barcodes extraction from a FB2 document page area.
