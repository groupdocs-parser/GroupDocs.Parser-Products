...
about:
    enable: true
    title: "Comment extraire les codes-barres de l'API XLSX fichiers Java ?"
    content: |
...
steps:
    enable: true
    title_left: "Extraire les codes-barres de XLSX dans Java"
    content_left: |
        [GroupDocs.Parser for Java](/fr/parser/java/) permet aux développeurs Java d'extraire facilement les codes-barres d'un fichier XLSX en mettant en œuvre quelques étapes simples.
    ...
    code: |
     ...
     {{< parser/code-parser title="Comment extraire les codes-barres du fichier XLSX à l'aide de l'exemple de code Java">}}

        ```java    
        // Extraire les codes-barres du fichier XLSX à l'aide de l'API GroupDocs.Parser
...
demos:
    enable: true
    title: "Démos en direct - Extrayez les codes-barres de XLSX en ligne"
    content: |
       Extrayez les codes-barres du fichier XLSX dès maintenant en visitant le site Web [GroupDocs.Parser Live Demos](https://products.groupdocs.app/parser/barcodes/xlsx).
