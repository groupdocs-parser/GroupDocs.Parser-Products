...
about:
    enable: true
    title: "How to Extract Barcodes from PST files Java API?"
    content: |
...
steps:
    enable: true
    title_left: "Extract barcodes from PST in Java"
    content_left: |
        [GroupDocs.Parser for Java](/parser/java/) makes it easy for Java developers to extract barcodes from a PST file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< parser/code-parser title="How to extract barcodes from PST file using Java example code">}}

        ```java    
        // Extract barcodes from PST file using GroupDocs.Parser API
...
demos:
    enable: true
    title: "Live Demos - Extract barcodes from PST Online"
    content: |
       Extract barcodes from PST file right now by visiting [GroupDocs.Parser Live Demos](https://products.groupdocs.app/parser/barcodes/pst) website.
