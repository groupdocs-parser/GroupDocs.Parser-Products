...
about:
    enable: true
    title: "Wie extrahiere ich Barcodes aus FB2-Dateien mit der Java-API?"
    content: |
...
steps:
    enable: true
    title_left: "Barcodes aus FB2 in Java extrahieren"
    content_left: |
        [GroupDocs.Parser for Java](/de/parser/java/) erleichtert Java-Entwicklern das Extrahieren von Barcodes aus einer FB2-Datei durch die Implementierung einiger einfacher Schritte.
    ...
    code: |
     ...
     {{< parser/code-parser title="So extrahieren Sie Barcodes aus der Datei FB2 mithilfe des Beispielcodes Java">}}

        ```java    
        // Extrahieren Sie Barcodes aus der Datei FB2 mit der API GroupDocs.Parser
...
demos:
    enable: true
    title: "Live-Demos – Barcodes aus FB2 online extrahieren"
    content: |
       Extrahieren Sie jetzt Barcodes aus der Datei FB2, indem Sie die Website [GroupDocs.Parser Live Demos](https://products.groupdocs.app/parser/barcodes/fb2) besuchen.
