...
draft: false
path: "parser/java/extract/barcode/dot/"
...
steps:
    enable: true
    block:
    - title_left: "How to Extract Barcodes from DOT Documents via Java"
      content_left: |
       GroupDocs.Parser Java API gives programmers the power to easily extract barcodes from DOT documents. The following Java code example demonstrates how to extract barcode images inside a DOT document with minimum effort and cost. 
    ...
    - title_left: "Get Barcodes from DOT Document's Page via Java"
      content_left: |
       GroupDocs.Parser Java enables software developers to parse and get barcodes from a DOT documents's page with ease. The following Java code shows how barcode extraction can be achived  from a specific document page inside a DOT document. 
    ...
    - title_left: "How to Extract Barcodes from DOT Documents Page Area"
      content_left: |
       GroupDocs.Parser Java API fully supports extraction of barcodes from DOT documents with ease. The following Java code example shows how to perform barcodes extraction from a DOT document page area.
