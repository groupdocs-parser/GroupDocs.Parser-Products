...
draft: false
path: "parser/java/extract/barcode/rtf/"
...
steps:
    enable: true
    block:
    - title_left: "How to Extract Barcodes from RTF Documents via Java"
      content_left: |
       GroupDocs.Parser Java API gives programmers the power to easily extract barcodes from RTF documents. The following Java code example demonstrates how to extract barcode images inside a RTF document with minimum effort and cost. 
    ...
    - title_left: "Get Barcodes from RTF Document's Page via Java"
      content_left: |
       GroupDocs.Parser Java enables software developers to parse and get barcodes from a RTF documents's page with ease. The following Java code shows how barcode extraction can be achived  from a specific document page inside a RTF document. 
    ...
    - title_left: "How to Extract Barcodes from RTF Documents Page Area"
      content_left: |
       GroupDocs.Parser Java API fully supports extraction of barcodes from RTF documents with ease. The following Java code example shows how to perform barcodes extraction from a RTF document page area.
