...
draft: false
path: "parser/java/extract/barcode/xlsb/"
...
steps:
    enable: true
    block:
    - title_left: "How to Extract Barcodes from XLSB Documents via Java"
      content_left: |
       GroupDocs.Parser Java API gives programmers the power to easily extract barcodes from XLSB documents. The following Java code example demonstrates how to extract barcode images inside a XLSB document with minimum effort and cost. 
    ...
    - title_left: "Get Barcodes from XLSB Document's Page via Java"
      content_left: |
       GroupDocs.Parser Java enables software developers to parse and get barcodes from a XLSB documents's page with ease. The following Java code shows how barcode extraction can be achived  from a specific document page inside a XLSB document. 
    ...
    - title_left: "How to Extract Barcodes from XLSB Documents Page Area"
      content_left: |
       GroupDocs.Parser Java API fully supports extraction of barcodes from XLSB documents with ease. The following Java code example shows how to perform barcodes extraction from a XLSB document page area.
