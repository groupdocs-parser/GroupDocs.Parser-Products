...
about:
    enable: true
    title: "Wie extrahiere ich Barcodes aus PDF-Dateien mit der Java-API?"
    content: |
...
steps:
    enable: true
    title_left: "Barcodes aus PDF in Java extrahieren"
    content_left: |
        [GroupDocs.Parser for Java](/de/parser/java/) erleichtert Java-Entwicklern das Extrahieren von Barcodes aus einer PDF-Datei durch die Implementierung einiger einfacher Schritte.
    ...
    code: |
     ...
     {{< parser/code-parser title="So extrahieren Sie Barcodes aus der Datei PDF mithilfe des Beispielcodes Java">}}

        ```java    
        // Extrahieren Sie Barcodes aus der Datei PDF mit der API GroupDocs.Parser
...
demos:
    enable: true
    title: "Live-Demos – Barcodes aus PDF online extrahieren"
    content: |
       Extrahieren Sie jetzt Barcodes aus der Datei PDF, indem Sie die Website [GroupDocs.Parser Live Demos](https://products.groupdocs.app/parser/barcodes/pdf) besuchen.
