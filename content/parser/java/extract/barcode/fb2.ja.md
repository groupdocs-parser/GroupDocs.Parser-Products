...
about:
    enable: true
    title: "FB2 ファイルからバーコードを抽出する方法 Java API?"
    content: |
...
steps:
    enable: true
    title_left: "Java の FB2 からバーコードを抽出します"
    content_left: |
        [GroupDocs.Parser for Java](/ja/parser/java/) を使用すると、Java 開発者は、いくつかの簡単な手順を実装することで、FB2 ファイルからバーコードを簡単に抽出できます。
    ...
    code: |
     ...
     {{< parser/code-parser title="Java サンプルコードを使用して FB2 ファイルからバーコードを抽出する方法">}}
...
demos:
    enable: true
    title: "ライブ デモ - オンライン FB2 からバーコードを抽出"
    content: |
       [GroupDocs.Parser ライブ デモ](https://products.groupdocs.app/parser/barcodes/fb2) Web サイトにアクセスして、今すぐ FB2 ファイルからバーコードを抽出してください。
