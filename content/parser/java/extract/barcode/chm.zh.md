...
draft: false
path: "zh/parser/java/extract/barcode/chm/"
...
steps:
    enable: true
    block:
    - title_left: "如何通过 Java 从 CHM 文档中提取条形码"
      content_left: |
       GroupDocs.Parser Java API 使程序员能够轻松地从 CHM 文档中提取条形码。 以下 Java 代码示例演示了如何以最少的工作量和成本提取 CHM 文档中的条形码图像。 
    ...
    - title_left: "通过 Java 从 CHM 文档页面获取条形码"
      content_left: |
       GroupDocs.Parser Java 使软件开发人员能够轻松地从 CHM 文档的页面解析和获取条形码。 以下 Java 代码显示了如何从 CHM 文档中的特定文档页面中提取条形码。 
    ...
    - title_left: "如何从 CHM 文档页面区域提取条形码"
      content_left: |
       GroupDocs.Parser Java API 完全支持轻松地从 CHM 文档中提取条形码。 以下 Java 代码示例显示如何从 CHM 文档页面区域执行条形码提取。
