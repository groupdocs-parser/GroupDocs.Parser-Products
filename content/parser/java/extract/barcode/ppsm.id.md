...
about:
    enable: true
    title: "Bagaimana cara Mengekstrak Kode Batang dari PPSM file Java API?"
    content: |
...
steps:
    enable: true
    title_left: "Ekstrak kode batang dari PPSM di Java"
    content_left: |
        [GroupDocs.Parser for Java](/id/parser/java/) memudahkan pengembang Java untuk mengekstrak kode batang dari file PPSM dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< parser/code-parser title="Cara mengekstrak kode batang dari file PPSM menggunakan kode contoh Java">}}
...
demos:
    enable: true
    title: "Demo Langsung - Ekstrak kode batang dari PPSM Online"
    content: |
       Ekstrak kode batang dari file PPSM sekarang juga dengan mengunjungi situs web [GroupDocs.Parser Demo Langsung](https://products.groupdocs.app/parser/barcodes/ppsm).
