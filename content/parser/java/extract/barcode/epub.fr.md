...
about:
    enable: true
    title: "Comment extraire les codes-barres de l'API EPUB fichiers Java ?"
    content: |
...
steps:
    enable: true
    title_left: "Extraire les codes-barres de EPUB dans Java"
    content_left: |
        [GroupDocs.Parser for Java](/fr/parser/java/) permet aux développeurs Java d'extraire facilement les codes-barres d'un fichier EPUB en mettant en œuvre quelques étapes simples.
    ...
    code: |
     ...
     {{< parser/code-parser title="Comment extraire les codes-barres du fichier EPUB à l'aide de l'exemple de code Java">}}

        ```java    
        // Extraire les codes-barres du fichier EPUB à l'aide de l'API GroupDocs.Parser
...
demos:
    enable: true
    title: "Démos en direct - Extrayez les codes-barres de EPUB en ligne"
    content: |
       Extrayez les codes-barres du fichier EPUB dès maintenant en visitant le site Web [GroupDocs.Parser Live Demos](https://products.groupdocs.app/parser/barcodes/epub).
