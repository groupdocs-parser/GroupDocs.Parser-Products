...
about:
    enable: true
    title: "Wie extrahiere ich Barcodes aus PPTX-Dateien mit der Java-API?"
    content: |
...
steps:
    enable: true
    title_left: "Barcodes aus PPTX in Java extrahieren"
    content_left: |
        [GroupDocs.Parser for Java](/de/parser/java/) erleichtert Java-Entwicklern das Extrahieren von Barcodes aus einer PPTX-Datei durch die Implementierung einiger einfacher Schritte.
    ...
    code: |
     ...
     {{< parser/code-parser title="So extrahieren Sie Barcodes aus der Datei PPTX mithilfe des Beispielcodes Java">}}
...
demos:
    enable: true
    title: "Live-Demos – Barcodes aus PPTX online extrahieren"
    content: |
       Extrahieren Sie jetzt Barcodes aus der Datei PPTX, indem Sie die Website [GroupDocs.Parser Live Demos](https://products.groupdocs.app/parser/barcodes/pptx) besuchen.
