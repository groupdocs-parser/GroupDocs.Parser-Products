...
about:
    enable: true
    title: "How to Extract Barcodes from ODS files Java API?"
    content: |
...
steps:
    enable: true
    title_left: "Extract barcodes from ODS in Java"
    content_left: |
        [GroupDocs.Parser for Java](/parser/java/) makes it easy for Java developers to extract barcodes from a ODS file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< parser/code-parser title="How to extract barcodes from ODS file using Java example code">}}

        ```java    
        // Extract barcodes from ODS file using GroupDocs.Parser API
...
demos:
    enable: true
    title: "Live Demos - Extract barcodes from ODS Online"
    content: |
       Extract barcodes from ODS file right now by visiting [GroupDocs.Parser Live Demos](https://products.groupdocs.app/parser/barcodes/ods) website.
