...
about:
    enable: true
    title: "XLSX ファイルからバーコードを抽出する方法 Java API?"
    content: |
...
steps:
    enable: true
    title_left: "Java の XLSX からバーコードを抽出します"
    content_left: |
        [GroupDocs.Parser for Java](/ja/parser/java/) を使用すると、Java 開発者は、いくつかの簡単な手順を実装することで、XLSX ファイルからバーコードを簡単に抽出できます。
    ...
    code: |
     ...
     {{< parser/code-parser title="Java サンプルコードを使用して XLSX ファイルからバーコードを抽出する方法">}}
...
demos:
    enable: true
    title: "ライブ デモ - オンライン XLSX からバーコードを抽出"
    content: |
       [GroupDocs.Parser ライブ デモ](https://products.groupdocs.app/parser/barcodes/xlsx) Web サイトにアクセスして、今すぐ XLSX ファイルからバーコードを抽出してください。
