...
steps:
    enable: true
    block:
    - title_left: "Cómo extraer hipervínculos de documentos XLA"
      content_left: |
       GroupDocs.Parser Java ha incluido la funcionalidad para extraer hipervínculos de documentos XLA. El siguiente ejemplo de código Java muestra cómo se pueden extraer los hipervínculos del documento XLA. 
    ...
    - title_left: "Cómo extraer hipervínculos de la página de documentos XLA"
      content_left: |
       GroupDocs.Parser .NET permite a los desarrolladores de software extraer hipervínculos de documentos XLA con un par de líneas de código. El siguiente código C# .NET muestra la extracción de hipervínculos dentro de un documento XLA.
    ...
    - title_left: "Extraer hipervínculos del área de la página de documentos XLA"
      content_left: |
       GroupDocs.Parser Java API ha brindado soporte completo para extraer hipervínculos de la página del documento XLA con facilidad. El siguiente código Java muestra cómo los programadores pueden extraer hipervínculos de un área de página de documento XLA dentro de sus propias aplicaciones Java.
