...
steps:
    enable: true
    block:
    - title_left: "Cara Mengekstrak Hyperlink dari Dokumen OTS"
      content_left: |
       GroupDocs.Parser Java telah menyertakan fungsionalitas untuk mengekstraksi Hyperlink dari dokumen OTS. Contoh kode Java berikut menunjukkan bagaimana hyperlink dapat diekstraksi dari dokumen OTS. 
    ...
    - title_left: "Cara Mengekstrak Hyperlink dari Halaman Dokumen OTS"
      content_left: |
       GroupDocs.Parser .NET memungkinkan pengembang perangkat lunak untuk mengekstrak hyperlink dari dokumen OTS dengan beberapa baris kode. Kode C# .NET di bawah ini menunjukkan ekstraksi hyperlink di dalam dokumen OTS. 
    ...
    - title_left: "Ekstrak Hyperlink dari OTS Area Halaman Dokumen"
      content_left: |
       GroupDocs.Parser Java API telah memberikan dukungan lengkap untuk mengekstrak hyperlink dari halaman dokumen OTS dengan mudah. Kode Java berikut menunjukkan bagaimana programmer dapat mengekstrak hyperlink dari area halaman dokumen OTS di dalam aplikasi Java mereka sendiri.
