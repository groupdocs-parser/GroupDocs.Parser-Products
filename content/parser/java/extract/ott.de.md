...
draft: false
path: "de/parser/java/extract/ott/"
...
steps:
    enable: true
    block:
    - title_left: "So extrahieren Sie Hyperlinks aus OTT-Dokumenten"
      content_left: |
       GroupDocs.Parser Java enthält Funktionen zum Extrahieren von Hyperlinks aus OTT-Dokumenten. Das folgende Java-Codebeispiel zeigt, wie Hyperlinks aus dem OTT-Dokument extrahiert werden können.
    ...
    - title_left: "So extrahieren Sie Hyperlinks von der OTT-Dokumentenseite"
      content_left: |
       GroupDocs.Parser .NET ermöglicht es Softwareentwicklern, mit ein paar Codezeilen Hyperlinks aus OTT-Dokumenten zu extrahieren. Der folgende C# .NET-Code zeigt die Extraktion von Hyperlinks innerhalb eines OTT-Dokuments. 
    ...
    - title_left: "Extrahieren Sie Hyperlinks aus dem Seitenbereich für OTT-Dokumente"
      content_left: |
       Die GroupDocs.Parser-Java-API bietet vollständige Unterstützung zum einfachen Extrahieren von Hyperlinks aus der Seite des OTT-Dokuments. Der folgende Java-Code zeigt, wie Programmierer Hyperlinks aus einem OTT-Dokumentseitenbereich in ihren eigenen Java-Anwendungen extrahieren können.
