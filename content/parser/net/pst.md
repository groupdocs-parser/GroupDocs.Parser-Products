...
steps:
    enable: true
    block:
    - title_left: "Extract Hyperlinks from PST Documents via .NET"
      content_left: |
       GroupDocs.Parser .NET provides complete support for extracting Hyperlinks from PST documents. The following C# .NET code example demonstrates how to extract hyperlinks inside a PST document. 
    ...
    - title_left: "Extract Hyperlinks from PST Documents Page"
      content_left: |
    ...
    - title_left: "Extract Hyperlinks from PST Documents Page Area"
      content_left: |
       GroupDocs.Parser .NET API fully supports extraction of hyperlinks from PST documents with ease. The following .NET code example demonstrates how to extract hyperlinks from a PST document page area.
