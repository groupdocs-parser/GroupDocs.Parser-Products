...
steps:
    enable: true
    block:
    - title_left: "Ekstrak Hyperlink dari CSV Dokumen melalui .NET"
      content_left: |
       GroupDocs.Parser .NET menyediakan dukungan lengkap untuk mengekstraksi Hyperlink dari dokumen CSV. Contoh kode C# .NET berikut menunjukkan cara mengekstrak hyperlink di dalam dokumen CSV. 
    ...
    - title_left: "Ekstrak Hyperlink dari Halaman Dokumen CSV"
      content_left: |
    ...
    - title_left: "Ekstrak Hyperlink dari CSV Area Halaman Dokumen"
      content_left: |
       GroupDocs.Parser .NET API sepenuhnya mendukung ekstraksi hyperlink dari dokumen CSV dengan mudah. Contoh kode .NET berikut menunjukkan cara mengekstrak hyperlink dari area halaman dokumen CSV.
