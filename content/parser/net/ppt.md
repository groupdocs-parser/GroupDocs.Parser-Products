...
steps:
    enable: true
    block:
    - title_left: "Extract Hyperlinks from PPT Documents via .NET"
      content_left: |
       GroupDocs.Parser .NET provides complete support for extracting Hyperlinks from PPT documents. The following C# .NET code example demonstrates how to extract hyperlinks inside a PPT document. 
    ...
    - title_left: "Extract Hyperlinks from PPT Documents Page"
      content_left: |
    ...
    - title_left: "Extract Hyperlinks from PPT Documents Page Area"
      content_left: |
       GroupDocs.Parser .NET API fully supports extraction of hyperlinks from PPT documents with ease. The following .NET code example demonstrates how to extract hyperlinks from a PPT document page area.
