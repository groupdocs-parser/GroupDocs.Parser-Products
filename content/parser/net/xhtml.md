...
steps:
    enable: true
    block:
    - title_left: "Extract Hyperlinks from XHTML Documents via .NET"
      content_left: |
       GroupDocs.Parser .NET provides complete support for extracting Hyperlinks from XHTML documents. The following C# .NET code example demonstrates how to extract hyperlinks inside a XHTML document. 
    ...
    - title_left: "Extract Hyperlinks from XHTML Documents Page"
      content_left: |
    ...
    - title_left: "Extract Hyperlinks from XHTML Documents Page Area"
      content_left: |
       GroupDocs.Parser .NET API fully supports extraction of hyperlinks from XHTML documents with ease. The following .NET code example demonstrates how to extract hyperlinks from a XHTML document page area.
