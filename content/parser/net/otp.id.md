...
steps:
    enable: true
    block:
    - title_left: "Ekstrak Hyperlink dari OTP Dokumen melalui .NET"
      content_left: |
       GroupDocs.Parser .NET menyediakan dukungan lengkap untuk mengekstraksi Hyperlink dari dokumen OTP. Contoh kode C# .NET berikut menunjukkan cara mengekstrak hyperlink di dalam dokumen OTP. 
    ...
    - title_left: "Ekstrak Hyperlink dari Halaman Dokumen OTP"
      content_left: |
    ...
    - title_left: "Ekstrak Hyperlink dari OTP Area Halaman Dokumen"
      content_left: |
       GroupDocs.Parser .NET API sepenuhnya mendukung ekstraksi hyperlink dari dokumen OTP dengan mudah. Contoh kode .NET berikut menunjukkan cara mengekstrak hyperlink dari area halaman dokumen OTP.
