...
############################# Head ############################
head_title: "Mengurai data dari file PPTX dalam aplikasi C#"
head_description: "Gunakan GroupDocs.Parser untuk mengekstrak teks, gambar, tabel, dan data lainnya dari file PPTX dalam C# tanpa bergantung pada alat pihak ketiga."

############################# Header ############################
title: "Mengurai dokumen PPTX menggunakan C#" 
...
steps:
    enable: true
    title: "Langkah-langkah untuk mengekstrak data dari Pptx dalam C#"
    content: |
      Ikuti langkah-langkah ini untuk mengurai konten dari dokumen PPTX dalam aplikasi .NET Anda menggunakan [GroupDocs.Parser](/parser/net/):
      
      1. Muat dokumen PPTX menggunakan instance Parser.
