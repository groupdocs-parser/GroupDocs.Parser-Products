...
############################# Head ############################
head_title: "Parse data from XLSX files in C# apps"
head_description: "Use GroupDocs.Parser to extract text, images, tables, and other data from XLSX files in C# without relying on third-party tools."

############################# Header ############################
title: "Parse XLSX documents using C#" 
...
steps:
    enable: true
    title: "Steps to extract data from Xlsx in C#"
    content: |
      Follow these steps to parse content from XLSX documents in your .NET apps using [GroupDocs.Parser](/parser/net/):
      
      1. Load the XLSX document using a Parser instance.
