...
############################# Head ############################
head_title: "Parsing Data dari ODP di C#"
head_description: "Mengurai data dengan cepat dari dokumen di C#."

############################# Header ############################
title: "Mengurai data dari ODP Di C#"
description: "Parsing data dari ODP dengan beberapa baris kode .NET."
...
demos:
    enable: true
    title: "Demo Langsung - Mengurai data dari ODP Online"
    content: |
       Parse data dari ODP file sekarang juga dengan mengunjungi situs web [GroupDocs.Parser Demo Langsung](https://products.groupdocs.app/parser/odp).
