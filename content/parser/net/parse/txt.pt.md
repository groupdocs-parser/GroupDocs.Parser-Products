...
############################# Head ############################
head_title: "Extraia dados de arquivos TXT em aplicativos C#"
head_description: "Use GroupDocs.Parser para extrair texto, imagens, tabelas e outros dados de arquivos TXT em C# sem depender de ferramentas de terceiros."

############################# Header ############################
title: "Analise documentos TXT usando C#" 
...
steps:
    enable: true
    title: "Passos para extrair dados de Txt em C#"
    content: |
      Siga estas etapas para analisar o conteúdo de documentos TXT em seus aplicativos .NET usando [GroupDocs.Parser](/parser/net/):
      
      1. Carregue o documento TXT usando uma instância de Parser.
