...
############################# Head ############################
head_title: "Extraia dados de arquivos DOCX em aplicativos C#"
head_description: "Use GroupDocs.Parser para extrair texto, imagens, tabelas e outros dados de arquivos DOCX em C# sem depender de ferramentas de terceiros."

############################# Header ############################
title: "Analise documentos DOCX usando C#" 
...
steps:
    enable: true
    title: "Passos para extrair dados de Docx em C#"
    content: |
      Siga estas etapas para analisar o conteúdo de documentos DOCX em seus aplicativos .NET usando [GroupDocs.Parser](/parser/net/):
      
      1. Carregue o documento DOCX usando uma instância de Parser.
