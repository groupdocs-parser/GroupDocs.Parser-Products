...
############################# Head ############################
head_title: "Parse data from PDF files in C# apps"
head_description: "Use GroupDocs.Parser to extract text, images, tables, and other data from PDF files in C# without relying on third-party tools."

############################# Header ############################
title: "Parse PDF documents using C#" 
...
steps:
    enable: true
    title: "Steps to extract data from Pdf in C#"
    content: |
      Follow these steps to parse content from PDF documents in your .NET apps using [GroupDocs.Parser](/parser/net/):
      
      1. Load the PDF document using a Parser instance.
