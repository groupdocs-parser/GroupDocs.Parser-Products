...
############################# Head ############################
head_title: "Estrai dati da file PDF nelle app C#"
head_description: "Utilizza GroupDocs.Parser per estrarre testo, immagini, tabelle e altri dati da file PDF in C# senza fare affidamento su strumenti di terze parti."

############################# Header ############################
title: "Estrai documenti PDF utilizzando C#" 
...
steps:
    enable: true
    title: "Passaggi per estrarre dati da Pdf in C#"
    content: |
      Segui questi passaggi per analizzare il contenuto dei documenti PDF nelle tue app .NET utilizzando [GroupDocs.Parser](/parser/net/):
      
      1. Carica il documento PDF utilizzando un'istanza di Parser.
