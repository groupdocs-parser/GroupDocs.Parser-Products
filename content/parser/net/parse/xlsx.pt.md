...
############################# Head ############################
head_title: "Extraia dados de arquivos XLSX em aplicativos C#"
head_description: "Use GroupDocs.Parser para extrair texto, imagens, tabelas e outros dados de arquivos XLSX em C# sem depender de ferramentas de terceiros."

############################# Header ############################
title: "Analise documentos XLSX usando C#" 
...
steps:
    enable: true
    title: "Passos para extrair dados de Xlsx em C#"
    content: |
      Siga estas etapas para analisar o conteúdo de documentos XLSX em seus aplicativos .NET usando [GroupDocs.Parser](/parser/net/):
      
      1. Carregue o documento XLSX usando uma instância de Parser.
