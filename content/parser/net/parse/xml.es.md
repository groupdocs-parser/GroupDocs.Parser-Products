...
############################# Head ############################
head_title: "Analizar datos de archivos XML en aplicaciones C#"
head_description: "Utiliza GroupDocs.Parser para extraer texto, imágenes, tablas y otros datos de archivos XML en C# sin depender de herramientas de terceros."

############################# Header ############################
title: "Analiza documentos XML con C#" 
...
steps:
    enable: true
    title: "Pasos para extraer datos de Xml en C#"
    content: |
      Sigue estos pasos para analizar contenido de documentos XML en tus aplicaciones .NET utilizando [GroupDocs.Parser](/parser/net/):
      
      1. Carga el documento XML utilizando una instancia de Parser.
