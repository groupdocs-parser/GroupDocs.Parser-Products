...
############################# Head ############################
head_title: "Analizar datos de archivos RTF en aplicaciones C#"
head_description: "Utiliza GroupDocs.Parser para extraer texto, imágenes, tablas y otros datos de archivos RTF en C# sin depender de herramientas de terceros."

############################# Header ############################
title: "Analiza documentos RTF con C#" 
...
steps:
    enable: true
    title: "Pasos para extraer datos de Rtf en C#"
    content: |
      Sigue estos pasos para analizar contenido de documentos RTF en tus aplicaciones .NET utilizando [GroupDocs.Parser](/parser/net/):
      
      1. Carga el documento RTF utilizando una instancia de Parser.
