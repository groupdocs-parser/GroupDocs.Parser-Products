...
############################# Head ############################
head_title: "Daten von DOCM in C# analysieren"
head_description: "Analysieren Sie schnell Daten aus Dokumenten in C#."

############################# Header ############################
title: "Daten von DOCM in C# analysieren"
description: "Analysieren Sie Daten aus DOCM mit ein paar Zeilen .NET-Code."
...
demos:
    enable: true
    title: "Live-Demos – Analysieren Sie Daten von DOCM Online"
    content: |
       Analysieren Sie jetzt Daten aus der Datei DOCM, indem Sie die Website [GroupDocs.Parser Live Demos](https://products.groupdocs.app/parser/docm) besuchen.
