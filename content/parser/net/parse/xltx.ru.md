...
############################# Head ############################
head_title: "Разобрать данные из XLTX в C#"
head_description: "Быстро сканируйте штрих-коды из файла XLTX в C#. Сохраните новый документ, содержащий выбранные страницы, с помощью API слияния документов."

############################# Header ############################
title: "Разобрать данные из XLTX в C#"
description: "Проанализируйте данные из XLTX с помощью нескольких строк кода .NET."
