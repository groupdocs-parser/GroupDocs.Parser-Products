...
############################# Head ############################
head_title: "Parse data from XML files in C# apps"
head_description: "Use GroupDocs.Parser to extract text, images, tables, and other data from XML files in C# without relying on third-party tools."

############################# Header ############################
title: "Parse XML documents using C#" 
...
steps:
    enable: true
    title: "Steps to extract data from Xml in C#"
    content: |
      Follow these steps to parse content from XML documents in your .NET apps using [GroupDocs.Parser](/parser/net/):
      
      1. Load the XML document using a Parser instance.
