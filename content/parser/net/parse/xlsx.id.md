...
############################# Head ############################
head_title: "Mengurai data dari file XLSX dalam aplikasi C#"
head_description: "Gunakan GroupDocs.Parser untuk mengekstrak teks, gambar, tabel, dan data lainnya dari file XLSX dalam C# tanpa bergantung pada alat pihak ketiga."

############################# Header ############################
title: "Mengurai dokumen XLSX menggunakan C#" 
...
steps:
    enable: true
    title: "Langkah-langkah untuk mengekstrak data dari Xlsx dalam C#"
    content: |
      Ikuti langkah-langkah ini untuk mengurai konten dari dokumen XLSX dalam aplikasi .NET Anda menggunakan [GroupDocs.Parser](/parser/net/):
      
      1. Muat dokumen XLSX menggunakan instance Parser.
