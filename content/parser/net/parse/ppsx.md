...
############################# Head ############################
head_title: "Parse Data from PPSX in C#"
head_description: "Quickly parse data from documents in C#."

############################# Header ############################
title: "Parse data from PPSX In C#"
description: "Parse data from PPSX with a few lines of .NET code."
...
demos:
    enable: true
    title: "Live Demos - Parse data from PPSX Online"
    content: |
       Parse data from PPSX file right now by visiting [GroupDocs.Parser Live Demos](https://products.groupdocs.app/parser/ppsx) website.
