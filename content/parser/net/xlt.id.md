...
steps:
    enable: true
    block:
    - title_left: "Ekstrak Hyperlink dari XLT Dokumen melalui .NET"
      content_left: |
       GroupDocs.Parser .NET menyediakan dukungan lengkap untuk mengekstraksi Hyperlink dari dokumen XLT. Contoh kode C# .NET berikut menunjukkan cara mengekstrak hyperlink di dalam dokumen XLT. 
    ...
    - title_left: "Ekstrak Hyperlink dari Halaman Dokumen XLT"
      content_left: |
    ...
    - title_left: "Ekstrak Hyperlink dari XLT Area Halaman Dokumen"
      content_left: |
       GroupDocs.Parser .NET API sepenuhnya mendukung ekstraksi hyperlink dari dokumen XLT dengan mudah. Contoh kode .NET berikut menunjukkan cara mengekstrak hyperlink dari area halaman dokumen XLT.
