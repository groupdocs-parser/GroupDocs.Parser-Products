...
steps:
    enable: true
    block:
    - title_left: "Ekstrak Hyperlink dari PPSM Dokumen melalui .NET"
      content_left: |
       GroupDocs.Parser .NET menyediakan dukungan lengkap untuk mengekstraksi Hyperlink dari dokumen PPSM. Contoh kode C# .NET berikut menunjukkan cara mengekstrak hyperlink di dalam dokumen PPSM. 
    ...
    - title_left: "Ekstrak Hyperlink dari Halaman Dokumen PPSM"
      content_left: |
    ...
    - title_left: "Ekstrak Hyperlink dari PPSM Area Halaman Dokumen"
      content_left: |
       GroupDocs.Parser .NET API sepenuhnya mendukung ekstraksi hyperlink dari dokumen PPSM dengan mudah. Contoh kode .NET berikut menunjukkan cara mengekstrak hyperlink dari area halaman dokumen PPSM.
