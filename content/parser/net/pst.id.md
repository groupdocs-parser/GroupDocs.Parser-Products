...
steps:
    enable: true
    block:
    - title_left: "Ekstrak Hyperlink dari PST Dokumen melalui .NET"
      content_left: |
       GroupDocs.Parser .NET menyediakan dukungan lengkap untuk mengekstraksi Hyperlink dari dokumen PST. Contoh kode C# .NET berikut menunjukkan cara mengekstrak hyperlink di dalam dokumen PST. 
    ...
    - title_left: "Ekstrak Hyperlink dari Halaman Dokumen PST"
      content_left: |
    ...
    - title_left: "Ekstrak Hyperlink dari PST Area Halaman Dokumen"
      content_left: |
       GroupDocs.Parser .NET API sepenuhnya mendukung ekstraksi hyperlink dari dokumen PST dengan mudah. Contoh kode .NET berikut menunjukkan cara mengekstrak hyperlink dari area halaman dokumen PST.
