...
about:
    enable: true
    title: "How to Parse & Extract Hyperlinks from XLSM documents via .NET API?"
    content: |
...
steps:
    enable: true
    title_left: "Extract hyperlinks from XLSM in .NET"
    content_left: |
        [GroupDocs.Parser for .NET](/parser/net/) makes it easy for C# developers to extract hyperlinks from a XLSM file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< parser/code-parser title="How to extract hyperlinks from XLSM file using C# example code">}}
