...
steps:
    enable: true
    block:
    - title_left: "Ekstrak Hyperlink dari MD Dokumen melalui .NET"
      content_left: |
       GroupDocs.Parser .NET menyediakan dukungan lengkap untuk mengekstraksi Hyperlink dari dokumen MD. Contoh kode C# .NET berikut menunjukkan cara mengekstrak hyperlink di dalam dokumen MD. 
    ...
    - title_left: "Ekstrak Hyperlink dari Halaman Dokumen MD"
      content_left: |
    ...
    - title_left: "Ekstrak Hyperlink dari MD Area Halaman Dokumen"
      content_left: |
       GroupDocs.Parser .NET API sepenuhnya mendukung ekstraksi hyperlink dari dokumen MD dengan mudah. Contoh kode .NET berikut menunjukkan cara mengekstrak hyperlink dari area halaman dokumen MD.
