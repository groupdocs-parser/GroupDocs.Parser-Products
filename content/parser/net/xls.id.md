...
steps:
    enable: true
    block:
    - title_left: "Ekstrak Hyperlink dari XLS Dokumen melalui .NET"
      content_left: |
       GroupDocs.Parser .NET menyediakan dukungan lengkap untuk mengekstraksi Hyperlink dari dokumen XLS. Contoh kode C# .NET berikut menunjukkan cara mengekstrak hyperlink di dalam dokumen XLS. 
    ...
    - title_left: "Ekstrak Hyperlink dari Halaman Dokumen XLS"
      content_left: |
    ...
    - title_left: "Ekstrak Hyperlink dari XLS Area Halaman Dokumen"
      content_left: |
       GroupDocs.Parser .NET API sepenuhnya mendukung ekstraksi hyperlink dari dokumen XLS dengan mudah. Contoh kode .NET berikut menunjukkan cara mengekstrak hyperlink dari area halaman dokumen XLS.
