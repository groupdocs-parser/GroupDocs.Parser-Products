...
steps:
    enable: true
    block:
    - title_left: "Extract Hyperlinks from FB2 Documents via .NET"
      content_left: |
       GroupDocs.Parser .NET provides complete support for extracting Hyperlinks from FB2 documents. The following C# .NET code example demonstrates how to extract hyperlinks inside a FB2 document. 
    ...
    - title_left: "Extract Hyperlinks from FB2 Documents Page"
      content_left: |
    ...
    - title_left: "Extract Hyperlinks from FB2 Documents Page Area"
      content_left: |
       GroupDocs.Parser .NET API fully supports extraction of hyperlinks from FB2 documents with ease. The following .NET code example demonstrates how to extract hyperlinks from a FB2 document page area.
