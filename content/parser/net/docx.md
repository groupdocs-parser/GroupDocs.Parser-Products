...
steps:
    enable: true
    block:
    - title_left: "Extract Hyperlinks from DOCX Documents via .NET"
      content_left: |
       GroupDocs.Parser .NET provides complete support for extracting Hyperlinks from DOCX documents. The following C# .NET code example demonstrates how to extract hyperlinks inside a DOCX document. 
    ...
    - title_left: "Extract Hyperlinks from DOCX Documents Page"
      content_left: |
    ...
    - title_left: "Extract Hyperlinks from DOCX Documents Page Area"
      content_left: |
       GroupDocs.Parser .NET API fully supports extraction of hyperlinks from DOCX documents with ease. The following .NET code example demonstrates how to extract hyperlinks from a DOCX document page area.
