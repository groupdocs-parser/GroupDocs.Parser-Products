...
steps:
    enable: true
    block:
    - title_left: "Ekstrak Hyperlink dari XLSB Dokumen melalui .NET"
      content_left: |
       GroupDocs.Parser .NET menyediakan dukungan lengkap untuk mengekstraksi Hyperlink dari dokumen XLSB. Contoh kode C# .NET berikut menunjukkan cara mengekstrak hyperlink di dalam dokumen XLSB. 
    ...
    - title_left: "Ekstrak Hyperlink dari Halaman Dokumen XLSB"
      content_left: |
    ...
    - title_left: "Ekstrak Hyperlink dari XLSB Area Halaman Dokumen"
      content_left: |
       GroupDocs.Parser .NET API sepenuhnya mendukung ekstraksi hyperlink dari dokumen XLSB dengan mudah. Contoh kode .NET berikut menunjukkan cara mengekstrak hyperlink dari area halaman dokumen XLSB.
