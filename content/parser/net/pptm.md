...
steps:
    enable: true
    block:
    - title_left: "Extract Hyperlinks from PPTM Documents via .NET"
      content_left: |
       GroupDocs.Parser .NET provides complete support for extracting Hyperlinks from PPTM documents. The following C# .NET code example demonstrates how to extract hyperlinks inside a PPTM document. 
    ...
    - title_left: "Extract Hyperlinks from PPTM Documents Page"
      content_left: |
    ...
    - title_left: "Extract Hyperlinks from PPTM Documents Page Area"
      content_left: |
       GroupDocs.Parser .NET API fully supports extraction of hyperlinks from PPTM documents with ease. The following .NET code example demonstrates how to extract hyperlinks from a PPTM document page area.
