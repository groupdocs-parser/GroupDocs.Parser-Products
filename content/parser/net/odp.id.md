...
steps:
    enable: true
    block:
    - title_left: "Ekstrak Hyperlink dari ODP Dokumen melalui .NET"
      content_left: |
       GroupDocs.Parser .NET menyediakan dukungan lengkap untuk mengekstraksi Hyperlink dari dokumen ODP. Contoh kode C# .NET berikut menunjukkan cara mengekstrak hyperlink di dalam dokumen ODP. 
    ...
    - title_left: "Ekstrak Hyperlink dari Halaman Dokumen ODP"
      content_left: |
    ...
    - title_left: "Ekstrak Hyperlink dari ODP Area Halaman Dokumen"
      content_left: |
       GroupDocs.Parser .NET API sepenuhnya mendukung ekstraksi hyperlink dari dokumen ODP dengan mudah. Contoh kode .NET berikut menunjukkan cara mengekstrak hyperlink dari area halaman dokumen ODP.
