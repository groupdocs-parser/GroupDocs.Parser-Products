...
############################# Head ############################
head_title: "Extraer imágenes de archivos DOCX en aplicaciones C#"
head_description: "Utiliza GroupDocs.Parser para detectar y extraer imágenes de archivos DOCX en C# sin herramientas adicionales."

############################# Header ############################
title: "Extrae imágenes de DOCX usando C#" 
...
steps:
    enable: true
    title: "Pasos para extraer imágenes de Docx en C#"
    content: |
      Con [GroupDocs.Parser](/parser/net/), puedes extraer imágenes de documentos DOCX en tus proyectos .NET en solo unos pocos pasos:
      
      1. Inicializa el Parser con el archivo DOCX.
