...
############################# Head ############################
head_title: "Extraia imagens de arquivos ODP em apps C#"
head_description: "Use GroupDocs.Parser para detectar e extrair imagens de arquivos ODP em C# sem ferramentas adicionais."

############################# Header ############################
title: "Extraia imagens de ODP usando C#" 
...
steps:
    enable: true
    title: "Etapas para extrair imagens de Odp em C#"
    content: |
      Com [GroupDocs.Parser](/parser/net/), você pode extrair imagens de documentos ODP em seus projetos .NET em apenas algumas etapas:
