...
############################# Head ############################
head_title: "Ekstrak gambar dari file PDF dalam aplikasi C#"
head_description: "Gunakan GroupDocs.Parser untuk mendeteksi dan mengekstrak gambar dari file PDF dalam C# tanpa alat tambahan."

############################# Header ############################
title: "Ekstrak gambar dari PDF menggunakan C#" 
...
steps:
    enable: true
    title: "Langkah-langkah untuk mengekstrak gambar dari Pdf di C#"
    content: |
      Dengan [GroupDocs.Parser](/parser/net/), Anda dapat mengekstrak gambar dari dokumen PDF dalam proyek .NET Anda hanya dalam beberapa langkah:
      
      1. Inisialisasi Parser dengan file PDF.
