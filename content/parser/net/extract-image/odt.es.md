...
############################# Head ############################
head_title: "Extraer imágenes de archivos ODT en aplicaciones C#"
head_description: "Utiliza GroupDocs.Parser para detectar y extraer imágenes de archivos ODT en C# sin herramientas adicionales."

############################# Header ############################
title: "Extrae imágenes de ODT usando C#" 
...
steps:
    enable: true
    title: "Pasos para extraer imágenes de Odt en C#"
    content: |
      Con [GroupDocs.Parser](/parser/net/), puedes extraer imágenes de documentos ODT en tus proyectos .NET en solo unos pocos pasos:
      
      1. Inicializa el Parser con el archivo ODT.
