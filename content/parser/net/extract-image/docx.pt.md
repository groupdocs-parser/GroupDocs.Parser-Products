...
############################# Head ############################
head_title: "Extraia imagens de arquivos DOCX em apps C#"
head_description: "Use GroupDocs.Parser para detectar e extrair imagens de arquivos DOCX em C# sem ferramentas adicionais."

############################# Header ############################
title: "Extraia imagens de DOCX usando C#" 
...
steps:
    enable: true
    title: "Etapas para extrair imagens de Docx em C#"
    content: |
      Com [GroupDocs.Parser](/parser/net/), você pode extrair imagens de documentos DOCX em seus projetos .NET em apenas algumas etapas:
      
      1. Inicialize o Parser com o arquivo DOCX.
