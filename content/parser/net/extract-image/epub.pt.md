...
############################# Head ############################
head_title: "Extraia imagens de arquivos EPUB em apps C#"
head_description: "Use GroupDocs.Parser para detectar e extrair imagens de arquivos EPUB em C# sem ferramentas adicionais."

############################# Header ############################
title: "Extraia imagens de EPUB usando C#" 
...
steps:
    enable: true
    title: "Etapas para extrair imagens de Epub em C#"
    content: |
      Com [GroupDocs.Parser](/parser/net/), você pode extrair imagens de documentos EPUB em seus projetos .NET em apenas algumas etapas:
      
      1. Inicialize o Parser com o arquivo EPUB.
