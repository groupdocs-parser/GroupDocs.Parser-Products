...
############################# Head ############################
head_title: "Extraer imágenes de archivos ODP en aplicaciones C#"
head_description: "Utiliza GroupDocs.Parser para detectar y extraer imágenes de archivos ODP en C# sin herramientas adicionales."

############################# Header ############################
title: "Extrae imágenes de ODP usando C#" 
...
steps:
    enable: true
    title: "Pasos para extraer imágenes de Odp en C#"
    content: |
      Con [GroupDocs.Parser](/parser/net/), puedes extraer imágenes de documentos ODP en tus proyectos .NET en solo unos pocos pasos:
