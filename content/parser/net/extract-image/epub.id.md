...
############################# Head ############################
head_title: "Ekstrak gambar dari file EPUB dalam aplikasi C#"
head_description: "Gunakan GroupDocs.Parser untuk mendeteksi dan mengekstrak gambar dari file EPUB dalam C# tanpa alat tambahan."

############################# Header ############################
title: "Ekstrak gambar dari EPUB menggunakan C#" 
...
steps:
    enable: true
    title: "Langkah-langkah untuk mengekstrak gambar dari Epub di C#"
    content: |
      Dengan [GroupDocs.Parser](/parser/net/), Anda dapat mengekstrak gambar dari dokumen EPUB dalam proyek .NET Anda hanya dalam beberapa langkah:
      
      1. Inisialisasi Parser dengan file EPUB.
