...
############################# Head ############################
head_title: "Ekstrak gambar dari file FB2 dalam aplikasi C#"
head_description: "Gunakan GroupDocs.Parser untuk mendeteksi dan mengekstrak gambar dari file FB2 dalam C# tanpa alat tambahan."

############################# Header ############################
title: "Ekstrak gambar dari FB2 menggunakan C#" 
...
steps:
    enable: true
    title: "Langkah-langkah untuk mengekstrak gambar dari Fb2 di C#"
    content: |
      Dengan [GroupDocs.Parser](/parser/net/), Anda dapat mengekstrak gambar dari dokumen FB2 dalam proyek .NET Anda hanya dalam beberapa langkah:
      
      1. Inisialisasi Parser dengan file FB2.
