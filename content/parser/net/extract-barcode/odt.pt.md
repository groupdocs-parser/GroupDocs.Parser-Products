...
############################# Head ############################
head_title: "Extraia códigos de barras de arquivos ODT em aplicativos C#"
head_description: "Utilize GroupDocs.Parser para detectar e extrair dados de código de barras de arquivos ODT em C# sem precisar de software adicional."

############################# Header ############################
title: "Extraia códigos de barras de ODT usando C#" 
...
steps:
    enable: true
    title: "Passos para extrair códigos de barras de Odt em C#"
    content: |
      [GroupDocs.Parser](/parser/net/) permite extrair dados de códigos de barras de arquivos ODT em aplicações .NET seguindo estes passos simples:
      
      1. Carregue o arquivo ODT usando uma instância de Parser.
