...
############################# Head ############################
head_title: "Ekstrak kode batang dari file XLSX dalam aplikasi C#"
head_description: "Gunakan GroupDocs.Parser untuk mendeteksi dan mengekstrak data kode batang dari file XLSX dalam C# tanpa perangkat lunak tambahan."

############################# Header ############################
title: "Ekstrak kode batang dari XLSX menggunakan C#" 
...
steps:
    enable: true
    title: "Langkah untuk mengekstrak kode batang dari Xlsx dalam C#"
    content: |
      [GroupDocs.Parser](/parser/net/) memungkinkan Anda mengekstrak data kode batang dari file XLSX dalam aplikasi .NET dengan mengikuti langkah-langkah sederhana berikut:
