...
############################# Head ############################
head_title: "Extraire des codes-barres des fichiers PDF dans les applications C#"
head_description: "Utilisez GroupDocs.Parser pour détecter et extraire les données des codes-barres à partir des fichiers PDF dans C# sans logiciel supplémentaire."

############################# Header ############################
title: "Extraire des codes-barres à partir de PDF en utilisant C#" 
...
steps:
    enable: true
    title: "Étapes pour extraire des codes-barres à partir de Pdf dans C#"
    content: |
      [GroupDocs.Parser](/parser/net/) vous permet d'extraire des données de codes-barres à partir des fichiers PDF dans les applications .NET en suivant ces étapes simples :
      
      1. Chargez le fichier PDF en utilisant une instance de Parser.
