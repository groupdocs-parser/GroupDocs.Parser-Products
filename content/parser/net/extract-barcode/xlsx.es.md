...
############################# Head ############################
head_title: "Extraiga códigos de barras de archivos XLSX en aplicaciones C#"
head_description: "Utilice GroupDocs.Parser para detectar y extraer datos de códigos de barras de archivos XLSX en C# sin software adicional."

############################# Header ############################
title: "Extraiga códigos de barras de XLSX utilizando C#" 
...
steps:
    enable: true
    title: "Pasos para extraer códigos de barras de Xlsx en C#"
    content: |
      [GroupDocs.Parser](/parser/net/) le permite extraer datos de códigos de barras de archivos XLSX en aplicaciones .NET siguiendo estos pasos sencillos:
      
      1. Cargue el archivo XLSX utilizando una instancia de Parser.
