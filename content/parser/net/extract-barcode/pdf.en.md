...
############################# Head ############################
head_title: "Extract barcodes from PDF files in C# apps"
head_description: "Use GroupDocs.Parser to detect and extract barcode data from PDF files in C# without additional software."

############################# Header ############################
title: "Extract barcodes from PDF using C#" 
...
steps:
    enable: true
    title: "Steps to extract barcodes from Pdf in C#"
    content: |
      [GroupDocs.Parser](/parser/net/) lets you easily extract barcode data from PDF files in .NET applications by following these simple steps:
