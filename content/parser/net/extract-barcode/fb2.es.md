...
############################# Head ############################
head_title: "Extraiga códigos de barras de archivos FB2 en aplicaciones C#"
head_description: "Utilice GroupDocs.Parser para detectar y extraer datos de códigos de barras de archivos FB2 en C# sin software adicional."

############################# Header ############################
title: "Extraiga códigos de barras de FB2 utilizando C#" 
...
steps:
    enable: true
    title: "Pasos para extraer códigos de barras de Fb2 en C#"
    content: |
      [GroupDocs.Parser](/parser/net/) le permite extraer datos de códigos de barras de archivos FB2 en aplicaciones .NET siguiendo estos pasos sencillos:
      
      1. Cargue el archivo FB2 utilizando una instancia de Parser.
