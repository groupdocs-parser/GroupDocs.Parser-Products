...
############################# Head ############################
head_title: "Extraia códigos de barras de arquivos FB2 em aplicativos C#"
head_description: "Utilize GroupDocs.Parser para detectar e extrair dados de código de barras de arquivos FB2 em C# sem precisar de software adicional."

############################# Header ############################
title: "Extraia códigos de barras de FB2 usando C#" 
...
steps:
    enable: true
    title: "Passos para extrair códigos de barras de Fb2 em C#"
    content: |
      [GroupDocs.Parser](/parser/net/) permite extrair dados de códigos de barras de arquivos FB2 em aplicações .NET seguindo estes passos simples:
      
      1. Carregue o arquivo FB2 usando uma instância de Parser.
