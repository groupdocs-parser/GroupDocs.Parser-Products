...
############################# Head ############################
head_title: "Estrai codici a barre da file ODT in app C#"
head_description: "Utilizza GroupDocs.Parser per rilevare ed estrarre dati da codici a barre presenti in file ODT in C# senza software aggiuntivo."

############################# Header ############################
title: "Estrai codici a barre da ODT utilizzando C#" 
...
steps:
    enable: true
    title: "Passaggi per estrarre codici a barre da Odt in C#"
    content: |
      [GroupDocs.Parser](/parser/net/) ti consente di estrarre dati da codici a barre da file ODT nelle applicazioni .NET seguendo questi semplici passaggi:
      
      1. Carica il file ODT utilizzando un'istanza di Parser.
