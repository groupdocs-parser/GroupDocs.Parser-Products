...
############################# Head ############################
head_title: "Extraiga códigos de barras de archivos PPTX en aplicaciones C#"
head_description: "Utilice GroupDocs.Parser para detectar y extraer datos de códigos de barras de archivos PPTX en C# sin software adicional."

############################# Header ############################
title: "Extraiga códigos de barras de PPTX utilizando C#" 
...
steps:
    enable: true
    title: "Pasos para extraer códigos de barras de Pptx en C#"
    content: |
      [GroupDocs.Parser](/parser/net/) le permite extraer datos de códigos de barras de archivos PPTX en aplicaciones .NET siguiendo estos pasos sencillos:
      
      1. Cargue el archivo PPTX utilizando una instancia de Parser.
