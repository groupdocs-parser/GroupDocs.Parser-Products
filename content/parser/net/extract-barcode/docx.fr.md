...
############################# Head ############################
head_title: "Extraire des codes-barres des fichiers DOCX dans les applications C#"
head_description: "Utilisez GroupDocs.Parser pour détecter et extraire les données des codes-barres à partir des fichiers DOCX dans C# sans logiciel supplémentaire."

############################# Header ############################
title: "Extraire des codes-barres à partir de DOCX en utilisant C#" 
...
steps:
    enable: true
    title: "Étapes pour extraire des codes-barres à partir de Docx dans C#"
    content: |
      [GroupDocs.Parser](/parser/net/) vous permet d'extraire des données de codes-barres à partir des fichiers DOCX dans les applications .NET en suivant ces étapes simples :
      
      1. Chargez le fichier DOCX en utilisant une instance de Parser.
