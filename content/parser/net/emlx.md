...
steps:
    enable: true
    block:
    - title_left: "Extract Hyperlinks from EMLX Documents via .NET"
      content_left: |
       GroupDocs.Parser .NET provides complete support for extracting Hyperlinks from EMLX documents. The following C# .NET code example demonstrates how to extract hyperlinks inside a EMLX document. 
    ...
    - title_left: "Extract Hyperlinks from EMLX Documents Page"
      content_left: |
    ...
    - title_left: "Extract Hyperlinks from EMLX Documents Page Area"
      content_left: |
       GroupDocs.Parser .NET API fully supports extraction of hyperlinks from EMLX documents with ease. The following .NET code example demonstrates how to extract hyperlinks from a EMLX document page area.
