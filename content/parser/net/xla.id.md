...
steps:
    enable: true
    block:
    - title_left: "Ekstrak Hyperlink dari XLA Dokumen melalui .NET"
      content_left: |
       GroupDocs.Parser .NET menyediakan dukungan lengkap untuk mengekstraksi Hyperlink dari dokumen XLA. Contoh kode C# .NET berikut menunjukkan cara mengekstrak hyperlink di dalam dokumen XLA. 
    ...
    - title_left: "Ekstrak Hyperlink dari Halaman Dokumen XLA"
      content_left: |
    ...
    - title_left: "Ekstrak Hyperlink dari XLA Area Halaman Dokumen"
      content_left: |
       GroupDocs.Parser .NET API sepenuhnya mendukung ekstraksi hyperlink dari dokumen XLA dengan mudah. Contoh kode .NET berikut menunjukkan cara mengekstrak hyperlink dari area halaman dokumen XLA.
