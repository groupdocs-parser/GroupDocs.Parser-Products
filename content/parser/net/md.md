...
steps:
    enable: true
    block:
    - title_left: "Extract Hyperlinks from MD Documents via .NET"
      content_left: |
       GroupDocs.Parser .NET provides complete support for extracting Hyperlinks from MD documents. The following C# .NET code example demonstrates how to extract hyperlinks inside a MD document. 
    ...
    - title_left: "Extract Hyperlinks from MD Documents Page"
      content_left: |
    ...
    - title_left: "Extract Hyperlinks from MD Documents Page Area"
      content_left: |
       GroupDocs.Parser .NET API fully supports extraction of hyperlinks from MD documents with ease. The following .NET code example demonstrates how to extract hyperlinks from a MD document page area.
