...
about:
    enable: true
    title: "¿Cómo analizar y extraer hipervínculos de documentos PPSX a través de la API .NET?"
    content: |
...
steps:
    enable: true
    title_left: "Extraer hipervínculos de PPSX en .NET"
    content_left: |
        [GroupDocs.Parser for .NET](/es/parser/net/) facilita a los desarrolladores de C# extraer hipervínculos de un archivo PPSX mediante la implementación de unos sencillos pasos.
    ...
    code: |
     ...
     {{< parser/code-parser title="Cómo extraer hipervínculos del archivo PPSX usando el código de ejemplo C#">}}
