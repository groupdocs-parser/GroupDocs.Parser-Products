...
steps:
    enable: true
    block:
    - title_left: "Extract Hyperlinks from DOTM Documents via .NET"
      content_left: |
       GroupDocs.Parser .NET provides complete support for extracting Hyperlinks from DOTM documents. The following C# .NET code example demonstrates how to extract hyperlinks inside a DOTM document. 
    ...
    - title_left: "Extract Hyperlinks from DOTM Documents Page"
      content_left: |
    ...
    - title_left: "Extract Hyperlinks from DOTM Documents Page Area"
      content_left: |
       GroupDocs.Parser .NET API fully supports extraction of hyperlinks from DOTM documents with ease. The following .NET code example demonstrates how to extract hyperlinks from a DOTM document page area.
