...
steps:
    enable: true
    block:
    - title_left: "Extract Hyperlinks from PPTX Documents via .NET"
      content_left: |
       GroupDocs.Parser .NET provides complete support for extracting Hyperlinks from PPTX documents. The following C# .NET code example demonstrates how to extract hyperlinks inside a PPTX document. 
    ...
    - title_left: "Extract Hyperlinks from PPTX Documents Page"
      content_left: |
    ...
    - title_left: "Extract Hyperlinks from PPTX Documents Page Area"
      content_left: |
       GroupDocs.Parser .NET API fully supports extraction of hyperlinks from PPTX documents with ease. The following .NET code example demonstrates how to extract hyperlinks from a PPTX document page area.
