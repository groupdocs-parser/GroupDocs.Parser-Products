...
############################# Head ############################
head_title: "Extraer tablas de archivos EPUB en aplicaciones C#"
head_description: "Utiliza GroupDocs.Parser para localizar y extraer datos de tablas estructuradas de archivos EPUB en aplicaciones C# sin dependencias adicionales."

############################# Header ############################
title: "Extrae tablas de EPUB usando C#" 
...
steps:
    enable: true
    title: "Pasos para extraer tablas de Epub en C#"
    content: |
      Sigue estas instrucciones para extraer tablas de archivos EPUB usando [GroupDocs.Parser](/parser/net/) dentro de tu entorno .NET:
