...
############################# Head ############################
head_title: "Trích xuất bảng từ tệp EPUB trong ứng dụng C#"
head_description: "Sử dụng GroupDocs.Parser để xác định và trích xuất dữ liệu bảng có cấu trúc từ các tệp EPUB trong ứng dụng C# mà không cần phụ thuộc thêm."

############################# Header ############################
title: "Trích xuất bảng từ EPUB bằng C#" 
...
steps:
    enable: true
    title: "Các bước để trích xuất bảng từ Epub trong C#"
    content: |
      Thực hiện các hướng dẫn sau để trích xuất bảng từ các tệp EPUB bằng [GroupDocs.Parser](/parser/net/) trong môi trường .NET của bạn:
      
      1. Khởi tạo một phiên bản Parser và tải tài liệu EPUB của bạn.
