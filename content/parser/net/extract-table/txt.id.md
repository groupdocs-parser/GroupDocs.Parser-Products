...
############################# Head ############################
head_title: "Ekstrak tabel dari file TXT dalam aplikasi C#"
head_description: "Gunakan GroupDocs.Parser untuk menemukan dan mengekstrak data tabel terstruktur dari file TXT dalam aplikasi C# tanpa dependensi tambahan."

############################# Header ############################
title: "Ekstrak tabel dari TXT menggunakan C#" 
...
steps:
    enable: true
    title: "Langkah-langkah untuk ekstrak tabel dari Txt dalam C#"
    content: |
      Ikuti instruksi ini untuk mengekstrak tabel dari file TXT menggunakan [GroupDocs.Parser](/parser/net/) dalam lingkungan .NET Anda:
      
      1. Inisialisasi instance Parser dan muat dokumen TXT Anda.
