...
############################# Head ############################
head_title: "Extraire des tables à partir de fichiers DOCX dans des applications C#"
head_description: "Utilisez GroupDocs.Parser pour localiser et extraire des données de table structurées à partir de fichiers DOCX dans des applications C# sans dépendances supplémentaires."

############################# Header ############################
title: "Extraire des tables à partir de DOCX en utilisant C#" 
...
steps:
    enable: true
    title: "Étapes pour extraire des tables à partir de Docx dans C#"
    content: |
      Suivez ces instructions pour extraire des tables à partir de fichiers DOCX en utilisant [GroupDocs.Parser](/parser/net/) dans votre environnement .NET :
