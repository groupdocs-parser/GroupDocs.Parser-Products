...
about:
    enable: true
    title: "如何通过 .NET API 解析和提取 OST 文档中的超链接？"
    content: |
...
steps:
    enable: true
    title_left: "从 .NET 中的 OST 中提取超链接"
    content_left: |
        [GroupDocs.Parser for .NET](/zh/parser/net/) 让 C# 开发者只需执行几个简单的步骤即可轻松从 OST 文件中提取超链接。
    ...
    code: |
     ...
     {{< parser/code-parser title="如何使用 C# 示例代码从 OST 文件中提取超链接">}}
