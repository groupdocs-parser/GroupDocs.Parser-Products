...
steps:
    enable: true
    block:
    - title_left: "Ekstrak Hyperlink dari POTX Dokumen melalui .NET"
      content_left: |
       GroupDocs.Parser .NET menyediakan dukungan lengkap untuk mengekstraksi Hyperlink dari dokumen POTX. Contoh kode C# .NET berikut menunjukkan cara mengekstrak hyperlink di dalam dokumen POTX. 
    ...
    - title_left: "Ekstrak Hyperlink dari Halaman Dokumen POTX"
      content_left: |
    ...
    - title_left: "Ekstrak Hyperlink dari POTX Area Halaman Dokumen"
      content_left: |
       GroupDocs.Parser .NET API sepenuhnya mendukung ekstraksi hyperlink dari dokumen POTX dengan mudah. Contoh kode .NET berikut menunjukkan cara mengekstrak hyperlink dari area halaman dokumen POTX.
