...
steps:
    enable: true
    block:
    - title_left: "Ekstrak Hyperlink dari DOCM Dokumen melalui .NET"
      content_left: |
       GroupDocs.Parser .NET menyediakan dukungan lengkap untuk mengekstraksi Hyperlink dari dokumen DOCM. Contoh kode C# .NET berikut menunjukkan cara mengekstrak hyperlink di dalam dokumen DOCM. 
    ...
    - title_left: "Ekstrak Hyperlink dari Halaman Dokumen DOCM"
      content_left: |
    ...
    - title_left: "Ekstrak Hyperlink dari DOCM Area Halaman Dokumen"
      content_left: |
       GroupDocs.Parser .NET API sepenuhnya mendukung ekstraksi hyperlink dari dokumen DOCM dengan mudah. Contoh kode .NET berikut menunjukkan cara mengekstrak hyperlink dari area halaman dokumen DOCM.
