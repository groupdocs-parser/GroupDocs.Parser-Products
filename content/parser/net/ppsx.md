...
steps:
    enable: true
    block:
    - title_left: "Extract Hyperlinks from PPSX Documents via .NET"
      content_left: |
       GroupDocs.Parser .NET provides complete support for extracting Hyperlinks from PPSX documents. The following C# .NET code example demonstrates how to extract hyperlinks inside a PPSX document. 
    ...
    - title_left: "Extract Hyperlinks from PPSX Documents Page"
      content_left: |
    ...
    - title_left: "Extract Hyperlinks from PPSX Documents Page Area"
      content_left: |
       GroupDocs.Parser .NET API fully supports extraction of hyperlinks from PPSX documents with ease. The following .NET code example demonstrates how to extract hyperlinks from a PPSX document page area.
