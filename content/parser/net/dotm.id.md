...
about:
    enable: true
    title: "Bagaimana cara Mengurai & Mengekstrak Hyperlink dari DOTM dokumen melalui .NET API?"
    content: |
...
steps:
    enable: true
    title_left: "Ekstrak hyperlink dari DOTM di .NET"
    content_left: |
        [GroupDocs.Parser for .NET](/id/parser/net/) memudahkan pengembang C# untuk mengekstrak hyperlink dari file DOTM dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< parser/code-parser title="Cara mengekstrak hyperlink dari file DOTM menggunakan kode contoh C#">}}
