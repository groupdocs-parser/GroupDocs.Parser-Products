...
steps:
    enable: true
    block:
    - title_left: "Extract Hyperlinks from ODS Documents via .NET"
      content_left: |
       GroupDocs.Parser .NET provides complete support for extracting Hyperlinks from ODS documents. The following C# .NET code example demonstrates how to extract hyperlinks inside a ODS document. 
    ...
    - title_left: "Extract Hyperlinks from ODS Documents Page"
      content_left: |
    ...
    - title_left: "Extract Hyperlinks from ODS Documents Page Area"
      content_left: |
       GroupDocs.Parser .NET API fully supports extraction of hyperlinks from ODS documents with ease. The following .NET code example demonstrates how to extract hyperlinks from a ODS document page area.
