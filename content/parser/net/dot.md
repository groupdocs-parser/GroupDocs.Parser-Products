...
steps:
    enable: true
    block:
    - title_left: "Extract Hyperlinks from DOT Documents via .NET"
      content_left: |
       GroupDocs.Parser .NET provides complete support for extracting Hyperlinks from DOT documents. The following C# .NET code example demonstrates how to extract hyperlinks inside a DOT document. 
    ...
    - title_left: "Extract Hyperlinks from DOT Documents Page"
      content_left: |
    ...
    - title_left: "Extract Hyperlinks from DOT Documents Page Area"
      content_left: |
       GroupDocs.Parser .NET API fully supports extraction of hyperlinks from DOT documents with ease. The following .NET code example demonstrates how to extract hyperlinks from a DOT document page area.
