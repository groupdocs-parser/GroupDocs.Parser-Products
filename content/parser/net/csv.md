...
steps:
    enable: true
    block:
    - title_left: "Extract Hyperlinks from CSV Documents via .NET"
      content_left: |
       GroupDocs.Parser .NET provides complete support for extracting Hyperlinks from CSV documents. The following C# .NET code example demonstrates how to extract hyperlinks inside a CSV document. 
    ...
    - title_left: "Extract Hyperlinks from CSV Documents Page"
      content_left: |
    ...
    - title_left: "Extract Hyperlinks from CSV Documents Page Area"
      content_left: |
       GroupDocs.Parser .NET API fully supports extraction of hyperlinks from CSV documents with ease. The following .NET code example demonstrates how to extract hyperlinks from a CSV document page area.
