...
steps:
    enable: true
    block:
    - title_left: "Ekstrak Hyperlink dari ONE Dokumen melalui .NET"
      content_left: |
       GroupDocs.Parser .NET menyediakan dukungan lengkap untuk mengekstraksi Hyperlink dari dokumen ONE. Contoh kode C# .NET berikut menunjukkan cara mengekstrak hyperlink di dalam dokumen ONE. 
    ...
    - title_left: "Ekstrak Hyperlink dari Halaman Dokumen ONE"
      content_left: |
    ...
    - title_left: "Ekstrak Hyperlink dari ONE Area Halaman Dokumen"
      content_left: |
       GroupDocs.Parser .NET API sepenuhnya mendukung ekstraksi hyperlink dari dokumen ONE dengan mudah. Contoh kode .NET berikut menunjukkan cara mengekstrak hyperlink dari area halaman dokumen ONE.
