...
steps:
    enable: true
    block:
    - title_left: "Ekstrak Hyperlink dari XLSX Dokumen melalui .NET"
      content_left: |
       GroupDocs.Parser .NET menyediakan dukungan lengkap untuk mengekstraksi Hyperlink dari dokumen XLSX. Contoh kode C# .NET berikut menunjukkan cara mengekstrak hyperlink di dalam dokumen XLSX. 
    ...
    - title_left: "Ekstrak Hyperlink dari Halaman Dokumen XLSX"
      content_left: |
    ...
    - title_left: "Ekstrak Hyperlink dari XLSX Area Halaman Dokumen"
      content_left: |
       GroupDocs.Parser .NET API sepenuhnya mendukung ekstraksi hyperlink dari dokumen XLSX dengan mudah. Contoh kode .NET berikut menunjukkan cara mengekstrak hyperlink dari area halaman dokumen XLSX.
