...
steps:
    enable: true
    block:
    - title_left: "Extract Hyperlinks from ODP Documents via .NET"
      content_left: |
       GroupDocs.Parser .NET provides complete support for extracting Hyperlinks from ODP documents. The following C# .NET code example demonstrates how to extract hyperlinks inside a ODP document. 
    ...
    - title_left: "Extract Hyperlinks from ODP Documents Page"
      content_left: |
    ...
    - title_left: "Extract Hyperlinks from ODP Documents Page Area"
      content_left: |
       GroupDocs.Parser .NET API fully supports extraction of hyperlinks from ODP documents with ease. The following .NET code example demonstrates how to extract hyperlinks from a ODP document page area.
