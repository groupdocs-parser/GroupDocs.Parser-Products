...
steps:
    enable: true
    block:
    - title_left: "Ekstrak Hyperlink dari DOC Dokumen melalui .NET"
      content_left: |
       GroupDocs.Parser .NET menyediakan dukungan lengkap untuk mengekstraksi Hyperlink dari dokumen DOC. Contoh kode C# .NET berikut menunjukkan cara mengekstrak hyperlink di dalam dokumen DOC. 
    ...
    - title_left: "Ekstrak Hyperlink dari Halaman Dokumen DOC"
      content_left: |
    ...
    - title_left: "Ekstrak Hyperlink dari DOC Area Halaman Dokumen"
      content_left: |
       GroupDocs.Parser .NET API sepenuhnya mendukung ekstraksi hyperlink dari dokumen DOC dengan mudah. Contoh kode .NET berikut menunjukkan cara mengekstrak hyperlink dari area halaman dokumen DOC.
