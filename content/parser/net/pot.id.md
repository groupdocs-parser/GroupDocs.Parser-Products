...
steps:
    enable: true
    block:
    - title_left: "Ekstrak Hyperlink dari POT Dokumen melalui .NET"
      content_left: |
       GroupDocs.Parser .NET menyediakan dukungan lengkap untuk mengekstraksi Hyperlink dari dokumen POT. Contoh kode C# .NET berikut menunjukkan cara mengekstrak hyperlink di dalam dokumen POT. 
    ...
    - title_left: "Ekstrak Hyperlink dari Halaman Dokumen POT"
      content_left: |
    ...
    - title_left: "Ekstrak Hyperlink dari POT Area Halaman Dokumen"
      content_left: |
       GroupDocs.Parser .NET API sepenuhnya mendukung ekstraksi hyperlink dari dokumen POT dengan mudah. Contoh kode .NET berikut menunjukkan cara mengekstrak hyperlink dari area halaman dokumen POT.
