...
steps:
    enable: true
    block:
    - title_left: "Ekstrak Hyperlink dari PPT Dokumen melalui .NET"
      content_left: |
       GroupDocs.Parser .NET menyediakan dukungan lengkap untuk mengekstraksi Hyperlink dari dokumen PPT. Contoh kode C# .NET berikut menunjukkan cara mengekstrak hyperlink di dalam dokumen PPT. 
    ...
    - title_left: "Ekstrak Hyperlink dari Halaman Dokumen PPT"
      content_left: |
    ...
    - title_left: "Ekstrak Hyperlink dari PPT Area Halaman Dokumen"
      content_left: |
       GroupDocs.Parser .NET API sepenuhnya mendukung ekstraksi hyperlink dari dokumen PPT dengan mudah. Contoh kode .NET berikut menunjukkan cara mengekstrak hyperlink dari area halaman dokumen PPT.
