...
steps:
    enable: true
    block:
    - title_left: "Ekstrak Hyperlink dari RTF Dokumen melalui .NET"
      content_left: |
       GroupDocs.Parser .NET menyediakan dukungan lengkap untuk mengekstraksi Hyperlink dari dokumen RTF. Contoh kode C# .NET berikut menunjukkan cara mengekstrak hyperlink di dalam dokumen RTF. 
    ...
    - title_left: "Ekstrak Hyperlink dari Halaman Dokumen RTF"
      content_left: |
    ...
    - title_left: "Ekstrak Hyperlink dari RTF Area Halaman Dokumen"
      content_left: |
       GroupDocs.Parser .NET API sepenuhnya mendukung ekstraksi hyperlink dari dokumen RTF dengan mudah. Contoh kode .NET berikut menunjukkan cara mengekstrak hyperlink dari area halaman dokumen RTF.
