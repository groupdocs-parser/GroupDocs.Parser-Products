...
steps:
    enable: true
    block:
    - title_left: "Ekstrak Hyperlink dari FB2 Dokumen melalui .NET"
      content_left: |
       GroupDocs.Parser .NET menyediakan dukungan lengkap untuk mengekstraksi Hyperlink dari dokumen FB2. Contoh kode C# .NET berikut menunjukkan cara mengekstrak hyperlink di dalam dokumen FB2. 
    ...
    - title_left: "Ekstrak Hyperlink dari Halaman Dokumen FB2"
      content_left: |
    ...
    - title_left: "Ekstrak Hyperlink dari FB2 Area Halaman Dokumen"
      content_left: |
       GroupDocs.Parser .NET API sepenuhnya mendukung ekstraksi hyperlink dari dokumen FB2 dengan mudah. Contoh kode .NET berikut menunjukkan cara mengekstrak hyperlink dari area halaman dokumen FB2.
