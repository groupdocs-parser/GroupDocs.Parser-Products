...
steps:
    enable: true
    block:
    - title_left: "Extract Hyperlinks from XLAM Documents via .NET"
      content_left: |
       GroupDocs.Parser .NET provides complete support for extracting Hyperlinks from XLAM documents. The following C# .NET code example demonstrates how to extract hyperlinks inside a XLAM document. 
    ...
    - title_left: "Extract Hyperlinks from XLAM Documents Page"
      content_left: |
    ...
    - title_left: "Extract Hyperlinks from XLAM Documents Page Area"
      content_left: |
       GroupDocs.Parser .NET API fully supports extraction of hyperlinks from XLAM documents with ease. The following .NET code example demonstrates how to extract hyperlinks from a XLAM document page area.
