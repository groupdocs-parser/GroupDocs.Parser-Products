...
about:
    enable: true
    title: "Wie kann ich Hyperlinks aus DOCX-Dokumenten über die .NET-API analysieren und extrahieren?"
    content: |
...
steps:
    enable: true
    title_left: "Extrahieren Sie Hyperlinks von DOCX in .NET"
    content_left: |
        [GroupDocs.Parser for .NET](/de/parser/net/) erleichtert C#-Entwicklern das Extrahieren von Hyperlinks aus einer DOCX-Datei durch die Implementierung einiger einfacher Schritte.
    ...
    code: |
     ...
     {{< parser/code-parser title="So extrahieren Sie Hyperlinks aus der Datei DOCX mithilfe des Beispielcodes C#">}}
