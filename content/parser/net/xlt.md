...
steps:
    enable: true
    block:
    - title_left: "Extract Hyperlinks from XLT Documents via .NET"
      content_left: |
       GroupDocs.Parser .NET provides complete support for extracting Hyperlinks from XLT documents. The following C# .NET code example demonstrates how to extract hyperlinks inside a XLT document. 
    ...
    - title_left: "Extract Hyperlinks from XLT Documents Page"
      content_left: |
    ...
    - title_left: "Extract Hyperlinks from XLT Documents Page Area"
      content_left: |
       GroupDocs.Parser .NET API fully supports extraction of hyperlinks from XLT documents with ease. The following .NET code example demonstrates how to extract hyperlinks from a XLT document page area.
