...
steps:
    enable: true
    block:
    - title_left: "Ekstrak Hyperlink dari CHM Dokumen melalui .NET"
      content_left: |
       GroupDocs.Parser .NET menyediakan dukungan lengkap untuk mengekstraksi Hyperlink dari dokumen CHM. Contoh kode C# .NET berikut menunjukkan cara mengekstrak hyperlink di dalam dokumen CHM. 
    ...
    - title_left: "Ekstrak Hyperlink dari Halaman Dokumen CHM"
      content_left: |
    ...
    - title_left: "Ekstrak Hyperlink dari CHM Area Halaman Dokumen"
      content_left: |
       GroupDocs.Parser .NET API sepenuhnya mendukung ekstraksi hyperlink dari dokumen CHM dengan mudah. Contoh kode .NET berikut menunjukkan cara mengekstrak hyperlink dari area halaman dokumen CHM.
