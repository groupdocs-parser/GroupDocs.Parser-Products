...
draft: false
path: "de/parser/net/extract/pst/"
...
steps:
    enable: true
    block:
    - title_left: "Hyperlinks aus PST-Dokumenten über .NET extrahieren"
      content_left: |
       GroupDocs.Parser .NET bietet vollständige Unterstützung für das Extrahieren von Hyperlinks aus PST-Dokumenten. Das folgende C# .NET-Codebeispiel zeigt, wie Hyperlinks in einem PST-Dokument extrahiert werden.
    ...
    - title_left: "Extrahieren Sie Hyperlinks von der Seite PST Dokumente"
      content_left: |
    ...
    - title_left: "Extrahieren Sie Hyperlinks aus dem Seitenbereich für PST-Dokumente"
      content_left: |
       GroupDocs.Parser .NET API unterstützt die Extraktion von Hyperlinks aus PST-Dokumenten mit Leichtigkeit. Das folgende .NET-Codebeispiel zeigt, wie Hyperlinks aus einem PST-Dokumentseitenbereich extrahiert werden.
