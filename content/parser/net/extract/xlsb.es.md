...
draft: false
path: "es/parser/net/extract/xlsb/"
...
steps:
    enable: true
    block:
    - title_left: "Extraiga hipervínculos de XLSB Documentos a través de .NET"
      content_left: |
       GroupDocs.Parser .NET brinda soporte completo para extraer hipervínculos de documentos XLSB. El siguiente ejemplo de código C# .NET demuestra cómo extraer hipervínculos dentro de un documento XLSB. 
    ...
    - title_left: "Extraer hipervínculos de la página de documentos XLSB"
      content_left: |
    ...
    - title_left: "Extraer hipervínculos del área de la página de documentos XLSB"
      content_left: |
       GroupDocs.Parser .NET API es totalmente compatible con la extracción de hipervínculos de documentos XLSB con facilidad. El siguiente ejemplo de código .NET demuestra cómo extraer hipervínculos de un área de página de documento XLSB.
