...
steps:
    enable: true
    block:
    - title_left: "Ekstrak Hyperlink dari XLAM Dokumen melalui .NET"
      content_left: |
       GroupDocs.Parser .NET menyediakan dukungan lengkap untuk mengekstraksi Hyperlink dari dokumen XLAM. Contoh kode C# .NET berikut menunjukkan cara mengekstrak hyperlink di dalam dokumen XLAM. 
    ...
    - title_left: "Ekstrak Hyperlink dari Halaman Dokumen XLAM"
      content_left: |
    ...
    - title_left: "Ekstrak Hyperlink dari XLAM Area Halaman Dokumen"
      content_left: |
       GroupDocs.Parser .NET API sepenuhnya mendukung ekstraksi hyperlink dari dokumen XLAM dengan mudah. Contoh kode .NET berikut menunjukkan cara mengekstrak hyperlink dari area halaman dokumen XLAM.
