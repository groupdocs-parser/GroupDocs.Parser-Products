...
draft: false
path: "de/parser/net/extract/pptm/"
...
steps:
    enable: true
    block:
    - title_left: "Hyperlinks aus PPTM-Dokumenten über .NET extrahieren"
      content_left: |
       GroupDocs.Parser .NET bietet vollständige Unterstützung für das Extrahieren von Hyperlinks aus PPTM-Dokumenten. Das folgende C# .NET-Codebeispiel zeigt, wie Hyperlinks in einem PPTM-Dokument extrahiert werden.
    ...
    - title_left: "Extrahieren Sie Hyperlinks von der Seite PPTM Dokumente"
      content_left: |
    ...
    - title_left: "Extrahieren Sie Hyperlinks aus dem Seitenbereich für PPTM-Dokumente"
      content_left: |
       GroupDocs.Parser .NET API unterstützt die Extraktion von Hyperlinks aus PPTM-Dokumenten mit Leichtigkeit. Das folgende .NET-Codebeispiel zeigt, wie Hyperlinks aus einem PPTM-Dokumentseitenbereich extrahiert werden.
