...
steps:
    enable: true
    block:
    - title_left: "Ekstrak Hyperlink dari EML Dokumen melalui .NET"
      content_left: |
       GroupDocs.Parser .NET menyediakan dukungan lengkap untuk mengekstraksi Hyperlink dari dokumen EML. Contoh kode C# .NET berikut menunjukkan cara mengekstrak hyperlink di dalam dokumen EML. 
    ...
    - title_left: "Ekstrak Hyperlink dari Halaman Dokumen EML"
      content_left: |
    ...
    - title_left: "Ekstrak Hyperlink dari EML Area Halaman Dokumen"
      content_left: |
       GroupDocs.Parser .NET API sepenuhnya mendukung ekstraksi hyperlink dari dokumen EML dengan mudah. Contoh kode .NET berikut menunjukkan cara mengekstrak hyperlink dari area halaman dokumen EML.
