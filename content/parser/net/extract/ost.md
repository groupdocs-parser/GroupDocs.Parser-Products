...
steps:
    enable: true
    block:
    - title_left: "Extract Hyperlinks from OST Documents via .NET"
      content_left: |
       GroupDocs.Parser .NET provides complete support for extracting Hyperlinks from OST documents. The following C# .NET code example demonstrates how to extract hyperlinks inside a OST document. 
    ...
    - title_left: "Extract Hyperlinks from OST Documents Page"
      content_left: |
    ...
    - title_left: "Extract Hyperlinks from OST Documents Page Area"
      content_left: |
       GroupDocs.Parser .NET API fully supports extraction of hyperlinks from OST documents with ease. The following .NET code example demonstrates how to extract hyperlinks from a OST document page area.
