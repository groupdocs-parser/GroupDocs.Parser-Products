...
steps:
    enable: true
    block:
    - title_left: "Extract Hyperlinks from EPUB Documents via .NET"
      content_left: |
       GroupDocs.Parser .NET provides complete support for extracting Hyperlinks from EPUB documents. The following C# .NET code example demonstrates how to extract hyperlinks inside a EPUB document. 
    ...
    - title_left: "Extract Hyperlinks from EPUB Documents Page"
      content_left: |
    ...
    - title_left: "Extract Hyperlinks from EPUB Documents Page Area"
      content_left: |
       GroupDocs.Parser .NET API fully supports extraction of hyperlinks from EPUB documents with ease. The following .NET code example demonstrates how to extract hyperlinks from a EPUB document page area.
