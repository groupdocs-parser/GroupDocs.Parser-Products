...
draft: false
path: "de/parser/net/extract/docx/"
...
steps:
    enable: true
    block:
    - title_left: "Hyperlinks aus DOCX-Dokumenten über .NET extrahieren"
      content_left: |
       GroupDocs.Parser .NET bietet vollständige Unterstützung für das Extrahieren von Hyperlinks aus DOCX-Dokumenten. Das folgende C# .NET-Codebeispiel zeigt, wie Hyperlinks in einem DOCX-Dokument extrahiert werden.
    ...
    - title_left: "Extrahieren Sie Hyperlinks von der Seite DOCX Dokumente"
      content_left: |
    ...
    - title_left: "Extrahieren Sie Hyperlinks aus dem Seitenbereich für DOCX-Dokumente"
      content_left: |
       GroupDocs.Parser .NET API unterstützt die Extraktion von Hyperlinks aus DOCX-Dokumenten mit Leichtigkeit. Das folgende .NET-Codebeispiel zeigt, wie Hyperlinks aus einem DOCX-Dokumentseitenbereich extrahiert werden.
