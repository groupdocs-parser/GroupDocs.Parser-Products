...
steps:
    enable: true
    block:
    - title_left: "Extract Hyperlinks from DOTX Documents via .NET"
      content_left: |
       GroupDocs.Parser .NET provides complete support for extracting Hyperlinks from DOTX documents. The following C# .NET code example demonstrates how to extract hyperlinks inside a DOTX document. 
    ...
    - title_left: "Extract Hyperlinks from DOTX Documents Page"
      content_left: |
    ...
    - title_left: "Extract Hyperlinks from DOTX Documents Page Area"
      content_left: |
       GroupDocs.Parser .NET API fully supports extraction of hyperlinks from DOTX documents with ease. The following .NET code example demonstrates how to extract hyperlinks from a DOTX document page area.
