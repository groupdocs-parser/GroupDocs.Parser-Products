...
steps:
    enable: true
    block:
    - title_left: "Extract Hyperlinks from DOCM Documents via .NET"
      content_left: |
       GroupDocs.Parser .NET provides complete support for extracting Hyperlinks from DOCM documents. The following C# .NET code example demonstrates how to extract hyperlinks inside a DOCM document. 
    ...
    - title_left: "Extract Hyperlinks from DOCM Documents Page"
      content_left: |
    ...
    - title_left: "Extract Hyperlinks from DOCM Documents Page Area"
      content_left: |
       GroupDocs.Parser .NET API fully supports extraction of hyperlinks from DOCM documents with ease. The following .NET code example demonstrates how to extract hyperlinks from a DOCM document page area.
