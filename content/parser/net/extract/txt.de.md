...
draft: false
path: "de/parser/net/extract/txt/"
...
steps:
    enable: true
    block:
    - title_left: "Hyperlinks aus TXT-Dokumenten über .NET extrahieren"
      content_left: |
       GroupDocs.Parser .NET bietet vollständige Unterstützung für das Extrahieren von Hyperlinks aus TXT-Dokumenten. Das folgende C# .NET-Codebeispiel zeigt, wie Hyperlinks in einem TXT-Dokument extrahiert werden.
    ...
    - title_left: "Extrahieren Sie Hyperlinks von der Seite TXT Dokumente"
      content_left: |
    ...
    - title_left: "Extrahieren Sie Hyperlinks aus dem Seitenbereich für TXT-Dokumente"
      content_left: |
       GroupDocs.Parser .NET API unterstützt die Extraktion von Hyperlinks aus TXT-Dokumenten mit Leichtigkeit. Das folgende .NET-Codebeispiel zeigt, wie Hyperlinks aus einem TXT-Dokumentseitenbereich extrahiert werden.
