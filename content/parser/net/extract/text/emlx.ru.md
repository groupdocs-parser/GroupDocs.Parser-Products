...
############################# Head ############################
head_title: "Извлечь текст из EMLX в C#"
head_description: "Быстро извлекайте текст из файла EMLX в C#. Сохраните новый документ, содержащий выбранные страницы, с помощью API слияния документов."

############################# Header ############################
title: "Извлечь текст из EMLX в C#"
description: "Извлеките текст из EMLX с помощью нескольких строк кода .NET."
...
about:
    enable: true
    title: "Как извлечь текст из EMLX файлов .NET API?"
    content: |
...
steps:
    enable: true
    title_left: "Извлечь текст из EMLX в C# API?"
    content_left: |
        [GroupDocs.Parser for .NET](/ru/parser/net/) позволяет разработчикам C# легко извлекать текст из файла EMLX, реализуя несколько простых шаги.
    ...
    code: |
     ...
     {{< parser/code-parser title="Как извлечь текст из файла EMLX, используя пример кода C#">}}
