...
############################# Head ############################
head_title: "Ekstrak Teks dari XLSX di C#"
head_description: "Ekstrak teks dengan cepat dari file dokumen di C#."

############################# Header ############################
title: "Ekstrak teks dari XLSX Di C#"
description: "Ekstrak teks dari XLSX dengan beberapa baris kode .NET."
...
about:
    enable: true
    title: "Bagaimana cara mengekstrak teks dari XLSX file .NET API?"
    content: |
...
steps:
    enable: true
    title_left: "Ekstrak teks dari XLSX di .NET"
    content_left: |
        [GroupDocs.Parser for .NET](/id/parser/net/) memudahkan pengembang C# untuk mengekstrak teks dari file XLSX dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< parser/code-parser title="Cara mengekstrak teks dari file XLSX menggunakan kode contoh C#">}}
