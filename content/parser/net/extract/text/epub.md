...
############################# Head ############################
head_title: "Extract Text from EPUB in C#"
head_description: "Quickly extract text from a documents file in C#."

############################# Header ############################
title: "Extract text from EPUB In C#"
description: "Extract text from EPUB with a few lines of .NET code."
...
about:
    enable: true
    title: "How to extract a text from EPUB files .NET API?"
    content: |
...
steps:
    enable: true
    title_left: "Extract text from EPUB in .NET"
    content_left: |
        [GroupDocs.Parser for .NET](/parser/net/) makes it easy for C# developers to extract a text from a EPUB file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< parser/code-parser title="How to extract text from EPUB file using C# example code">}}
