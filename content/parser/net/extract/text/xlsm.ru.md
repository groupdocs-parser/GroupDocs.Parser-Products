...
############################# Head ############################
head_title: "Извлечь текст из XLSM в C#"
head_description: "Быстро извлекайте текст из файла XLSM в C#. Сохраните новый документ, содержащий выбранные страницы, с помощью API слияния документов."

############################# Header ############################
title: "Извлечь текст из XLSM в C#"
description: "Извлеките текст из XLSM с помощью нескольких строк кода .NET."
...
about:
    enable: true
    title: "Как извлечь текст из XLSM файлов .NET API?"
    content: |
...
steps:
    enable: true
    title_left: "Извлечь текст из XLSM в C# API?"
    content_left: |
        [GroupDocs.Parser for .NET](/ru/parser/net/) позволяет разработчикам C# легко извлекать текст из файла XLSM, реализуя несколько простых шаги.
    ...
    code: |
     ...
     {{< parser/code-parser title="Как извлечь текст из файла XLSM, используя пример кода C#">}}
