...
############################# Head ############################
head_title: "Text aus EML in C# extrahieren"
head_description: "Extrahieren Sie schnell Text aus einer Dokumentdatei in C#."

############################# Header ############################
title: "Text aus EML in C# extrahieren"
description: "Extrahieren Sie Text aus EML mit ein paar Zeilen .NET-Code."
...
about:
    enable: true
    title: "Wie extrahiere ich einen Text aus der EML-API der Datei .NET?"
    content: |
...
steps:
    enable: true
    title_left: "Text aus EML in .NET extrahieren"
    content_left: |
        [GroupDocs.Parser for .NET](/de/parser/net/) erleichtert C#-Entwicklern das Extrahieren eines Textes aus einer EML-Datei durch die Implementierung einiger einfacher Schritte.
    ...
    code: |
     ...
     {{< parser/code-parser title="So extrahieren Sie Text aus der Datei EML mithilfe des Beispielcodes C#">}}
