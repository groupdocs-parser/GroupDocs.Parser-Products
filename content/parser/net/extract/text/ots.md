...
############################# Head ############################
head_title: "Extract Text from OTS in C#"
head_description: "Quickly extract text from a documents file in C#."

############################# Header ############################
title: "Extract text from OTS In C#"
description: "Extract text from OTS with a few lines of .NET code."
...
about:
    enable: true
    title: "How to extract a text from OTS files .NET API?"
    content: |
...
steps:
    enable: true
    title_left: "Extract text from OTS in .NET"
    content_left: |
        [GroupDocs.Parser for .NET](/parser/net/) makes it easy for C# developers to extract a text from a OTS file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< parser/code-parser title="How to extract text from OTS file using C# example code">}}
