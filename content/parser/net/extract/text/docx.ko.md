...
############################# Head ############################
head_title: "C#의 DOCX에서 텍스트 추출"
head_description: "C#의 문서 파일에서 빠르게 텍스트를 추출합니다."

############################# Header ############################
title: "DOCX에서 C#의 텍스트 추출"
description: "몇 줄의 .NET 코드로 DOCX에서 텍스트를 추출합니다."
...
about:
    enable: true
    title: "DOCX 파일 .NET API에서 텍스트를 추출하는 방법은 무엇입니까?"
    content: |
...
steps:
    enable: true
    title_left: ".NET의 DOCX에서 텍스트 추출"
    content_left: |
        [GroupDocs.Parser for .NET](/ko/parser/net/)를 사용하면 C# 개발자가 몇 가지 간단한 단계를 구현하여 DOCX 파일에서 텍스트를 쉽게 추출할 수 있습니다.
    ...
    code: |
     ...
     {{< parser/code-parser title="C# 예제 코드를 사용하여 DOCX 파일에서 텍스트를 추출하는 방법">}}
