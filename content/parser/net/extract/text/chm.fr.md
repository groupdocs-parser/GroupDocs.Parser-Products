...
############################# Head ############################
head_title: "Extraire le texte de CHM dans C#"
head_description: "Extrayez rapidement du texte d'un fichier de documents dans C#."

############################# Header ############################
title: "Extraire le texte de CHM Dans C#"
description: "Extrayez le texte de CHM avec quelques lignes de code .NET."
...
about:
    enable: true
    title: "Comment extraire un texte de CHM fichiers .NET API ?"
    content: |
...
steps:
    enable: true
    title_left: "Extraire le texte de CHM dans .NET"
    content_left: |
        [GroupDocs.Parser for .NET](/fr/parser/net/) permet aux développeurs C# d'extraire facilement un texte d'un fichier CHM en mettant en œuvre quelques étapes simples.
    ...
    code: |
     ...
     {{< parser/code-parser title="Comment extraire du texte du fichier CHM à l'aide de l'exemple de code C#">}}
