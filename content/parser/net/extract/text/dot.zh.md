...
############################# Head ############################
head_title: "从 C# 中的 DOT 中提取文本"
head_description: "从 C# 中的文档文件中快速提取文本。"

############################# Header ############################
title: "从 C# 中的 DOT 中提取文本"
description: "使用几行 .NET 代码从 DOT 中提取文本。"
...
about:
    enable: true
    title: "如何从 DOT 文件 .NET API 中提取文本？"
    content: |
...
steps:
    enable: true
    title_left: "从 .NET 中的 DOT 中提取文本"
    content_left: |
        [GroupDocs.Parser for .NET](/zh/parser/net/) 让 C# 开发者只需执行几个简单的步骤即可轻松从 DOT 文件中提取文本。
    ...
    code: |
     ...
     {{< parser/code-parser title="如何使用 C# 示例代码从 DOT 文件中提取文本">}}
