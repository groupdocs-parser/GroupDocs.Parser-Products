...
############################# Head ############################
head_title: "Extraire le texte de PPTM dans C#"
head_description: "Extrayez rapidement du texte d'un fichier de documents dans C#."

############################# Header ############################
title: "Extraire le texte de PPTM Dans C#"
description: "Extrayez le texte de PPTM avec quelques lignes de code .NET."
...
about:
    enable: true
    title: "Comment extraire un texte de PPTM fichiers .NET API ?"
    content: |
...
steps:
    enable: true
    title_left: "Extraire le texte de PPTM dans .NET"
    content_left: |
        [GroupDocs.Parser for .NET](/fr/parser/net/) permet aux développeurs C# d'extraire facilement un texte d'un fichier PPTM en mettant en œuvre quelques étapes simples.
    ...
    code: |
     ...
     {{< parser/code-parser title="Comment extraire du texte du fichier PPTM à l'aide de l'exemple de code C#">}}
