...
############################# Head ############################
head_title: "Извлечь текст из DOCX в C#"
head_description: "Быстро извлекайте текст из файла DOCX в C#. Сохраните новый документ, содержащий выбранные страницы, с помощью API слияния документов."

############################# Header ############################
title: "Извлечь текст из DOCX в C#"
description: "Извлеките текст из DOCX с помощью нескольких строк кода .NET."
...
about:
    enable: true
    title: "Как извлечь текст из DOCX файлов .NET API?"
    content: |
...
steps:
    enable: true
    title_left: "Извлечь текст из DOCX в C# API?"
    content_left: |
        [GroupDocs.Parser for .NET](/ru/parser/net/) позволяет разработчикам C# легко извлекать текст из файла DOCX, реализуя несколько простых шаги.
    ...
    code: |
     ...
     {{< parser/code-parser title="Как извлечь текст из файла DOCX, используя пример кода C#">}}
