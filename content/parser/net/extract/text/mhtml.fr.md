...
############################# Head ############################
head_title: "Extraire le texte de MHTML dans C#"
head_description: "Extrayez rapidement du texte d'un fichier de documents dans C#."

############################# Header ############################
title: "Extraire le texte de MHTML Dans C#"
description: "Extrayez le texte de MHTML avec quelques lignes de code .NET."
...
about:
    enable: true
    title: "Comment extraire un texte de MHTML fichiers .NET API ?"
    content: |
...
steps:
    enable: true
    title_left: "Extraire le texte de MHTML dans .NET"
    content_left: |
        [GroupDocs.Parser for .NET](/fr/parser/net/) permet aux développeurs C# d'extraire facilement un texte d'un fichier MHTML en mettant en œuvre quelques étapes simples.
    ...
    code: |
     ...
     {{< parser/code-parser title="Comment extraire du texte du fichier MHTML à l'aide de l'exemple de code C#">}}
