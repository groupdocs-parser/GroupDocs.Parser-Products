...
############################# Head ############################
head_title: "Extraer texto de XLAM en C#"
head_description: "Extraiga rápidamente texto de un archivo de documentos en C#."

############################# Header ############################
title: "Extraer texto de XLAM en C#"
description: "Extraiga texto de XLAM con unas pocas líneas de código .NET."
...
about:
    enable: true
    title: "¿Cómo extraer un texto de XLAM archivos .NET API?"
    content: |
...
steps:
    enable: true
    title_left: "Extraer texto de XLAM en .NET"
    content_left: |
        [GroupDocs.Parser for .NET](/es/parser/net/) facilita a los desarrolladores de C# extraer un texto de un archivo XLAM mediante la implementación de unos sencillos pasos.
    ...
    code: |
     ...
     {{< parser/code-parser title="Cómo extraer texto del archivo XLAM usando el código de ejemplo C#">}}
