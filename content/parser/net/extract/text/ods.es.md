...
############################# Head ############################
head_title: "Extraer texto de ODS en C#"
head_description: "Extraiga rápidamente texto de un archivo de documentos en C#."

############################# Header ############################
title: "Extraer texto de ODS en C#"
description: "Extraiga texto de ODS con unas pocas líneas de código .NET."
...
about:
    enable: true
    title: "¿Cómo extraer un texto de ODS archivos .NET API?"
    content: |
...
steps:
    enable: true
    title_left: "Extraer texto de ODS en .NET"
    content_left: |
        [GroupDocs.Parser for .NET](/es/parser/net/) facilita a los desarrolladores de C# extraer un texto de un archivo ODS mediante la implementación de unos sencillos pasos.
    ...
    code: |
     ...
     {{< parser/code-parser title="Cómo extraer texto del archivo ODS usando el código de ejemplo C#">}}
