...
############################# Head ############################
head_title: "Extraer texto de MSG en C#"
head_description: "Extraiga rápidamente texto de un archivo de documentos en C#."

############################# Header ############################
title: "Extraer texto de MSG en C#"
description: "Extraiga texto de MSG con unas pocas líneas de código .NET."
...
about:
    enable: true
    title: "¿Cómo extraer un texto de MSG archivos .NET API?"
    content: |
...
steps:
    enable: true
    title_left: "Extraer texto de MSG en .NET"
    content_left: |
        [GroupDocs.Parser for .NET](/es/parser/net/) facilita a los desarrolladores de C# extraer un texto de un archivo MSG mediante la implementación de unos sencillos pasos.
    ...
    code: |
     ...
     {{< parser/code-parser title="Cómo extraer texto del archivo MSG usando el código de ejemplo C#">}}
