...
############################# Head ############################
head_title: "Ekstrak Teks dari CSV di C#"
head_description: "Ekstrak teks dengan cepat dari file dokumen di C#."

############################# Header ############################
title: "Ekstrak teks dari CSV Di C#"
description: "Ekstrak teks dari CSV dengan beberapa baris kode .NET."
...
about:
    enable: true
    title: "Bagaimana cara mengekstrak teks dari CSV file .NET API?"
    content: |
...
steps:
    enable: true
    title_left: "Ekstrak teks dari CSV di .NET"
    content_left: |
        [GroupDocs.Parser for .NET](/id/parser/net/) memudahkan pengembang C# untuk mengekstrak teks dari file CSV dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< parser/code-parser title="Cara mengekstrak teks dari file CSV menggunakan kode contoh C#">}}
