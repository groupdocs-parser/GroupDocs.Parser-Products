...
############################# Head ############################
head_title: "Извлечь текст из XLT в C#"
head_description: "Быстро извлекайте текст из файла XLT в C#. Сохраните новый документ, содержащий выбранные страницы, с помощью API слияния документов."

############################# Header ############################
title: "Извлечь текст из XLT в C#"
description: "Извлеките текст из XLT с помощью нескольких строк кода .NET."
...
about:
    enable: true
    title: "Как извлечь текст из XLT файлов .NET API?"
    content: |
...
steps:
    enable: true
    title_left: "Извлечь текст из XLT в C# API?"
    content_left: |
        [GroupDocs.Parser for .NET](/ru/parser/net/) позволяет разработчикам C# легко извлекать текст из файла XLT, реализуя несколько простых шаги.
    ...
    code: |
     ...
     {{< parser/code-parser title="Как извлечь текст из файла XLT, используя пример кода C#">}}
