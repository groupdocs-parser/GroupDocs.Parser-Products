...
############################# Head ############################
head_title: "Extraire le texte de XLSM dans C#"
head_description: "Extrayez rapidement du texte d'un fichier de documents dans C#."

############################# Header ############################
title: "Extraire le texte de XLSM Dans C#"
description: "Extrayez le texte de XLSM avec quelques lignes de code .NET."
...
about:
    enable: true
    title: "Comment extraire un texte de XLSM fichiers .NET API ?"
    content: |
...
steps:
    enable: true
    title_left: "Extraire le texte de XLSM dans .NET"
    content_left: |
        [GroupDocs.Parser for .NET](/fr/parser/net/) permet aux développeurs C# d'extraire facilement un texte d'un fichier XLSM en mettant en œuvre quelques étapes simples.
    ...
    code: |
     ...
     {{< parser/code-parser title="Comment extraire du texte du fichier XLSM à l'aide de l'exemple de code C#">}}
