...
############################# Head ############################
head_title: "Extraer texto de XML en C#"
head_description: "Extraiga rápidamente texto de un archivo de documentos en C#."

############################# Header ############################
title: "Extraer texto de XML en C#"
description: "Extraiga texto de XML con unas pocas líneas de código .NET."
...
about:
    enable: true
    title: "¿Cómo extraer un texto de XML archivos .NET API?"
    content: |
...
steps:
    enable: true
    title_left: "Extraer texto de XML en .NET"
    content_left: |
        [GroupDocs.Parser for .NET](/es/parser/net/) facilita a los desarrolladores de C# extraer un texto de un archivo XML mediante la implementación de unos sencillos pasos.
    ...
    code: |
     ...
     {{< parser/code-parser title="Cómo extraer texto del archivo XML usando el código de ejemplo C#">}}
