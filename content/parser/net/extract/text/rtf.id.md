...
############################# Head ############################
head_title: "Ekstrak Teks dari RTF di C#"
head_description: "Ekstrak teks dengan cepat dari file dokumen di C#."

############################# Header ############################
title: "Ekstrak teks dari RTF Di C#"
description: "Ekstrak teks dari RTF dengan beberapa baris kode .NET."
...
about:
    enable: true
    title: "Bagaimana cara mengekstrak teks dari RTF file .NET API?"
    content: |
...
steps:
    enable: true
    title_left: "Ekstrak teks dari RTF di .NET"
    content_left: |
        [GroupDocs.Parser for .NET](/id/parser/net/) memudahkan pengembang C# untuk mengekstrak teks dari file RTF dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< parser/code-parser title="Cara mengekstrak teks dari file RTF menggunakan kode contoh C#">}}
