...
############################# Head ############################
head_title: "Extract Text from FB2 in C#"
head_description: "Quickly extract text from a documents file in C#."

############################# Header ############################
title: "Extract text from FB2 In C#"
description: "Extract text from FB2 with a few lines of .NET code."
...
about:
    enable: true
    title: "How to extract a text from FB2 files .NET API?"
    content: |
...
steps:
    enable: true
    title_left: "Extract text from FB2 in .NET"
    content_left: |
        [GroupDocs.Parser for .NET](/parser/net/) makes it easy for C# developers to extract a text from a FB2 file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< parser/code-parser title="How to extract text from FB2 file using C# example code">}}
