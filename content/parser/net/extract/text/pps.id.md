...
############################# Head ############################
head_title: "Ekstrak Teks dari PPS di C#"
head_description: "Ekstrak teks dengan cepat dari file dokumen di C#."

############################# Header ############################
title: "Ekstrak teks dari PPS Di C#"
description: "Ekstrak teks dari PPS dengan beberapa baris kode .NET."
...
about:
    enable: true
    title: "Bagaimana cara mengekstrak teks dari PPS file .NET API?"
    content: |
...
steps:
    enable: true
    title_left: "Ekstrak teks dari PPS di .NET"
    content_left: |
        [GroupDocs.Parser for .NET](/id/parser/net/) memudahkan pengembang C# untuk mengekstrak teks dari file PPS dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< parser/code-parser title="Cara mengekstrak teks dari file PPS menggunakan kode contoh C#">}}
