...
############################# Head ############################
head_title: "Извлечь текст из PPTX в C#"
head_description: "Быстро извлекайте текст из файла PPTX в C#. Сохраните новый документ, содержащий выбранные страницы, с помощью API слияния документов."

############################# Header ############################
title: "Извлечь текст из PPTX в C#"
description: "Извлеките текст из PPTX с помощью нескольких строк кода .NET."
...
about:
    enable: true
    title: "Как извлечь текст из PPTX файлов .NET API?"
    content: |
...
steps:
    enable: true
    title_left: "Извлечь текст из PPTX в C# API?"
    content_left: |
        [GroupDocs.Parser for .NET](/ru/parser/net/) позволяет разработчикам C# легко извлекать текст из файла PPTX, реализуя несколько простых шаги.
    ...
    code: |
     ...
     {{< parser/code-parser title="Как извлечь текст из файла PPTX, используя пример кода C#">}}
