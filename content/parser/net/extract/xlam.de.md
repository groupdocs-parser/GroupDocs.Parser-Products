...
draft: false
path: "de/parser/net/extract/xlam/"
...
steps:
    enable: true
    block:
    - title_left: "Hyperlinks aus XLAM-Dokumenten über .NET extrahieren"
      content_left: |
       GroupDocs.Parser .NET bietet vollständige Unterstützung für das Extrahieren von Hyperlinks aus XLAM-Dokumenten. Das folgende C# .NET-Codebeispiel zeigt, wie Hyperlinks in einem XLAM-Dokument extrahiert werden.
    ...
    - title_left: "Extrahieren Sie Hyperlinks von der Seite XLAM Dokumente"
      content_left: |
    ...
    - title_left: "Extrahieren Sie Hyperlinks aus dem Seitenbereich für XLAM-Dokumente"
      content_left: |
       GroupDocs.Parser .NET API unterstützt die Extraktion von Hyperlinks aus XLAM-Dokumenten mit Leichtigkeit. Das folgende .NET-Codebeispiel zeigt, wie Hyperlinks aus einem XLAM-Dokumentseitenbereich extrahiert werden.
