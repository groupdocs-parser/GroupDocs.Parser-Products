...
steps:
    enable: true
    block:
    - title_left: "Ekstrak Hyperlink dari DOT Dokumen melalui .NET"
      content_left: |
       GroupDocs.Parser .NET menyediakan dukungan lengkap untuk mengekstraksi Hyperlink dari dokumen DOT. Contoh kode C# .NET berikut menunjukkan cara mengekstrak hyperlink di dalam dokumen DOT. 
    ...
    - title_left: "Ekstrak Hyperlink dari Halaman Dokumen DOT"
      content_left: |
    ...
    - title_left: "Ekstrak Hyperlink dari DOT Area Halaman Dokumen"
      content_left: |
       GroupDocs.Parser .NET API sepenuhnya mendukung ekstraksi hyperlink dari dokumen DOT dengan mudah. Contoh kode .NET berikut menunjukkan cara mengekstrak hyperlink dari area halaman dokumen DOT.
