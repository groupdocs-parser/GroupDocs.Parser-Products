...
steps:
    enable: true
    block:
    - title_left: "Ekstrak Hyperlink dari OST Dokumen melalui .NET"
      content_left: |
       GroupDocs.Parser .NET menyediakan dukungan lengkap untuk mengekstraksi Hyperlink dari dokumen OST. Contoh kode C# .NET berikut menunjukkan cara mengekstrak hyperlink di dalam dokumen OST. 
    ...
    - title_left: "Ekstrak Hyperlink dari Halaman Dokumen OST"
      content_left: |
    ...
    - title_left: "Ekstrak Hyperlink dari OST Area Halaman Dokumen"
      content_left: |
       GroupDocs.Parser .NET API sepenuhnya mendukung ekstraksi hyperlink dari dokumen OST dengan mudah. Contoh kode .NET berikut menunjukkan cara mengekstrak hyperlink dari area halaman dokumen OST.
