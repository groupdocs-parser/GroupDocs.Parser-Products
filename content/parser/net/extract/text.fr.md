...
############################# Head ############################
head_title: "Extraire le texte des documents dans C#"
head_description: "Extrayez rapidement du texte d'un fichier de documents dans C#."

############################# Header ############################
title: "Extraire le texte des documents dans C#"
description: "Extrayez du texte de documents avec quelques lignes de code .NET."
...
about:
    enable: true
    title: "Comment extraire un texte des fichiers API .NET ?"
    content: |
...
steps:
    enable: true
    title_left: "Extraire le texte des documents dans .NET"
    content_left: |
        [GroupDocs.Parser for .NET](/fr/parser/net/) permet aux développeurs C# d'extraire facilement un texte de documents en mettant en œuvre quelques étapes simples.
    ...
    code: |
     ...
     {{< parser/code-parser title="Comment extraire du texte de documents à l'aide de l'exemple de code C#">}}
