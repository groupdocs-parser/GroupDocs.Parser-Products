...
steps:
    enable: true
    block:
    - title_left: "Ekstrak Hyperlink dari PPTX Dokumen melalui .NET"
      content_left: |
       GroupDocs.Parser .NET menyediakan dukungan lengkap untuk mengekstraksi Hyperlink dari dokumen PPTX. Contoh kode C# .NET berikut menunjukkan cara mengekstrak hyperlink di dalam dokumen PPTX. 
    ...
    - title_left: "Ekstrak Hyperlink dari Halaman Dokumen PPTX"
      content_left: |
    ...
    - title_left: "Ekstrak Hyperlink dari PPTX Area Halaman Dokumen"
      content_left: |
       GroupDocs.Parser .NET API sepenuhnya mendukung ekstraksi hyperlink dari dokumen PPTX dengan mudah. Contoh kode .NET berikut menunjukkan cara mengekstrak hyperlink dari area halaman dokumen PPTX.
