...
steps:
    enable: true
    block:
    - title_left: "Ekstrak Hyperlink dari EMLX Dokumen melalui .NET"
      content_left: |
       GroupDocs.Parser .NET menyediakan dukungan lengkap untuk mengekstraksi Hyperlink dari dokumen EMLX. Contoh kode C# .NET berikut menunjukkan cara mengekstrak hyperlink di dalam dokumen EMLX. 
    ...
    - title_left: "Ekstrak Hyperlink dari Halaman Dokumen EMLX"
      content_left: |
    ...
    - title_left: "Ekstrak Hyperlink dari EMLX Area Halaman Dokumen"
      content_left: |
       GroupDocs.Parser .NET API sepenuhnya mendukung ekstraksi hyperlink dari dokumen EMLX dengan mudah. Contoh kode .NET berikut menunjukkan cara mengekstrak hyperlink dari area halaman dokumen EMLX.
