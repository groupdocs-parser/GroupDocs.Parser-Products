...
steps:
    enable: true
    block:
    - title_left: "Ekstrak Hyperlink dari DOCX Dokumen melalui .NET"
      content_left: |
       GroupDocs.Parser .NET menyediakan dukungan lengkap untuk mengekstraksi Hyperlink dari dokumen DOCX. Contoh kode C# .NET berikut menunjukkan cara mengekstrak hyperlink di dalam dokumen DOCX. 
    ...
    - title_left: "Ekstrak Hyperlink dari Halaman Dokumen DOCX"
      content_left: |
    ...
    - title_left: "Ekstrak Hyperlink dari DOCX Area Halaman Dokumen"
      content_left: |
       GroupDocs.Parser .NET API sepenuhnya mendukung ekstraksi hyperlink dari dokumen DOCX dengan mudah. Contoh kode .NET berikut menunjukkan cara mengekstrak hyperlink dari area halaman dokumen DOCX.
