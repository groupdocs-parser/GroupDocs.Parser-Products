...
about:
    enable: true
    title: "Comment extraire des tableaux de Excel, Word, PDF et d'autres documents via l'API .NET ?"
    content: |
...
steps:
    enable: true
    title_left: "Extraire les tables des documents dans .NET"
    content_left: |
        [GroupDocs.Parser for .NET](/fr/parser/net/) permet aux développeurs C# d'extraire facilement des tableaux de documents en mettant en œuvre quelques étapes simples.
    ...
    code: |
     ...
     {{< parser/code-parser title="Comment extraire des tableaux de documents à l'aide de l'exemple de code C#">}}
