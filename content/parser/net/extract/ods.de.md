...
draft: false
path: "de/parser/net/extract/ods/"
...
steps:
    enable: true
    block:
    - title_left: "Hyperlinks aus ODS-Dokumenten über .NET extrahieren"
      content_left: |
       GroupDocs.Parser .NET bietet vollständige Unterstützung für das Extrahieren von Hyperlinks aus ODS-Dokumenten. Das folgende C# .NET-Codebeispiel zeigt, wie Hyperlinks in einem ODS-Dokument extrahiert werden.
    ...
    - title_left: "Extrahieren Sie Hyperlinks von der Seite ODS Dokumente"
      content_left: |
    ...
    - title_left: "Extrahieren Sie Hyperlinks aus dem Seitenbereich für ODS-Dokumente"
      content_left: |
       GroupDocs.Parser .NET API unterstützt die Extraktion von Hyperlinks aus ODS-Dokumenten mit Leichtigkeit. Das folgende .NET-Codebeispiel zeigt, wie Hyperlinks aus einem ODS-Dokumentseitenbereich extrahiert werden.
