...
about:
    enable: true
    title: "How to Extract Barcodes from Excel, Word, PDF & Other Documents .NET API?"
    content: |
...
steps:
    enable: true
    title_left: "Extract barcodes from documents in .NET"
    content_left: |
        [GroupDocs.Parser for .NET](/parser/net/) makes it easy for C# developers to extract barcodes from documents by implementing a few easy steps.
    ...
    code: |
     ...
     {{< parser/code-parser title="How to extract barcodes from documents using C# example code">}}
