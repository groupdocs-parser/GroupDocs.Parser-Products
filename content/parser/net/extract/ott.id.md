...
steps:
    enable: true
    block:
    - title_left: "Ekstrak Hyperlink dari OTT Dokumen melalui .NET"
      content_left: |
       GroupDocs.Parser .NET menyediakan dukungan lengkap untuk mengekstraksi Hyperlink dari dokumen OTT. Contoh kode C# .NET berikut menunjukkan cara mengekstrak hyperlink di dalam dokumen OTT. 
    ...
    - title_left: "Ekstrak Hyperlink dari Halaman Dokumen OTT"
      content_left: |
    ...
    - title_left: "Ekstrak Hyperlink dari OTT Area Halaman Dokumen"
      content_left: |
       GroupDocs.Parser .NET API sepenuhnya mendukung ekstraksi hyperlink dari dokumen OTT dengan mudah. Contoh kode .NET berikut menunjukkan cara mengekstrak hyperlink dari area halaman dokumen OTT.
