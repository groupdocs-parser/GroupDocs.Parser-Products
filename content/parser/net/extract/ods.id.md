...
steps:
    enable: true
    block:
    - title_left: "Ekstrak Hyperlink dari ODS Dokumen melalui .NET"
      content_left: |
       GroupDocs.Parser .NET menyediakan dukungan lengkap untuk mengekstraksi Hyperlink dari dokumen ODS. Contoh kode C# .NET berikut menunjukkan cara mengekstrak hyperlink di dalam dokumen ODS. 
    ...
    - title_left: "Ekstrak Hyperlink dari Halaman Dokumen ODS"
      content_left: |
    ...
    - title_left: "Ekstrak Hyperlink dari ODS Area Halaman Dokumen"
      content_left: |
       GroupDocs.Parser .NET API sepenuhnya mendukung ekstraksi hyperlink dari dokumen ODS dengan mudah. Contoh kode .NET berikut menunjukkan cara mengekstrak hyperlink dari area halaman dokumen ODS.
