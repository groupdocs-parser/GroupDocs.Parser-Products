...
steps:
    enable: true
    block:
    - title_left: "Extract Images from DOTX Documents via C# "
      content_left: |
       GroupDocs.Parser .NET API enables software developers to extract images from DOTX documents. The following C# .NET code example demonstrates how to extract images inside a DOTX document. 
    ...
    - title_left: "Images Extraction from DOTX Document's Page via C#"
      content_left: |
       GroupDocs.Parser .NET allows software developers to extract images from DOTX documents's page. The below C# .NET code shows how images extraction can be achived  inside a DOTX document. 
    ...
    - title_left: "How to Extract Image from DOTX Documents Page Area"
      content_left: |
       GroupDocs.Parser .NET API fully supports extraction of images from DOTX documents using a couple of lines of .NET code. The following .NET code example shows how to perform images extraction from a DOTX document page area.
    ...
    - title_left: "How to Extract & Save Image to a File via C# .NET"
      content_left: |
       GroupDocs.Parser .NET API allows software developers to extract images from a document and save it into a file with a just couple of lines of .NET code. The following example demonstrates  how to perform images extraction from a DOTX document and save the image contents to the file. 
