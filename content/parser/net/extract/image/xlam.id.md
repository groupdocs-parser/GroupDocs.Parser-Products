...
steps:
    enable: true
    block:
    - title_left: "Ekstrak Gambar dari XLAM Dokumen melalui C# "
      content_left: |
       GroupDocs.Parser .NET API memungkinkan pengembang perangkat lunak mengekstrak gambar dari dokumen XLAM. Contoh kode C# .NET berikut menunjukkan cara mengekstrak gambar di dalam dokumen XLAM. 
    ...
    - title_left: "Ekstraksi Gambar dari Halaman Dokumen XLAM melalui C#"
      content_left: |
       GroupDocs.Parser .NET memungkinkan pengembang perangkat lunak mengekstrak gambar dari halaman dokumen XLAM. Kode C# .NET di bawah ini menunjukkan bagaimana ekstraksi gambar dapat dilakukan di dalam dokumen XLAM. 
    ...
    - title_left: "Cara Mengekstrak Gambar dari Area Halaman Dokumen XLAM"
      content_left: |
       GroupDocs.Parser .NET API sepenuhnya mendukung ekstraksi gambar dari dokumen XLAM menggunakan beberapa baris kode .NET. Contoh kode .NET berikut menunjukkan cara melakukan ekstraksi gambar dari area halaman dokumen XLAM.
    ...
    - title_left: "Cara Mengekstrak & Menyimpan Gambar ke File melalui C# .NET"
      content_left: |
       GroupDocs.Parser .NET API memungkinkan pengembang perangkat lunak mengekstrak gambar dari dokumen dan menyimpannya ke dalam file hanya dengan beberapa baris kode .NET. Contoh berikut menunjukkan cara melakukan ekstraksi gambar dari dokumen XLAM dan menyimpan konten gambar ke file. 
