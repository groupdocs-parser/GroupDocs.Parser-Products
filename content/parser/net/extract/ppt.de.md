...
draft: false
path: "de/parser/net/extract/ppt/"
...
steps:
    enable: true
    block:
    - title_left: "Hyperlinks aus PPT-Dokumenten über .NET extrahieren"
      content_left: |
       GroupDocs.Parser .NET bietet vollständige Unterstützung für das Extrahieren von Hyperlinks aus PPT-Dokumenten. Das folgende C# .NET-Codebeispiel zeigt, wie Hyperlinks in einem PPT-Dokument extrahiert werden.
    ...
    - title_left: "Extrahieren Sie Hyperlinks von der Seite PPT Dokumente"
      content_left: |
    ...
    - title_left: "Extrahieren Sie Hyperlinks aus dem Seitenbereich für PPT-Dokumente"
      content_left: |
       GroupDocs.Parser .NET API unterstützt die Extraktion von Hyperlinks aus PPT-Dokumenten mit Leichtigkeit. Das folgende .NET-Codebeispiel zeigt, wie Hyperlinks aus einem PPT-Dokumentseitenbereich extrahiert werden.
