...
draft: false
path: "de/parser/net/extract/xlsx/"
...
steps:
    enable: true
    block:
    - title_left: "Hyperlinks aus XLSX-Dokumenten über .NET extrahieren"
      content_left: |
       GroupDocs.Parser .NET bietet vollständige Unterstützung für das Extrahieren von Hyperlinks aus XLSX-Dokumenten. Das folgende C# .NET-Codebeispiel zeigt, wie Hyperlinks in einem XLSX-Dokument extrahiert werden.
    ...
    - title_left: "Extrahieren Sie Hyperlinks von der Seite XLSX Dokumente"
      content_left: |
    ...
    - title_left: "Extrahieren Sie Hyperlinks aus dem Seitenbereich für XLSX-Dokumente"
      content_left: |
       GroupDocs.Parser .NET API unterstützt die Extraktion von Hyperlinks aus XLSX-Dokumenten mit Leichtigkeit. Das folgende .NET-Codebeispiel zeigt, wie Hyperlinks aus einem XLSX-Dokumentseitenbereich extrahiert werden.
