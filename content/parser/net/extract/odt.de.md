...
draft: false
path: "de/parser/net/extract/odt/"
...
steps:
    enable: true
    block:
    - title_left: "Hyperlinks aus ODT-Dokumenten über .NET extrahieren"
      content_left: |
       GroupDocs.Parser .NET bietet vollständige Unterstützung für das Extrahieren von Hyperlinks aus ODT-Dokumenten. Das folgende C# .NET-Codebeispiel zeigt, wie Hyperlinks in einem ODT-Dokument extrahiert werden.
    ...
    - title_left: "Extrahieren Sie Hyperlinks von der Seite ODT Dokumente"
      content_left: |
    ...
    - title_left: "Extrahieren Sie Hyperlinks aus dem Seitenbereich für ODT-Dokumente"
      content_left: |
       GroupDocs.Parser .NET API unterstützt die Extraktion von Hyperlinks aus ODT-Dokumenten mit Leichtigkeit. Das folgende .NET-Codebeispiel zeigt, wie Hyperlinks aus einem ODT-Dokumentseitenbereich extrahiert werden.
