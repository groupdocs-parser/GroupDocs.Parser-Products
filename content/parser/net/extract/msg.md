...
steps:
    enable: true
    block:
    - title_left: "Extract Hyperlinks from MSG Documents via .NET"
      content_left: |
       GroupDocs.Parser .NET provides complete support for extracting Hyperlinks from MSG documents. The following C# .NET code example demonstrates how to extract hyperlinks inside a MSG document. 
    ...
    - title_left: "Extract Hyperlinks from MSG Documents Page"
      content_left: |
    ...
    - title_left: "Extract Hyperlinks from MSG Documents Page Area"
      content_left: |
       GroupDocs.Parser .NET API fully supports extraction of hyperlinks from MSG documents with ease. The following .NET code example demonstrates how to extract hyperlinks from a MSG document page area.
