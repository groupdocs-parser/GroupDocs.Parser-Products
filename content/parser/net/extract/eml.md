...
steps:
    enable: true
    block:
    - title_left: "Extract Hyperlinks from EML Documents via .NET"
      content_left: |
       GroupDocs.Parser .NET provides complete support for extracting Hyperlinks from EML documents. The following C# .NET code example demonstrates how to extract hyperlinks inside a EML document. 
    ...
    - title_left: "Extract Hyperlinks from EML Documents Page"
      content_left: |
    ...
    - title_left: "Extract Hyperlinks from EML Documents Page Area"
      content_left: |
       GroupDocs.Parser .NET API fully supports extraction of hyperlinks from EML documents with ease. The following .NET code example demonstrates how to extract hyperlinks from a EML document page area.
