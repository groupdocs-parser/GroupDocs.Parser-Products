...
steps:
    enable: true
    block:
    - title_left: "Extract Hyperlinks from PDF Documents via .NET"
      content_left: |
       GroupDocs.Parser .NET provides complete support for extracting Hyperlinks from PDF documents. The following C# .NET code example demonstrates how to extract hyperlinks inside a PDF document. 
    ...
    - title_left: "Extract Hyperlinks from PDF Documents Page"
      content_left: |
    ...
    - title_left: "Extract Hyperlinks from PDF Documents Page Area"
      content_left: |
       GroupDocs.Parser .NET API fully supports extraction of hyperlinks from PDF documents with ease. The following .NET code example demonstrates how to extract hyperlinks from a PDF document page area.
