...
draft: false
path: "es/parser/net/extract/pst/"
...
steps:
    enable: true
    block:
    - title_left: "Extraiga hipervínculos de PST Documentos a través de .NET"
      content_left: |
       GroupDocs.Parser .NET brinda soporte completo para extraer hipervínculos de documentos PST. El siguiente ejemplo de código C# .NET demuestra cómo extraer hipervínculos dentro de un documento PST. 
    ...
    - title_left: "Extraer hipervínculos de la página de documentos PST"
      content_left: |
    ...
    - title_left: "Extraer hipervínculos del área de la página de documentos PST"
      content_left: |
       GroupDocs.Parser .NET API es totalmente compatible con la extracción de hipervínculos de documentos PST con facilidad. El siguiente ejemplo de código .NET demuestra cómo extraer hipervínculos de un área de página de documento PST.
