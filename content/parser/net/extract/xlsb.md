...
steps:
    enable: true
    block:
    - title_left: "Extract Hyperlinks from XLSB Documents via .NET"
      content_left: |
       GroupDocs.Parser .NET provides complete support for extracting Hyperlinks from XLSB documents. The following C# .NET code example demonstrates how to extract hyperlinks inside a XLSB document. 
    ...
    - title_left: "Extract Hyperlinks from XLSB Documents Page"
      content_left: |
    ...
    - title_left: "Extract Hyperlinks from XLSB Documents Page Area"
      content_left: |
       GroupDocs.Parser .NET API fully supports extraction of hyperlinks from XLSB documents with ease. The following .NET code example demonstrates how to extract hyperlinks from a XLSB document page area.
