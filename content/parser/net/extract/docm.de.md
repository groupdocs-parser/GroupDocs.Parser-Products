...
draft: false
path: "de/parser/net/extract/docm/"
...
steps:
    enable: true
    block:
    - title_left: "Hyperlinks aus DOCM-Dokumenten über .NET extrahieren"
      content_left: |
       GroupDocs.Parser .NET bietet vollständige Unterstützung für das Extrahieren von Hyperlinks aus DOCM-Dokumenten. Das folgende C# .NET-Codebeispiel zeigt, wie Hyperlinks in einem DOCM-Dokument extrahiert werden.
    ...
    - title_left: "Extrahieren Sie Hyperlinks von der Seite DOCM Dokumente"
      content_left: |
    ...
    - title_left: "Extrahieren Sie Hyperlinks aus dem Seitenbereich für DOCM-Dokumente"
      content_left: |
       GroupDocs.Parser .NET API unterstützt die Extraktion von Hyperlinks aus DOCM-Dokumenten mit Leichtigkeit. Das folgende .NET-Codebeispiel zeigt, wie Hyperlinks aus einem DOCM-Dokumentseitenbereich extrahiert werden.
