...
about:
    enable: true
    title: "Wie extrahiere ich Barcodes aus der API Excel, Word, PDF und anderen Dokumenten .NET?"
    content: |
...
steps:
    enable: true
    title_left: "Barcodes aus Dokumenten in .NET extrahieren"
    content_left: |
        [GroupDocs.Parser for .NET](/de/parser/net/) erleichtert C# Entwicklern das Extrahieren von Barcodes aus Dokumenten durch die Implementierung einiger einfacher Schritte.
    ...
    code: |
     ...
     {{< parser/code-parser title="So extrahieren Sie Barcodes aus Dokumenten mithilfe des Beispielcodes C#">}}
