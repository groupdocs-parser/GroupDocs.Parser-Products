...
steps:
    enable: true
    block:
    - title_left: "Extract Hyperlinks from XLTX Documents via .NET"
      content_left: |
       GroupDocs.Parser .NET provides complete support for extracting Hyperlinks from XLTX documents. The following C# .NET code example demonstrates how to extract hyperlinks inside a XLTX document. 
    ...
    - title_left: "Extract Hyperlinks from XLTX Documents Page"
      content_left: |
    ...
    - title_left: "Extract Hyperlinks from XLTX Documents Page Area"
      content_left: |
       GroupDocs.Parser .NET API fully supports extraction of hyperlinks from XLTX documents with ease. The following .NET code example demonstrates how to extract hyperlinks from a XLTX document page area.
