...
############################# Head ############################
head_title: "Извлечение таблиц из PDF, DOCX, PPTX, XLSX, EPUB и других файлов через .NET C# API"
...
############################# Header ############################
title: "Извлечение таблиц из документов Excel, Word, PDF и PowerPoint через .NET C# API"
...
about:
    enable: true
    title: "Как извлечь таблицы из Excel, Word, PDF и других документов с помощью .NET API?"
    content: |
...
steps:
    enable: true
    title_left: "Извлечение таблиц из документов в .NET"
    content_left: |
        [GroupDocs.Parser for .NET](/ru/parser/net/) позволяет разработчикам C# легко извлекать таблицы из документов, выполняя несколько простых шагов.
    ...
    code: |
     ...
     {{< parser/code-parser title="Как извлечь таблицы из документов, используя пример кода C#">}}

        ```csharp    
        // Извлечение таблиц из документов с помощью API GroupDocs.Parser
