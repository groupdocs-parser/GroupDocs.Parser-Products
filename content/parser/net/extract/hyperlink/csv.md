...
about:
    enable: true
    title: "How to Parse & Extract Hyperlinks from CSV documents via .NET API?"
    content: |
...
steps:
    enable: true
    title_left: "Extract hyperlinks from CSV in .NET"
    content_left: |
        [GroupDocs.Parser for .NET](/parser/net/) makes it easy for C# developers to extract hyperlinks from a CSV file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< parser/code-parser title="How to extract hyperlinks from CSV file using C# example code">}}
