...
about:
    enable: true
    title: "Wie kann ich Hyperlinks aus XLA-Dokumenten über die .NET-API analysieren und extrahieren?"
    content: |
...
steps:
    enable: true
    title_left: "Extrahieren Sie Hyperlinks von XLA in .NET"
    content_left: |
        [GroupDocs.Parser for .NET](/de/parser/net/) erleichtert C#-Entwicklern das Extrahieren von Hyperlinks aus einer XLA-Datei durch die Implementierung einiger einfacher Schritte.
    ...
    code: |
     ...
     {{< parser/code-parser title="So extrahieren Sie Hyperlinks aus der Datei XLA mithilfe des Beispielcodes C#">}}
