...
about:
    enable: true
    title: "Comment analyser et extraire les hyperliens des documents DOCX via l'API .NET ?"
    content: |
...
steps:
    enable: true
    title_left: "Extraire les hyperliens de DOCX dans .NET"
    content_left: |
        [GroupDocs.Parser for .NET](/fr/parser/net/) permet aux développeurs C# d'extraire facilement des liens hypertexte d'un fichier DOCX en mettant en œuvre quelques étapes simples.
    ...
    code: |
     ...
     {{< parser/code-parser title="Comment extraire des hyperliens du fichier DOCX à l'aide de l'exemple de code C#">}}
