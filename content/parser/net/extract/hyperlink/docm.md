...
about:
    enable: true
    title: "How to Parse & Extract Hyperlinks from DOCM documents via .NET API?"
    content: |
...
steps:
    enable: true
    title_left: "Extract hyperlinks from DOCM in .NET"
    content_left: |
        [GroupDocs.Parser for .NET](/parser/net/) makes it easy for C# developers to extract hyperlinks from a DOCM file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< parser/code-parser title="How to extract hyperlinks from DOCM file using C# example code">}}
