...
about:
    enable: true
    title: "Wie kann ich Hyperlinks aus XLTX-Dokumenten über die .NET-API analysieren und extrahieren?"
    content: |
...
steps:
    enable: true
    title_left: "Extrahieren Sie Hyperlinks von XLTX in .NET"
    content_left: |
        [GroupDocs.Parser for .NET](/de/parser/net/) erleichtert C#-Entwicklern das Extrahieren von Hyperlinks aus einer XLTX-Datei durch die Implementierung einiger einfacher Schritte.
    ...
    code: |
     ...
     {{< parser/code-parser title="So extrahieren Sie Hyperlinks aus der Datei XLTX mithilfe des Beispielcodes C#">}}
