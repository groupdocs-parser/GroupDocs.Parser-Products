...
steps:
    enable: true
    block:
    - title_left: "Extract Hyperlinks from POTX Documents via .NET"
      content_left: |
       GroupDocs.Parser .NET provides complete support for extracting Hyperlinks from POTX documents. The following C# .NET code example demonstrates how to extract hyperlinks inside a POTX document. 
    ...
    - title_left: "Extract Hyperlinks from POTX Documents Page"
      content_left: |
    ...
    - title_left: "Extract Hyperlinks from POTX Documents Page Area"
      content_left: |
       GroupDocs.Parser .NET API fully supports extraction of hyperlinks from POTX documents with ease. The following .NET code example demonstrates how to extract hyperlinks from a POTX document page area.
