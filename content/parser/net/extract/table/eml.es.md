...
about:
    enable: true
    title: "¿Cómo extraer tablas de archivos EML a través de la API .NET?"
    content: |
...
steps:
    enable: true
    title_left: "Extraer tablas de EML en .NET"
    content_left: |
        [GroupDocs.Parser for .NET](/es/parser/net/) facilita a los desarrolladores de C# extraer tablas de un archivo EML mediante la implementación de unos sencillos pasos.
    ...
    code: |
     ...
     {{< parser/code-parser title="Cómo extraer tablas del archivo EML usando el código de ejemplo C#">}}
