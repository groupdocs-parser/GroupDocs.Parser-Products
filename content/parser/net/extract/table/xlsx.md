...
draft: false
path: "parser/net/extract/table/xlsx/"
...
steps:
    enable: true
    block:
    - title_left: "How to Extract Tables from XLSX Documents via C# .NET "
      content_left: |
       GroupDocs.Parser .NET API helps software developers to extract tables from XLSX documents with just couple of lines of code. The following C# .NET code example demonstrates how developers can extract tables from a XLSX document. 
    ...
    - title_left: "Use .NET API to Extract Tables from XLSX Document's Page"
      content_left: |
       GroupDocs.Parser .NET empowers software developers to extract tables from XLSX documents's page. The following C# .NET code shows how programmers can perform barcodes extraction inside a XLSX document. 
