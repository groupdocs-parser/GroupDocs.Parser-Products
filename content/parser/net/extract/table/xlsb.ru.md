...
############################# Head ############################
head_title: "Извлечение таблиц из XLSB и других файлов через .NET C# API"
...
############################# Header ############################
title: "Извлечение таблиц из XLSB через .NET C# API"
...
about:
    enable: true
    title: "Как извлечь таблицы из файлов XLSB с помощью API .NET?"
    content: |
...
steps:
    enable: true
    title_left: "Извлечь таблицы из XLSB в .NET"
    content_left: |
        [GroupDocs.Parser for .NET](/ru/parser/net/) позволяет разработчикам C# извлекать таблицы из файла XLSB, выполняя несколько простых шагов.
    ...
    code: |
     ...
     {{< parser/code-parser title="Как извлечь таблицы из файла XLSB, используя пример кода C#">}}

        ```csharp    
        // Извлечение таблиц из файла XLSB с помощью API GroupDocs.Parser
