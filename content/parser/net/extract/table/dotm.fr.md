...
about:
    enable: true
    title: "Comment extraire des tables de fichiers DOTM via l'API .NET ?"
    content: |
...
steps:
    enable: true
    title_left: "Extraire les tables de DOTM dans .NET"
    content_left: |
        [GroupDocs.Parser for .NET](/fr/parser/net/) permet aux développeurs C# d'extraire facilement des tables d'un fichier DOTM en mettant en œuvre quelques étapes simples.
    ...
    code: |
     ...
     {{< parser/code-parser title="Comment extraire des tables du fichier DOTM à l'aide de l'exemple de code C#">}}
