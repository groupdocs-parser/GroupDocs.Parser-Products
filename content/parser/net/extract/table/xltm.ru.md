...
############################# Head ############################
head_title: "Извлечение таблиц из XLTM и других файлов через .NET C# API"
...
############################# Header ############################
title: "Извлечение таблиц из XLTM через .NET C# API"
...
about:
    enable: true
    title: "Как извлечь таблицы из файлов XLTM с помощью API .NET?"
    content: |
...
steps:
    enable: true
    title_left: "Извлечь таблицы из XLTM в .NET"
    content_left: |
        [GroupDocs.Parser for .NET](/ru/parser/net/) позволяет разработчикам C# извлекать таблицы из файла XLTM, выполняя несколько простых шагов.
    ...
    code: |
     ...
     {{< parser/code-parser title="Как извлечь таблицы из файла XLTM, используя пример кода C#">}}

        ```csharp    
        // Извлечение таблиц из файла XLTM с помощью API GroupDocs.Parser
