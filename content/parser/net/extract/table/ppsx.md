...
draft: false
path: "parser/net/extract/table/ppsx/"
...
steps:
    enable: true
    block:
    - title_left: "How to Extract Tables from PPSX Documents via C# .NET "
      content_left: |
       GroupDocs.Parser .NET API helps software developers to extract tables from PPSX documents with just couple of lines of code. The following C# .NET code example demonstrates how developers can extract tables from a PPSX document. 
    ...
    - title_left: "Use .NET API to Extract Tables from PPSX Document's Page"
      content_left: |
       GroupDocs.Parser .NET empowers software developers to extract tables from PPSX documents's page. The following C# .NET code shows how programmers can perform barcodes extraction inside a PPSX document. 
