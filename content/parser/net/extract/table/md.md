...
draft: false
path: "parser/net/extract/table/md/"
...
steps:
    enable: true
    block:
    - title_left: "How to Extract Tables from MD Documents via C# .NET "
      content_left: |
       GroupDocs.Parser .NET API helps software developers to extract tables from MD documents with just couple of lines of code. The following C# .NET code example demonstrates how developers can extract tables from a MD document. 
    ...
    - title_left: "Use .NET API to Extract Tables from MD Document's Page via .NET"
      content_left: |
       GroupDocs.Parser .NET empowers software developers to extract tables from MD documents's page. The following C# .NET code shows how programmers can perform barcodes extraction inside a MD document. 
