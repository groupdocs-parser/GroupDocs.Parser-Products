...
draft: false
path: "ko/parser/net/extract/table/epub/"
...
steps:
    enable: true
    block:
    - title_left: "C# .NET을 통해 EPUB 문서에서 테이블을 추출하는 방법 "
      content_left: |
       GroupDocs.Parser .NET API를 사용하면 소프트웨어 개발자가 몇 줄의 코드로 EPUB 문서에서 테이블을 추출할 수 있습니다. 다음 C# .NET 코드 예제는 개발자가 EPUB 문서에서 테이블을 추출하는 방법을 보여줍니다. 
