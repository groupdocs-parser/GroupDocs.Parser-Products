...
draft: false
path: "parser/net/extract/table/docm/"
...
steps:
    enable: true
    block:
    - title_left: "How to Extract Tables from DOCM Documents via C# .NET "
      content_left: |
       GroupDocs.Parser .NET API helps software developers to extract tables from DOCM documents with just couple of lines of code. The following C# .NET code example demonstrates how developers can extract tables from a DOCM document. 
    ...
    - title_left: "Use .NET API to Extract Tables from DOCM Document's Page via .NET"
      content_left: |
       GroupDocs.Parser .NET empowers software developers to extract tables from DOCM documents's page. The following C# .NET code shows how programmers can perform barcodes extraction inside a DOCM document. 
