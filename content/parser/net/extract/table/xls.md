...
about:
    enable: true
    title: "How to Extract Tables from XLS files via .NET API?"
    content: |
...
steps:
    enable: true
    title_left: "Extract tables from XLS in .NET"
    content_left: |
        [GroupDocs.Parser for .NET](/parser/net/) makes it easy for C# developers to extract tables from a XLS file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< parser/code-parser title="How to extract tables from XLS file using C# example code">}}
