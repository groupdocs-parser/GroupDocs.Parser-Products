...
draft: false
path: "parser/net/extract/table/msg/"
...
steps:
    enable: true
    block:
    - title_left: "How to Extract Tables from MSG Documents via C# .NET "
      content_left: |
       GroupDocs.Parser .NET API helps software developers to extract tables from MSG documents with just couple of lines of code. The following C# .NET code example demonstrates how developers can extract tables from a MSG document. 
    ...
    - title_left: "Use .NET API to Extract Tables from MSG Document's Page via .NET"
      content_left: |
       GroupDocs.Parser .NET empowers software developers to extract tables from MSG documents's page. The following C# .NET code shows how programmers can perform barcodes extraction inside a MSG document. 
