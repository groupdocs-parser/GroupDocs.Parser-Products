...
draft: false
path: "de/parser/net/extract/table/ost/"
...
steps:
    enable: true
    block:
    - title_left: "So extrahieren Sie Tabellen aus OST-Dokumenten über C# .NET "
      content_left: |
       GroupDocs.Parser .NET API hilft Softwareentwicklern, Tabellen aus OST-Dokumenten mit nur wenigen Codezeilen zu extrahieren. Das folgende C# .NET-Codebeispiel zeigt, wie Entwickler Tabellen aus einem OST-Dokument extrahieren können. 
    ...
    - title_left: "Verwenden Sie die .NET-API, um Tabellen aus der Seite des OST-Dokuments zu extrahieren"
      content_left: |
       GroupDocs.Parser .NET ermöglicht Softwareentwicklern, Tabellen aus der Seite von OST-Dokumenten zu extrahieren. Der folgende C# .NET-Code zeigt, wie Programmierer eine Barcode-Extraktion innerhalb eines OST-Dokuments durchführen können. 
