...
draft: false
path: "de/parser/net/extract/table/xltx/"
...
steps:
    enable: true
    block:
    - title_left: "So extrahieren Sie Tabellen aus XLTX-Dokumenten über C# .NET "
      content_left: |
       GroupDocs.Parser .NET API hilft Softwareentwicklern, Tabellen aus XLTX-Dokumenten mit nur wenigen Codezeilen zu extrahieren. Das folgende C# .NET-Codebeispiel zeigt, wie Entwickler Tabellen aus einem XLTX-Dokument extrahieren können. 
    ...
    - title_left: "Verwenden Sie die .NET-API, um Tabellen aus der Seite des XLTX-Dokuments zu extrahieren"
      content_left: |
       GroupDocs.Parser .NET ermöglicht Softwareentwicklern, Tabellen aus der Seite von XLTX-Dokumenten zu extrahieren. Der folgende C# .NET-Code zeigt, wie Programmierer eine Barcode-Extraktion innerhalb eines XLTX-Dokuments durchführen können. 
