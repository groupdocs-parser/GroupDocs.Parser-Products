...
draft: false
path: "parser/net/extract/table/dotm/"
...
steps:
    enable: true
    block:
    - title_left: "How to Extract Tables from DOTM Documents via C# .NET "
      content_left: |
       GroupDocs.Parser .NET API helps software developers to extract tables from DOTM documents with just couple of lines of code. The following C# .NET code example demonstrates how developers can extract tables from a DOTM document. 
    ...
    - title_left: "Use .NET API to Extract Tables from DOTM Document's Page via .NET"
      content_left: |
       GroupDocs.Parser .NET empowers software developers to extract tables from DOTM documents's page. The following C# .NET code shows how programmers can perform barcodes extraction inside a DOTM document. 
