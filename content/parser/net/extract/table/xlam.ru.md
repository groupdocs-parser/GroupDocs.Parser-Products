...
############################# Head ############################
head_title: "Извлечение таблиц из XLAM и других файлов через .NET C# API"
...
############################# Header ############################
title: "Извлечение таблиц из XLAM через .NET C# API"
...
about:
    enable: true
    title: "Как извлечь таблицы из файлов XLAM с помощью API .NET?"
    content: |
...
steps:
    enable: true
    title_left: "Извлечь таблицы из XLAM в .NET"
    content_left: |
        [GroupDocs.Parser for .NET](/ru/parser/net/) позволяет разработчикам C# извлекать таблицы из файла XLAM, выполняя несколько простых шагов.
    ...
    code: |
     ...
     {{< parser/code-parser title="Как извлечь таблицы из файла XLAM, используя пример кода C#">}}

        ```csharp    
        // Извлечение таблиц из файла XLAM с помощью API GroupDocs.Parser
