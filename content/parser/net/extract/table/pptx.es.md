...
about:
    enable: true
    title: "¿Cómo extraer tablas de archivos PPTX a través de la API .NET?"
    content: |
...
steps:
    enable: true
    title_left: "Extraer tablas de PPTX en .NET"
    content_left: |
        [GroupDocs.Parser for .NET](/es/parser/net/) facilita a los desarrolladores de C# extraer tablas de un archivo PPTX mediante la implementación de unos sencillos pasos.
    ...
    code: |
     ...
     {{< parser/code-parser title="Cómo extraer tablas del archivo PPTX usando el código de ejemplo C#">}}
