...
############################# Head ############################
head_title: "Извлечение таблиц из ODS и других файлов через .NET C# API"
...
############################# Header ############################
title: "Извлечение таблиц из ODS через .NET C# API"
...
about:
    enable: true
    title: "Как извлечь таблицы из файлов ODS с помощью API .NET?"
    content: |
...
steps:
    enable: true
    title_left: "Извлечь таблицы из ODS в .NET"
    content_left: |
        [GroupDocs.Parser for .NET](/ru/parser/net/) позволяет разработчикам C# извлекать таблицы из файла ODS, выполняя несколько простых шагов.
    ...
    code: |
     ...
     {{< parser/code-parser title="Как извлечь таблицы из файла ODS, используя пример кода C#">}}

        ```csharp    
        // Извлечение таблиц из файла ODS с помощью API GroupDocs.Parser
