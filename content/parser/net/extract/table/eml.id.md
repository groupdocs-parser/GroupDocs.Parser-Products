...
about:
    enable: true
    title: "Bagaimana cara Mengekstrak Tabel dari EML file melalui .NET API?"
    content: |
...
steps:
    enable: true
    title_left: "Ekstrak tabel dari EML di .NET"
    content_left: |
        [GroupDocs.Parser for .NET](/id/parser/net/) memudahkan pengembang C# untuk mengekstrak tabel dari file EML dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< parser/code-parser title="Cara mengekstrak tabel dari file EML menggunakan kode contoh C#">}}
