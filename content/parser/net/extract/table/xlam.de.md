...
about:
    enable: true
    title: "Wie extrahiere ich Tabellen aus XLAM-Dateien über die .NET-API?"
    content: |
...
steps:
    enable: true
    title_left: "Tabellen aus XLAM in .NET extrahieren"
    content_left: |
        [GroupDocs.Parser for .NET](/de/parser/net/) erleichtert C#-Entwicklern das Extrahieren von Tabellen aus einer XLAM-Datei durch die Implementierung einiger einfacher Schritte.
    ...
    code: |
     ...
     {{< parser/code-parser title="So extrahieren Sie Tabellen aus der Datei XLAM mithilfe des Beispielcodes C#">}}
