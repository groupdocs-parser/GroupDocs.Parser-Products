...
about:
    enable: true
    title: "Wie extrahiere ich Tabellen aus OTS-Dateien über die .NET-API?"
    content: |
...
steps:
    enable: true
    title_left: "Tabellen aus OTS in .NET extrahieren"
    content_left: |
        [GroupDocs.Parser for .NET](/de/parser/net/) erleichtert C#-Entwicklern das Extrahieren von Tabellen aus einer OTS-Datei durch die Implementierung einiger einfacher Schritte.
    ...
    code: |
     ...
     {{< parser/code-parser title="So extrahieren Sie Tabellen aus der Datei OTS mithilfe des Beispielcodes C#">}}
