...
############################# Head ############################
head_title: "Извлечение таблиц из EPUB и других файлов через .NET C# API"
...
############################# Header ############################
title: "Извлечение таблиц из EPUB через .NET C# API"
...
about:
    enable: true
    title: "Как извлечь таблицы из файлов EPUB с помощью API .NET?"
    content: |
...
steps:
    enable: true
    title_left: "Извлечь таблицы из EPUB в .NET"
    content_left: |
        [GroupDocs.Parser for .NET](/ru/parser/net/) позволяет разработчикам C# извлекать таблицы из файла EPUB, выполняя несколько простых шагов.
    ...
    code: |
     ...
     {{< parser/code-parser title="Как извлечь таблицы из файла EPUB, используя пример кода C#">}}

        ```csharp    
        // Извлечение таблиц из файла EPUB с помощью API GroupDocs.Parser
