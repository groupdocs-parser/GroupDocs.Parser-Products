...
draft: false
path: "zh/parser/net/extract/table/csv/"
...
steps:
    enable: true
    block:
    - title_left: "如何通过 C# .NET 从 CSV 文档中提取表格"
      content_left: |
       GroupDocs.Parser .NET API 可帮助软件开发人员从 CSV 文档中提取表格，只需几行代码。 以下 C# .NET 代码示例演示了开发人员如何从 CSV 文档中提取表。 
