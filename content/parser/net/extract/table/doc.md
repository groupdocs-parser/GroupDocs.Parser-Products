...
draft: false
path: "parser/net/extract/table/doc/"
...
steps:
    enable: true
    block:
    - title_left: "How to Extract Tables from DOC Documents via C# .NET "
      content_left: |
       GroupDocs.Parser .NET API helps software developers to extract tables from DOC documents with just couple of lines of code. The following C# .NET code example demonstrates how developers can extract tables from a DOC document. 
    ...
    - title_left: "Use .NET API to Extract Tables from DOC Document's Page"
      content_left: |
