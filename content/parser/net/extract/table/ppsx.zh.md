...
draft: false
path: "zh/parser/net/extract/table/ppsx/"
...
steps:
    enable: true
    block:
    - title_left: "如何通过 C# .NET 从 PPSX 文档中提取表格"
      content_left: |
       GroupDocs.Parser .NET API 可帮助软件开发人员从 PPSX 文档中提取表格，只需几行代码。 以下 C# .NET 代码示例演示了开发人员如何从 PPSX 文档中提取表。 
    ...
    - title_left: "使用 .NET API 从 PPSX 文档的页面中提取表格"
      content_left: |
       GroupDocs.Parser .NET 使软件开发人员能够从 PPSX 文档的页面中提取表格。 以下 C# .NET 代码显示了程序员如何在 PPSX 文档中执行条形码提取。 
