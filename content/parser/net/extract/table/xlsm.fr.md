...
about:
    enable: true
    title: "Comment extraire des tables de fichiers XLSM via l'API .NET ?"
    content: |
...
steps:
    enable: true
    title_left: "Extraire les tables de XLSM dans .NET"
    content_left: |
        [GroupDocs.Parser for .NET](/fr/parser/net/) permet aux développeurs C# d'extraire facilement des tables d'un fichier XLSM en mettant en œuvre quelques étapes simples.
    ...
    code: |
     ...
     {{< parser/code-parser title="Comment extraire des tables du fichier XLSM à l'aide de l'exemple de code C#">}}
