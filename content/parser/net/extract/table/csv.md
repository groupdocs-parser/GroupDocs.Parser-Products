...
draft: false
path: "parser/net/extract/table/csv/"
...
steps:
    enable: true
    block:
    - title_left: "How to Extract Tables from CSV Documents via C# .NET "
      content_left: |
       GroupDocs.Parser .NET API helps software developers to extract tables from CSV documents with just couple of lines of code. The following C# .NET code example demonstrates how developers can extract tables from a CSV document. 
    ...
    - title_left: "Use .NET API to Extract Tables from CSV Document's Page via .NET"
      content_left: |
       GroupDocs.Parser .NET empowers software developers to extract tables from CSV documents's page. The following C# .NET code shows how programmers can perform barcodes extraction inside a CSV document. 
