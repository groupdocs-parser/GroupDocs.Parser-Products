...
about:
    enable: true
    title: "Bagaimana cara Mengekstrak Tabel dari MSG file melalui .NET API?"
    content: |
...
steps:
    enable: true
    title_left: "Ekstrak tabel dari MSG di .NET"
    content_left: |
        [GroupDocs.Parser for .NET](/id/parser/net/) memudahkan pengembang C# untuk mengekstrak tabel dari file MSG dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< parser/code-parser title="Cara mengekstrak tabel dari file MSG menggunakan kode contoh C#">}}
