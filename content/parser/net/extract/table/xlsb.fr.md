...
about:
    enable: true
    title: "Comment extraire des tables de fichiers XLSB via l'API .NET ?"
    content: |
...
steps:
    enable: true
    title_left: "Extraire les tables de XLSB dans .NET"
    content_left: |
        [GroupDocs.Parser for .NET](/fr/parser/net/) permet aux développeurs C# d'extraire facilement des tables d'un fichier XLSB en mettant en œuvre quelques étapes simples.
    ...
    code: |
     ...
     {{< parser/code-parser title="Comment extraire des tables du fichier XLSB à l'aide de l'exemple de code C#">}}
