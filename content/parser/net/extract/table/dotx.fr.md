...
draft: false
path: "fr/parser/net/extract/table/dotx/"
...
steps:
    enable: true
    block:
    - title_left: "Comment extraire des tables de DOTX Documents via C# .NET "
      content_left: |
       L'API GroupDocs.Parser .NET aide les développeurs de logiciels à extraire des tables de documents DOTX avec seulement quelques lignes de code. L'exemple de code C# .NET suivant montre comment les développeurs peuvent extraire des tables d'un document DOTX. 
    ...
    - title_left: "Utiliser l'API .NET pour extraire les tableaux de la page du document DOTX"
      content_left: |
       GroupDocs.Parser .NET permet aux développeurs de logiciels d'extraire des tables de la page de DOTX documents. Le code C# .NET suivant montre comment les programmeurs peuvent effectuer une extraction de codes-barres dans un document DOTX. 
