...
draft: false
path: "parser/net/extract/table/odp/"
...
steps:
    enable: true
    block:
    - title_left: "How to Extract Tables from ODP Documents via C# .NET "
      content_left: |
       GroupDocs.Parser .NET API helps software developers to extract tables from ODP documents with just couple of lines of code. The following C# .NET code example demonstrates how developers can extract tables from a ODP document. 
    ...
    - title_left: "Use .NET API to Extract Tables from ODP Document's Page via .NET"
      content_left: |
       GroupDocs.Parser .NET empowers software developers to extract tables from ODP documents's page. The following C# .NET code shows how programmers can perform barcodes extraction inside a ODP document. 
