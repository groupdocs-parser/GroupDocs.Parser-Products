...
about:
    enable: true
    title: "¿Cómo extraer tablas de archivos OTS a través de la API .NET?"
    content: |
...
steps:
    enable: true
    title_left: "Extraer tablas de OTS en .NET"
    content_left: |
        [GroupDocs.Parser for .NET](/es/parser/net/) facilita a los desarrolladores de C# extraer tablas de un archivo OTS mediante la implementación de unos sencillos pasos.
    ...
    code: |
     ...
     {{< parser/code-parser title="Cómo extraer tablas del archivo OTS usando el código de ejemplo C#">}}
