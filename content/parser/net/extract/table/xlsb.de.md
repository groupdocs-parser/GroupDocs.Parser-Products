...
about:
    enable: true
    title: "Wie extrahiere ich Tabellen aus XLSB-Dateien über die .NET-API?"
    content: |
...
steps:
    enable: true
    title_left: "Tabellen aus XLSB in .NET extrahieren"
    content_left: |
        [GroupDocs.Parser for .NET](/de/parser/net/) erleichtert C#-Entwicklern das Extrahieren von Tabellen aus einer XLSB-Datei durch die Implementierung einiger einfacher Schritte.
    ...
    code: |
     ...
     {{< parser/code-parser title="So extrahieren Sie Tabellen aus der Datei XLSB mithilfe des Beispielcodes C#">}}
