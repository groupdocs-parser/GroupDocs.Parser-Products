...
draft: false
path: "de/parser/net/extract/xltm/"
...
steps:
    enable: true
    block:
    - title_left: "Hyperlinks aus XLTM-Dokumenten über .NET extrahieren"
      content_left: |
       GroupDocs.Parser .NET bietet vollständige Unterstützung für das Extrahieren von Hyperlinks aus XLTM-Dokumenten. Das folgende C# .NET-Codebeispiel zeigt, wie Hyperlinks in einem XLTM-Dokument extrahiert werden.
    ...
    - title_left: "Extrahieren Sie Hyperlinks von der Seite XLTM Dokumente"
      content_left: |
    ...
    - title_left: "Extrahieren Sie Hyperlinks aus dem Seitenbereich für XLTM-Dokumente"
      content_left: |
       GroupDocs.Parser .NET API unterstützt die Extraktion von Hyperlinks aus XLTM-Dokumenten mit Leichtigkeit. Das folgende .NET-Codebeispiel zeigt, wie Hyperlinks aus einem XLTM-Dokumentseitenbereich extrahiert werden.
