...
steps:
    enable: true
    block:
    - title_left: "Ekstrak Hyperlink dari OTS Dokumen melalui .NET"
      content_left: |
       GroupDocs.Parser .NET menyediakan dukungan lengkap untuk mengekstraksi Hyperlink dari dokumen OTS. Contoh kode C# .NET berikut menunjukkan cara mengekstrak hyperlink di dalam dokumen OTS. 
    ...
    - title_left: "Ekstrak Hyperlink dari Halaman Dokumen OTS"
      content_left: |
    ...
    - title_left: "Ekstrak Hyperlink dari OTS Area Halaman Dokumen"
      content_left: |
       GroupDocs.Parser .NET API sepenuhnya mendukung ekstraksi hyperlink dari dokumen OTS dengan mudah. Contoh kode .NET berikut menunjukkan cara mengekstrak hyperlink dari area halaman dokumen OTS.
