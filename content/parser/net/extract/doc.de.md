...
draft: false
path: "de/parser/net/extract/doc/"
...
steps:
    enable: true
    block:
    - title_left: "Hyperlinks aus DOC-Dokumenten über .NET extrahieren"
      content_left: |
       GroupDocs.Parser .NET bietet vollständige Unterstützung für das Extrahieren von Hyperlinks aus DOC-Dokumenten. Das folgende C# .NET-Codebeispiel zeigt, wie Hyperlinks in einem DOC-Dokument extrahiert werden.
    ...
    - title_left: "Extrahieren Sie Hyperlinks von der Seite DOC Dokumente"
      content_left: |
    ...
    - title_left: "Extrahieren Sie Hyperlinks aus dem Seitenbereich für DOC-Dokumente"
      content_left: |
       GroupDocs.Parser .NET API unterstützt die Extraktion von Hyperlinks aus DOC-Dokumenten mit Leichtigkeit. Das folgende .NET-Codebeispiel zeigt, wie Hyperlinks aus einem DOC-Dokumentseitenbereich extrahiert werden.
