...
about:
    enable: true
    title: "How to Extract Tables from Excel, Word, PDF & other documents via .NET API?"
    content: |
...
steps:
    enable: true
    title_left: "Extract tables from documents in .NET"
    content_left: |
        [GroupDocs.Parser for .NET](/parser/net/) makes it easy for C# developers to extract tables from documents by implementing a few easy steps.
    ...
    code: |
     ...
     {{< parser/code-parser title="How to extract tables from documents using C# example code">}}
