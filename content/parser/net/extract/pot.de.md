...
draft: false
path: "de/parser/net/extract/pot/"
...
steps:
    enable: true
    block:
    - title_left: "Hyperlinks aus POT-Dokumenten über .NET extrahieren"
      content_left: |
       GroupDocs.Parser .NET bietet vollständige Unterstützung für das Extrahieren von Hyperlinks aus POT-Dokumenten. Das folgende C# .NET-Codebeispiel zeigt, wie Hyperlinks in einem POT-Dokument extrahiert werden.
    ...
    - title_left: "Extrahieren Sie Hyperlinks von der Seite POT Dokumente"
      content_left: |
    ...
    - title_left: "Extrahieren Sie Hyperlinks aus dem Seitenbereich für POT-Dokumente"
      content_left: |
       GroupDocs.Parser .NET API unterstützt die Extraktion von Hyperlinks aus POT-Dokumenten mit Leichtigkeit. Das folgende .NET-Codebeispiel zeigt, wie Hyperlinks aus einem POT-Dokumentseitenbereich extrahiert werden.
