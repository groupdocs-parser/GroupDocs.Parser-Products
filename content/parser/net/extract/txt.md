...
steps:
    enable: true
    block:
    - title_left: "Extract Hyperlinks from TXT Documents via .NET"
      content_left: |
       GroupDocs.Parser .NET provides complete support for extracting Hyperlinks from TXT documents. The following C# .NET code example demonstrates how to extract hyperlinks inside a TXT document. 
    ...
    - title_left: "Extract Hyperlinks from TXT Documents Page"
      content_left: |
    ...
    - title_left: "Extract Hyperlinks from TXT Documents Page Area"
      content_left: |
       GroupDocs.Parser .NET API fully supports extraction of hyperlinks from TXT documents with ease. The following .NET code example demonstrates how to extract hyperlinks from a TXT document page area.
