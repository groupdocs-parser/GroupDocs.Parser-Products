...
draft: false
path: "de/parser/net/extract/xhtml/"
...
steps:
    enable: true
    block:
    - title_left: "Hyperlinks aus XHTML-Dokumenten über .NET extrahieren"
      content_left: |
       GroupDocs.Parser .NET bietet vollständige Unterstützung für das Extrahieren von Hyperlinks aus XHTML-Dokumenten. Das folgende C# .NET-Codebeispiel zeigt, wie Hyperlinks in einem XHTML-Dokument extrahiert werden.
    ...
    - title_left: "Extrahieren Sie Hyperlinks von der Seite XHTML Dokumente"
      content_left: |
    ...
    - title_left: "Extrahieren Sie Hyperlinks aus dem Seitenbereich für XHTML-Dokumente"
      content_left: |
       GroupDocs.Parser .NET API unterstützt die Extraktion von Hyperlinks aus XHTML-Dokumenten mit Leichtigkeit. Das folgende .NET-Codebeispiel zeigt, wie Hyperlinks aus einem XHTML-Dokumentseitenbereich extrahiert werden.
