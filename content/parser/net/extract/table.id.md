...
about:
    enable: true
    title: "Bagaimana cara Mengekstrak Tabel dari Excel, Word, PDF & dokumen lain melalui .NET API?"
    content: |
...
steps:
    enable: true
    title_left: "Ekstrak tabel dari dokumen di .NET"
    content_left: |
        [GroupDocs.Parser for .NET](/id/parser/net/) memudahkan pengembang C# untuk mengekstrak tabel dari dokumen dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< parser/code-parser title="Cara mengekstrak tabel dari dokumen menggunakan kode contoh C#">}}
