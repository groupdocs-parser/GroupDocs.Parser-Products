...
draft: false
path: "de/parser/net/extract/msg/"
...
steps:
    enable: true
    block:
    - title_left: "Hyperlinks aus MSG-Dokumenten über .NET extrahieren"
      content_left: |
       GroupDocs.Parser .NET bietet vollständige Unterstützung für das Extrahieren von Hyperlinks aus MSG-Dokumenten. Das folgende C# .NET-Codebeispiel zeigt, wie Hyperlinks in einem MSG-Dokument extrahiert werden.
    ...
    - title_left: "Extrahieren Sie Hyperlinks von der Seite MSG Dokumente"
      content_left: |
    ...
    - title_left: "Extrahieren Sie Hyperlinks aus dem Seitenbereich für MSG-Dokumente"
      content_left: |
       GroupDocs.Parser .NET API unterstützt die Extraktion von Hyperlinks aus MSG-Dokumenten mit Leichtigkeit. Das folgende .NET-Codebeispiel zeigt, wie Hyperlinks aus einem MSG-Dokumentseitenbereich extrahiert werden.
