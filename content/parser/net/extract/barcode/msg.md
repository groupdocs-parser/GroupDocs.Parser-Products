...
about:
    enable: true
    title: "How to Extract Barcodes from MSG files .NET API?"
    content: |
...
steps:
    enable: true
    title_left: "Extract barcodes from MSG in .NET"
    content_left: |
        [GroupDocs.Parser for .NET](/parser/net/) makes it easy for C# developers to extract barcodes from a MSG file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< parser/code-parser title="How to extract barcodes from MSG file using C# example code">}}
