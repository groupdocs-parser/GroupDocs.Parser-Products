...
about:
    enable: true
    title: "¿Cómo extraer códigos de barras de FB2 archivos .NET API?"
    content: |
...
steps:
    enable: true
    title_left: "Extraer códigos de barras de FB2 en .NET"
    content_left: |
        [GroupDocs.Parser for .NET](/es/parser/net/) facilita a los desarrolladores de C# la extracción de códigos de barras de un archivo FB2 mediante la implementación de unos sencillos pasos.
    ...
    code: |
     ...
     {{< parser/code-parser title="Cómo extraer códigos de barras del archivo FB2 usando el código de ejemplo C#">}}
