...
about:
    enable: true
    title: "Comment extraire les codes-barres de l'API PPTM fichiers .NET ?"
    content: |
...
steps:
    enable: true
    title_left: "Extraire les codes-barres de PPTM dans .NET"
    content_left: |
        [GroupDocs.Parser for .NET](/fr/parser/net/) permet aux développeurs C# d'extraire facilement les codes-barres d'un fichier PPTM en mettant en œuvre quelques étapes simples.
    ...
    code: |
     ...
     {{< parser/code-parser title="Comment extraire les codes-barres du fichier PPTM à l'aide de l'exemple de code C#">}}
