...
about:
    enable: true
    title: "Comment extraire les codes-barres de l'API ONE fichiers .NET ?"
    content: |
...
steps:
    enable: true
    title_left: "Extraire les codes-barres de ONE dans .NET"
    content_left: |
        [GroupDocs.Parser for .NET](/fr/parser/net/) permet aux développeurs C# d'extraire facilement les codes-barres d'un fichier ONE en mettant en œuvre quelques étapes simples.
    ...
    code: |
     ...
     {{< parser/code-parser title="Comment extraire les codes-barres du fichier ONE à l'aide de l'exemple de code C#">}}
