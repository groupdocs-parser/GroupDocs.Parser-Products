...
about:
    enable: true
    title: "Bagaimana cara Mengekstrak Kode Batang dari CSV file .NET API?"
    content: |
...
steps:
    enable: true
    title_left: "Ekstrak kode batang dari CSV di .NET"
    content_left: |
        [GroupDocs.Parser for .NET](/id/parser/net/) memudahkan pengembang C# untuk mengekstrak kode batang dari file CSV dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< parser/code-parser title="Cara mengekstrak kode batang dari file CSV menggunakan kode contoh C#">}}
