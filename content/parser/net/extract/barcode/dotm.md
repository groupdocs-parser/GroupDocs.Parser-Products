...
about:
    enable: true
    title: "How to Extract Barcodes from DOTM files .NET API?"
    content: |
...
steps:
    enable: true
    title_left: "Extract barcodes from DOTM in .NET"
    content_left: |
        [GroupDocs.Parser for .NET](/parser/net/) makes it easy for C# developers to extract barcodes from a DOTM file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< parser/code-parser title="How to extract barcodes from DOTM file using C# example code">}}
