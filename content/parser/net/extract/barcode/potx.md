...
about:
    enable: true
    title: "How to Extract Barcodes from POTX files .NET API?"
    content: |
...
steps:
    enable: true
    title_left: "Extract barcodes from POTX in .NET"
    content_left: |
        [GroupDocs.Parser for .NET](/parser/net/) makes it easy for C# developers to extract barcodes from a POTX file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< parser/code-parser title="How to extract barcodes from POTX file using C# example code">}}
