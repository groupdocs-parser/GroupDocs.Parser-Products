...
about:
    enable: true
    title: "Bagaimana cara Mengekstrak Kode Batang dari FB2 file .NET API?"
    content: |
...
steps:
    enable: true
    title_left: "Ekstrak kode batang dari FB2 di .NET"
    content_left: |
        [GroupDocs.Parser for .NET](/id/parser/net/) memudahkan pengembang C# untuk mengekstrak kode batang dari file FB2 dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< parser/code-parser title="Cara mengekstrak kode batang dari file FB2 menggunakan kode contoh C#">}}
