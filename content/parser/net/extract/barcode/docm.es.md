...
about:
    enable: true
    title: "¿Cómo extraer códigos de barras de DOCM archivos .NET API?"
    content: |
...
steps:
    enable: true
    title_left: "Extraer códigos de barras de DOCM en .NET"
    content_left: |
        [GroupDocs.Parser for .NET](/es/parser/net/) facilita a los desarrolladores de C# la extracción de códigos de barras de un archivo DOCM mediante la implementación de unos sencillos pasos.
    ...
    code: |
     ...
     {{< parser/code-parser title="Cómo extraer códigos de barras del archivo DOCM usando el código de ejemplo C#">}}
