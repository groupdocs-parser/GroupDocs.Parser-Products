...
about:
    enable: true
    title: "Bagaimana cara Mengekstrak Kode Batang dari PPT file .NET API?"
    content: |
...
steps:
    enable: true
    title_left: "Ekstrak kode batang dari PPT di .NET"
    content_left: |
        [GroupDocs.Parser for .NET](/id/parser/net/) memudahkan pengembang C# untuk mengekstrak kode batang dari file PPT dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< parser/code-parser title="Cara mengekstrak kode batang dari file PPT menggunakan kode contoh C#">}}
