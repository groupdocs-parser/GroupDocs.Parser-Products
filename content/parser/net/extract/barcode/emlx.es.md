...
about:
    enable: true
    title: "¿Cómo extraer códigos de barras de EMLX archivos .NET API?"
    content: |
...
steps:
    enable: true
    title_left: "Extraer códigos de barras de EMLX en .NET"
    content_left: |
        [GroupDocs.Parser for .NET](/es/parser/net/) facilita a los desarrolladores de C# la extracción de códigos de barras de un archivo EMLX mediante la implementación de unos sencillos pasos.
    ...
    code: |
     ...
     {{< parser/code-parser title="Cómo extraer códigos de barras del archivo EMLX usando el código de ejemplo C#">}}
