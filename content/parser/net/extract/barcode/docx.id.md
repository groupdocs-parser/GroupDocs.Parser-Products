...
about:
    enable: true
    title: "Bagaimana cara Mengekstrak Kode Batang dari DOCX file .NET API?"
    content: |
...
steps:
    enable: true
    title_left: "Ekstrak kode batang dari DOCX di .NET"
    content_left: |
        [GroupDocs.Parser for .NET](/id/parser/net/) memudahkan pengembang C# untuk mengekstrak kode batang dari file DOCX dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< parser/code-parser title="Cara mengekstrak kode batang dari file DOCX menggunakan kode contoh C#">}}
