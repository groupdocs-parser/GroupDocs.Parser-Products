...
about:
    enable: true
    title: "How to Extract Barcodes from MD files .NET API?"
    content: |
...
steps:
    enable: true
    title_left: "Extract barcodes from MD in .NET"
    content_left: |
        [GroupDocs.Parser for .NET](/parser/net/) makes it easy for C# developers to extract barcodes from a MD file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< parser/code-parser title="How to extract barcodes from MD file using C# example code">}}
