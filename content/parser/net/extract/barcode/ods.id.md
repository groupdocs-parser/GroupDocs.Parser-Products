...
about:
    enable: true
    title: "Bagaimana cara Mengekstrak Kode Batang dari ODS file .NET API?"
    content: |
...
steps:
    enable: true
    title_left: "Ekstrak kode batang dari ODS di .NET"
    content_left: |
        [GroupDocs.Parser for .NET](/id/parser/net/) memudahkan pengembang C# untuk mengekstrak kode batang dari file ODS dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< parser/code-parser title="Cara mengekstrak kode batang dari file ODS menggunakan kode contoh C#">}}
