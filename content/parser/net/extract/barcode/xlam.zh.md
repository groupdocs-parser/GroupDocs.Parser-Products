...
steps:
    enable: true
    title_left: "从.NET中的XLAM中提取条形码"
    content_left: |
        [GroupDocs.Parser for .NET](/zh/parser/net/) 让 C# 开发者只需执行几个简单的步骤即可轻松从 XLAM 文件中提取条形码。
    ...
    code: |
     ...
     {{< parser/code-parser title="如何使用 C# 示例代码从 XLAM 文件中提取条形码">}}
