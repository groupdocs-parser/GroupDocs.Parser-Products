...
about:
    enable: true
    title: "How to Extract Barcodes from FB2 files .NET API?"
    content: |
...
steps:
    enable: true
    title_left: "Extract barcodes from FB2 in .NET"
    content_left: |
        [GroupDocs.Parser for .NET](/parser/net/) makes it easy for C# developers to extract barcodes from a FB2 file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< parser/code-parser title="How to extract barcodes from FB2 file using C# example code">}}
