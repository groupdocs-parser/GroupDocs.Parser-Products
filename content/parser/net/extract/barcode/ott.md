...
about:
    enable: true
    title: "How to Extract Barcodes from OTT files .NET API?"
    content: |
...
steps:
    enable: true
    title_left: "Extract barcodes from OTT in .NET"
    content_left: |
        [GroupDocs.Parser for .NET](/parser/net/) makes it easy for C# developers to extract barcodes from a OTT file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< parser/code-parser title="How to extract barcodes from OTT file using C# example code">}}
