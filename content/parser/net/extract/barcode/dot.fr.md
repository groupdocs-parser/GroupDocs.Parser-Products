...
about:
    enable: true
    title: "Comment extraire les codes-barres de l'API DOT fichiers .NET ?"
    content: |
...
steps:
    enable: true
    title_left: "Extraire les codes-barres de DOT dans .NET"
    content_left: |
        [GroupDocs.Parser for .NET](/fr/parser/net/) permet aux développeurs C# d'extraire facilement les codes-barres d'un fichier DOT en mettant en œuvre quelques étapes simples.
    ...
    code: |
     ...
     {{< parser/code-parser title="Comment extraire les codes-barres du fichier DOT à l'aide de l'exemple de code C#">}}
