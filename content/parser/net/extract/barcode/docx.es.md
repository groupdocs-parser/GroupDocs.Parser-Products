...
draft: false
path: "es/parser/net/extract/docx/"
...
steps:
    enable: true
    block:
    - title_left: "Extraiga hipervínculos de DOCX Documentos a través de .NET"
      content_left: |
       GroupDocs.Parser .NET brinda soporte completo para extraer hipervínculos de documentos DOCX. El siguiente ejemplo de código C# .NET demuestra cómo extraer hipervínculos dentro de un documento DOCX. 
    ...
    - title_left: "Extraer hipervínculos de la página de documentos DOCX"
      content_left: |
    ...
    - title_left: "Extraer hipervínculos del área de la página de documentos DOCX"
      content_left: |
       GroupDocs.Parser .NET API es totalmente compatible con la extracción de hipervínculos de documentos DOCX con facilidad. El siguiente ejemplo de código .NET demuestra cómo extraer hipervínculos de un área de página de documento DOCX.
