...
about:
    enable: true
    title: "How to Extract Barcodes from XLSX files .NET API?"
    content: |
...
steps:
    enable: true
    title_left: "Extract barcodes from XLSX in .NET"
    content_left: |
        [GroupDocs.Parser for .NET](/parser/net/) makes it easy for C# developers to extract barcodes from a XLSX file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< parser/code-parser title="How to extract barcodes from XLSX file using C# example code">}}
