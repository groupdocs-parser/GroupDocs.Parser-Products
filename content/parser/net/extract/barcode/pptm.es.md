...
draft: false
path: "es/parser/net/extract/pptm/"
...
steps:
    enable: true
    block:
    - title_left: "Extraiga hipervínculos de PPTM Documentos a través de .NET"
      content_left: |
       GroupDocs.Parser .NET brinda soporte completo para extraer hipervínculos de documentos PPTM. El siguiente ejemplo de código C# .NET demuestra cómo extraer hipervínculos dentro de un documento PPTM. 
    ...
    - title_left: "Extraer hipervínculos de la página de documentos PPTM"
      content_left: |
    ...
    - title_left: "Extraer hipervínculos del área de la página de documentos PPTM"
      content_left: |
       GroupDocs.Parser .NET API es totalmente compatible con la extracción de hipervínculos de documentos PPTM con facilidad. El siguiente ejemplo de código .NET demuestra cómo extraer hipervínculos de un área de página de documento PPTM.
