...
about:
    enable: true
    title: "How to Extract Barcodes from DOTX files .NET API?"
    content: |
...
steps:
    enable: true
    title_left: "Extract barcodes from DOTX in .NET"
    content_left: |
        [GroupDocs.Parser for .NET](/parser/net/) makes it easy for C# developers to extract barcodes from a DOTX file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< parser/code-parser title="How to extract barcodes from DOTX file using C# example code">}}
