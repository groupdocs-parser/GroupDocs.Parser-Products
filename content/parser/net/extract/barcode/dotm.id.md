...
about:
    enable: true
    title: "Bagaimana cara Mengekstrak Kode Batang dari DOTM file .NET API?"
    content: |
...
steps:
    enable: true
    title_left: "Ekstrak kode batang dari DOTM di .NET"
    content_left: |
        [GroupDocs.Parser for .NET](/id/parser/net/) memudahkan pengembang C# untuk mengekstrak kode batang dari file DOTM dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< parser/code-parser title="Cara mengekstrak kode batang dari file DOTM menggunakan kode contoh C#">}}
