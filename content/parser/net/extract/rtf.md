...
steps:
    enable: true
    block:
    - title_left: "Extract Hyperlinks from RTF Documents via .NET"
      content_left: |
       GroupDocs.Parser .NET provides complete support for extracting Hyperlinks from RTF documents. The following C# .NET code example demonstrates how to extract hyperlinks inside a RTF document. 
    ...
    - title_left: "Extract Hyperlinks from RTF Documents Page"
      content_left: |
    ...
    - title_left: "Extract Hyperlinks from RTF Documents Page Area"
      content_left: |
       GroupDocs.Parser .NET API fully supports extraction of hyperlinks from RTF documents with ease. The following .NET code example demonstrates how to extract hyperlinks from a RTF document page area.
