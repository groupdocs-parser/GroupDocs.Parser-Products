...
steps:
    enable: true
    block:
    - title_left: "Ekstrak Hyperlink dari DOTX Dokumen melalui .NET"
      content_left: |
       GroupDocs.Parser .NET menyediakan dukungan lengkap untuk mengekstraksi Hyperlink dari dokumen DOTX. Contoh kode C# .NET berikut menunjukkan cara mengekstrak hyperlink di dalam dokumen DOTX. 
    ...
    - title_left: "Ekstrak Hyperlink dari Halaman Dokumen DOTX"
      content_left: |
    ...
    - title_left: "Ekstrak Hyperlink dari DOTX Area Halaman Dokumen"
      content_left: |
       GroupDocs.Parser .NET API sepenuhnya mendukung ekstraksi hyperlink dari dokumen DOTX dengan mudah. Contoh kode .NET berikut menunjukkan cara mengekstrak hyperlink dari area halaman dokumen DOTX.
