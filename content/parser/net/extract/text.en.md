...
############################# Head ############################
head_title: "Extract Text from documents in C#"
head_description: "Quickly extract text from a documents file in C#."

############################# Header ############################
title: "Extract text from documents In C#"
description: "Extract text from documents with a few lines of .NET code."
...
about:
    enable: true
    title: "How to extract a text from files .NET API?"
    content: |
...
steps:
    enable: true
    title_left: "Extract text from documents in .NET"
    content_left: |
        [GroupDocs.Parser for .NET](/parser/net/) makes it easy for C# developers to extract a text from documents by implementing a few easy steps.
    ...
    code: |
     ...
     {{< parser/code-parser title="How to extract text from documents using C# example code">}}
