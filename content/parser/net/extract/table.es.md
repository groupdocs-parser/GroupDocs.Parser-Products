...
about:
    enable: true
    title: "¿Cómo extraer tablas de Excel, Word, PDF y otros documentos a través de la API .NET?"
    content: |
...
steps:
    enable: true
    title_left: "Extraer tablas de documentos en .NET"
    content_left: |
        [GroupDocs.Parser for .NET](/es/parser/net/) facilita a los desarrolladores de C# la extracción de tablas de documentos mediante la implementación de unos sencillos pasos.
    ...
    code: |
     ...
     {{< parser/code-parser title="Cómo extraer tablas de documentos usando el código de ejemplo C#">}}
