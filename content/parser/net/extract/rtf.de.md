...
draft: false
path: "de/parser/net/extract/rtf/"
...
steps:
    enable: true
    block:
    - title_left: "Hyperlinks aus RTF-Dokumenten über .NET extrahieren"
      content_left: |
       GroupDocs.Parser .NET bietet vollständige Unterstützung für das Extrahieren von Hyperlinks aus RTF-Dokumenten. Das folgende C# .NET-Codebeispiel zeigt, wie Hyperlinks in einem RTF-Dokument extrahiert werden.
    ...
    - title_left: "Extrahieren Sie Hyperlinks von der Seite RTF Dokumente"
      content_left: |
    ...
    - title_left: "Extrahieren Sie Hyperlinks aus dem Seitenbereich für RTF-Dokumente"
      content_left: |
       GroupDocs.Parser .NET API unterstützt die Extraktion von Hyperlinks aus RTF-Dokumenten mit Leichtigkeit. Das folgende .NET-Codebeispiel zeigt, wie Hyperlinks aus einem RTF-Dokumentseitenbereich extrahiert werden.
