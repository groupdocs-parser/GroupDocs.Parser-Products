...
draft: false
path: "de/parser/net/extract/odp/"
...
steps:
    enable: true
    block:
    - title_left: "Hyperlinks aus ODP-Dokumenten über .NET extrahieren"
      content_left: |
       GroupDocs.Parser .NET bietet vollständige Unterstützung für das Extrahieren von Hyperlinks aus ODP-Dokumenten. Das folgende C# .NET-Codebeispiel zeigt, wie Hyperlinks in einem ODP-Dokument extrahiert werden.
    ...
    - title_left: "Extrahieren Sie Hyperlinks von der Seite ODP Dokumente"
      content_left: |
    ...
    - title_left: "Extrahieren Sie Hyperlinks aus dem Seitenbereich für ODP-Dokumente"
      content_left: |
       GroupDocs.Parser .NET API unterstützt die Extraktion von Hyperlinks aus ODP-Dokumenten mit Leichtigkeit. Das folgende .NET-Codebeispiel zeigt, wie Hyperlinks aus einem ODP-Dokumentseitenbereich extrahiert werden.
