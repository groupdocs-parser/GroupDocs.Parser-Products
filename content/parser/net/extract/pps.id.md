...
steps:
    enable: true
    block:
    - title_left: "Ekstrak Hyperlink dari PPS Dokumen melalui .NET"
      content_left: |
       GroupDocs.Parser .NET menyediakan dukungan lengkap untuk mengekstraksi Hyperlink dari dokumen PPS. Contoh kode C# .NET berikut menunjukkan cara mengekstrak hyperlink di dalam dokumen PPS. 
    ...
    - title_left: "Ekstrak Hyperlink dari Halaman Dokumen PPS"
      content_left: |
    ...
    - title_left: "Ekstrak Hyperlink dari PPS Area Halaman Dokumen"
      content_left: |
       GroupDocs.Parser .NET API sepenuhnya mendukung ekstraksi hyperlink dari dokumen PPS dengan mudah. Contoh kode .NET berikut menunjukkan cara mengekstrak hyperlink dari area halaman dokumen PPS.
