...
steps:
    enable: true
    block:
    - title_left: "Ekstrak Hyperlink dari PPTM Dokumen melalui .NET"
      content_left: |
       GroupDocs.Parser .NET menyediakan dukungan lengkap untuk mengekstraksi Hyperlink dari dokumen PPTM. Contoh kode C# .NET berikut menunjukkan cara mengekstrak hyperlink di dalam dokumen PPTM. 
    ...
    - title_left: "Ekstrak Hyperlink dari Halaman Dokumen PPTM"
      content_left: |
    ...
    - title_left: "Ekstrak Hyperlink dari PPTM Area Halaman Dokumen"
      content_left: |
       GroupDocs.Parser .NET API sepenuhnya mendukung ekstraksi hyperlink dari dokumen PPTM dengan mudah. Contoh kode .NET berikut menunjukkan cara mengekstrak hyperlink dari area halaman dokumen PPTM.
