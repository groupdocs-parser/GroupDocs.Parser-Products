...
steps:
    enable: true
    block:
    - title_left: "Ekstrak Hyperlink dari ODT Dokumen melalui .NET"
      content_left: |
       GroupDocs.Parser .NET menyediakan dukungan lengkap untuk mengekstraksi Hyperlink dari dokumen ODT. Contoh kode C# .NET berikut menunjukkan cara mengekstrak hyperlink di dalam dokumen ODT. 
    ...
    - title_left: "Ekstrak Hyperlink dari Halaman Dokumen ODT"
      content_left: |
    ...
    - title_left: "Ekstrak Hyperlink dari ODT Area Halaman Dokumen"
      content_left: |
       GroupDocs.Parser .NET API sepenuhnya mendukung ekstraksi hyperlink dari dokumen ODT dengan mudah. Contoh kode .NET berikut menunjukkan cara mengekstrak hyperlink dari area halaman dokumen ODT.
