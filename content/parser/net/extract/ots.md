...
steps:
    enable: true
    block:
    - title_left: "Extract Hyperlinks from OTS Documents via .NET"
      content_left: |
       GroupDocs.Parser .NET provides complete support for extracting Hyperlinks from OTS documents. The following C# .NET code example demonstrates how to extract hyperlinks inside a OTS document. 
    ...
    - title_left: "Extract Hyperlinks from OTS Documents Page"
      content_left: |
    ...
    - title_left: "Extract Hyperlinks from OTS Documents Page Area"
      content_left: |
       GroupDocs.Parser .NET API fully supports extraction of hyperlinks from OTS documents with ease. The following .NET code example demonstrates how to extract hyperlinks from a OTS document page area.
