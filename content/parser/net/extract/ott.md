...
steps:
    enable: true
    block:
    - title_left: "Extract Hyperlinks from OTT Documents via .NET"
      content_left: |
       GroupDocs.Parser .NET provides complete support for extracting Hyperlinks from OTT documents. The following C# .NET code example demonstrates how to extract hyperlinks inside a OTT document. 
    ...
    - title_left: "Extract Hyperlinks from OTT Documents Page"
      content_left: |
    ...
    - title_left: "Extract Hyperlinks from OTT Documents Page Area"
      content_left: |
       GroupDocs.Parser .NET API fully supports extraction of hyperlinks from OTT documents with ease. The following .NET code example demonstrates how to extract hyperlinks from a OTT document page area.
