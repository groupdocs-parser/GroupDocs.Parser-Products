...
draft: false
path: "de/parser/net/extract/xltx/"
...
steps:
    enable: true
    block:
    - title_left: "Hyperlinks aus XLTX-Dokumenten über .NET extrahieren"
      content_left: |
       GroupDocs.Parser .NET bietet vollständige Unterstützung für das Extrahieren von Hyperlinks aus XLTX-Dokumenten. Das folgende C# .NET-Codebeispiel zeigt, wie Hyperlinks in einem XLTX-Dokument extrahiert werden.
    ...
    - title_left: "Extrahieren Sie Hyperlinks von der Seite XLTX Dokumente"
      content_left: |
    ...
    - title_left: "Extrahieren Sie Hyperlinks aus dem Seitenbereich für XLTX-Dokumente"
      content_left: |
       GroupDocs.Parser .NET API unterstützt die Extraktion von Hyperlinks aus XLTX-Dokumenten mit Leichtigkeit. Das folgende .NET-Codebeispiel zeigt, wie Hyperlinks aus einem XLTX-Dokumentseitenbereich extrahiert werden.
