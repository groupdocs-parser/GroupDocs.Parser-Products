...
steps:
    enable: true
    block:
    - title_left: "Extract Hyperlinks from DOC Documents via .NET"
      content_left: |
       GroupDocs.Parser .NET provides complete support for extracting Hyperlinks from DOC documents. The following C# .NET code example demonstrates how to extract hyperlinks inside a DOC document. 
    ...
    - title_left: "Extract Hyperlinks from DOC Documents Page"
      content_left: |
    ...
    - title_left: "Extract Hyperlinks from DOC Documents Page Area"
      content_left: |
       GroupDocs.Parser .NET API fully supports extraction of hyperlinks from DOC documents with ease. The following .NET code example demonstrates how to extract hyperlinks from a DOC document page area.
