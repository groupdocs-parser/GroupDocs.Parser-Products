...
steps:
    enable: true
    block:
    - title_left: "Ekstrak Hyperlink dari DOTM Dokumen melalui .NET"
      content_left: |
       GroupDocs.Parser .NET menyediakan dukungan lengkap untuk mengekstraksi Hyperlink dari dokumen DOTM. Contoh kode C# .NET berikut menunjukkan cara mengekstrak hyperlink di dalam dokumen DOTM. 
    ...
    - title_left: "Ekstrak Hyperlink dari Halaman Dokumen DOTM"
      content_left: |
    ...
    - title_left: "Ekstrak Hyperlink dari DOTM Area Halaman Dokumen"
      content_left: |
       GroupDocs.Parser .NET API sepenuhnya mendukung ekstraksi hyperlink dari dokumen DOTM dengan mudah. Contoh kode .NET berikut menunjukkan cara mengekstrak hyperlink dari area halaman dokumen DOTM.
