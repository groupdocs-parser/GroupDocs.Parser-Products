...
draft: false
path: "de/parser/net/extract/dotx/"
...
steps:
    enable: true
    block:
    - title_left: "Hyperlinks aus DOTX-Dokumenten über .NET extrahieren"
      content_left: |
       GroupDocs.Parser .NET bietet vollständige Unterstützung für das Extrahieren von Hyperlinks aus DOTX-Dokumenten. Das folgende C# .NET-Codebeispiel zeigt, wie Hyperlinks in einem DOTX-Dokument extrahiert werden.
    ...
    - title_left: "Extrahieren Sie Hyperlinks von der Seite DOTX Dokumente"
      content_left: |
    ...
    - title_left: "Extrahieren Sie Hyperlinks aus dem Seitenbereich für DOTX-Dokumente"
      content_left: |
       GroupDocs.Parser .NET API unterstützt die Extraktion von Hyperlinks aus DOTX-Dokumenten mit Leichtigkeit. Das folgende .NET-Codebeispiel zeigt, wie Hyperlinks aus einem DOTX-Dokumentseitenbereich extrahiert werden.
