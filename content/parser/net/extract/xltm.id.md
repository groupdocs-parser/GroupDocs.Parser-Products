...
steps:
    enable: true
    block:
    - title_left: "Ekstrak Hyperlink dari XLTM Dokumen melalui .NET"
      content_left: |
       GroupDocs.Parser .NET menyediakan dukungan lengkap untuk mengekstraksi Hyperlink dari dokumen XLTM. Contoh kode C# .NET berikut menunjukkan cara mengekstrak hyperlink di dalam dokumen XLTM. 
    ...
    - title_left: "Ekstrak Hyperlink dari Halaman Dokumen XLTM"
      content_left: |
    ...
    - title_left: "Ekstrak Hyperlink dari XLTM Area Halaman Dokumen"
      content_left: |
       GroupDocs.Parser .NET API sepenuhnya mendukung ekstraksi hyperlink dari dokumen XLTM dengan mudah. Contoh kode .NET berikut menunjukkan cara mengekstrak hyperlink dari area halaman dokumen XLTM.
