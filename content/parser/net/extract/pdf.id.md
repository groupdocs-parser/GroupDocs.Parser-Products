...
steps:
    enable: true
    block:
    - title_left: "Ekstrak Hyperlink dari PDF Dokumen melalui .NET"
      content_left: |
       GroupDocs.Parser .NET menyediakan dukungan lengkap untuk mengekstraksi Hyperlink dari dokumen PDF. Contoh kode C# .NET berikut menunjukkan cara mengekstrak hyperlink di dalam dokumen PDF. 
    ...
    - title_left: "Ekstrak Hyperlink dari Halaman Dokumen PDF"
      content_left: |
    ...
    - title_left: "Ekstrak Hyperlink dari PDF Area Halaman Dokumen"
      content_left: |
       GroupDocs.Parser .NET API sepenuhnya mendukung ekstraksi hyperlink dari dokumen PDF dengan mudah. Contoh kode .NET berikut menunjukkan cara mengekstrak hyperlink dari area halaman dokumen PDF.
