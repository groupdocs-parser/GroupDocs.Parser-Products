...
draft: false
path: "fr/parser/net/extract/docm/"
...
steps:
    enable: true
    block:
    - title_left: "Extrayez les liens hypertexte des documents DOCM via .NET"
      content_left: |
       GroupDocs.Parser .NET fournit une prise en charge complète pour extraire des liens hypertexte à partir de documents DOCM. L'exemple de code C# .NET suivant montre comment extraire des liens hypertexte dans un document DOCM. 
    ...
    - title_left: "Extraire les liens hypertexte de la page DOCM Documents"
      content_left: |
    ...
    - title_left: "Extraire les liens hypertexte de la zone de page DOCM Documents"
      content_left: |
       L'API GroupDocs.Parser .NET prend entièrement en charge l'extraction de liens hypertexte à partir de documents DOCM en toute simplicité. L'exemple de code .NET suivant montre comment extraire des liens hypertexte d'une zone de page de document DOCM.
