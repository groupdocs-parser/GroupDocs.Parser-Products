...
draft: false
path: "fr/parser/net/extract/dotx/"
...
steps:
    enable: true
    block:
    - title_left: "Extrayez les liens hypertexte des documents DOTX via .NET"
      content_left: |
       GroupDocs.Parser .NET fournit une prise en charge complète pour extraire des liens hypertexte à partir de documents DOTX. L'exemple de code C# .NET suivant montre comment extraire des liens hypertexte dans un document DOTX. 
    ...
    - title_left: "Extraire les liens hypertexte de la page DOTX Documents"
      content_left: |
    ...
    - title_left: "Extraire les liens hypertexte de la zone de page DOTX Documents"
      content_left: |
       L'API GroupDocs.Parser .NET prend entièrement en charge l'extraction de liens hypertexte à partir de documents DOTX en toute simplicité. L'exemple de code .NET suivant montre comment extraire des liens hypertexte d'une zone de page de document DOTX.
