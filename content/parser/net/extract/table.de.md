...
about:
    enable: true
    title: "Wie extrahiere ich Tabellen aus Excel, Word, PDF und anderen Dokumenten über die .NET-API?"
    content: |
...
steps:
    enable: true
    title_left: "Extrahieren Sie Tabellen aus Dokumenten in .NET"
    content_left: |
        [GroupDocs.Parser for .NET](/de/parser/net/) erleichtert C# Entwicklern das Extrahieren von Tabellen aus Dokumenten durch die Implementierung einiger einfacher Schritte.
    ...
    code: |
     ...
     {{< parser/code-parser title="So extrahieren Sie Tabellen aus Dokumenten mithilfe des Beispielcodes C#">}}
