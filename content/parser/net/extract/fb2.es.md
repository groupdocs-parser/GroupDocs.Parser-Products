...
draft: false
path: "es/parser/net/extract/fb2/"
...
steps:
    enable: true
    block:
    - title_left: "Extraiga hipervínculos de FB2 Documentos a través de .NET"
      content_left: |
       GroupDocs.Parser .NET brinda soporte completo para extraer hipervínculos de documentos FB2. El siguiente ejemplo de código C# .NET demuestra cómo extraer hipervínculos dentro de un documento FB2. 
    ...
    - title_left: "Extraer hipervínculos de la página de documentos FB2"
      content_left: |
    ...
    - title_left: "Extraer hipervínculos del área de la página de documentos FB2"
      content_left: |
       GroupDocs.Parser .NET API es totalmente compatible con la extracción de hipervínculos de documentos FB2 con facilidad. El siguiente ejemplo de código .NET demuestra cómo extraer hipervínculos de un área de página de documento FB2.
