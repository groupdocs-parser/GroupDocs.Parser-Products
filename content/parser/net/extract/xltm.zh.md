...
draft: false
path: "zh/parser/net/extract/xltm/"
...
steps:
    enable: true
    block:
    - title_left: "通过 .NET 从 XLTM 文档中提取超链接"
      content_left: |
       GroupDocs.Parser .NET 完全支持从 XLTM 文档中提取超链接。 以下 C# .NET 代码示例演示了如何在 XLTM 文档中提取超链接。
    ...
    - title_left: "从 XLTM 文档页面区域提取超链接"
      content_left: |
       GroupDocs.Parser .NET API 完全支持从 XLTM 文档中轻松提取超链接。 以下 .NET 代码示例演示了如何从 XLTM 文档页面区域中提取超链接。
