...
############################# Head ############################
head_title: "Extrahieren Sie Text aus Dokumenten in C#"
head_description: "Extrahieren Sie schnell Text aus einer Dokumentdatei in C#."

############################# Header ############################
title: "Extrahieren Sie Text aus Dokumenten in C#"
description: "Extrahieren Sie Text aus Dokumenten mit ein paar Zeilen .NET-Code."
...
about:
    enable: true
    title: "Wie extrahiere ich einen Text aus der Datei-API .NET?"
    content: |
...
steps:
    enable: true
    title_left: "Extrahieren Sie Text aus Dokumenten in .NET"
    content_left: |
        [GroupDocs.Parser for .NET](/de/parser/net/) erleichtert C# Entwicklern das Extrahieren eines Textes aus Dokumenten durch die Implementierung einiger einfacher Schritte.
    ...
    code: |
     ...
     {{< parser/code-parser title="So extrahieren Sie Text aus Dokumenten mithilfe des Beispielcodes C#">}}
