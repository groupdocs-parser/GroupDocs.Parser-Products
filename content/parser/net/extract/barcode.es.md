...
about:
    enable: true
    title: "¿Cómo extraer códigos de barras de Excel, Word, PDF y otros documentos .NET API?"
    content: |
...
steps:
    enable: true
    title_left: "Extraer códigos de barras de documentos en .NET"
    content_left: |
        [GroupDocs.Parser for .NET](/es/parser/net/) facilita a los desarrolladores de C# la extracción de códigos de barras de los documentos mediante la implementación de unos sencillos pasos.
    ...
    code: |
     ...
     {{< parser/code-parser title="Cómo extraer códigos de barras de documentos usando el código de ejemplo C#">}}
