...
draft: false
path: "de/parser/net/extract/epub/"
...
steps:
    enable: true
    block:
    - title_left: "Hyperlinks aus EPUB-Dokumenten über .NET extrahieren"
      content_left: |
       GroupDocs.Parser .NET bietet vollständige Unterstützung für das Extrahieren von Hyperlinks aus EPUB-Dokumenten. Das folgende C# .NET-Codebeispiel zeigt, wie Hyperlinks in einem EPUB-Dokument extrahiert werden.
    ...
    - title_left: "Extrahieren Sie Hyperlinks von der Seite EPUB Dokumente"
      content_left: |
    ...
    - title_left: "Extrahieren Sie Hyperlinks aus dem Seitenbereich für EPUB-Dokumente"
      content_left: |
       GroupDocs.Parser .NET API unterstützt die Extraktion von Hyperlinks aus EPUB-Dokumenten mit Leichtigkeit. Das folgende .NET-Codebeispiel zeigt, wie Hyperlinks aus einem EPUB-Dokumentseitenbereich extrahiert werden.
