...
draft: false
path: "de/parser/net/extract/potx/"
...
steps:
    enable: true
    block:
    - title_left: "Hyperlinks aus POTX-Dokumenten über .NET extrahieren"
      content_left: |
       GroupDocs.Parser .NET bietet vollständige Unterstützung für das Extrahieren von Hyperlinks aus POTX-Dokumenten. Das folgende C# .NET-Codebeispiel zeigt, wie Hyperlinks in einem POTX-Dokument extrahiert werden.
    ...
    - title_left: "Extrahieren Sie Hyperlinks von der Seite POTX Dokumente"
      content_left: |
    ...
    - title_left: "Extrahieren Sie Hyperlinks aus dem Seitenbereich für POTX-Dokumente"
      content_left: |
       GroupDocs.Parser .NET API unterstützt die Extraktion von Hyperlinks aus POTX-Dokumenten mit Leichtigkeit. Das folgende .NET-Codebeispiel zeigt, wie Hyperlinks aus einem POTX-Dokumentseitenbereich extrahiert werden.
