...
steps:
    enable: true
    block:
    - title_left: "Extract Hyperlinks from POT Documents via .NET"
      content_left: |
       GroupDocs.Parser .NET provides complete support for extracting Hyperlinks from POT documents. The following C# .NET code example demonstrates how to extract hyperlinks inside a POT document. 
    ...
    - title_left: "Extract Hyperlinks from POT Documents Page"
      content_left: |
    ...
    - title_left: "Extract Hyperlinks from POT Documents Page Area"
      content_left: |
       GroupDocs.Parser .NET API fully supports extraction of hyperlinks from POT documents with ease. The following .NET code example demonstrates how to extract hyperlinks from a POT document page area.
