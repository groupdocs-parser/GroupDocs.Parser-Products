...
draft: false
path: "de/parser/net/extract/pdf/"
...
steps:
    enable: true
    block:
    - title_left: "Hyperlinks aus PDF-Dokumenten über .NET extrahieren"
      content_left: |
       GroupDocs.Parser .NET bietet vollständige Unterstützung für das Extrahieren von Hyperlinks aus PDF-Dokumenten. Das folgende C# .NET-Codebeispiel zeigt, wie Hyperlinks in einem PDF-Dokument extrahiert werden.
    ...
    - title_left: "Extrahieren Sie Hyperlinks von der Seite PDF Dokumente"
      content_left: |
    ...
    - title_left: "Extrahieren Sie Hyperlinks aus dem Seitenbereich für PDF-Dokumente"
      content_left: |
       GroupDocs.Parser .NET API unterstützt die Extraktion von Hyperlinks aus PDF-Dokumenten mit Leichtigkeit. Das folgende .NET-Codebeispiel zeigt, wie Hyperlinks aus einem PDF-Dokumentseitenbereich extrahiert werden.
