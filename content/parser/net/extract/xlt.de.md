...
draft: false
path: "de/parser/net/extract/xlt/"
...
steps:
    enable: true
    block:
    - title_left: "Hyperlinks aus XLT-Dokumenten über .NET extrahieren"
      content_left: |
       GroupDocs.Parser .NET bietet vollständige Unterstützung für das Extrahieren von Hyperlinks aus XLT-Dokumenten. Das folgende C# .NET-Codebeispiel zeigt, wie Hyperlinks in einem XLT-Dokument extrahiert werden.
    ...
    - title_left: "Extrahieren Sie Hyperlinks von der Seite XLT Dokumente"
      content_left: |
    ...
    - title_left: "Extrahieren Sie Hyperlinks aus dem Seitenbereich für XLT-Dokumente"
      content_left: |
       GroupDocs.Parser .NET API unterstützt die Extraktion von Hyperlinks aus XLT-Dokumenten mit Leichtigkeit. Das folgende .NET-Codebeispiel zeigt, wie Hyperlinks aus einem XLT-Dokumentseitenbereich extrahiert werden.
