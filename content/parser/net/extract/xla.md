...
steps:
    enable: true
    block:
    - title_left: "Extract Hyperlinks from XLA Documents via .NET"
      content_left: |
       GroupDocs.Parser .NET provides complete support for extracting Hyperlinks from XLA documents. The following C# .NET code example demonstrates how to extract hyperlinks inside a XLA document. 
    ...
    - title_left: "Extract Hyperlinks from XLA Documents Page"
      content_left: |
    ...
    - title_left: "Extract Hyperlinks from XLA Documents Page Area"
      content_left: |
       GroupDocs.Parser .NET API fully supports extraction of hyperlinks from XLA documents with ease. The following .NET code example demonstrates how to extract hyperlinks from a XLA document page area.
