...
steps:
    enable: true
    block:
    - title_left: "Extract Hyperlinks from XLSM Documents via .NET"
      content_left: |
       GroupDocs.Parser .NET provides complete support for extracting Hyperlinks from XLSM documents. The following C# .NET code example demonstrates how to extract hyperlinks inside a XLSM document. 
    ...
    - title_left: "Extract Hyperlinks from XLSM Documents Page"
      content_left: |
    ...
    - title_left: "Extract Hyperlinks from XLSM Documents Page Area"
      content_left: |
       GroupDocs.Parser .NET API fully supports extraction of hyperlinks from XLSM documents with ease. The following .NET code example demonstrates how to extract hyperlinks from a XLSM document page area.
