...
############################# Head ############################
head_title: "Trích xuất liên kết từ các tệp EPUB trong ứng dụng C#"
head_description: "Sử dụng GroupDocs.Parser để phát hiện và trích xuất liên kết từ các tệp EPUB trong C# mà không cần công cụ hoặc phần mềm bổ sung."

############################# Header ############################
title: "Trích xuất liên kết từ EPUB bằng C#" 
...
steps:
    enable: true
    title: "Các bước để trích xuất liên kết từ Epub trong C#"
    content: |
      [GroupDocs.Parser](/parser/net/) cho phép các nhà phát triển .NET trích xuất liên kết từ các tệp EPUB bằng cách làm theo các bước đơn giản sau:
      
      1. Tải tệp EPUB bằng cách sử dụng một thể hiện Parser.
