...
############################# Head ############################
head_title: "在C#应用程序中从PDF文件提取超链接"
head_description: "使用GroupDocs.Parser在C#中检测并提取PDF文件的超链接，无需额外的工具或软件。"
...
steps:
    enable: true
    title: "在C#中从Pdf提取超链接的步骤"
    content: |
      [GroupDocs.Parser](/parser/net/)使.NET开发者能够通过以下简单步骤从PDF文件中提取超链接：
