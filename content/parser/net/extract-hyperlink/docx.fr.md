...
############################# Head ############################
head_title: "Extraire des hyperliens à partir de fichiers DOCX dans des applications C#"
head_description: "Utilisez GroupDocs.Parser pour détecter et extraire des hyperliens à partir de fichiers DOCX dans C# sans outils ou logiciels supplémentaires."

############################# Header ############################
title: "Extraire des hyperliens à partir de DOCX en utilisant C#" 
...
steps:
    enable: true
    title: "Étapes pour extraire des hyperliens à partir de Docx dans C#"
    content: |
      [GroupDocs.Parser](/parser/net/) permet aux développeurs .NET d'extraire des hyperliens à partir de fichiers DOCX en suivant ces étapes simples :
      
      1. Chargez le fichier DOCX à l'aide d'une instance de Parser.
