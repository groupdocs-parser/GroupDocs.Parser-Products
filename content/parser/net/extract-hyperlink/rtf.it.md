...
############################# Head ############################
head_title: "Estrai collegamenti ipertestuali da file RTF in app C#"
head_description: "Utilizza GroupDocs.Parser per rilevare ed estrarre collegamenti ipertestuali da file RTF in C# senza strumenti o software aggiuntivi."

############################# Header ############################
title: "Estrai collegamenti ipertestuali da RTF utilizzando C#" 
...
steps:
    enable: true
    title: "Passaggi per estrarre collegamenti ipertestuali da Rtf in C#"
    content: |
      [GroupDocs.Parser](/parser/net/) consente agli sviluppatori di .NET di estrarre collegamenti ipertestuali da file RTF seguendo questi semplici passaggi:
      
      1. Carica il file RTF utilizzando un'istanza di Parser.
