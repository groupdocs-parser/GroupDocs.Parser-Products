...
############################# Head ############################
head_title: "Extraire des hyperliens à partir de fichiers PPTX dans des applications C#"
head_description: "Utilisez GroupDocs.Parser pour détecter et extraire des hyperliens à partir de fichiers PPTX dans C# sans outils ou logiciels supplémentaires."

############################# Header ############################
title: "Extraire des hyperliens à partir de PPTX en utilisant C#" 
...
steps:
    enable: true
    title: "Étapes pour extraire des hyperliens à partir de Pptx dans C#"
    content: |
      [GroupDocs.Parser](/parser/net/) permet aux développeurs .NET d'extraire des hyperliens à partir de fichiers PPTX en suivant ces étapes simples :
      
      1. Chargez le fichier PPTX à l'aide d'une instance de Parser.
