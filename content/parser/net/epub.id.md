...
steps:
    enable: true
    block:
    - title_left: "Ekstrak Hyperlink dari EPUB Dokumen melalui .NET"
      content_left: |
       GroupDocs.Parser .NET menyediakan dukungan lengkap untuk mengekstraksi Hyperlink dari dokumen EPUB. Contoh kode C# .NET berikut menunjukkan cara mengekstrak hyperlink di dalam dokumen EPUB. 
    ...
    - title_left: "Ekstrak Hyperlink dari Halaman Dokumen EPUB"
      content_left: |
    ...
    - title_left: "Ekstrak Hyperlink dari EPUB Area Halaman Dokumen"
      content_left: |
       GroupDocs.Parser .NET API sepenuhnya mendukung ekstraksi hyperlink dari dokumen EPUB dengan mudah. Contoh kode .NET berikut menunjukkan cara mengekstrak hyperlink dari area halaman dokumen EPUB.
