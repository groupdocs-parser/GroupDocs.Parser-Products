...
steps:
    enable: true
    block:
    - title_left: "Extract Hyperlinks from XLSX Documents via .NET"
      content_left: |
       GroupDocs.Parser .NET provides complete support for extracting Hyperlinks from XLSX documents. The following C# .NET code example demonstrates how to extract hyperlinks inside a XLSX document. 
    ...
    - title_left: "Extract Hyperlinks from XLSX Documents Page"
      content_left: |
    ...
    - title_left: "Extract Hyperlinks from XLSX Documents Page Area"
      content_left: |
       GroupDocs.Parser .NET API fully supports extraction of hyperlinks from XLSX documents with ease. The following .NET code example demonstrates how to extract hyperlinks from a XLSX document page area.
