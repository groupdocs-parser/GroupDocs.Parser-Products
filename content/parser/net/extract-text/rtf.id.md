...
############################# Head ############################
head_title: "Ekstrak teks dari file RTF di aplikasi C#"
head_description: "Gunakan GroupDocs.Parser untuk mengekstrak teks biasa atau terstruktur dari file RTF dalam aplikasi C# tanpa memerlukan alat eksternal."

############################# Header ############################
title: "Ekstrak teks dari RTF menggunakan C#" 
...
steps:
    enable: true
    title: "Langkah untuk mengekstrak teks dari Rtf dalam C#"
    content: |
      Anda dapat mengekstrak teks yang bersih dan terstruktur dari dokumen RTF dalam aplikasi .NET dengan [GroupDocs.Parser](/parser/net/) dengan mengikuti langkah-langkah berikut:
