...
############################# Head ############################
head_title: "C# 앱에서 PDF 파일의 텍스트 추출"
head_description: "GroupDocs.Parser를 사용하여 C# 애플리케이션에서 PDF 파일의 일반 텍스트 또는 구조화된 텍스트를 외부 도구 없이 추출할 수 있습니다."
...
steps:
    enable: true
    title: "C#에서 Pdf의 텍스트 추출 단계"
    content: |
      [GroupDocs.Parser](/parser/net/)를 사용하여 .NET 앱에서 PDF 문서에서 깨끗하고 구조화된 텍스트를 추출하려면 다음 단계를 따르세요:
      
      1. Parser 인스턴스를 사용하여 PDF 문서를 엽니다.
