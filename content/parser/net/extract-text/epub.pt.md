...
############################# Head ############################
head_title: "Extraia texto de arquivos EPUB em aplicativos C#"
head_description: "Utilize GroupDocs.Parser para extrair texto simples ou estruturado de arquivos EPUB em aplicações C# sem a necessidade de ferramentas externas."

############################# Header ############################
title: "Extraia texto de EPUB usando C#" 
...
steps:
    enable: true
    title: "Passos para extrair texto de Epub em C#"
    content: |
      Você pode extrair texto limpo e estruturado de documentos EPUB em aplicativos .NET com [GroupDocs.Parser](/parser/net/) seguindo estes passos:
      
      1. Abra o documento EPUB usando uma instância de Parser.
