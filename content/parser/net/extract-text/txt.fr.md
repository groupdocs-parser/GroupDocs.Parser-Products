...
############################# Head ############################
head_title: "Extraire du texte des fichiers TXT dans des applications C#"
head_description: "Utilisez GroupDocs.Parser pour extraire du texte brut ou structuré des fichiers TXT dans des applications C# sans nécessiter d'outils externes."

############################# Header ############################
title: "Extraire du texte des TXT avec C#" 
...
steps:
    enable: true
    title: "Étapes pour extraire du texte d'un Txt en C#"
    content: |
      Vous pouvez extraire du texte clair et structuré à partir de documents TXT dans des applications .NET avec [GroupDocs.Parser](/parser/net/) en suivant ces étapes :
      
      1. Ouvrez le document TXT à l'aide d'une instance de Parser.
