...
############################# Head ############################
head_title: "Extraia texto de arquivos XML em aplicativos C#"
head_description: "Utilize GroupDocs.Parser para extrair texto simples ou estruturado de arquivos XML em aplicações C# sem a necessidade de ferramentas externas."

############################# Header ############################
title: "Extraia texto de XML usando C#" 
...
steps:
    enable: true
    title: "Passos para extrair texto de Xml em C#"
    content: |
      Você pode extrair texto limpo e estruturado de documentos XML em aplicativos .NET com [GroupDocs.Parser](/parser/net/) seguindo estes passos:
      
      1. Abra o documento XML usando uma instância de Parser.
