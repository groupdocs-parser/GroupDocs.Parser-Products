...
############################# Head ############################
head_title: "Extraer texto de archivos RTF en aplicaciones C#"
head_description: "Utiliza GroupDocs.Parser para extraer texto plano o estructurado de archivos RTF en aplicaciones C# sin necesidad de herramientas externas."

############################# Header ############################
title: "Extraer texto de RTF usando C#" 
...
steps:
    enable: true
    title: "Pasos para extraer texto de Rtf en C#"
    content: |
      Puedes extraer texto limpio y estructurado de documentos RTF en aplicaciones .NET con [GroupDocs.Parser](/parser/net/) siguiendo estos pasos:
