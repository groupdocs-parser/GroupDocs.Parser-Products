...
############################# Head ############################
head_title: "Extraia texto de arquivos PDF em aplicativos C#"
head_description: "Utilize GroupDocs.Parser para extrair texto simples ou estruturado de arquivos PDF em aplicações C# sem a necessidade de ferramentas externas."

############################# Header ############################
title: "Extraia texto de PDF usando C#" 
...
steps:
    enable: true
    title: "Passos para extrair texto de Pdf em C#"
    content: |
      Você pode extrair texto limpo e estruturado de documentos PDF em aplicativos .NET com [GroupDocs.Parser](/parser/net/) seguindo estes passos:
      
      1. Abra o documento PDF usando uma instância de Parser.
