...
############################# Head ############################
head_title: "Ekstrak teks dari file PPTX di aplikasi C#"
head_description: "Gunakan GroupDocs.Parser untuk mengekstrak teks biasa atau terstruktur dari file PPTX dalam aplikasi C# tanpa memerlukan alat eksternal."

############################# Header ############################
title: "Ekstrak teks dari PPTX menggunakan C#" 
...
steps:
    enable: true
    title: "Langkah untuk mengekstrak teks dari Pptx dalam C#"
    content: |
      Anda dapat mengekstrak teks yang bersih dan terstruktur dari dokumen PPTX dalam aplikasi .NET dengan [GroupDocs.Parser](/parser/net/) dengan mengikuti langkah-langkah berikut:
      
      1. Buka dokumen PPTX menggunakan instance Parser.
