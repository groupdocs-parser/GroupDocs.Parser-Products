...
steps:
    enable: true
    block:
    - title_left: "Extract Hyperlinks from OTP Documents via .NET"
      content_left: |
       GroupDocs.Parser .NET provides complete support for extracting Hyperlinks from OTP documents. The following C# .NET code example demonstrates how to extract hyperlinks inside a OTP document. 
    ...
    - title_left: "Extract Hyperlinks from OTP Documents Page"
      content_left: |
    ...
    - title_left: "Extract Hyperlinks from OTP Documents Page Area"
      content_left: |
       GroupDocs.Parser .NET API fully supports extraction of hyperlinks from OTP documents with ease. The following .NET code example demonstrates how to extract hyperlinks from a OTP document page area.
