...
steps:
    enable: true
    block:
    - title_left: "Extract Hyperlinks from CHM Documents via .NET"
      content_left: |
       GroupDocs.Parser .NET provides complete support for extracting Hyperlinks from CHM documents. The following C# .NET code example demonstrates how to extract hyperlinks inside a CHM document. 
    ...
    - title_left: "Extract Hyperlinks from CHM Documents Page"
      content_left: |
    ...
    - title_left: "Extract Hyperlinks from CHM Documents Page Area"
      content_left: |
       GroupDocs.Parser .NET API fully supports extraction of hyperlinks from CHM documents with ease. The following .NET code example demonstrates how to extract hyperlinks from a CHM document page area.
