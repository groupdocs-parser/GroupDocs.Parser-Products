...
steps:
    enable: true
    block:
    - title_left: "Ekstrak Hyperlink dari XLSM Dokumen melalui .NET"
      content_left: |
       GroupDocs.Parser .NET menyediakan dukungan lengkap untuk mengekstraksi Hyperlink dari dokumen XLSM. Contoh kode C# .NET berikut menunjukkan cara mengekstrak hyperlink di dalam dokumen XLSM. 
    ...
    - title_left: "Ekstrak Hyperlink dari Halaman Dokumen XLSM"
      content_left: |
    ...
    - title_left: "Ekstrak Hyperlink dari XLSM Area Halaman Dokumen"
      content_left: |
       GroupDocs.Parser .NET API sepenuhnya mendukung ekstraksi hyperlink dari dokumen XLSM dengan mudah. Contoh kode .NET berikut menunjukkan cara mengekstrak hyperlink dari area halaman dokumen XLSM.
